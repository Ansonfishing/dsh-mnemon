...
默认 Sidebar 工作台使用「状态、运行时、记忆体、档案」四个一级标签；记忆体下再提供「概览、检索、内容、实体」，「沉淀记忆」作为右侧主操作。运行时记忆、记忆体和项目档案统一采用“标题区右侧添加、下方查看/检索”的结构，添加时打开 DSH 风格弹窗；Buildin 继续保留原有八页分组导航与内联表单视觉。主要界面随 DSH 全局语言在中文与英文间切换。
