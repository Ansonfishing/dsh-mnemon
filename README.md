...
<p align="center">
  <a href="https://github.com/omdsh-dev/dsh-mnemon/blob/main/docs/assets/media/dsh-mnemon-memory-system-demo.mp4">
    <img src="https://raw.githubusercontent.com/omdsh-dev/dsh-mnemon/main/docs/assets/media/dsh-mnemon-memory-system-demo-poster.jpg" alt="dsh-mnemon v0.2.0 Memory System status and provider overview" width="1180">
  </a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/omdsh-dev/dsh-mnemon/blob/main/docs/assets/media/dsh-mnemon-memory-system-demo.mp4">Watch the widescreen demo</a>
</p>
...
[Watch the 1600×900 MP4](https://github.com/omdsh-dev/dsh-mnemon/blob/main/docs/assets/media/dsh-mnemon-memory-system-demo.mp4) · [Open the page-by-page UI guide](./docs/en/ui-guide.md)
...
Both are enabled by default and can be changed independently under **Settings → Memory System → Conversation interface**.
