...
本文流程以 dsh-mnemon v0.3.0、DSH 0.1.0-rc.8 和 Mnemon 0.2.3 为推荐基线；部分保持兼容的界面截图拍摄于 v0.2.0。在 rc.8 进入 npm `latest` 标签前，请通过 `@deepseek-ai/dsh@next` 安装 DSH。升级前先备份，并在隔离目录重复本页验证。
