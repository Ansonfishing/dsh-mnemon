...
This guide follows the default `sidebar` presentation and a real user path through Memory System. Screenshots come from the v0.1.4 interface and use the Chinese locale; names, counts, and content vary with your data.
