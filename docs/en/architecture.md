...
Agent calls mnemon_recall(query, optional memoryBodyIds)
  ...
  -> if surviving evidence loses structured query anchors, run one bounded Native keyword recovery
