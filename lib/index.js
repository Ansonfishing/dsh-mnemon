...
var DocumentController = class {
	...
	constructor(workspaceRoot, limitBytes = DOCUMENTS_ACTIVE_LIMIT_BYTES, now = () => /* @__PURE__ */ new Date()) {
...
var DocumentManager = class {
	...
	constructor(limitBytes = DOCUMENTS_ACTIVE_LIMIT_BYTES, now = () => /* @__PURE__ */ new Date()) {
		this.limitBytes = limitBytes;
		this.now = now;
	}
...
//#endregion
export { Config, DocumentManager, MnemonLifecycle, MnemonService, MnemonSubagentCoordinator, RuntimeMemoryController, apply, createRunner, inject, name, resolveConfig };
