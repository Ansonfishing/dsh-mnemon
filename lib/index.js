...
var MnemonSubagentCoordinator = class {
	...
	constructor(subagents, runtimeMemory) {
	...
	async delegate(parent, operation, label, prompt, tools, outputSchema, signal, preferredProvider = "spawn", persona = WRITE_PERSONA) {
		...
		try {
			run = await this.subagents.start(provider, {
				...
				parent,
				signal,
				...operation === "migration" ? { agentOptions: { maxTokens: 16384 } } : operation === "compaction" ? { agentOptions: { maxTokens: 8192 } } : {},
				outputSchema,
				maxDepth: 1,
...
function createReadHandler(service, lifecycle, runtimeMemory) {
...
function registerRpc(connection, service, lifecycle, runtimeMemory) {
...
function registerTools(ctx, service, coordinator, runtimeMemory) {
...
//#endregion
export { Config, MnemonLifecycle, MnemonService, MnemonSubagentCoordinator, RuntimeMemoryController, apply, createRunner, inject, name, resolveConfig };
