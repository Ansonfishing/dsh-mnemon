window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$4 = ".pDTviq_card{box-sizing:border-box;width:100%;max-width:720px;color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-bg-layer-1));border-radius:12px;overflow:clip}.pDTviq_panelHeader{box-sizing:border-box;align-items:flex-start;gap:20px;min-height:76px;padding:16px;display:flex}.pDTviq_headerCopy{flex:1;min-width:0}.pDTviq_panelHeader h3{margin:0;font-size:15px;font-weight:600;line-height:22px}.pDTviq_panelHeader p{max-width:60ch;color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere;margin:2px 0 0;font-size:12px;line-height:18px}.pDTviq_status{background:var(--dsw-alias-bg-layer-2);min-height:22px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;border-radius:999px;flex:none;align-items:center;margin-top:1px;padding:0 8px;font-size:11px;font-weight:500;line-height:18px;display:inline-flex}.pDTviq_statusDirty{color:var(--dsw-alias-state-warn-label,var(--dsw-alias-label-primary));background:var(--dsw-alias-interactive-bg-hover)}.pDTviq_body{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:16px;padding:16px;display:flex}.pDTviq_notice{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;font-size:12px;line-height:18px}.pDTviq_notice code{font-family:var(--dsw-font-family-mono,var(--ds-font-family-code,monospace));font-size:.95em}.pDTviq_loading{min-height:48px;color:var(--dsw-alias-label-tertiary);text-align:center;margin:0;font-size:12px;line-height:48px}.pDTviq_primarySettings{gap:16px;width:100%;max-width:660px;display:grid}.pDTviq_interactionGroup{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;gap:14px;width:100%;max-width:660px;margin-top:6px;padding:12px 14px 4px;display:grid}.pDTviq_interactionHeader{justify-content:space-between;align-items:center;gap:8px;display:flex}.pDTviq_interactionHeader strong{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.pDTviq_interactionHeader span{color:var(--dsw-alias-state-success-primary);background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 12%, transparent);border-radius:999px;flex:none;padding:1px 8px;font-size:10px;font-weight:500;line-height:16px}.pDTviq_interactionHint{color:var(--dsw-alias-label-secondary);margin:-6px 0 0;font-size:11px;line-height:16px}.pDTviq_checkboxLine{cursor:pointer;width:fit-content;min-height:20px;color:var(--dsw-alias-label-secondary);user-select:none;align-items:center;gap:8px;font-size:12px;line-height:18px;display:inline-flex}.pDTviq_checkboxLine input{width:14px;height:14px;accent-color:var(--dsw-alias-state-business-primary);cursor:pointer;margin:0}.pDTviq_checkboxLine input:disabled{cursor:default}.pDTviq_field{gap:6px;min-width:0;display:grid}.pDTviq_fieldHeading{align-items:center;gap:6px;min-height:20px;display:flex}.pDTviq_fieldTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:500;line-height:18px}.pDTviq_overridden{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;flex:none;padding:1px 6px;font-size:10px;font-style:normal;font-weight:400;line-height:16px}.pDTviq_reset{color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;background:0 0;border:0;flex:none;margin-left:auto;padding:2px 0;font-size:11px;line-height:16px}.pDTviq_reset:hover{color:var(--dsw-alias-label-primary)}.pDTviq_reset:disabled{cursor:not-allowed;opacity:.5}.pDTviq_field input,.pDTviq_field select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:38px;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major,var(--dsw-alias-bg-layer-2));font:inherit;border-radius:8px;outline:0;padding:0 10px;font-size:12px;transition:border-color .12s,box-shadow .12s,background-color .12s}.pDTviq_field input{font-family:var(--dsw-font-family-mono,var(--ds-font-family-code,monospace))}.pDTviq_field input:focus,.pDTviq_field select:focus{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px var(--dsw-alias-interactive-bg-hover)}.pDTviq_field input[aria-invalid=true]{border-color:var(--dsw-alias-state-error-primary)}.pDTviq_field input:disabled,.pDTviq_field select:disabled{cursor:not-allowed;opacity:.55}.pDTviq_fieldHint{color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;margin:0;font-size:11px;line-height:16px}.pDTviq_feedback:empty{display:none}.pDTviq_error,.pDTviq_readOnly{background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:7px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.pDTviq_error{color:var(--dsw-alias-state-error-primary)}.pDTviq_readOnly{color:var(--dsw-alias-label-tertiary)}.pDTviq_feedback{gap:6px;display:grid}.pDTviq_actions{justify-content:flex-end;gap:8px;padding-top:2px;display:flex}.pDTviq_actions button{cursor:pointer;min-width:88px;min-height:34px;font:inherit;touch-action:manipulation;border-radius:999px;padding:7px 14px;font-size:12px;font-weight:500;line-height:18px;transition:background-color .12s,border-color .12s,color .12s,opacity .12s}.pDTviq_actions button:disabled{cursor:not-allowed;opacity:.5}.pDTviq_actions button:focus-visible,.pDTviq_reset:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.pDTviq_discard{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3,transparent);border:1px solid var(--dsw-alias-border-l2)}.pDTviq_discard:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-solid,var(--dsw-alias-interactive-bg-hover))}.pDTviq_save{color:var(--dsw-alias-label-primary-foreground,#fff);background:var(--dsw-alias-button-primary-fill,var(--dsw-alias-state-business-primary));border:1px solid #0000}.pDTviq_save:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover,var(--dsw-alias-state-business-primary))}@media (width<=560px){.pDTviq_body{padding:14px}.pDTviq_panelHeader{flex-direction:column;gap:8px;padding:14px}.pDTviq_status{margin-top:0}.pDTviq_field input,.pDTviq_field select{height:40px}.pDTviq_actions button{flex:1}}@media (width<=360px){.pDTviq_actions{flex-direction:column-reverse}.pDTviq_fieldHeading{flex-wrap:wrap}.pDTviq_reset{margin-left:0}}@media (prefers-reduced-motion:reduce){.pDTviq_field input,.pDTviq_field select,.pDTviq_actions button{transition:none}}";
		...
		var MnemonSettingsCard_module_css_default = {
			...
			"panelHeader": "pDTviq_panelHeader",
			"reset": "pDTviq_reset",
			"overridden": "pDTviq_overridden",
			"checkboxLine": "pDTviq_checkboxLine",
			"fieldHeading": "pDTviq_fieldHeading",
			"interactionHint": "pDTviq_interactionHint",
			...
			"interactionGroup": "pDTviq_interactionGroup",
			"fieldTitle": "pDTviq_fieldTitle",
			"fieldHint": "pDTviq_fieldHint",
			"statusDirty": "pDTviq_statusDirty",
			"interactionHeader": "pDTviq_interactionHeader",
			"headerCopy": "pDTviq_headerCopy",
			"primarySettings": "pDTviq_primarySettings"
		};
		//#endregion
