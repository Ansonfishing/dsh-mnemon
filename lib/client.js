window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$4 = ".pDTviq_page{box-sizing:border-box;width:100%;max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:24px;font-family:inherit;display:flex}.pDTviq_loading{min-height:120px;color:var(--dsw-alias-label-tertiary);text-align:center;margin:0;font-size:13px;line-height:120px}.pDTviq_section{flex-direction:column;gap:10px;min-width:0;display:flex}.pDTviq_section+.pDTviq_section{padding-top:2px}.pDTviq_sectionHeading{align-items:flex-start;gap:16px;min-width:0;display:flex}.pDTviq_sectionHeading>div{flex:1;min-width:0}.pDTviq_sectionHeading h2{color:var(--dsw-alias-label-primary);margin:0;font-size:13px;font-weight:500;line-height:20px}.pDTviq_sectionHeading p{max-width:64ch;color:var(--dsw-alias-label-tertiary);margin:2px 0 0;font-size:12px;line-height:18px}.pDTviq_reset{color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;background:0 0;border:0;flex:none;padding:1px 0;font-size:12px;line-height:18px}.pDTviq_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.pDTviq_reset:disabled{cursor:default;opacity:.4}.pDTviq_choiceGrid{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;display:grid}.pDTviq_choiceCard{cursor:pointer;min-width:0;display:block}.pDTviq_choiceCard>input{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.pDTviq_choiceFace{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);min-width:0;min-height:60px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3);border-radius:8px;flex-direction:column;justify-content:center;gap:1px;padding:9px 34px 9px 12px;transition:border-color .14s,background-color .14s;display:flex;position:relative}.pDTviq_choiceFace:hover{border-color:var(--dsw-alias-label-dimmed);background:var(--dsw-alias-interactive-bg-hover)}.pDTviq_choiceFace strong{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.pDTviq_choiceFace small{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:400;line-height:17px;overflow:hidden}.pDTviq_check{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:18px;display:none;position:absolute;top:10px;right:11px}.pDTviq_choiceCard>input:checked+.pDTviq_choiceFace{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-interactive-bg-hover)}.pDTviq_choiceCard>input:checked+.pDTviq_choiceFace .pDTviq_check{display:block}.pDTviq_choiceCard>input:focus-visible+.pDTviq_choiceFace,.pDTviq_reset:focus-visible,.pDTviq_actions button:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary));outline-offset:2px}.pDTviq_choiceCard>input:disabled+.pDTviq_choiceFace{cursor:default;opacity:.45}.pDTviq_choiceCard:has(input:disabled){cursor:default}.pDTviq_customField{flex-direction:column;gap:6px;padding-top:2px;display:flex}.pDTviq_fieldHeading{align-items:center;gap:12px;display:flex}.pDTviq_fieldHeading label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:12px;font-weight:500;line-height:18px}.pDTviq_inlineActions{flex:none;gap:12px;display:flex}.pDTviq_customField input,.pDTviq_customField select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3);font:inherit;font-family:var(--ds-font-family-code,monospace);border-radius:8px;padding:0 12px;font-size:13px;line-height:20px}.pDTviq_customField select{appearance:auto}.pDTviq_customField input:focus-visible,.pDTviq_customField select:focus-visible{border-color:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary));outline:none}.pDTviq_customField input[aria-invalid=true]{border-color:var(--dsw-alias-state-error-primary)}.pDTviq_customField input:disabled,.pDTviq_customField select:disabled{cursor:default;opacity:.45}.pDTviq_addPackFields{border-top:1px solid var(--dsw-alias-border-l2);grid-template-columns:minmax(0,.8fr) minmax(0,1.4fr) auto;gap:8px;margin-top:4px;padding-top:10px;display:grid}.pDTviq_compactButton{appearance:none;border:1px solid var(--dsw-alias-border-l2);min-width:76px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3);cursor:pointer;font:inherit;border-radius:8px;padding:0 12px;font-size:12px}.pDTviq_compactButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.pDTviq_compactButton:disabled{cursor:default;opacity:.4}.pDTviq_customField p,.pDTviq_settingsNote{color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;margin:0;font-size:11px;line-height:17px}.pDTviq_feedback{gap:6px;margin-top:-10px;display:grid}.pDTviq_feedback:empty{display:none}.pDTviq_error,.pDTviq_readOnly{overflow-wrap:anywhere;margin:0;font-size:12px;line-height:18px}.pDTviq_error{color:var(--dsw-alias-state-error-primary)}.pDTviq_readOnly{color:var(--dsw-alias-label-tertiary)}.pDTviq_actions{display:none}.pDTviq_actionsVisible{border-top:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:16px;padding-top:12px;display:flex}.pDTviq_actions>span{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.pDTviq_actions>div{gap:8px;display:flex}.pDTviq_actions button{appearance:none;cursor:pointer;min-width:82px;font:inherit;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:20px}.pDTviq_actions button:disabled{cursor:default;opacity:.4}.pDTviq_discard{color:var(--dsw-alias-label-secondary);background:0 0;border-color:var(--dsw-alias-border-l2)!important}.pDTviq_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)!important}.pDTviq_save{color:var(--dsw-alias-bg-layer-3);background:var(--dsw-alias-label-primary)}.pDTviq_settingsNote{margin-top:-12px}.pDTviq_settingsNote code{color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,monospace);font-size:inherit}.pDTviq_packTarget{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:8px;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:10px;min-width:0;padding:9px 11px;display:grid}.pDTviq_packTarget[data-pending-restart]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b7791f) 40%, var(--dsw-alias-border-l2))}.pDTviq_packTargetGlyph{width:26px;height:26px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);border-radius:7px;place-items:center;font-size:13px;display:grid}.pDTviq_packTarget>div{grid-template-columns:auto minmax(0,1fr);align-items:baseline;gap:0 9px;min-width:0;display:grid}.pDTviq_packTarget strong{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:500}.pDTviq_packTarget code{min-width:0;color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,monospace);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}.pDTviq_packTarget small{color:var(--dsw-alias-label-tertiary);grid-column:1/-1;font-size:10px;line-height:15px}.pDTviq_packTarget em{color:var(--dsw-alias-state-warning-primary,#9a6700);background:color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b7791f) 10%, transparent);white-space:nowrap;border-radius:999px;padding:2px 7px;font-size:10px;font-style:normal}.pDTviq_packGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;display:grid}.pDTviq_packCard{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:8px;align-items:center;gap:10px;min-width:0;min-height:76px;padding:10px;display:flex}.pDTviq_packCardHeading{flex:1;align-items:center;gap:9px;min-width:0;display:flex}.pDTviq_packCardHeading>span{border:1px solid var(--dsw-alias-border-l2);width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);font:600 9px/1 var(--ds-font-family-code,monospace);letter-spacing:.04em;border-radius:7px;flex:none;place-items:center;display:grid}.pDTviq_packCardHeading>div{min-width:0;display:grid}.pDTviq_packCardHeading strong{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:500;line-height:18px}.pDTviq_packCardHeading small{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:15px;overflow:hidden}.pDTviq_packCardActions{flex-direction:column;flex:none;gap:4px;display:flex}.pDTviq_packCardActions button,.pDTviq_packImportActions button,.pDTviq_packReplaceConfirm button,.pDTviq_packPreview header button{appearance:none;border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;background:0 0;border-radius:7px;font-size:11px}.pDTviq_packCardActions button{min-width:58px;padding:3px 8px}.pDTviq_packCardActions button:hover:not(:disabled),.pDTviq_packImportActions button:hover:not(:disabled),.pDTviq_packReplaceConfirm button:hover:not(:disabled),.pDTviq_packPreview header button:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.pDTviq_packCardActions button:disabled,.pDTviq_packImportActions button:disabled,.pDTviq_packReplaceConfirm button:disabled,.pDTviq_packPreview header button:disabled{cursor:default;opacity:.4}.pDTviq_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.pDTviq_packFormatHint{color:var(--dsw-alias-label-tertiary);margin:-3px 0 0;font-size:10px;line-height:16px}.pDTviq_packPreview{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);border-radius:9px;gap:11px;padding:12px;display:grid}.pDTviq_packPreview header{justify-content:space-between;align-items:flex-start;gap:12px;display:flex}.pDTviq_packPreview header>div{min-width:0;display:grid}.pDTviq_packPreview header span{color:var(--dsw-alias-label-tertiary);text-transform:uppercase;letter-spacing:.08em;font-size:9px;line-height:14px}.pDTviq_packPreview header strong{color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,monospace);text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:500;overflow:hidden}.pDTviq_packPreview header button{border-color:#0000;flex:none;width:26px;height:26px;font-size:17px;line-height:20px}.pDTviq_packPreview dl{grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;margin:0;display:grid}.pDTviq_packPreview dl>div{gap:1px;min-width:0;display:grid}.pDTviq_packPreview dt{color:var(--dsw-alias-label-tertiary);font-size:9px}.pDTviq_packPreview dd{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:10px;line-height:16px;overflow:hidden}.pDTviq_packPreview dd code{font-family:var(--ds-font-family-code,monospace)}.pDTviq_packComponentChoices{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px;display:grid}.pDTviq_packComponentChoices label{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);cursor:pointer;border-radius:7px;grid-template-columns:auto minmax(0,1fr);align-items:start;gap:6px;min-width:0;padding:7px 8px;display:grid;position:relative}.pDTviq_packComponentChoices label:has(input:disabled){cursor:default}.pDTviq_packComponentChoices input{margin:3px 0 0}.pDTviq_packComponentChoices span{min-width:0;display:grid}.pDTviq_packComponentChoices strong{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:500}.pDTviq_packComponentChoices small{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:9px;overflow:hidden}.pDTviq_packComponentChoices em{width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);border-radius:999px;grid-column:2;padding:1px 5px;font-size:8px;font-style:normal}.pDTviq_packImportActions{border-top:1px solid var(--dsw-alias-border-l2);grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;padding-top:10px;display:grid}.pDTviq_packImportActions>div{display:grid}.pDTviq_packImportActions strong{color:var(--dsw-alias-label-primary);font-size:11px;font-weight:500}.pDTviq_packImportActions small{color:var(--dsw-alias-label-tertiary);font-size:9px}.pDTviq_packImportActions button,.pDTviq_packReplaceConfirm button{min-height:30px;padding:4px 10px}.pDTviq_packPrimary{border-color:var(--dsw-alias-label-primary)!important;color:var(--dsw-alias-bg-layer-3)!important;background:var(--dsw-alias-label-primary)!important}.pDTviq_packDangerLink{color:var(--dsw-alias-state-error-primary)!important;border-color:#0000!important}.pDTviq_packReplaceConfirm{border:1px solid color-mix(in srgb, var(--dsw-alias-state-error-primary) 32%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 5%, var(--dsw-alias-bg-layer-3));border-radius:7px;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;padding:8px;display:grid}.pDTviq_packReplaceConfirm>div{display:grid}.pDTviq_packReplaceConfirm strong{color:var(--dsw-alias-state-error-primary);font-size:11px;font-weight:500}.pDTviq_packReplaceConfirm span{color:var(--dsw-alias-label-tertiary);font-size:9px}.pDTviq_packDanger{border-color:var(--dsw-alias-state-error-primary)!important;color:var(--dsw-alias-bg-layer-3)!important;background:var(--dsw-alias-state-error-primary)!important}.pDTviq_packFeedback{gap:4px;display:grid}.pDTviq_packFeedback:empty{display:none}.pDTviq_packFeedback p{margin:0}.pDTviq_packSuccess{color:var(--dsw-alias-state-success-primary);overflow-wrap:anywhere;font-size:11px;line-height:17px}@media (width<=620px){.pDTviq_choiceGrid{grid-template-columns:minmax(0,1fr)}.pDTviq_actionsVisible{flex-direction:column;align-items:stretch}.pDTviq_actions>div,.pDTviq_actions button{flex:1}.pDTviq_addPackFields,.pDTviq_packGrid,.pDTviq_packPreview dl,.pDTviq_packComponentChoices,.pDTviq_packImportActions,.pDTviq_packReplaceConfirm{grid-template-columns:minmax(0,1fr)}.pDTviq_packCard{flex-direction:column;align-items:stretch}.pDTviq_packCardActions{flex-direction:row}.pDTviq_packCardActions button{flex:1}.pDTviq_packTarget{grid-template-columns:auto minmax(0,1fr)}.pDTviq_packTarget em{grid-column:2;width:max-content}}@media (prefers-reduced-motion:reduce){.pDTviq_choiceFace{transition:none}}";
		...
		var MnemonSettingsCard_module_css_default = {
			...
			"reset": "pDTviq_reset",
			"packCardHeading": "pDTviq_packCardHeading",
			"save": "pDTviq_save",
			"packImportActions": "pDTviq_packImportActions",
			"packDanger": "pDTviq_packDanger",
			"section": "pDTviq_section",
			"page": "pDTviq_page",
			"packReplaceConfirm": "pDTviq_packReplaceConfirm",
			"packComponentChoices": "pDTviq_packComponentChoices",
			"fieldHeading": "pDTviq_fieldHeading",
			"packCardActions": "pDTviq_packCardActions",
			"inlineActions": "pDTviq_inlineActions",
			"packPrimary": "pDTviq_packPrimary",
			"packFormatHint": "pDTviq_packFormatHint",
			"feedback": "pDTviq_feedback",
			"packTargetGlyph": "pDTviq_packTargetGlyph",
			"packPreview": "pDTviq_packPreview",
			"choiceCard": "pDTviq_choiceCard",
			"packDangerLink": "pDTviq_packDangerLink",
			...
			"packGrid": "pDTviq_packGrid",
			"sectionHeading": "pDTviq_sectionHeading",
			"compactButton": "pDTviq_compactButton",
			"readOnly": "pDTviq_readOnly",
			"packFeedback": "pDTviq_packFeedback",
			"packCard": "pDTviq_packCard",
			"customField": "pDTviq_customField",
			"actionsVisible": "pDTviq_actionsVisible",
			"addPackFields": "pDTviq_addPackFields",
			"error": "pDTviq_error",
			"settingsNote": "pDTviq_settingsNote",
			"packTarget": "pDTviq_packTarget",
			"check": "pDTviq_check"
		};
		//#endregion
		...
		const zh = {
			...
			"status.storageFootnote": "当前实际读写根：{root}。存储范围只在 DSH「设置 → 记忆系统」中修改，重启后生效；插件不会自动迁移、合并或删除旧内容。",
			...
			"config.noticeAfter": "；存储设置重启 DSH 后生效，对话呈现保存后实时生效。切换范围不会自动迁移旧内容。",
			"config.storageTitle": "存储位置",
			"config.storageDescription": "决定 Mnemon 的运行时记忆、项目档案与记忆体保存在哪里。",
			"config.scope": "存储范围",
			...
			"config.packDescription": "整体或按组件导出与导入当前正在运行的 Mnemon 数据；导入始终落到下方显示的生效目录。",
			"config.packActiveTarget": "当前生效目录",
			"config.packTargetLoading": "正在读取运行目标…",
			"config.packRestartPending": "等待重启切换",
			"config.packUnavailable": "当前 DSH 主机不支持 Mnemon Pack 通道。",
			...
			"config.packFailed": "Pack 操作失败：{error}"
		};
		const en = {
			...
			"status.storageFootnote": "Current read/write root: {root}. Change the scope only in DSH Settings → Memory System; it applies after restart and never auto-migrates, merges, or deletes old content.",
			...
			"config.ready": "Settings synchronized",
			"config.restart": "Applies after restart",
			"config.noticeBefore": "Configuration is written to",
			"config.noticeAfter": ". Storage settings apply after restarting DSH; conversation presentation applies live after saving. Switching scopes never migrates existing content automatically.",
			"config.storageTitle": "Storage location",
			"config.storageDescription": "Choose where Mnemon keeps runtime memory, project Documents, and Memory Spaces.",
			...
			"config.customHintShort": "Enter an absolute path",
			...
			"config.packDescription": "Export or import the complete active Mnemon data domain or one component. Imports always target the effective directory shown below.",
			"config.packActiveTarget": "Active directory",
			"config.packTargetLoading": "Loading the running target…",
			"config.packRestartPending": "Restart required to switch",
			"config.packUnavailable": "This DSH host does not provide the Mnemon Pack channel.",
			...
			"config.packFailed": "Pack operation failed: {error}"
		};
		...
		var MnemonClient = class {
			...
			importPack(base64, mode, components) {
				return this.call(MNEMON_PACK_CHANNEL, "import", {
					base64,
					mode,
		...
		function fileBase64(file) {
			return new Promise((resolve, reject) => {
				...
				reader.onerror = () => reject(reader.error ?? /* @__PURE__ */ new Error("Could not read Pack file"));
				reader.onload = () => {
					const value = reader.result;
					if (typeof value !== "string") return reject(/* @__PURE__ */ new Error("Could not read Pack file"));
					const separator = value.indexOf(",");
					if (separator < 0) return reject(/* @__PURE__ */ new Error("Pack file encoding is invalid"));
		...
		function MnemonPackSection({ connection, configuredScope, configuredDirectory, storageDirty, t }) {
			const client = (0, react.useMemo)(() => connection === void 0 ? null : new MnemonClient(connection), [connection]);
			const inputs = (0, react.useRef)({});
			const [target, setTarget] = (0, react.useState)(null);
			const [targetFailed, setTargetFailed] = (0, react.useState)(null);
			...
			const componentLabel = (component) => component === "runtime" ? t("config.packRuntime") : component === "documents" ? t("config.packDocuments") : t("config.packMemorySpaces");
			...
			const scopes = [
				{
					scope: "full",
					glyph: "PK",
					title: t("config.packFull"),
					hint: t("config.packFullHint")
				},
				{
					scope: "runtime",
					glyph: "RT",
					title: t("config.packRuntime"),
					hint: t("config.packRuntimeHint")
				},
				{
					scope: "documents",
					glyph: "DC",
					title: t("config.packDocuments"),
					hint: t("config.packDocumentsHint")
				},
				{
					scope: "memory-spaces",
					glyph: "DB",
					title: t("config.packMemorySpaces"),
					hint: t("config.packMemorySpacesHint")
				}
			];
			...
			const inspectFile = async (requestedScope, file) => {
				...
				try {
					...
					const components = requestedScope === "full" ? [...preview.manifest.components] : preview.manifest.components.includes(requestedScope) ? [requestedScope] : [];
			...
			const chooseFile = (scope, event) => {
				...
				if (file !== void 0) inspectFile(scope, file);
			};
			const toggleComponent = (component) => {
				setPending((current) => {
					if (current === null || current.requestedScope !== "full") return current;
					const components = current.components.includes(component) ? current.components.filter((value) => value !== component) : current.preview.manifest.components.filter((value) => value === component || current.components.includes(value));
					return {
						...current,
						components
					};
			...
			const importPending = async (mode) => {
				...
				try {
					...
					setNotice(t("config.packImported", {
						components: result.components.map(componentLabel).join("、"),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("config.packDescription") })] })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: MnemonSettingsCard_module_css_default.packTarget,
						"data-pending-restart": restartPending || void 0,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: MnemonSettingsCard_module_css_default.packTargetGlyph,
								"aria-hidden": "true",
								children: "⌂"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("config.packActiveTarget") }), target !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: target.root }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", { children: [scopeLabel(target.scope), target.customPackId === void 0 ? "" : ` · ${target.customPackId}`] })] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: targetFailed === null ? t("config.packTargetLoading") : t("config.packUnavailable") })] }),
							restartPending && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", { children: t("config.packRestartPending") })
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: MnemonSettingsCard_module_css_default.packGrid,
						children: scopes.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
							className: MnemonSettingsCard_module_css_default.packCard,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: MnemonSettingsCard_module_css_default.packCardHeading,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										"aria-hidden": "true",
										children: item.glyph
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: item.title }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: item.hint })] })]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: MnemonSettingsCard_module_css_default.packCardActions,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										disabled: unavailable || busy !== null,
										onClick: () => void exportScope(item.scope),
										children: busy === `export:${item.scope}` ? t("config.packExporting") : t("config.packExport")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										disabled: unavailable || busy !== null,
										onClick: () => inputs.current[item.scope]?.click(),
										children: busy === `inspect:${item.scope}` ? t("config.packInspecting") : t("config.packImport")
									})]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									ref: (element) => {
										inputs.current[item.scope] = element;
									},
									className: MnemonSettingsCard_module_css_default.visuallyHidden,
									type: "file",
									accept: PACK_ACCEPT,
									"aria-label": t("config.packChooseFile", { component: item.title }),
									onChange: (event) => chooseFile(item.scope, event)
								})
							]
						}, item.scope))
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: MnemonSettingsCard_module_css_default.packFormatHint,
						children: t("config.packFormatHint")
					}),
					pending !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						className: MnemonSettingsCard_module_css_default.packPreview,
						"aria-labelledby": "mnemon-pack-preview-heading",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.packPreviewEyebrow") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
								id: "mnemon-pack-preview-heading",
								children: pending.preview.fileName ?? t("config.packUnnamed")
							})] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								disabled: busy !== null,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", { children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("config.packSource") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dd", { children: [
									pending.preview.manifest.source.plugin,
									" ",
									pending.preview.manifest.source.pluginVersion,
									" · ",
									new Date(pending.preview.manifest.exportedAt).toLocaleString()
								] })] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("config.packDestination") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: pending.preview.targetRoot }) })] }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("config.packArchiveSize") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dd", { children: [
									formatBytes(pending.preview.archiveBytes),
									" / ",
									formatBytes(pending.preview.expandedBytes)
								] })] })
							] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: MnemonSettingsCard_module_css_default.packComponentChoices,
								"aria-label": t("config.packComponents"),
								children: pending.preview.manifest.summary.map((summary) => {
									...
									return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											...
											onChange: () => toggleComponent(summary.component)
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: componentLabel(summary.component) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: t("config.packComponentSummary", {
											items: summary.items,
											files: summary.files,
											size: formatBytes(summary.bytes)
										}) })] }),
										pending.preview.occupied[summary.component] && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("em", { children: t("config.packHasData") })
									] }, summary.component);
								})
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: MnemonSettingsCard_module_css_default.packImportActions,
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("config.packMerge") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: t("config.packMergeHint") })] }),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: MnemonSettingsCard_module_css_default.packPrimary,
										disabled: busy !== null || pending.components.length === 0,
										onClick: () => void importPending("merge"),
										children: busy === "import:merge" ? t("config.packImporting") : t("config.packMergeAction")
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: MnemonSettingsCard_module_css_default.packDangerLink,
										disabled: busy !== null || pending.components.length === 0,
										onClick: () => setConfirmReplace(true),
										children: t("config.packReplaceAction")
									})
								]
							}),
							confirmReplace && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: MnemonSettingsCard_module_css_default.packReplaceConfirm,
								role: "alert",
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("config.packReplace") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.packReplaceHint") })] }),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										disabled: busy !== null,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: MnemonSettingsCard_module_css_default.packDanger,
										disabled: busy !== null,
										onClick: () => void importPending("replace"),
										children: busy === "import:replace" ? t("config.packImporting") : t("config.packConfirmReplace")
									})
								]
							})
						]
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						"aria-live": "polite",
						children: [
							targetFailed !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: MnemonSettingsCard_module_css_default.error,
								children: t("config.packFailed", { error: targetFailed })
							}),
		...
		function coreDraft(value) {
			...
			if (legacyDirectory !== "" && !customPacks.some((pack) => pack.dataDir === legacyDirectory)) {
				...
				customPacks.push({
					id,
					name: "Custom Pack",
					dataDir: legacyDirectory
				});
			}
			const selected = customPacks.find((pack) => pack.id === resolved.customPackId) ?? customPacks.find((pack) => pack.dataDir === legacyDirectory) ?? (customPacks.length === 1 ? customPacks[0] : void 0);
			return {
		...
		function operations(fields, dirty, reset, draft) {
			return fields.flatMap((field) => {
				...
				if (reset.has(field) || field === "dataDir" && draft.dataDir.trim() === "") return [{
					op: "unset",
					path: [field]
				}];
		...
		function MnemonSettingsCard({ scope, interactionScope: suppliedInteractionScope, connection, t = translateZh }) {
			...
			const [failed, setFailed] = (0, react.useState)(null);
			const [addingPack, setAddingPack] = (0, react.useState)(false);
			const [newPackName, setNewPackName] = (0, react.useState)("");
			const [newPackDirectory, setNewPackDirectory] = (0, react.useState)("");
			(0, react.useEffect)(() => {
			...
			const inherited = (0, react.useMemo)(() => draftOf(record(coreSnapshot.base), record(interactionSnapshot.base)), [coreSnapshot.base, interactionSnapshot.base]);
			const coreUser = (0, react.useMemo)(() => record(coreSnapshot.user), [coreSnapshot.user]);
			const interactionUser = (0, react.useMemo)(() => record(interactionSnapshot.user), [interactionSnapshot.user]);
			...
			const chooseScope = (storageScope) => {
				...
				const customPacks = [...draft.customPacks, {
					id,
					name: t("config.customDefaultName"),
					dataDir: ""
				}];
				stageCore({
					storageScope,
			...
			const chooseCustomPack = (customPackId) => {
				...
				}, ["customPackId", "dataDir"]);
			};
			const editCustomDirectory = (dataDir) => {
				const customPacks = draft.customPacks.map((pack) => pack.id === draft.customPackId ? {
					...pack,
					dataDir
				} : pack);
				stageCore({
			...
			const resetFields = (fields) => {
				for (const field of fields) if (overridden(field)) resetField(field);
			};
			const discard = () => {
			...
			const save = async () => {
				...
				setFailed(null);
				try {
					const coreOps = operations(draft.storageScope === "custom" ? [
						"customPacks",
						"customPackId",
						"dataDir",
						"storageScope"
					] : CORE_FIELDS, dirty, reset, draft);
				...
				children: loading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
									...
									" ",
									t("config.restart")
								] })] }), storageOverridden && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									className: MnemonSettingsCard_module_css_default.reset,
									type: "button",
									disabled: coreDisabled,
									onClick: () => resetFields(CORE_FIELDS),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChoiceCard, {
										...
										disabled: coreDisabled,
										onChange: () => chooseScope("workspace")
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChoiceCard, {
										id: "mnemon-storage-custom",
										name: "mnemon-storage",
										label: t("config.custom"),
										detail: draft.customPacks.find((pack) => pack.id === draft.customPackId)?.name || t("config.customHintShort"),
										checked: draft.storageScope === "custom",
										disabled: coreDisabled,
										onChange: () => chooseScope("custom")
									})
								]
							}),
							draft.storageScope === "custom" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: MnemonSettingsCard_module_css_default.customField,
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: MnemonSettingsCard_module_css_default.fieldHeading,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
											htmlFor: "mnemon-custom-pack",
											children: t("config.customPack")
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: MnemonSettingsCard_module_css_default.inlineActions,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												className: MnemonSettingsCard_module_css_default.reset,
												type: "button",
												disabled: coreDisabled,
												onClick: () => setAddingPack((value) => !value),
												children: addingPack ? t("config.cancelAddPack") : t("config.addPack")
											}), draft.customPacks.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												className: MnemonSettingsCard_module_css_default.reset,
												type: "button",
												disabled: coreDisabled,
												onClick: removeCustomPack,
												children: t("config.removePack")
											})]
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
										id: "mnemon-custom-pack",
										"aria-label": t("config.customPackAria"),
										value: draft.customPackId,
										onChange: (event) => chooseCustomPack(event.target.value),
										disabled: coreDisabled || draft.customPacks.length === 0,
										children: [draft.customPacks.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: "",
											children: t("config.noCustomPacks")
										}), draft.customPacks.map((pack) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: pack.id,
											children: pack.name
										}, pack.id))]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: MnemonSettingsCard_module_css_default.fieldHeading,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
											htmlFor: "mnemon-custom-directory",
											children: t("config.customDirectory")
										}), overridden("dataDir") && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											className: MnemonSettingsCard_module_css_default.reset,
											type: "button",
											disabled: coreDisabled,
											onClick: () => resetField("dataDir"),
											children: t("config.reset")
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
										...
										value: draft.dataDir,
										onChange: (event) => editCustomDirectory(event.target.value),
										placeholder: "~/mnemon-data",
										spellCheck: false,
										autoComplete: "off",
										disabled: coreDisabled || draft.customPackId === ""
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
										id: "mnemon-custom-directory-hint",
										children: t("config.customHint")
									}),
									addingPack && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: MnemonSettingsCard_module_css_default.addPackFields,
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
												"aria-label": t("config.customPackNameAria"),
												value: newPackName,
												onChange: (event) => setNewPackName(event.target.value),
												placeholder: t("config.customPackNamePlaceholder"),
												maxLength: 100,
												disabled: coreDisabled
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
												"aria-label": t("config.newPackDirectoryAria"),
												value: newPackDirectory,
												onChange: (event) => setNewPackDirectory(event.target.value),
												placeholder: "~/mnemon-packs/project",
												spellCheck: false,
												autoComplete: "off",
												disabled: coreDisabled
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												type: "button",
												className: MnemonSettingsCard_module_css_default.compactButton,
												disabled: coreDisabled || newPackName.trim() === "" || newPackDirectory.trim() === "",
												onClick: addCustomPack,
												children: t("config.confirmAddPack")
											})
										]
									})
								]
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("config.interactionHint") })] }), interactionOverridden && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								className: MnemonSettingsCard_module_css_default.reset,
								type: "button",
								disabled: interactionDisabled,
								onClick: () => resetFields(INTERACTION_FIELDS),
								children: t("config.reset")
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MnemonSettingsCard_module_css_default.choiceGrid,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToggleCard, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("footer", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.unsaved") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							disabled: dirty.size === 0 || saving || error !== null || !writable,
							onClick: () => void save(),
