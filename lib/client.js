window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$4 = ".pDTviq_page{box-sizing:border-box;width:min(760px,100%);color:var(--dsw-alias-label-primary);margin:0 auto;padding:4px 0 28px}.pDTviq_pageHeader{align-items:flex-start;gap:24px;padding:8px 0 18px;display:flex}.pDTviq_headerCopy{flex:1;min-width:0}.pDTviq_eyebrow{color:var(--dsw-alias-state-business-primary);letter-spacing:.12em;margin-bottom:3px;font-size:10px;font-weight:700;line-height:16px;display:block}.pDTviq_pageHeader h2{margin:0;font-size:20px;font-weight:600;line-height:28px}.pDTviq_pageHeader p{max-width:62ch;color:var(--dsw-alias-label-secondary);margin:4px 0 0;font-size:12px;line-height:18px}.pDTviq_status,.pDTviq_restartBadge,.pDTviq_liveBadge,.pDTviq_overridden{white-space:nowrap;border-radius:6px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:10px;font-weight:500;line-height:18px;display:inline-flex}.pDTviq_status{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-2);margin-top:20px}.pDTviq_statusDirty{color:var(--dsw-alias-state-warn-primary,var(--dsw-alias-label-primary));background:var(--dsw-alias-interactive-bg-hover)}.pDTviq_notice{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:8px;margin:0 0 14px;padding:9px 11px;font-size:11px;line-height:17px}.pDTviq_notice code{font-family:var(--dsw-font-family-mono,var(--ds-font-family-code,monospace));font-size:.95em}.pDTviq_loading{min-height:120px;color:var(--dsw-alias-label-tertiary);text-align:center;margin:0;font-size:12px;line-height:120px}.pDTviq_group{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;margin-top:12px;overflow:hidden}.pDTviq_groupHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);align-items:flex-start;gap:20px;padding:14px 16px;display:flex}.pDTviq_groupHeader>div{flex:1;min-width:0}.pDTviq_groupHeader h3{margin:0;font-size:13px;font-weight:600;line-height:20px}.pDTviq_groupHeader p{max-width:62ch;color:var(--dsw-alias-label-secondary);margin:2px 0 0;font-size:11px;line-height:16px}.pDTviq_restartBadge{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-1)}.pDTviq_liveBadge{color:var(--dsw-alias-state-success-primary,#219653);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#219653) 10%, transparent)}.pDTviq_fields{gap:16px;padding:16px;display:grid}.pDTviq_field{gap:6px;min-width:0;display:grid}.pDTviq_fieldHeading{align-items:center;gap:6px;min-height:20px;display:flex}.pDTviq_fieldTitle{font-size:12px;font-weight:500;line-height:18px}.pDTviq_overridden{min-height:18px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);padding:0 6px;font-style:normal}.pDTviq_reset{cursor:pointer;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border:0;flex:none;margin-left:auto;padding:2px 0;font-size:11px;line-height:16px}.pDTviq_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.pDTviq_reset:disabled{cursor:not-allowed;opacity:.5}.pDTviq_field input,.pDTviq_field select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:36px;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major,var(--dsw-alias-bg-layer-2));font:inherit;border-radius:8px;outline:0;padding:0 10px;font-size:12px;transition:border-color .12s,box-shadow .12s}.pDTviq_field input{font-family:var(--dsw-font-family-mono,var(--ds-font-family-code,monospace))}.pDTviq_field input:focus,.pDTviq_field select:focus{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px var(--dsw-alias-interactive-bg-hover)}.pDTviq_field input[aria-invalid=true]{border-color:var(--dsw-alias-state-error-primary)}.pDTviq_field input:disabled,.pDTviq_field select:disabled{cursor:not-allowed;opacity:.55}.pDTviq_fieldHint{color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;margin:0;font-size:11px;line-height:16px}.pDTviq_switches{display:grid}.pDTviq_switchRow{align-items:center;gap:20px;min-height:64px;padding:10px 16px;display:flex}.pDTviq_switchRow+.pDTviq_switchRow{border-top:1px solid var(--dsw-alias-border-l2)}.pDTviq_switchCopy{cursor:pointer;flex:1;gap:2px;min-width:0;display:grid}.pDTviq_switchCopy strong{font-size:12px;font-weight:500;line-height:18px}.pDTviq_switchCopy span{max-width:60ch;color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px}.pDTviq_switchControl{flex:none;align-items:center;gap:12px;display:flex}.pDTviq_switchControl .pDTviq_reset{margin-left:0}.pDTviq_switch{cursor:pointer;display:inline-flex;position:relative}.pDTviq_switch input{opacity:0;width:1px;height:1px;position:absolute;overflow:hidden}.pDTviq_switch span{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-bg-layer-2));border-radius:10px;width:34px;height:20px;transition:background-color .12s,border-color .12s;display:block;position:relative}.pDTviq_switch span:after{content:\"\";background:var(--dsw-alias-label-tertiary);border-radius:50%;width:14px;height:14px;transition:transform .12s,background-color .12s;position:absolute;top:2px;left:2px}.pDTviq_switch input:checked+span{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary)}.pDTviq_switch input:checked+span:after{background:var(--dsw-alias-label-primary-foreground,#fff);transform:translate(14px)}.pDTviq_switch input:focus-visible+span,.pDTviq_actions button:focus-visible,.pDTviq_reset:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.pDTviq_switch input:disabled+span{cursor:not-allowed;opacity:.5}.pDTviq_feedback{gap:6px;margin-top:12px;display:grid}.pDTviq_feedback:empty{display:none}.pDTviq_error,.pDTviq_readOnly{background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:7px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.pDTviq_error{color:var(--dsw-alias-state-error-primary)}.pDTviq_readOnly{color:var(--dsw-alias-label-tertiary)}.pDTviq_actions{display:none}.pDTviq_actionsVisible{z-index:1;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;justify-content:space-between;align-items:center;gap:16px;margin-top:14px;padding:10px 12px;display:flex;position:sticky;bottom:0;box-shadow:0 -4px 16px #0000000f}.pDTviq_actions>span{color:var(--dsw-alias-label-secondary);font-size:11px}.pDTviq_actions>div{gap:8px;display:flex}.pDTviq_actions button{cursor:pointer;min-width:84px;min-height:32px;font:inherit;border-radius:8px;padding:6px 13px;font-size:12px;font-weight:500;line-height:18px}.pDTviq_actions button:disabled{cursor:not-allowed;opacity:.5}.pDTviq_discard{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:0 0}.pDTviq_discard:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.pDTviq_save{color:var(--dsw-alias-label-primary-foreground,#fff);background:var(--dsw-alias-button-primary-fill,var(--dsw-alias-state-business-primary));border:1px solid #0000}.pDTviq_save:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover,var(--dsw-alias-state-business-primary))}@media (width<=560px){.pDTviq_pageHeader,.pDTviq_groupHeader{gap:12px}.pDTviq_pageHeader{padding-inline:2px}.pDTviq_status{margin-top:4px}.pDTviq_switchRow{align-items:flex-start;gap:12px}.pDTviq_switchControl{padding-top:2px}.pDTviq_switchControl .pDTviq_reset{display:none}.pDTviq_actionsVisible{flex-direction:column;align-items:stretch}.pDTviq_actions>div,.pDTviq_actions button{flex:1}}";
		...
		var MnemonSettingsCard_module_css_default = {
			"overridden": "pDTviq_overridden",
			"switches": "pDTviq_switches",
			"error": "pDTviq_error",
			"switchControl": "pDTviq_switchControl",
			"fieldHeading": "pDTviq_fieldHeading",
			"restartBadge": "pDTviq_restartBadge",
			"save": "pDTviq_save",
			"eyebrow": "pDTviq_eyebrow",
			"fieldHint": "pDTviq_fieldHint",
			"liveBadge": "pDTviq_liveBadge",
			"switch": "pDTviq_switch",
			"fields": "pDTviq_fields",
			"statusDirty": "pDTviq_statusDirty",
			"reset": "pDTviq_reset",
			"switchCopy": "pDTviq_switchCopy",
			"discard": "pDTviq_discard",
			"pageHeader": "pDTviq_pageHeader",
			"switchRow": "pDTviq_switchRow",
			"notice": "pDTviq_notice",
			"groupHeader": "pDTviq_groupHeader",
			"status": "pDTviq_status",
			"readOnly": "pDTviq_readOnly",
			"feedback": "pDTviq_feedback",
			"loading": "pDTviq_loading",
			"field": "pDTviq_field",
			"page": "pDTviq_page",
			"headerCopy": "pDTviq_headerCopy",
			"group": "pDTviq_group",
			"fieldTitle": "pDTviq_fieldTitle",
		...
		const zh = {
			...
			"config.noticeAfter": "；运行配置在重启 DSH 后应用，对话呈现设置保存后实时生效。切换范围不会自动迁移旧内容。",
			"config.storageTitle": "存储与运行",
			"config.storageDescription": "决定 Mnemon 数据域的位置；插件不会移动、合并或删除其他范围中的内容。",
			"config.scope": "存储范围",
		...
		const en = {
			...
			"config.noticeAfter": ". Runtime settings apply after restarting DSH; conversation presentation applies live after saving. Switching scopes never migrates existing content automatically.",
			"config.storageTitle": "Storage and runtime",
			"config.storageDescription": "Choose where the Mnemon data domain lives. The plugin never moves, merges, or deletes content from another scope.",
		...
		function operations(fields, dirty, reset, draft) {
			return fields.flatMap((field) => {
				...
				return [{
					op: "set",
					path: [field],
					value: typeof draft[field] === "string" ? draft[field].trim() : draft[field]
				}];
			});
		}
		...
		function MnemonSettingsCard({ scope, interactionScope: suppliedInteractionScope, t = translateZh }) {
			...
			const save = async () => {
				...
				setFailed(null);
				try {
					const coreOps = operations(draft.storageScope === "custom" ? ["dataDir", "storageScope"] : CORE_FIELDS, dirty, reset, draft);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: MnemonSettingsCard_module_css_default.eyebrow,
								children: "MNEMON"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", { children: t("config.title") }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("config.description") })
						]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: `${MnemonSettingsCard_module_css_default.status} ${dirty.size > 0 ? MnemonSettingsCard_module_css_default.statusDirty : ""}`,
						"aria-live": "polite",
						children: loading ? t("common.loading") : dirty.size > 0 ? t("config.unsaved") : t("config.ready")
					})]
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						className: MnemonSettingsCard_module_css_default.group,
						"aria-labelledby": "mnemon-storage-heading",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MnemonSettingsCard_module_css_default.groupHeader,
							...
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("config.storageDescription") })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: MnemonSettingsCard_module_css_default.restartBadge,
								children: t("config.restart")
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MnemonSettingsCard_module_css_default.fields,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingField, {
								...
								overridden: overridden("storageScope"),
								resetDisabled: coreDisabled,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("config.interactionHint") })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: MnemonSettingsCard_module_css_default.liveBadge,
								children: t("config.interactionLive")
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SwitchRow, {
									...
									overridden: overridden("toolviews"),
									t,
									onReset: () => resetField("toolviews"),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SwitchRow, {
									...
									disabled: interactionDisabled,
									overridden: overridden("turnBar"),
									t,
									onReset: () => resetField("turnBar"),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SwitchRow, {
									...
									disabled: interactionDisabled,
									overridden: overridden("saveAction"),
									t,
									onReset: () => resetField("saveAction"),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("footer", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: dirty.size > 0 ? t("config.unsaved") : t("config.ready") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
		...
		function SwitchRow(props) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: MnemonSettingsCard_module_css_default.switchRow,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
					htmlFor: props.id,
					className: MnemonSettingsCard_module_css_default.switchCopy,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: props.label }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: props.hint })]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: MnemonSettingsCard_module_css_default.switchControl,
					children: [props.overridden && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						className: MnemonSettingsCard_module_css_default.reset,
						type: "button",
