window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var MnemonView_module_css_default = {
			...
			"commandList": "lvR3Qq_commandList",
		...
		function RememberPage(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: MnemonView_module_css_default.page,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PageHeader, {
					kicker: "SUPERVISED WRITEBACK",
					title: "沉淀记忆",
					description: "保存稳定、可复用，并且未来确实值得再次检索的信息。",
					meta: props.writeEnabled ? "WRITE ENABLED" : "READ ONLY"
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("ol", { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: "自包含" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "包含原因、范围和必要约束" })] })
							] }),
		...
		function StatusPage(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PageHeader, {
					...
					title: "状态与配置",
					description: "诊断当前运行时，并在 Mnemon 工作台内维护插件配置。",
					meta: status?.healthy === true ? "SYSTEM NOMINAL" : "CHECK REQUIRED",
					action: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: MnemonView_module_css_default.secondaryButton,
					...
					className: MnemonView_module_css_default.statusGrid,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
							className: MnemonView_module_css_default.runtimeCard,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: "访问模式" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: status?.writeEnabled === true ? "读取与写入" : "只读" })] })
							] })]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
							className: MnemonView_module_css_default.infoCard,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: MnemonView_module_css_default.cardKicker,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: MnemonView_module_css_default.commandList,
									children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "查询状态、召回、写入、关联和软删除均可使用原生命令。" })
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		function MnemonView({ connection, settingsScope }) {
