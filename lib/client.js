window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-footer.cwwhwj/src/client/MnemonSettingsCard.module.css.mjs
		const css$5 = ".Gj_wrG_page{box-sizing:border-box;width:100%;min-width:0;max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:28px;padding-bottom:28px;font-family:inherit;display:flex}.Gj_wrG_page *,.Gj_wrG_page :before,.Gj_wrG_page :after{box-sizing:border-box}.Gj_wrG_page button,.Gj_wrG_page input{color:inherit;font:inherit}.Gj_wrG_loading{min-height:140px;color:var(--dsw-alias-label-tertiary);text-align:center;margin:0;font-size:13px;line-height:140px}.Gj_wrG_pageHeader h1{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:500;line-height:24px}.Gj_wrG_pageHeader p{max-width:64ch;color:var(--dsw-alias-label-tertiary);margin:8px 0 0;font-size:14px;line-height:22px}.Gj_wrG_section{flex-direction:column;gap:12px;min-width:0;display:flex}.Gj_wrG_sectionHeading{justify-content:space-between;align-items:flex-start;gap:18px;min-width:0;display:flex}.Gj_wrG_sectionHeading>div{flex:1;min-width:0}.Gj_wrG_sectionHeading h2{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;font-weight:500;line-height:22px}.Gj_wrG_sectionHeading p{max-width:66ch;color:var(--dsw-alias-label-tertiary);margin:1px 0 0;font-size:12px;line-height:18px}.Gj_wrG_choiceGrid{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;display:grid}.Gj_wrG_displayGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.Gj_wrG_choiceCard{cursor:pointer;min-width:0;display:block}.Gj_wrG_choiceCard>input,.Gj_wrG_toggleRow>input,.Gj_wrG_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.Gj_wrG_choiceFace{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;justify-content:center;gap:1px;min-width:0;min-height:66px;padding:10px 34px 10px 13px;transition:border-color .14s,background-color .14s;display:flex;position:relative}.Gj_wrG_choiceFace:hover{background:var(--dsw-alias-interactive-bg-hover)}.Gj_wrG_choiceFace strong{text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:21px;overflow:hidden}.Gj_wrG_choiceFace small{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:17px;overflow:hidden}.Gj_wrG_check{font-size:14px;line-height:18px;display:none;position:absolute;top:11px;right:12px}.Gj_wrG_choiceCard>input:checked+.Gj_wrG_choiceFace{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-interactive-bg-hover)}.Gj_wrG_choiceCard>input:checked+.Gj_wrG_choiceFace .Gj_wrG_check{display:block}.Gj_wrG_choiceCard>input:disabled+.Gj_wrG_choiceFace{cursor:default;opacity:.42}.Gj_wrG_choiceCard:has(input:disabled){cursor:default}.Gj_wrG_settingRow,.Gj_wrG_toggleRow{border-top:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:18px;min-width:0;min-height:62px;padding:11px 0;display:flex}.Gj_wrG_settingCopy{flex-direction:column;flex:1;min-width:0;display:flex}.Gj_wrG_settingCopy strong{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:21px}.Gj_wrG_settingCopy small{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.Gj_wrG_settingCopy code{font-family:var(--ds-font-family-code,ui-monospace, monospace)}.Gj_wrG_directoryControl{flex:0 420px;align-items:center;gap:8px;min-width:0;max-width:60%;display:flex}.Gj_wrG_directoryInput{border:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:38px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3);font-family:var(--ds-font-family-code,ui-monospace, monospace);border-radius:10px;outline:none;padding:0 11px;font-size:12px;line-height:20px}.Gj_wrG_directoryInput::placeholder{color:var(--dsw-alias-label-caption)}.Gj_wrG_directoryInput:disabled{cursor:default;opacity:.46}.Gj_wrG_rowGroup{border-bottom:1px solid var(--dsw-alias-border-l2)}.Gj_wrG_toggleRow{cursor:pointer}.Gj_wrG_toggleRow:first-child{border-top:1px solid var(--dsw-alias-border-l2)}.Gj_wrG_toggleRow:has(input:disabled){cursor:default;opacity:.46}.Gj_wrG_switch{background:var(--dsw-alias-bg-layer-2);width:40px;height:24px;box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2);border-radius:999px;flex:none;transition:background-color .14s;display:block;position:relative}.Gj_wrG_switch i{background:var(--dsw-alias-bg-layer-3);width:18px;height:18px;box-shadow:0 1px 3px color-mix(in srgb, var(--dsw-alias-label-primary) 22%, transparent);border-radius:50%;transition:transform .14s;position:absolute;top:3px;left:3px}.Gj_wrG_toggleRow>input:checked+.Gj_wrG_switch{background:var(--dsw-alias-label-primary);box-shadow:none}.Gj_wrG_toggleRow>input:checked+.Gj_wrG_switch i{transform:translate(16px)}.Gj_wrG_pillButton,.Gj_wrG_primaryPill,.Gj_wrG_actions button{appearance:none;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:4px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.Gj_wrG_pillButton:hover:not(:disabled),.Gj_wrG_actions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-solid)}.Gj_wrG_pillButton:disabled,.Gj_wrG_primaryPill:disabled,.Gj_wrG_actions button:disabled,.Gj_wrG_textButton:disabled{cursor:default;opacity:.4}.Gj_wrG_primaryPill,.Gj_wrG_save{color:var(--dsw-alias-label-primary-foreground)!important;background:var(--dsw-alias-button-primary-fill)!important;border-color:#0000!important}.Gj_wrG_primaryPill:hover:not(:disabled),.Gj_wrG_save:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)!important}.Gj_wrG_textButton{appearance:none;box-sizing:border-box;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;background:0 0;border:0;border-radius:14px;flex:none;justify-content:center;align-items:center;padding:0 10px;font-size:12px;line-height:18px;display:inline-flex}.Gj_wrG_textButton:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Gj_wrG_activePath{width:fit-content;max-width:100%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;margin-top:4px;font-size:11px;line-height:17px;overflow:hidden}.Gj_wrG_scopeMeta{color:var(--dsw-alias-label-tertiary);margin-top:1px;font-size:10px;font-style:normal;line-height:15px}.Gj_wrG_rowActions{flex:none;align-items:center;gap:8px;display:flex}.Gj_wrG_importBar{background:var(--dsw-alias-bg-layer-2);border-radius:12px;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:10px;min-width:0;padding:10px 12px;display:grid}.Gj_wrG_importBar>div{min-width:0;display:grid}.Gj_wrG_importBar strong{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:500;line-height:18px;overflow:hidden}.Gj_wrG_importBar small{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.Gj_wrG_importBar .Gj_wrG_textButton{padding:0 10px}.Gj_wrG_feedback,.Gj_wrG_packFeedback{gap:4px;display:grid}.Gj_wrG_feedback:empty,.Gj_wrG_packFeedback:empty{display:none}.Gj_wrG_feedback p,.Gj_wrG_packFeedback p{overflow-wrap:anywhere;margin:0;font-size:12px;line-height:18px}.Gj_wrG_error{color:var(--dsw-alias-state-error-primary)}.Gj_wrG_success{color:var(--dsw-alias-state-success-primary)}.Gj_wrG_readOnly{color:var(--dsw-alias-label-tertiary)}.Gj_wrG_packSuccess{color:var(--dsw-alias-state-success-primary)}.Gj_wrG_actions{display:none}.Gj_wrG_actionsVisible{border-top:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:16px;padding-top:14px;display:flex}.Gj_wrG_actions>span{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.Gj_wrG_actions>div{gap:8px;display:flex}.Gj_wrG_discard{color:var(--dsw-alias-label-primary);background:0 0;border-color:var(--dsw-alias-border-l2)!important}.Gj_wrG_settingsNote{color:var(--dsw-alias-label-tertiary);margin:-14px 0 0;font-size:10px;line-height:16px}.Gj_wrG_settingsNote code{color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,ui-monospace, monospace)}.Gj_wrG_choiceCard>input:focus-visible+.Gj_wrG_choiceFace,.Gj_wrG_toggleRow>input:focus-visible+.Gj_wrG_switch,.Gj_wrG_directoryInput:focus-visible,.Gj_wrG_pillButton:focus-visible,.Gj_wrG_primaryPill:focus-visible,.Gj_wrG_textButton:focus-visible,.Gj_wrG_actions button:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3);outline:none}@media (width<=620px){.Gj_wrG_page{gap:24px}.Gj_wrG_choiceGrid{grid-template-columns:minmax(0,1fr)}.Gj_wrG_settingRow{flex-direction:column;align-items:stretch;gap:9px}.Gj_wrG_directoryControl{justify-content:space-between;max-width:none}.Gj_wrG_rowActions{width:100%}.Gj_wrG_rowActions button{flex:1}.Gj_wrG_importBar{grid-template-columns:minmax(0,1fr) auto}.Gj_wrG_importBar .Gj_wrG_primaryPill{grid-column:1/-1}.Gj_wrG_actionsVisible{flex-direction:column;align-items:stretch}.Gj_wrG_actions>div,.Gj_wrG_actions button{flex:1}}@media (prefers-reduced-motion:reduce){.Gj_wrG_choiceFace,.Gj_wrG_switch,.Gj_wrG_switch i{transition:none}}";
		const tagId$5 = "dsh-mnemon/MnemonSettingsCard.module.css";
		...
		var MnemonSettingsCard_module_css_default = {
			"pageHeader": "Gj_wrG_pageHeader",
			"directoryControl": "Gj_wrG_directoryControl",
			"choiceCard": "Gj_wrG_choiceCard",
			"settingsNote": "Gj_wrG_settingsNote",
			"importBar": "Gj_wrG_importBar",
			"switch": "Gj_wrG_switch",
			"feedback": "Gj_wrG_feedback",
			"displayGrid": "Gj_wrG_displayGrid",
			"rowActions": "Gj_wrG_rowActions",
			"choiceFace": "Gj_wrG_choiceFace",
			"check": "Gj_wrG_check",
			"directoryInput": "Gj_wrG_directoryInput",
			"settingRow": "Gj_wrG_settingRow",
			"success": "Gj_wrG_success",
			"visuallyHidden": "Gj_wrG_visuallyHidden",
			"actions": "Gj_wrG_actions",
			"settingCopy": "Gj_wrG_settingCopy",
			"sectionHeading": "Gj_wrG_sectionHeading",
			"choiceGrid": "Gj_wrG_choiceGrid",
			"pillButton": "Gj_wrG_pillButton",
			"rowGroup": "Gj_wrG_rowGroup",
			"textButton": "Gj_wrG_textButton",
			"activePath": "Gj_wrG_activePath",
			"packFeedback": "Gj_wrG_packFeedback",
			"readOnly": "Gj_wrG_readOnly",
			"save": "Gj_wrG_save",
			"scopeMeta": "Gj_wrG_scopeMeta",
			"discard": "Gj_wrG_discard",
			"error": "Gj_wrG_error",
			"toggleRow": "Gj_wrG_toggleRow",
			"page": "Gj_wrG_page",
			"primaryPill": "Gj_wrG_primaryPill",
			"loading": "Gj_wrG_loading",
			"section": "Gj_wrG_section",
			"packSuccess": "Gj_wrG_packSuccess",
			"actionsVisible": "Gj_wrG_actionsVisible"
		};
		//#endregion
		...
		const zh = {
			...
			"saveAction.submit": "确认并交给记忆子 Agent",
			...
			"versions.hintInstall": "未找到 Mnemon CLI；请先安装并确保 mnemon 位于 PATH，或配置 cliPath。",
		...
		const en = {
			...
			"saveAction.submit": "Confirm and send to memory subagent",
			...
			"versions.hintInstall": "Mnemon CLI was not found. Install it and place mnemon on PATH, or configure cliPath.",
		...
		//#endregion
		//#region ../../../Users/grivn/github.com/omdsh-dev/dsh-mnemon/node_modules/.pnpm/markdown-to-jsx@7.7.17_react@18.3.1/node_modules/markdown-to-jsx/dist/index.module.js
		function n() {
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-footer.cwwhwj/src/client/MnemonSidebarView.module.css.mjs
		const css$4 = ".v4-Ooq_shell.v4-Ooq_shell{background:var(--dsw-alias-bg-base);font-family:var(--dsw-font-family)}.v4-Ooq_shell .v4-Ooq_masthead{background:var(--dsw-alias-bg-base);border-bottom:0;align-items:center;gap:12px;min-height:50px;padding:10px 16px 6px;display:flex}.v4-Ooq_shell .v4-Ooq_brand{flex:auto;gap:8px;overflow:hidden}.v4-Ooq_shell .v4-Ooq_brand h1{letter-spacing:0;flex:none;margin:0;font-size:16px;font-weight:700;line-height:24px}.v4-Ooq_shell [class*=storageMode]{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);gap:5px;min-width:96px;min-height:32px;padding:0 9px}.v4-Ooq_shell [class*=storageMode]>span{color:var(--dsw-alias-label-tertiary);font-size:11px}.v4-Ooq_shell [class*=storageMode]>strong{color:var(--dsw-alias-label-primary);font-size:12px}.v4-Ooq_shell .v4-Ooq_headerActions{flex:0 auto;gap:6px}.v4-Ooq_shell .v4-Ooq_workspacePicker{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex:0 auto;gap:7px;min-height:32px;padding-left:9px}.v4-Ooq_shell .v4-Ooq_workspacePicker>span{color:var(--dsw-alias-label-tertiary);font-size:11px;display:block}.v4-Ooq_shell .v4-Ooq_workspacePicker select{border:0;border-left:1px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-input-major);border-radius:0 7px 7px 0;width:min(190px,20vw);height:30px;padding:0 28px 0 10px;font-size:13px}.v4-Ooq_shell .v4-Ooq_statusCluster{background:0 0;border:0;border-radius:8px;gap:7px;min-height:30px;padding:0 2px 0 8px;font-size:12px}.v4-Ooq_shell .v4-Ooq_statusCluster>span:not([class*=statusDot]){min-width:56px}.v4-Ooq_shell .v4-Ooq_workspaceMismatch{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 34%, var(--dsw-alias-border-l1));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-layer-1));white-space:nowrap;border-radius:8px;flex:none;justify-content:flex-start;gap:6px;min-height:32px;margin:0;padding:0 3px 0 9px}.v4-Ooq_shell .v4-Ooq_workspaceMismatch>span{color:var(--dsw-alias-label-secondary);font-size:11px}.v4-Ooq_shell .v4-Ooq_workspaceMismatch>button{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 55%, var(--dsw-alias-border-l2));min-height:26px;color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-base);cursor:pointer;border-radius:6px;padding:0 8px;font-size:11px}.v4-Ooq_shell .v4-Ooq_workspaceMismatch>button:hover{background:var(--dsw-alias-interactive-bg-hover)}.v4-Ooq_shell .v4-Ooq_topNavigation{background:var(--dsw-alias-bg-base);border-bottom:0;gap:0;min-height:0;padding:0 16px}.v4-Ooq_shell .v4-Ooq_topNavigation:after{display:none}.v4-Ooq_shell .v4-Ooq_nav{border-bottom:1px solid var(--dsw-alias-border-l1);flex:1;gap:2px;padding-right:0}.v4-Ooq_shell .v4-Ooq_nav button{border-bottom:2px solid #0000;border-radius:6px 6px 0 0;gap:0;min-height:0;padding:7px 14px;font-size:13px;font-weight:400}.v4-Ooq_shell .v4-Ooq_nav button:hover{background:var(--dsw-alias-interactive-bg-hover)}.v4-Ooq_shell .v4-Ooq_nav button[data-active]{color:var(--dsw-alias-label-primary);border-bottom-color:var(--dsw-alias-state-business-primary);font-weight:600}.v4-Ooq_shell .v4-Ooq_memoryWorkspace{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);flex:none;padding:12px 16px 0}.v4-Ooq_shell .v4-Ooq_memoryWorkspace>[class*=pageHeader]{margin-bottom:8px}.v4-Ooq_shell .v4-Ooq_memoryNavigation{flex:none;align-items:flex-end;gap:12px;min-width:0;padding:0;display:flex}.v4-Ooq_shell .v4-Ooq_memoryTabs{scrollbar-width:none;flex:1;gap:2px;min-width:0;display:flex;overflow-x:auto}.v4-Ooq_shell .v4-Ooq_memoryTabs::-webkit-scrollbar{display:none}.v4-Ooq_shell .v4-Ooq_memoryTabs button{min-width:max-content;min-height:0;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-bottom:2px solid #0000;border-radius:6px 6px 0 0;padding:6px 12px;font-size:13px}.v4-Ooq_shell .v4-Ooq_memoryTabs button:hover{background:var(--dsw-alias-interactive-bg-hover)}.v4-Ooq_shell .v4-Ooq_memoryTabs button[data-active]{border-bottom-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-label-primary);font-weight:600}.v4-Ooq_shell .v4-Ooq_memoryWriteButton{flex:none}.v4-Ooq_shell .v4-Ooq_modalBackdrop{z-index:1300;overscroll-behavior:contain;background:var(--dsw-alias-bg-mask-1);justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.v4-Ooq_shell .v4-Ooq_modal{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);width:min(680px,100vw - 48px);max-height:calc(100vh - 96px);box-shadow:var(--dsw-shadow-lv3);border-radius:14px;flex-direction:column;display:flex;overflow:hidden}.v4-Ooq_shell .v4-Ooq_modal>header{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;justify-content:space-between;align-items:flex-start;gap:18px;padding:15px 18px;display:flex}.v4-Ooq_shell .v4-Ooq_modal>header h2{margin:0;font-size:15px;line-height:22px}.v4-Ooq_shell .v4-Ooq_modal>header p{max-width:64ch;color:var(--dsw-alias-label-secondary);margin:3px 0 0;font-size:12px;line-height:1.5}.v4-Ooq_shell .v4-Ooq_modal>div:last-child{min-height:0;padding:18px;overflow-y:auto}.v4-Ooq_shell .v4-Ooq_modal form[class*=runtimeComposer],.v4-Ooq_shell .v4-Ooq_modal form[class*=documentEditor]{background:0 0;border:0;border-radius:0;margin:0;padding:0}.v4-Ooq_shell .v4-Ooq_modal form[class*=runtimeComposer]>[class*=runtimeComposerHeading],.v4-Ooq_shell .v4-Ooq_modal form[class*=documentEditor]>header{display:none}.v4-Ooq_shell .v4-Ooq_modal section[class*=supervisedComposer]{overflow:visible}.v4-Ooq_shell .v4-Ooq_modal form[class*=supervisedForm]{padding:0}.v4-Ooq_shell .v4-Ooq_modal [class*=supervisedHeading]{margin-bottom:10px}.v4-Ooq_shell .v4-Ooq_modal [class*=supervisedHeading] h3{display:none}.v4-Ooq_shell .v4-Ooq_modal [class*=formActions]{justify-content:flex-end}.v4-Ooq_shell .v4-Ooq_modal details[class*=advancedWrite]{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:10px;margin-top:14px;overflow:hidden}.v4-Ooq_shell [class*=primaryButton]{min-height:32px;color:var(--dsw-alias-label-primary-foreground);background:var(--dsw-alias-button-info-fill);white-space:nowrap;border:0;border-radius:8px;padding:6px 14px;font-size:13px;font-weight:600}.v4-Ooq_shell [class*=primaryButton]:hover:not(:disabled){filter:none;background:var(--dsw-alias-button-info-hover)}.v4-Ooq_shell [class*=secondaryButton],.v4-Ooq_shell [class*=ghostButton]{border:1px solid var(--dsw-alias-border-l2);min-height:32px;color:var(--dsw-alias-label-primary);white-space:nowrap;background:0 0;border-radius:8px;padding:5px 12px;font-size:12px;font-weight:400}.v4-Ooq_shell [class*=secondaryButton]:hover:not(:disabled),.v4-Ooq_shell [class*=ghostButton]:hover:not(:disabled){filter:none;background:var(--dsw-alias-interactive-bg-hover)}.v4-Ooq_shell [class*=dangerButton]{min-height:0;color:var(--dsw-alias-state-error-primary);white-space:nowrap;background:0 0;border:0;border-radius:0;padding:0;font-size:12px;font-weight:400}.v4-Ooq_shell [class*=dangerButton]:hover:not(:disabled){filter:none;background:0 0;text-decoration:underline}.v4-Ooq_shell [class*=dangerSolidButton]{color:#fff;background:var(--dsw-alias-state-error-primary);white-space:nowrap;border:0;border-radius:8px;min-height:32px;padding:6px 14px;font-size:13px;font-weight:600}.v4-Ooq_shell [class*=dangerSolidButton]:hover:not(:disabled){filter:brightness(1.08)}.v4-Ooq_shell [class*=iconButton],.v4-Ooq_shell [class*=bodyEditButton],.v4-Ooq_shell [class*=inspectorEye],.v4-Ooq_shell [class*=inspectorHeading] button,.v4-Ooq_shell [class*=sectionHeading] button,.v4-Ooq_shell [class*=previewHeading] button{width:26px;height:26px;min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;border:0;border-radius:6px;justify-content:center;align-items:center;padding:0;font-size:13px;display:inline-flex}.v4-Ooq_shell [class*=iconButton]:hover:not(:disabled),.v4-Ooq_shell [class*=bodyEditButton]:hover:not(:disabled),.v4-Ooq_shell [class*=inspectorEye]:hover:not(:disabled),.v4-Ooq_shell [class*=inspectorHeading] button:hover:not(:disabled),.v4-Ooq_shell [class*=sectionHeading] button:hover:not(:disabled),.v4-Ooq_shell [class*=previewHeading] button:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover);border:0}.v4-Ooq_shell [class*=primaryButton],.v4-Ooq_shell [class*=secondaryButton],.v4-Ooq_shell [class*=ghostButton],.v4-Ooq_shell [class*=dangerButton],.v4-Ooq_shell [class*=dangerSolidButton],.v4-Ooq_shell [class*=iconButton],.v4-Ooq_shell [class*=bodyEditButton],.v4-Ooq_shell [class*=inspectorEye],.v4-Ooq_shell [class*=inspectorHeading] button,.v4-Ooq_shell [class*=sectionHeading] button,.v4-Ooq_shell [class*=previewHeading] button{cursor:pointer;transition:background-color .12s,color .12s,border-color .12s,outline-color .12s,box-shadow .12s,transform .12s}.v4-Ooq_shell [class*=primaryButton]:active:not(:disabled),.v4-Ooq_shell [class*=secondaryButton]:active:not(:disabled),.v4-Ooq_shell [class*=ghostButton]:active:not(:disabled),.v4-Ooq_shell [class*=dangerButton]:active:not(:disabled),.v4-Ooq_shell [class*=dangerSolidButton]:active:not(:disabled),.v4-Ooq_shell [class*=iconButton]:active:not(:disabled),.v4-Ooq_shell [class*=bodyEditButton]:active:not(:disabled),.v4-Ooq_shell [class*=inspectorEye]:active:not(:disabled),.v4-Ooq_shell [class*=inspectorHeading] button:active:not(:disabled),.v4-Ooq_shell [class*=sectionHeading] button:active:not(:disabled),.v4-Ooq_shell [class*=previewHeading] button:active:not(:disabled){transform:translateY(1px)}.v4-Ooq_shell [class*=primaryButton]:disabled,.v4-Ooq_shell [class*=secondaryButton]:disabled,.v4-Ooq_shell [class*=ghostButton]:disabled,.v4-Ooq_shell [class*=dangerButton]:disabled,.v4-Ooq_shell [class*=dangerSolidButton]:disabled,.v4-Ooq_shell [class*=iconButton]:disabled,.v4-Ooq_shell [class*=bodyEditButton]:disabled,.v4-Ooq_shell [class*=inspectorEye]:disabled{cursor:default;opacity:.45}.v4-Ooq_shell .v4-Ooq_canvas{background:var(--dsw-alias-bg-base)}.v4-Ooq_shell button,.v4-Ooq_shell input,.v4-Ooq_shell select,.v4-Ooq_shell textarea{font-family:var(--dsw-font-family)}.v4-Ooq_shell button:focus-visible,.v4-Ooq_shell input:focus-visible,.v4-Ooq_shell select:focus-visible,.v4-Ooq_shell textarea:focus-visible,.v4-Ooq_shell summary:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.v4-Ooq_shell .v4-Ooq_canvas>div{width:100%;padding:14px 16px clamp(96px,14vh,150px)}.v4-Ooq_shell .v4-Ooq_pageHeader{margin-bottom:12px}.v4-Ooq_shell .v4-Ooq_pageHeader h2{letter-spacing:0;margin-top:0;font-size:16px;line-height:1.35}.v4-Ooq_shell .v4-Ooq_pageHeader p{font-size:13px;line-height:1.55}.v4-Ooq_shell .v4-Ooq_canvas[data-lock-page-header] [class*=pageHeader]{z-index:12;border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);margin:-14px -16px 12px;padding:14px 16px 10px;position:sticky;top:0}.v4-Ooq_shell input,.v4-Ooq_shell select,.v4-Ooq_shell textarea{font-family:var(--dsw-font-family);font-size:13px;font-weight:400}.v4-Ooq_shell [class*=bodyEdit] label,.v4-Ooq_shell [class*=runtimeComposerActions] label,.v4-Ooq_shell [class*=documentEditor] label,.v4-Ooq_shell [class*=searchControls] label,.v4-Ooq_shell [class*=formGrid] label,.v4-Ooq_shell [class*=fieldWide]{color:var(--dsw-alias-label-secondary);gap:5px;font-size:12px;font-weight:500}.v4-Ooq_shell [class*=bodyEdit] input,.v4-Ooq_shell [class*=bodyEdit] select,.v4-Ooq_shell [class*=bodyEdit] textarea,.v4-Ooq_shell [class*=runtimeComposer]>textarea,.v4-Ooq_shell [class*=runtimeComposerActions] select,.v4-Ooq_shell [class*=runtimeEntry] select,.v4-Ooq_shell [class*=documentEditor] input,.v4-Ooq_shell [class*=documentEditor] textarea,.v4-Ooq_shell [class*=searchControls] select,.v4-Ooq_shell [class*=formGrid] select,.v4-Ooq_shell [class*=formGrid] input,.v4-Ooq_shell [class*=listToolbar] input,.v4-Ooq_shell [class*=listToolbar] select,.v4-Ooq_shell [class*=entitySearch] input,.v4-Ooq_shell [class*=bodyCreate] input{border:1px solid var(--dsw-alias-border-l2);min-height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major);border-radius:8px;padding:7px 10px;font-size:13px;font-weight:400}.v4-Ooq_shell select{cursor:pointer;font-weight:400}.v4-Ooq_shell textarea{font-weight:400;line-height:1.55}.v4-Ooq_shell [class*=cardKicker],.v4-Ooq_shell [class*=sectionHeading]>div>span,.v4-Ooq_shell [class*=entityHeading]>span,.v4-Ooq_shell [class*=inspectorHeading]>span{letter-spacing:.06em;font-size:11px}.v4-Ooq_shell [class*=bodyDirectoryHeader] p,.v4-Ooq_shell [class*=bodyCard]>p,.v4-Ooq_shell [class*=graphToolbar],.v4-Ooq_shell [class*=graphFooter],.v4-Ooq_shell [class*=runtimeTargetDescription],.v4-Ooq_shell [class*=documentList]>button p,.v4-Ooq_shell [class*=documentDetail]>header p,.v4-Ooq_shell [class*=documentArchiveReceipt] p,.v4-Ooq_shell [class*=healthStrip] p,.v4-Ooq_shell [class*=storageAreaGrid] article>p,.v4-Ooq_shell [class*=statusSectionHeader] p,.v4-Ooq_shell [class*=writeGuide] li span,.v4-Ooq_shell [class*=writeGuide]>p,.v4-Ooq_shell [class*=manualActions] p{font-size:12px}.v4-Ooq_shell [class*=bodyDirectoryPath],.v4-Ooq_shell [class*=bodyCard] footer,.v4-Ooq_shell [class*=bodyHealth],.v4-Ooq_shell [class*=badge],.v4-Ooq_shell [class*=entities] span,.v4-Ooq_shell [class*=runtimeEntryMeta]>span,.v4-Ooq_shell [class*=runtimeEntryBadges]>span,.v4-Ooq_shell [class*=runtimeEntryMeta] time,.v4-Ooq_shell [class*=runtimeFootnote],.v4-Ooq_shell [class*=documentSummary] article>span,.v4-Ooq_shell [class*=documentSummary] article>small,.v4-Ooq_shell [class*=documentList]>header,.v4-Ooq_shell [class*=documentList]>button time,.v4-Ooq_shell [class*=documentList]>button footer,.v4-Ooq_shell [class*=documentDetail] dt,.v4-Ooq_shell [class*=documentSources]>span,.v4-Ooq_shell [class*=storageRoot] span,.v4-Ooq_shell [class*=storageRoot] small,.v4-Ooq_shell [class*=storageAreaMetric] span,.v4-Ooq_shell [class*=storageAreaMetric] code,.v4-Ooq_shell [class*=storagePath],.v4-Ooq_shell [class*=storageAreaGrid] article>small,.v4-Ooq_shell [class*=storageFootnote]{font-size:11px}.v4-Ooq_shell [class*=bodySwitch],.v4-Ooq_shell [class*=graphCanvasControls] button,.v4-Ooq_shell [class*=documentToolbar]>div button,.v4-Ooq_shell [class*=documentDetail] dd,.v4-Ooq_shell [class*=documentDanger] p,.v4-Ooq_shell [class*=advancedWrite] summary small{font-size:12px}.v4-Ooq_shell [class*=documentList]>button strong,.v4-Ooq_shell [class*=runtimeEntry]>p,.v4-Ooq_shell [class*=inspectorMeta] dd{font-size:13px}.v4-Ooq_shell [class*=runtimeEntryBadges]>span{border:1px solid var(--dsw-alias-border-l1);min-height:22px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-radius:999px;align-items:center;padding:0 8px;font-size:11px;font-weight:400;line-height:20px;display:inline-flex}.v4-Ooq_shell [class*=runtimeEntryBadges]>[class*=runtimeEntryTarget]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 30%, var(--dsw-alias-border-l1));color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-layer-1));font-family:var(--dsw-font-family);font-weight:500}.v4-Ooq_shell [class*=runtimeEntry][data-importance=critical] [class*=runtimeEntryBadges]>span:last-child{border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 24%, var(--dsw-alias-border-l1));color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 6%, var(--dsw-alias-bg-layer-1))}.v4-Ooq_shell [class*=listProgress],.v4-Ooq_shell [class*=compactListProgress]{color:var(--dsw-alias-label-tertiary);font-size:12px}.v4-Ooq_shell [class*=documentWorkspace]{align-items:stretch;height:clamp(520px,100dvh - 220px,760px);min-height:520px}.v4-Ooq_shell [class*=documentList],.v4-Ooq_shell [class*=documentReader]{overscroll-behavior:contain;scrollbar-gutter:stable;min-height:0;overflow-y:auto}.v4-Ooq_shell [class*=bodyGrid]{grid-template-columns:repeat(auto-fit,minmax(min(320px,100%),1fr))}.v4-Ooq_shell article[class*=bodyCard]{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);height:100%;box-shadow:none;opacity:1;flex-direction:column;padding:12px;display:flex}.v4-Ooq_shell article[class*=bodyCard][data-active]{border-color:var(--dsw-alias-border-l1);box-shadow:none}.v4-Ooq_shell .v4-Ooq_bodyCardHeader{justify-content:space-between;align-items:flex-start;gap:12px;min-width:0;display:flex}.v4-Ooq_shell .v4-Ooq_bodyDirectoryActions{flex:none;align-items:center;gap:8px;display:flex}.v4-Ooq_shell .v4-Ooq_bodyDirectoryActions>strong{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent);white-space:nowrap;border-radius:999px;padding:5px 8px;font-size:11px;font-weight:600}.v4-Ooq_shell .v4-Ooq_bodyCardIdentity{flex:1;align-items:flex-start;gap:8px;min-width:0;display:flex}.v4-Ooq_shell .v4-Ooq_bodyCardIdentity>[class*=bodySignal]{flex:none;width:6px;height:6px;margin-top:7px}.v4-Ooq_shell .v4-Ooq_bodyCardIdentity>div{flex:1;gap:2px;min-width:0;display:grid}.v4-Ooq_shell .v4-Ooq_bodyCardIdentity strong{text-overflow:ellipsis;white-space:nowrap;font-size:13px;line-height:20px;overflow:hidden}.v4-Ooq_shell .v4-Ooq_bodyCardMeta{align-items:center;gap:8px;min-width:0;display:flex}.v4-Ooq_shell .v4-Ooq_bodyCardMeta code{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}.v4-Ooq_shell .v4-Ooq_bodyCardMeta [class*=bodyHealth]{letter-spacing:0;flex:none;font-size:11px}.v4-Ooq_shell .v4-Ooq_bodyCardHeader>[class*=bodySwitch]{flex:none;min-height:24px}.v4-Ooq_shell article[class*=bodyCard]>p{-webkit-line-clamp:4;-webkit-box-orient:vertical;min-height:6.2em;max-height:6.2em;margin:12px 0;line-height:1.55;display:-webkit-box;overflow:hidden}.v4-Ooq_shell .v4-Ooq_bodyCardFooter{white-space:nowrap;grid-template-columns:minmax(max-content,1fr) max-content;align-items:center;gap:10px;min-width:0;margin-top:auto;padding-top:9px;display:grid}.v4-Ooq_shell .v4-Ooq_bodyCardStats{flex-wrap:nowrap;align-items:center;gap:10px;min-width:max-content;display:flex}.v4-Ooq_shell .v4-Ooq_bodyCardFooter [class*=bodyCardActions]{flex-wrap:nowrap;flex:none;align-items:center;gap:6px;display:flex}.v4-Ooq_shell .v4-Ooq_itemActionButton{border:1px solid;border-radius:7px;min-height:28px;padding:4px 9px;font-size:12px;line-height:18px}.v4-Ooq_shell [class*=runtimeEntry] footer,.v4-Ooq_shell [class*=cardActions]{gap:6px}.v4-Ooq_shell .v4-Ooq_itemEditAction{color:var(--dsw-alias-state-business-primary);border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, var(--dsw-alias-border-l2));background:0 0}.v4-Ooq_shell .v4-Ooq_itemEditAction:hover:not(:disabled){color:var(--dsw-alias-state-business-primary);border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 58%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.v4-Ooq_shell .v4-Ooq_itemDangerAction{color:var(--dsw-alias-state-error-primary);border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 34%, var(--dsw-alias-border-l2));background:0 0;padding:4px 9px}.v4-Ooq_shell .v4-Ooq_itemDangerAction:hover:not(:disabled){border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 54%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 8%, transparent);text-decoration:none}.v4-Ooq_shell [class*=bodyDeleteConfirm]>p{font-size:13px}.v4-Ooq_shell [class*=pageHeaderMeta]>code{text-align:center;font-variant-numeric:tabular-nums;min-width:72px;font-size:11px}.v4-Ooq_shell .v4-Ooq_inspectorGlyph{border:1px solid var(--dsw-alias-border-l1);width:44px;height:44px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-1);font:20px/1 var(--mn-code);opacity:1;border-radius:10px;place-items:center;margin-bottom:10px;display:grid}@media (width<=760px){.v4-Ooq_shell .v4-Ooq_masthead{min-height:48px;padding:8px 12px 4px}.v4-Ooq_shell .v4-Ooq_headerActions{max-width:none}.v4-Ooq_shell .v4-Ooq_statusCluster>span:not([class*=statusDot]){display:inline}.v4-Ooq_shell [class*=storageMode]{min-width:0}.v4-Ooq_shell [class*=storageMode]>span,.v4-Ooq_shell .v4-Ooq_workspacePicker>span,.v4-Ooq_shell .v4-Ooq_workspaceMismatch>span{display:none}.v4-Ooq_shell .v4-Ooq_workspacePicker{gap:0;padding-left:0}.v4-Ooq_shell .v4-Ooq_workspacePicker select{border-left:0;width:min(160px,31vw)}.v4-Ooq_shell .v4-Ooq_topNavigation{padding:0 12px}.v4-Ooq_shell .v4-Ooq_memoryNavigation{padding-inline:12px}.v4-Ooq_shell .v4-Ooq_memoryTabs button{padding-inline:10px}.v4-Ooq_shell .v4-Ooq_nav button{text-align:left;flex-direction:row;min-width:max-content;padding:7px 12px}.v4-Ooq_shell .v4-Ooq_canvas>div{padding:14px 12px calc(170px + env(safe-area-inset-bottom,0px))}.v4-Ooq_shell .v4-Ooq_canvas[data-lock-page-header] [class*=pageHeader]{margin-inline:-12px;padding-inline:12px}.v4-Ooq_shell .v4-Ooq_modalBackdrop{padding:12px}.v4-Ooq_shell .v4-Ooq_modal{width:calc(100vw - 24px);max-height:calc(100vh - 24px)}.v4-Ooq_shell .v4-Ooq_modal>div:last-child{padding:14px}.v4-Ooq_shell [class*=documentWorkspace]{height:auto;min-height:0}.v4-Ooq_shell [class*=documentList]{scrollbar-gutter:auto;overflow-y:auto}.v4-Ooq_shell [class*=documentReader]{scrollbar-gutter:auto;overflow:visible}}@media (width<=520px){.v4-Ooq_shell .v4-Ooq_masthead{min-height:46px}.v4-Ooq_shell .v4-Ooq_brand h1{font-size:16px}.v4-Ooq_shell .v4-Ooq_headerActions{max-width:62vw}.v4-Ooq_shell [class*=storageMode]{padding-inline:7px}.v4-Ooq_shell .v4-Ooq_workspacePicker select{width:min(118px,30vw);padding-left:8px}.v4-Ooq_shell .v4-Ooq_workspaceMismatch>button{padding-inline:6px}.v4-Ooq_shell .v4-Ooq_statusCluster [class*=iconButton]{display:none}}@media (prefers-reduced-motion:reduce){.v4-Ooq_shell [class*=primaryButton],.v4-Ooq_shell [class*=secondaryButton],.v4-Ooq_shell [class*=ghostButton],.v4-Ooq_shell [class*=dangerButton],.v4-Ooq_shell [class*=dangerSolidButton],.v4-Ooq_shell [class*=iconButton],.v4-Ooq_shell [class*=bodyEditButton],.v4-Ooq_shell [class*=inspectorEye],.v4-Ooq_shell [class*=inspectorHeading] button,.v4-Ooq_shell [class*=sectionHeading] button,.v4-Ooq_shell [class*=previewHeading] button{transition:none}}";
		const tagId$4 = "dsh-mnemon/MnemonSidebarView.module.css";
		...
		var MnemonSidebarView_module_css_default = {
			"nav": "v4-Ooq_nav",
			"itemEditAction": "v4-Ooq_itemEditAction",
			"shell": "v4-Ooq_shell",
			"memoryWriteButton": "v4-Ooq_memoryWriteButton",
			"workspacePicker": "v4-Ooq_workspacePicker",
			"itemDangerAction": "v4-Ooq_itemDangerAction",
			"inspectorGlyph": "v4-Ooq_inspectorGlyph",
			"workspaceMismatch": "v4-Ooq_workspaceMismatch",
			"bodyCardMeta": "v4-Ooq_bodyCardMeta",
			"bodyCardFooter": "v4-Ooq_bodyCardFooter",
			"topNavigation": "v4-Ooq_topNavigation",
			"modalBackdrop": "v4-Ooq_modalBackdrop",
			"memoryTabs": "v4-Ooq_memoryTabs",
			"brand": "v4-Ooq_brand",
			"pageHeader": "v4-Ooq_pageHeader",
			"bodyCardHeader": "v4-Ooq_bodyCardHeader",
			"canvas": "v4-Ooq_canvas",
			"bodyCardIdentity": "v4-Ooq_bodyCardIdentity",
			"bodyDirectoryActions": "v4-Ooq_bodyDirectoryActions",
			"bodyCardStats": "v4-Ooq_bodyCardStats",
			"masthead": "v4-Ooq_masthead",
			"memoryWorkspace": "v4-Ooq_memoryWorkspace",
			"statusCluster": "v4-Ooq_statusCluster",
			"memoryNavigation": "v4-Ooq_memoryNavigation",
			"modal": "v4-Ooq_modal",
			"headerActions": "v4-Ooq_headerActions",
			"itemActionButton": "v4-Ooq_itemActionButton"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-footer.cwwhwj/src/client/MnemonView.module.css.mjs
		const css$3 = ".Wtbe8a_shell{--mn-bg:var(--dsw-alias-bg-base);--mn-layer-1:var(--dsw-alias-bg-layer-1);--mn-layer-2:var(--dsw-alias-bg-layer-2);--mn-input:var(--dsw-specific-input-major,var(--dsw-alias-bg-layer-2));--mn-text:var(--dsw-alias-label-primary);--mn-muted:var(--dsw-alias-label-secondary);--mn-faint:var(--dsw-alias-label-tertiary);--mn-line:var(--dsw-alias-border-l1);--mn-line-strong:var(--dsw-alias-border-l2);--mn-accent:var(--dsw-alias-state-business-primary);--mn-hover:var(--dsw-alias-interactive-bg-hover);--mn-danger:var(--dsw-alias-state-error-primary);--mn-success:var(--dsw-alias-state-success-primary);--mn-code:var(--ds-font-family-code,\"SFMono-Regular\", Consolas, monospace);--mn-sans:var(--dsw-font-family,-apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif);box-sizing:border-box;min-width:0;height:100%;min-height:0;color:var(--mn-text);background:var(--mn-bg);font:13px/1.55 var(--mn-sans);-webkit-tap-highlight-color:transparent;flex-direction:column;display:flex;overflow:hidden}.Wtbe8a_shell *,.Wtbe8a_shell :before,.Wtbe8a_shell :after{box-sizing:border-box}.Wtbe8a_shell button,.Wtbe8a_shell input,.Wtbe8a_shell select,.Wtbe8a_shell textarea{color:inherit;font:inherit}.Wtbe8a_shell button,.Wtbe8a_shell select{touch-action:manipulation}.Wtbe8a_shell button:focus-visible,.Wtbe8a_shell input:focus-visible,.Wtbe8a_shell select:focus-visible,.Wtbe8a_shell textarea:focus-visible,.Wtbe8a_shell summary:focus-visible,.Wtbe8a_shell [role=button]:focus-visible{outline:2px solid var(--mn-accent);outline-offset:2px}.Wtbe8a_masthead{border-bottom:1px solid var(--mn-line);background:var(--mn-bg);flex:none;grid-template-columns:minmax(220px,1fr) auto auto;align-items:center;gap:clamp(12px,2vw,24px);min-height:56px;padding:8px 16px;display:grid}.Wtbe8a_brand{align-items:center;gap:11px;min-width:0;display:flex}.Wtbe8a_brandLogo{width:32px;height:32px;box-shadow:0 0 0 1px var(--mn-line);border-radius:8px;flex:none;overflow:hidden}.Wtbe8a_brand h1{letter-spacing:-.02em;margin:1px 0 0;font-size:16px;line-height:1.15}.Wtbe8a_storageMode{border:1px solid var(--mn-line-strong);min-height:32px;color:var(--mn-muted);background:var(--mn-layer-1);white-space:nowrap;border-radius:8px;flex:none;align-items:center;gap:6px;padding:0 9px;display:flex}.Wtbe8a_storageMode>span{font-size:10px}.Wtbe8a_storageMode>strong{color:var(--mn-text);font-size:11px;font-weight:600}.Wtbe8a_cardKicker,.Wtbe8a_sectionHeading>div>span,.Wtbe8a_entityHeading>span,.Wtbe8a_inspectorHeading>span{color:var(--mn-faint);font:650 9px/1.2 var(--mn-code);letter-spacing:.12em;text-transform:uppercase}.Wtbe8a_statusCluster{border:1px solid var(--mn-line-strong);min-height:34px;color:var(--mn-muted);background:var(--mn-layer-1);border-radius:9px;flex:none;align-items:center;gap:8px;padding:0 4px 0 11px;font-size:11px;display:flex}.Wtbe8a_statusDot{border-radius:50%;width:6px;height:6px}.Wtbe8a_online{background:var(--mn-success);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 15%, transparent)}.Wtbe8a_offline{background:var(--mn-danger);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-danger) 14%, transparent)}.Wtbe8a_checking{background:var(--mn-faint);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-faint) 12%, transparent)}.Wtbe8a_iconButton{width:32px;height:32px;color:inherit;cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;display:grid}.Wtbe8a_iconButton:hover{color:var(--mn-accent);background:var(--mn-hover)}.Wtbe8a_headerActions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;display:flex}.Wtbe8a_workspacePicker{min-width:0;color:var(--mn-faint);align-items:center;gap:7px;font-size:10px;display:flex}.Wtbe8a_workspacePicker>span{white-space:nowrap}.Wtbe8a_workspacePicker select{border:1px solid var(--mn-line-strong);width:min(190px,22vw);min-width:112px;height:34px;color:var(--mn-text);background:var(--mn-input);cursor:pointer;border-radius:9px;outline:0;padding:0 28px 0 9px;font-size:11px}.Wtbe8a_workspacePicker select:hover{border-color:color-mix(in srgb, var(--mn-accent) 50%, var(--mn-line-strong))}.Wtbe8a_alert,.Wtbe8a_inlineError{border:1px solid color-mix(in srgb, var(--mn-danger) 32%, transparent);color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 7%, var(--mn-layer-1));border-radius:9px;padding:10px 13px;font-size:12px}.Wtbe8a_alert{flex-direction:column;flex:none;margin:10px clamp(18px,2.5vw,32px) 0;display:flex}.Wtbe8a_workspaceMismatch{border:1px solid color-mix(in srgb, var(--mn-accent) 36%, var(--mn-line));background:color-mix(in srgb, var(--mn-accent) 7%, var(--mn-layer-1));border-radius:10px;flex:none;justify-content:space-between;align-items:center;gap:18px;min-width:0;margin:10px clamp(18px,2.5vw,32px) 0;padding:11px 12px 11px 14px;display:flex}.Wtbe8a_workspaceMismatch>div{gap:2px;min-width:0;display:grid}.Wtbe8a_workspaceMismatch strong{font-size:12px}.Wtbe8a_workspaceMismatch span{color:var(--mn-muted);font-size:10px}.Wtbe8a_workspaceMismatch>div>div{flex-wrap:wrap;gap:5px 12px;min-width:0;margin-top:4px;display:flex}.Wtbe8a_workspaceMismatch code{color:var(--mn-faint);font:9px/1.4 var(--mn-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Wtbe8a_workspaceMismatch>button{white-space:nowrap;flex:none;min-height:32px}.Wtbe8a_telemetry{align-items:center;min-width:0;display:flex}.Wtbe8a_telemetryMetric{border-left:1px solid var(--mn-line);gap:2px;min-width:72px;padding:1px 14px;display:grid}.Wtbe8a_telemetryMetric span{color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;font-size:9px;overflow:hidden}.Wtbe8a_telemetryMetric strong{font:650 13px/1 var(--mn-code);font-variant-numeric:tabular-nums}.Wtbe8a_workspace{flex-direction:column;flex:1;min-height:0;display:flex}.Wtbe8a_topNavigation{border-bottom:1px solid var(--mn-line);background:var(--mn-layer-1);flex:none;justify-content:space-between;align-items:stretch;gap:14px;min-width:0;min-height:46px;padding:0 16px;display:flex}.Wtbe8a_nav{overscroll-behavior-inline:contain;scrollbar-width:none;align-items:stretch;gap:10px;min-width:0;display:flex;overflow-x:auto}.Wtbe8a_nav::-webkit-scrollbar{display:none}.Wtbe8a_navGroup{align-items:stretch;gap:14px;min-width:0;display:flex}.Wtbe8a_navGroupDivider{background:var(--mn-line);flex:none;align-self:center;width:1px;height:22px}.Wtbe8a_nav button{min-width:max-content;min-height:44px;color:var(--mn-muted);text-align:left;cursor:pointer;background:0 0;border:0;align-items:center;gap:7px;padding:0 3px;display:flex;position:relative}.Wtbe8a_nav button:hover,.Wtbe8a_nav button[aria-current=page]{color:var(--mn-text)}.Wtbe8a_nav button[aria-current=page]:after{content:\"\";background:var(--mn-accent);border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.Wtbe8a_nav button[aria-current=page] .Wtbe8a_navGlyph{color:var(--mn-accent)}.Wtbe8a_nav button>span:last-child{min-width:0;display:block}.Wtbe8a_nav button strong{font-size:12px;font-weight:600}.Wtbe8a_nav button small{display:none}.Wtbe8a_navGlyph{color:var(--mn-faint);font:600 13px/1 var(--mn-code)}@media (width>=1000px){.Wtbe8a_nav button{min-height:50px}.Wtbe8a_nav button small{color:var(--mn-faint);margin-top:1px;font-size:9px;line-height:1.3;display:block}}.Wtbe8a_spaceSummary{border-left:1px solid var(--mn-line);flex:none;grid-template-columns:minmax(0,1fr) auto;align-content:center;gap:1px 9px;min-width:142px;padding:0 0 0 14px;display:grid}.Wtbe8a_spaceSummary>span{color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;font-size:9px;overflow:hidden}.Wtbe8a_spaceSummary code{color:var(--mn-accent);font:650 12px/1 var(--mn-code);grid-row:span 2;align-self:center}.Wtbe8a_spaceSummary small{color:var(--mn-faint);font-size:9px}.Wtbe8a_canvas{overscroll-behavior-x:contain;overscroll-behavior-y:auto;scroll-behavior:auto;-webkit-overflow-scrolling:touch;background:var(--mn-bg);flex:1;min-width:0;overflow:auto}.Wtbe8a_page{width:min(1320px,100%);min-height:100%;margin:0 auto;padding:clamp(16px,2vw,24px) clamp(16px,2.4vw,28px) clamp(96px,14vh,150px)}.Wtbe8a_pageHeader{justify-content:space-between;align-items:flex-start;gap:24px;margin-bottom:16px;display:flex}.Wtbe8a_pageHeader h2{letter-spacing:-.025em;margin:2px 0;font-size:20px;line-height:1.2}.Wtbe8a_pageHeader p{max-width:72ch;color:var(--mn-muted);margin:0;font-size:12px;line-height:1.65}.Wtbe8a_pageHeaderMeta{flex:none;align-items:center;gap:9px;display:flex}.Wtbe8a_pageHeaderMeta>code{border:1px solid var(--mn-line);color:var(--mn-faint);background:var(--mn-layer-1);font:600 9px/1 var(--mn-code);letter-spacing:.06em;border-radius:7px;padding:6px 8px}.Wtbe8a_primaryButton,.Wtbe8a_secondaryButton,.Wtbe8a_ghostButton,.Wtbe8a_dangerButton,.Wtbe8a_dangerSolidButton{cursor:pointer;border-radius:8px;min-height:36px;padding:0 13px;font-size:12px;transition:border-color .14s,background-color .14s,color .14s,transform .14s}.Wtbe8a_primaryButton{border:1px solid var(--mn-accent);color:#fff;background:var(--mn-accent)}.Wtbe8a_secondaryButton{border:1px solid var(--mn-line-strong);color:var(--mn-text);background:var(--mn-layer-1)}.Wtbe8a_ghostButton,.Wtbe8a_dangerButton{background:0 0;border:1px solid #0000;min-height:32px;padding:0 9px}.Wtbe8a_ghostButton{color:var(--mn-muted)}.Wtbe8a_dangerButton{color:var(--mn-danger)}.Wtbe8a_dangerSolidButton{border:1px solid var(--mn-danger);color:#fff;background:var(--mn-danger);min-height:29px}.Wtbe8a_primaryButton:hover,.Wtbe8a_secondaryButton:hover,.Wtbe8a_ghostButton:hover,.Wtbe8a_dangerButton:hover{filter:brightness(.98);background-color:var(--mn-hover)}.Wtbe8a_primaryButton:hover{background-color:var(--mn-accent)}.Wtbe8a_shell button:disabled{cursor:not-allowed;opacity:.48}.Wtbe8a_emptyState{border:1px dashed var(--mn-line-strong);background:color-mix(in srgb, var(--mn-layer-1) 50%, transparent);border-radius:13px;justify-content:center;align-items:center;gap:22px;min-height:220px;padding:30px;display:flex}.Wtbe8a_emptyGlyph{border:1px solid color-mix(in srgb, var(--mn-accent) 35%, var(--mn-line));width:76px;height:76px;color:var(--mn-accent);background:radial-gradient(circle, color-mix(in srgb, var(--mn-accent) 12%, transparent), transparent 65%);font:500 26px/1 var(--mn-code);border-radius:50%;flex:none;place-items:center;display:grid}.Wtbe8a_emptyState h3{margin:0 0 5px;font-size:16px}.Wtbe8a_emptyState p{max-width:500px;color:var(--mn-muted);margin:0}.Wtbe8a_loadingPanel{border:1px solid var(--mn-line);min-height:220px;color:var(--mn-muted);background:var(--mn-layer-1);border-radius:13px;place-items:center;display:grid}.Wtbe8a_inlineError{margin:0 0 14px}.Wtbe8a_muted,.Wtbe8a_loading{color:var(--mn-faint);padding:16px 0;font-size:12px}.Wtbe8a_bodyDirectory{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-1) 72%, var(--mn-bg));border-radius:11px;margin-bottom:12px;padding:12px 14px}.Wtbe8a_bodyDirectoryHeader{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:10px;display:flex}.Wtbe8a_bodyDirectoryHeader h3{margin:1px 0;font-size:13px}.Wtbe8a_bodyDirectoryHeader p{color:var(--mn-muted);margin:0;font-size:10px}.Wtbe8a_bodyDirectoryPath{max-width:min(62vw,720px);color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;margin-top:4px;font-size:9px;display:block;overflow:hidden}.Wtbe8a_bodyDirectoryHeader>strong{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 9px var(--mn-code);border-radius:999px;flex:none;padding:5px 8px}.Wtbe8a_bodyGrid{grid-template-columns:repeat(auto-fit,minmax(245px,1fr));gap:7px;display:grid}.Wtbe8a_bodyDirectoryEmpty{border:1px dashed color-mix(in srgb, var(--mn-line) 84%, transparent);min-height:92px;color:var(--mn-muted);border-radius:12px;grid-column:1/-1;justify-content:center;align-items:center;gap:14px;display:flex}.Wtbe8a_bodyDirectoryEmpty>span{opacity:.6;font-size:28px}.Wtbe8a_bodyDirectoryEmpty strong{color:var(--mn-text);display:block}.Wtbe8a_bodyDirectoryEmpty p{margin:3px 0 0;font-size:10px}.Wtbe8a_bodyCard{--mn-body-accent:var(--mn-success);border:1px solid var(--mn-line);background:var(--mn-layer-1);opacity:.7;border-radius:9px;min-width:0;padding:9px 10px;transition:opacity .18s,border-color .18s}.Wtbe8a_bodyCard[data-active]{border-color:color-mix(in srgb, var(--mn-body-accent) 42%, var(--mn-line));opacity:1;box-shadow:inset 0 1px 0 color-mix(in srgb, var(--mn-body-accent) 10%, transparent)}.Wtbe8a_bodyCardTop{grid-template-columns:7px minmax(0,1fr) auto;align-items:center;gap:8px;display:grid}.Wtbe8a_bodySignal{background:var(--mn-faint);border-radius:50%;width:7px;height:7px}.Wtbe8a_bodyCard[data-active] .Wtbe8a_bodySignal{background:var(--mn-body-accent);box-shadow:0 0 0 4px color-mix(in srgb, var(--mn-body-accent) 14%, transparent)}.Wtbe8a_bodyCard:not([data-healthy]) .Wtbe8a_bodySignal{background:var(--mn-danger);box-shadow:0 0 0 4px color-mix(in srgb, var(--mn-danger) 12%, transparent)}.Wtbe8a_bodyCardTop>div{min-width:0;display:grid}.Wtbe8a_bodyCardTop strong{text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.Wtbe8a_bodyCardTop code{color:var(--mn-faint);font:9px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Wtbe8a_bodyHealth{color:var(--mn-success);font:650 8px var(--mn-code);letter-spacing:.07em;text-transform:uppercase}.Wtbe8a_bodyCard:not([data-healthy]) .Wtbe8a_bodyHealth{color:var(--mn-danger)}.Wtbe8a_bodySwitch{min-height:32px;color:var(--mn-faint);cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0 1px;font-size:9.5px;display:flex}.Wtbe8a_bodySwitchTrack{border:1px solid var(--mn-line-strong);background:var(--mn-layer-2);border-radius:999px;flex:none;width:29px;height:17px;transition:border-color .18s,background-color .18s;position:relative}.Wtbe8a_bodySwitchTrack i{background:var(--mn-faint);border-radius:50%;width:11px;height:11px;transition:transform .2s cubic-bezier(.2,.8,.2,1),background-color .18s;position:absolute;top:2px;left:2px}.Wtbe8a_bodySwitch:hover{color:var(--mn-text)}.Wtbe8a_bodySwitch:hover .Wtbe8a_bodySwitchTrack{border-color:var(--mn-body-accent)}.Wtbe8a_bodySwitch[aria-checked=true]{color:var(--mn-text)}.Wtbe8a_bodySwitch[aria-checked=true] .Wtbe8a_bodySwitchTrack{border-color:color-mix(in srgb, var(--mn-body-accent) 65%, var(--mn-line));background:color-mix(in srgb, var(--mn-body-accent) 25%, var(--mn-layer-2))}.Wtbe8a_bodySwitch[aria-checked=true] .Wtbe8a_bodySwitchTrack i{background:var(--mn-body-accent);transform:translate(12px)}.Wtbe8a_bodyCardActions{align-items:center;gap:6px;display:flex}.Wtbe8a_bodyEditButton{width:28px;height:28px;color:var(--mn-muted);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:7px;place-items:center;font-size:12px;display:grid}.Wtbe8a_bodyEditButton:hover{color:var(--mn-text);border-color:var(--mn-line);background:var(--mn-hover)}.Wtbe8a_bodyEdit{gap:9px;padding-top:2px;display:grid}.Wtbe8a_bodyEdit label{color:var(--mn-faint);gap:4px;font-size:9px;display:grid}.Wtbe8a_bodyEdit input,.Wtbe8a_bodyEdit textarea{border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:8px;outline:0;padding:7px 9px;font-size:12px;line-height:1.5}.Wtbe8a_bodyEdit textarea{resize:vertical}.Wtbe8a_bodyEdit input:focus,.Wtbe8a_bodyEdit textarea:focus{border-color:var(--mn-accent)}.Wtbe8a_bodyEditActions{justify-content:flex-end;gap:7px;display:flex}.Wtbe8a_bodyDeleteConfirm{gap:16px;display:grid}.Wtbe8a_bodyDeleteConfirm>p{color:var(--mn-muted);margin:0;font-size:12px;line-height:1.6}.Wtbe8a_bodyDeleteSummary{border:1px solid color-mix(in srgb, var(--mn-danger) 22%, var(--mn-line));background:color-mix(in srgb, var(--mn-danger) 5%, var(--mn-layer-1));border-radius:8px;gap:3px;padding:12px;display:grid}.Wtbe8a_bodyDeleteSummary strong{font-size:13px}.Wtbe8a_bodyDeleteContent{white-space:pre-wrap;overflow-wrap:anywhere;margin:0;font-size:13px;font-weight:400;line-height:1.55}.Wtbe8a_bodyDeleteSummary span{color:var(--mn-muted);font-size:11px}.Wtbe8a_bodyCard>p{min-height:15px;color:var(--mn-muted);margin:7px 0;font-size:10px;line-height:1.45}.Wtbe8a_bodyCard footer{border-top:1px solid var(--mn-line);color:var(--mn-faint);flex-wrap:wrap;gap:5px 11px;padding-top:6px;font-size:9px;display:flex}.Wtbe8a_bodyCreate{border-top:1px solid var(--mn-line);margin-top:10px;padding-top:8px}.Wtbe8a_bodyCreate summary{cursor:pointer;width:max-content;color:var(--mn-accent);font-size:10px;list-style:none}.Wtbe8a_bodyCreate summary::-webkit-details-marker{display:none}.Wtbe8a_bodyCreate form{grid-template-columns:minmax(130px,.7fr) minmax(150px,.9fr) minmax(230px,1.7fr) auto;gap:7px;margin-top:9px;display:grid}.Wtbe8a_bodyCreate input{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:0;height:34px;padding:0 9px}.Wtbe8a_bodyCreate input:focus{border-color:var(--mn-accent)}.Wtbe8a_graphLayout{grid-template-columns:minmax(0,1fr) minmax(240px,270px);gap:10px;display:grid}.Wtbe8a_graphPanel,.Wtbe8a_graphInspector{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px}.Wtbe8a_graphPanel{min-width:0;overflow:hidden}.Wtbe8a_graphToolbar,.Wtbe8a_graphFooter{min-height:43px;color:var(--mn-muted);justify-content:space-between;align-items:center;gap:14px;padding:0 13px;font-size:10px;display:flex}.Wtbe8a_graphToolbar{border-bottom:1px solid var(--mn-line)}.Wtbe8a_graphToolbar>div:first-child{align-items:center;gap:7px;display:flex}.Wtbe8a_graphToolbar small{color:var(--mn-faint)}.Wtbe8a_liveDot{background:var(--mn-success);width:6px;height:6px;box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 15%, transparent);border-radius:50%}.Wtbe8a_graphLegend{flex-wrap:wrap;justify-content:flex-end;gap:5px 10px;display:flex}.Wtbe8a_graphLegend span{align-items:center;gap:4px;display:flex}.Wtbe8a_graphLegend span:before{content:\"\";background:var(--edge-color);border-radius:2px;width:13px;height:2px}.Wtbe8a_graphLegend [data-edge=temporal]{--edge-color:#87909f}.Wtbe8a_graphLegend [data-edge=scope]{--edge-color:#708199}.Wtbe8a_graphLegend [data-edge=scope]:before{background:repeating-linear-gradient(90deg, var(--edge-color) 0 4px, transparent 4px 7px)}.Wtbe8a_graphLegend [data-edge=semantic]{--edge-color:#4d7cfe}.Wtbe8a_graphLegend [data-edge=causal]{--edge-color:#ef6b5b}.Wtbe8a_graphLegend [data-edge=entity]{--edge-color:#22a879}.Wtbe8a_graphViewport{background:radial-gradient(circle at 50% 48%, color-mix(in srgb, var(--mn-accent) 6%, transparent), transparent 47%);min-height:clamp(390px,42vw,560px);position:relative;overflow:hidden}.Wtbe8a_graphCanvasControls{z-index:2;border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-1) 88%, transparent);box-shadow:0 6px 18px color-mix(in srgb, var(--mn-text) 7%, transparent);backdrop-filter:blur(10px);border-radius:9px;align-items:center;gap:5px;padding:4px;display:flex;position:absolute;top:10px;right:10px}.Wtbe8a_graphCanvasControls span{color:var(--mn-faint);font:9px var(--mn-code);align-items:center;gap:5px;padding:0 6px;display:flex}.Wtbe8a_graphCanvasControls span i{background:var(--mn-accent);width:5px;height:5px;box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-accent) 12%, transparent);border-radius:50%}.Wtbe8a_graphCanvasControls button{min-height:30px;color:var(--mn-muted);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;padding:0 9px;font-size:9.5px}.Wtbe8a_graphCanvasControls button:hover,.Wtbe8a_graphCanvasControls button[data-active]{border-color:var(--mn-line);color:var(--mn-text);background:var(--mn-hover)}.Wtbe8a_graphCanvasControls button[data-active]{color:var(--mn-accent)}.Wtbe8a_graphSvg{touch-action:pan-y pinch-zoom;user-select:none;width:100%;height:clamp(390px,42vw,560px);display:block}.Wtbe8a_graphBackdrop{fill:var(--mn-layer-1)}.Wtbe8a_graphGridLine{stroke:var(--mn-line);stroke-width:.6px;opacity:.5}.Wtbe8a_graphEdge{fill:none;stroke:#87909f;stroke-width:1px;opacity:.32;vector-effect:non-scaling-stroke}.Wtbe8a_graphEdge[data-edge=scope]{stroke:#708199;stroke-dasharray:4 5;opacity:.28}.Wtbe8a_graphEdge[data-edge=semantic]{stroke:#4d7cfe;opacity:.48}.Wtbe8a_graphEdge[data-edge=causal]{stroke:#ef6b5b;opacity:.52}.Wtbe8a_graphEdge[data-edge=entity]{stroke:#22a879;stroke-width:1.45px;opacity:.78}.Wtbe8a_graphNode{--node:#8290a8;cursor:grab;touch-action:none;outline:none}.Wtbe8a_graphNode[data-dragging]{cursor:grabbing}.Wtbe8a_graphNode[data-category=decision]{--node:#ef8354}.Wtbe8a_graphNode[data-category=preference]{--node:#a879e1}.Wtbe8a_graphNode[data-category=fact]{--node:#4d7cfe}.Wtbe8a_graphNode[data-category=insight]{--node:#19a77d}.Wtbe8a_graphNode[data-category=context]{--node:#d8a624}.Wtbe8a_graphNode[data-kind=space]{--node:var(--mn-success)}.Wtbe8a_graphNode[data-kind=entity]{--node:#2b9db9}.Wtbe8a_nodeHalo{fill:color-mix(in srgb, var(--node) 18%, var(--mn-layer-1));stroke:color-mix(in srgb, var(--node) 60%, var(--mn-layer-1));stroke-width:1.5px;transition:r .16s}.Wtbe8a_nodeCore{fill:var(--node)}.Wtbe8a_nodeLabel{fill:var(--mn-muted);font:10px var(--mn-code);pointer-events:auto}.Wtbe8a_nodeBodyLabel{fill:var(--mn-faint);font:650 8px var(--mn-code);letter-spacing:.04em;pointer-events:auto}.Wtbe8a_graphSvg[data-density=sparse] .Wtbe8a_nodeLabel{font-size:12px}.Wtbe8a_graphNode:hover .Wtbe8a_nodeHalo,.Wtbe8a_graphNode:focus .Wtbe8a_nodeHalo,.Wtbe8a_graphNode[data-selected] .Wtbe8a_nodeHalo{fill:color-mix(in srgb, var(--node) 28%, var(--mn-layer-1));stroke:var(--node)}.Wtbe8a_graphNode[data-selected] .Wtbe8a_nodeLabel{fill:var(--mn-text);font-weight:650}.Wtbe8a_graphFooter{border-top:1px solid var(--mn-line);min-height:38px;color:var(--mn-faint)}.Wtbe8a_graphInspector{min-width:0;min-height:calc(clamp(390px,42vw,560px) + 83px);padding:15px;overflow:hidden}.Wtbe8a_inspectorEmpty{text-align:center;flex-direction:column;justify-content:center;align-items:center;height:100%;display:flex}.Wtbe8a_inspectorLogo{opacity:.72;border-radius:11px;width:54px;height:54px;margin-bottom:15px}.Wtbe8a_inspectorEmpty h3{margin:7px 0 3px;font-size:14px}.Wtbe8a_inspectorEmpty p{color:var(--mn-faint);margin:0;font-size:11px}.Wtbe8a_inspectorHeading{justify-content:space-between;align-items:center;display:flex}.Wtbe8a_inspectorHeading button,.Wtbe8a_sectionHeading button{width:32px;height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;display:grid}.Wtbe8a_inspectorHeading button:hover,.Wtbe8a_sectionHeading button:hover{background:var(--mn-hover)}.Wtbe8a_categoryChip{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 10%, transparent);border-radius:999px;margin-top:24px;padding:3px 8px;font-size:10px;display:inline-flex}.Wtbe8a_inspectorTitleRow{align-items:flex-start;gap:8px;min-width:0;margin:12px 0 20px;display:flex}.Wtbe8a_inspectorTitle{overflow-wrap:anywhere;white-space:pre-wrap;-webkit-line-clamp:6;-webkit-box-orient:vertical;flex:1;min-width:0;margin:0;font-size:14px;line-height:1.6;display:-webkit-box;overflow:hidden}.Wtbe8a_inspectorEye{border:1px solid var(--mn-line);width:27px;height:27px;color:var(--mn-muted);background:var(--mn-layer-1);cursor:pointer;border-radius:7px;flex:none;place-items:center;transition:color .15s,border-color .15s,background-color .15s;display:grid}.Wtbe8a_inspectorEye:hover{color:var(--mn-accent);border-color:var(--mn-line-strong);background:var(--mn-hover)}.Wtbe8a_inspectorMeta{margin:0}.Wtbe8a_inspectorMeta>div{border-top:1px solid var(--mn-line);gap:3px;padding:11px 0;display:grid}.Wtbe8a_inspectorMeta dt{color:var(--mn-faint);font:9px var(--mn-code);text-transform:uppercase}.Wtbe8a_inspectorMeta dd{overflow-wrap:anywhere;color:var(--mn-muted);margin:0;font-size:11px}.Wtbe8a_inspectorActions{gap:8px;margin-top:20px;display:grid}.Wtbe8a_previewOverlay{z-index:40;background:color-mix(in srgb, var(--mn-bg) 58%, transparent);backdrop-filter:blur(4px);place-items:center;padding:clamp(16px,4vw,48px);display:grid;position:fixed;inset:0}.Wtbe8a_previewDialog{border:1px solid var(--mn-line-strong);background:var(--mn-layer-1);width:min(680px,100%);max-height:min(76dvh,640px);box-shadow:0 24px 64px color-mix(in srgb, var(--mn-text) 20%, transparent);border-radius:13px;flex-direction:column;display:flex;overflow:hidden}.Wtbe8a_previewHeading{border-bottom:1px solid var(--mn-line);flex:none;justify-content:space-between;align-items:center;gap:12px;min-height:46px;padding:0 14px 0 16px;display:flex}.Wtbe8a_previewHeading>span{color:var(--mn-accent);font:650 9px/1.2 var(--mn-code);letter-spacing:.08em;text-transform:uppercase}.Wtbe8a_previewHeading button{width:32px;height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;font-size:15px;display:grid}.Wtbe8a_previewHeading button:hover{background:var(--mn-hover)}.Wtbe8a_previewMeta{border-bottom:1px solid var(--mn-line);color:var(--mn-faint);font:9px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;flex:none;padding:8px 16px;overflow:hidden}.Wtbe8a_previewBody{-webkit-overflow-scrolling:touch;min-height:0;padding:14px 16px 18px;overflow:auto}.Wtbe8a_previewBody p{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--mn-text);margin:0;font-size:13px;line-height:1.7}.Wtbe8a_searchBar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:13px;margin-bottom:18px;padding:13px}.Wtbe8a_queryField{border:1px solid var(--mn-line-strong);background:var(--mn-input);border-radius:9px;grid-template-columns:24px minmax(0,1fr) 24px;align-items:center;gap:5px;padding:0 10px;display:grid}.Wtbe8a_queryField>span{color:var(--mn-accent);font:18px var(--mn-code)}.Wtbe8a_queryField input{background:0 0;border:0;outline:0;width:100%;height:42px}.Wtbe8a_queryField kbd{color:var(--mn-faint);font:11px var(--mn-code)}.Wtbe8a_searchControls{justify-content:flex-end;align-items:flex-end;gap:10px;padding-top:10px;display:flex}.Wtbe8a_searchActions{align-items:center;gap:7px;display:flex}.Wtbe8a_agentAnswer{border:1px solid color-mix(in srgb, var(--mn-accent) 30%, var(--mn-line));background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 7%, var(--mn-layer-1)), var(--mn-layer-1) 60%);border-radius:11px;margin-bottom:16px;padding:16px 18px}.Wtbe8a_agentAnswerHeading{justify-content:space-between;align-items:flex-start;gap:16px;display:flex}.Wtbe8a_agentAnswerHeading span{color:var(--mn-accent);font:650 9px/1.2 var(--mn-code);letter-spacing:.08em}.Wtbe8a_agentAnswerHeading h3{margin:4px 0 0;font-size:15px}.Wtbe8a_agentAnswerHeading>code{color:var(--mn-faint);font-size:9px}.Wtbe8a_agentAnswer>p{white-space:pre-wrap;color:var(--mn-text);margin:12px 0;font-size:13px;line-height:1.7}.Wtbe8a_agentCitations{border-top:1px solid var(--mn-line);flex-wrap:wrap;gap:5px;padding-top:10px;display:flex}.Wtbe8a_agentCitations code{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:5px;padding:3px 6px;font-size:9px}.Wtbe8a_searchControls label,.Wtbe8a_formGrid label,.Wtbe8a_fieldWide{color:var(--mn-muted);gap:5px;font-size:11px;display:grid}.Wtbe8a_searchControls select,.Wtbe8a_formGrid select,.Wtbe8a_formGrid input,.Wtbe8a_listToolbar input,.Wtbe8a_listToolbar select,.Wtbe8a_entitySearch input{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:140px;height:34px;padding:0 9px}.Wtbe8a_searchControls select:focus,.Wtbe8a_formGrid select:focus,.Wtbe8a_formGrid input:focus,.Wtbe8a_listToolbar input:focus,.Wtbe8a_listToolbar select:focus,.Wtbe8a_entitySearch input:focus,.Wtbe8a_supervisedForm textarea:focus{border-color:var(--mn-accent)}.Wtbe8a_singleColumn{max-width:830px}.Wtbe8a_resultLayout{grid-template-columns:minmax(0,1.15fr) minmax(300px,.85fr);align-items:start;gap:14px;display:grid}.Wtbe8a_results,.Wtbe8a_relatedPane,.Wtbe8a_entityResults{min-width:0}.Wtbe8a_sectionHeading{justify-content:space-between;align-items:center;gap:16px;min-height:39px;margin-bottom:8px;display:flex}.Wtbe8a_sectionHeading h3{margin:2px 0 0;font-size:15px}.Wtbe8a_sectionHeading>strong{min-width:27px;height:27px;color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 11px var(--mn-code);border-radius:7px;place-items:center;display:grid}.Wtbe8a_relatedPane{border:1px solid var(--mn-line);background:var(--mn-layer-1);-webkit-overflow-scrolling:touch;border-radius:12px;max-height:calc(100dvh - 230px);padding:13px;scroll-margin-top:14px;position:sticky;top:12px;overflow:auto}.Wtbe8a_relatedSource{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:8px;margin:0 0 13px;padding:10px;font-size:11px}.Wtbe8a_insightCard{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;margin-bottom:9px;padding:14px;transition:border-color .15s,transform .15s,box-shadow .15s}.Wtbe8a_insightCard:hover{border-color:var(--mn-line-strong);transform:translateY(-1px)}.Wtbe8a_cardTop{justify-content:space-between;align-items:center;gap:10px;display:flex}.Wtbe8a_badges,.Wtbe8a_tags,.Wtbe8a_entities{flex-wrap:wrap;gap:5px;display:flex}.Wtbe8a_badge{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:999px;padding:2px 6px;font-size:9px}.Wtbe8a_id{color:var(--mn-faint);font:9px var(--mn-code)}.Wtbe8a_content{white-space:pre-wrap;overflow-wrap:anywhere;margin:10px 0;line-height:1.65}.Wtbe8a_tags{color:var(--mn-accent);font-size:10px}.Wtbe8a_entities{margin-top:7px}.Wtbe8a_entities span{border:1px solid var(--mn-line);color:var(--mn-muted);border-radius:5px;padding:2px 6px;font-size:9px}.Wtbe8a_cardActions{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:3px;min-height:30px;margin-top:10px;padding-top:8px;display:flex}.Wtbe8a_confirmBar{width:100%;color:var(--mn-danger);justify-content:flex-end;align-items:center;gap:5px;font-size:11px;display:flex}.Wtbe8a_confirmBar>span{margin-right:auto}.Wtbe8a_entityLayout{grid-template-columns:265px minmax(0,1fr);align-items:start;gap:16px;display:grid}.Wtbe8a_entityRail{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;padding:13px;position:sticky;top:0}.Wtbe8a_entitySearch{grid-template-columns:minmax(0,1fr) auto;gap:7px;display:grid}.Wtbe8a_entitySearch input{min-width:0}.Wtbe8a_entityHeading{justify-content:space-between;align-items:center;margin:18px 2px 7px;display:flex}.Wtbe8a_entityHeading small{color:var(--mn-faint);font-size:9px}.Wtbe8a_entityList{gap:3px;display:grid}.Wtbe8a_entityList button{min-height:34px;color:var(--mn-muted);cursor:pointer;text-align:left;background:0 0;border:0;border-radius:7px;justify-content:space-between;align-items:center;gap:10px;padding:0 9px;display:flex}.Wtbe8a_entityList button:hover,.Wtbe8a_entityList button[aria-pressed=true]{color:var(--mn-text);background:var(--mn-hover)}.Wtbe8a_entityList strong{color:var(--mn-faint);font:10px var(--mn-code)}.Wtbe8a_entityResults>.Wtbe8a_emptyState{min-height:360px}.Wtbe8a_runtimeComposer,.Wtbe8a_runtimeTarget{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px}.Wtbe8a_runtimeComposer{background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 5%, var(--mn-layer-1)), var(--mn-layer-1) 55%);margin-bottom:13px;padding:15px}.Wtbe8a_runtimeComposerHeading{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:11px;display:flex}.Wtbe8a_runtimeComposerHeading h3{margin:0 0 2px;font-size:14px}.Wtbe8a_runtimeComposerHeading p{color:var(--mn-muted);margin:0;font-size:10px}.Wtbe8a_runtimeComposerHeading>span{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 9px var(--mn-code);border-radius:999px;flex:none;padding:4px 8px}.Wtbe8a_runtimeComposer>textarea,.Wtbe8a_runtimeEntry textarea{resize:vertical;border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:9px;outline:0;padding:10px 11px;line-height:1.6}.Wtbe8a_runtimeComposer>textarea:focus,.Wtbe8a_runtimeEntry textarea:focus{border-color:var(--mn-accent)}.Wtbe8a_runtimeComposerActions{justify-content:flex-end;align-items:flex-end;gap:9px;margin-top:10px;display:flex}.Wtbe8a_runtimeComposerActions label{color:var(--mn-faint);gap:4px;font-size:9px;display:grid}.Wtbe8a_runtimeComposerActions select,.Wtbe8a_runtimeEntry select{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:135px;height:34px;padding:0 8px}.Wtbe8a_runtimeNotice,.Wtbe8a_runtimeReadOnly{border:1px solid color-mix(in srgb, var(--mn-success) 28%, var(--mn-line));color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 6%, var(--mn-layer-1));border-radius:9px;margin-bottom:13px;padding:9px 12px;font-size:11px}.Wtbe8a_runtimeReadOnly{color:var(--mn-muted);border-color:var(--mn-line);background:var(--mn-layer-1)}.Wtbe8a_runtimeGrid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:12px;display:grid}.Wtbe8a_runtimeSummaryGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-bottom:10px;display:grid}.Wtbe8a_runtimeSummaryCard{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0}.Wtbe8a_runtimeBrowser{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;overflow:hidden}.Wtbe8a_runtimeBrowserToolbar{border-bottom:1px solid var(--mn-line);justify-content:space-between;align-items:center;gap:12px;padding:10px;display:flex}.Wtbe8a_runtimeScopeFilter{flex-wrap:wrap;align-items:center;gap:3px;display:flex}.Wtbe8a_runtimeScopeFilter button{min-height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:7px;padding:0 10px}.Wtbe8a_runtimeScopeFilter button:hover{background:var(--mn-hover)}.Wtbe8a_runtimeScopeFilter button[data-active]{border-color:var(--mn-line);color:var(--mn-text);background:var(--mn-layer-2)}.Wtbe8a_runtimeScopeFilter b{color:var(--mn-faint);font:600 10px var(--mn-code);margin-left:4px}.Wtbe8a_runtimeFilterQuery{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;align-items:center;gap:7px;width:min(320px,42%);min-width:210px;padding:0 9px;display:flex}.Wtbe8a_runtimeFilterQuery>span{color:var(--mn-faint)}.Wtbe8a_runtimeFilterQuery input{width:100%;min-width:0;height:32px;color:var(--mn-text);background:0 0;border:0;outline:0}.Wtbe8a_runtimeUnifiedList{background:color-mix(in srgb, var(--mn-layer-2) 30%, var(--mn-layer-1));grid-template-columns:1fr;gap:8px;padding:10px;display:grid}.Wtbe8a_runtimeEntryBadges{flex-wrap:wrap;align-items:center;gap:5px;display:flex}.Wtbe8a_runtimeEntryMeta .Wtbe8a_runtimeEntryTarget{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 8%, var(--mn-layer-2));font-family:var(--mn-code)}.Wtbe8a_runtimeTarget{min-width:0;overflow:hidden}.Wtbe8a_runtimeTargetHeader{justify-content:space-between;align-items:center;gap:14px;padding:14px 15px 9px;display:flex}.Wtbe8a_runtimeTargetHeader>div{gap:1px;display:grid}.Wtbe8a_runtimeTargetHeader span{color:var(--mn-faint);font:650 9px var(--mn-code);letter-spacing:.08em}.Wtbe8a_runtimeTargetHeader h3{margin:0;font-size:15px}.Wtbe8a_runtimeTargetHeader>strong{min-width:28px;height:28px;color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 11px var(--mn-code);border-radius:8px;place-items:center;display:grid}.Wtbe8a_capacityLine{align-items:center;gap:9px;padding:0 15px;display:flex}.Wtbe8a_capacityLine>div{background:var(--mn-layer-2);border-radius:999px;flex:1;height:4px;overflow:hidden}.Wtbe8a_capacityLine i{border-radius:inherit;background:var(--mn-success);height:100%;transition:width .25s;display:block}.Wtbe8a_capacityLine>span{min-width:88px;color:var(--mn-faint);font:9px var(--mn-code);text-align:right}.Wtbe8a_runtimeTargetDescription{min-height:31px;color:var(--mn-muted);margin:8px 15px 12px;font-size:10px}.Wtbe8a_runtimeEntries{border-top:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 36%, var(--mn-layer-1));gap:7px;padding:10px;display:grid}.Wtbe8a_runtimeEntry{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:9px;padding:11px;position:relative}.Wtbe8a_runtimeEntry:before{content:\"\";background:var(--mn-muted);border-radius:0 2px 2px 0;width:2px;position:absolute;top:12px;bottom:12px;left:-1px}.Wtbe8a_runtimeEntry[data-importance=critical]:before{background:var(--mn-danger)}.Wtbe8a_runtimeEntry[data-importance=low]:before{background:var(--mn-faint);opacity:.45}.Wtbe8a_runtimeEntryMeta{justify-content:space-between;align-items:center;gap:12px;display:flex}.Wtbe8a_runtimeEntryMeta>span{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:999px;padding:2px 6px;font-size:9px}.Wtbe8a_runtimeEntry[data-importance=critical] .Wtbe8a_runtimeEntryMeta>span{color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 8%, transparent)}.Wtbe8a_runtimeEntryMeta time{color:var(--mn-faint);font:8px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Wtbe8a_runtimeEntry>p{white-space:pre-wrap;overflow-wrap:anywhere;min-height:42px;margin:9px 0;font-size:12px;line-height:1.6}.Wtbe8a_runtimeEntry>select{margin-top:7px}.Wtbe8a_runtimeEntry footer{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:4px;min-height:30px;margin-top:7px;padding-top:7px;display:flex}.Wtbe8a_runtimeEntry footer>span{color:var(--mn-danger);margin-right:auto;font-size:10px}.Wtbe8a_runtimeEmpty{min-height:126px;color:var(--mn-faint);text-align:center;align-content:center;place-items:center;gap:5px;display:grid}.Wtbe8a_runtimeEmpty>span{font:24px var(--mn-code);opacity:.65}.Wtbe8a_runtimeEmpty p{margin:0;font-size:10px}.Wtbe8a_runtimeFootnote{color:var(--mn-faint);margin:10px 2px 0;font-size:9px}.Wtbe8a_documentSummary{grid-template-columns:.7fr .7fr 1.6fr;gap:9px;margin-bottom:12px;display:grid}.Wtbe8a_documentSummary article{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;min-height:91px;padding:13px 14px}.Wtbe8a_documentSummary article>span{color:var(--mn-faint);font-size:9px;display:block}.Wtbe8a_documentSummary article>strong{font:650 21px/1 var(--mn-code);margin:7px 0 4px;display:block}.Wtbe8a_documentSummary article>small{color:var(--mn-muted);font-size:9px}.Wtbe8a_documentCapacity>div{background:var(--mn-layer-2);border-radius:999px;height:4px;margin:7px 0 6px;overflow:hidden}.Wtbe8a_documentCapacity>div i{border-radius:inherit;background:var(--mn-accent);height:100%;transition:width .3s;display:block}.Wtbe8a_documentToolbar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;align-items:center;gap:9px;margin-bottom:12px;padding:9px;display:flex}.Wtbe8a_documentToolbar form{flex:1;grid-template-columns:20px minmax(0,1fr) auto;align-items:center;gap:5px;min-width:260px;padding-left:8px;display:grid}.Wtbe8a_documentToolbar form>span{color:var(--mn-faint);font:15px var(--mn-code)}.Wtbe8a_documentToolbar input,.Wtbe8a_documentEditor input,.Wtbe8a_documentEditor textarea{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;width:100%;padding:8px 10px}.Wtbe8a_documentToolbar input{background:0 0;border-color:#0000;height:34px}.Wtbe8a_documentToolbar input:focus,.Wtbe8a_documentEditor input:focus,.Wtbe8a_documentEditor textarea:focus{border-color:var(--mn-accent)}.Wtbe8a_documentToolbar>div{border:1px solid var(--mn-line);background:var(--mn-layer-2);border-radius:8px;align-items:center;gap:3px;padding:3px;display:flex}.Wtbe8a_documentToolbar>div button{min-height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:6px;padding:0 10px;font-size:10.5px}.Wtbe8a_documentToolbar>div button[data-active]{color:var(--mn-text);background:var(--mn-layer-1);box-shadow:0 1px 3px color-mix(in srgb, var(--mn-text) 8%, transparent)}.Wtbe8a_documentToolbar>div b{color:var(--mn-faint);font:600 9px var(--mn-code);margin-left:4px}.Wtbe8a_documentWorkspace{grid-template-columns:minmax(250px,310px) minmax(0,1fr);gap:10px;min-height:590px;display:grid}.Wtbe8a_documentList,.Wtbe8a_documentReader{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;overflow:hidden}.Wtbe8a_documentList{align-self:stretch}.Wtbe8a_documentList>header{border-bottom:1px solid var(--mn-line);min-height:42px;color:var(--mn-faint);justify-content:space-between;align-items:center;padding:0 12px;font-size:9px;display:flex}.Wtbe8a_documentList>header code{color:var(--mn-accent)}.Wtbe8a_documentList>button{border:0;border-bottom:1px solid var(--mn-line);width:100%;color:var(--mn-text);text-align:left;cursor:pointer;background:0 0;padding:12px;transition:background-color .15s,box-shadow .15s;display:block}.Wtbe8a_documentList>button:hover{background:var(--mn-hover)}.Wtbe8a_documentList>button[data-selected]{background:color-mix(in srgb, var(--mn-accent) 7%, var(--mn-layer-1));box-shadow:inset 2px 0 var(--mn-accent)}.Wtbe8a_documentList>button>div{justify-content:space-between;align-items:baseline;gap:12px;display:flex}.Wtbe8a_documentList>button strong{text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.Wtbe8a_documentList>button time{color:var(--mn-faint);font:8px var(--mn-code);flex:none}.Wtbe8a_documentList>button p{min-height:30px;color:var(--mn-muted);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:6px 0 9px;font-size:10px;line-height:1.5;display:-webkit-box;overflow:hidden}.Wtbe8a_documentList>button footer{color:var(--mn-faint);align-items:center;gap:8px;font-size:9px;display:flex}.Wtbe8a_documentList>button footer code{margin-left:auto}.Wtbe8a_documentList>button footer em{color:var(--mn-danger);font-style:normal}.Wtbe8a_documentListEmpty{min-height:230px;color:var(--mn-muted);text-align:center;align-content:center;place-items:center;gap:4px;padding:22px;display:grid}.Wtbe8a_documentListEmpty>span{color:var(--mn-accent);font:28px var(--mn-code);opacity:.6;margin-bottom:6px}.Wtbe8a_documentListEmpty p{color:var(--mn-faint);margin:0;font-size:10px}.Wtbe8a_documentReader{padding:clamp(16px,2vw,22px)}.Wtbe8a_documentReader>.Wtbe8a_emptyState{background:0 0;border:0;height:100%}.Wtbe8a_documentDetail>header{border-bottom:1px solid var(--mn-line);justify-content:space-between;align-items:flex-start;gap:18px;padding-bottom:15px;display:flex}.Wtbe8a_documentDetail>header span{color:var(--mn-accent);font:650 9px var(--mn-code);letter-spacing:.08em;text-transform:uppercase}.Wtbe8a_documentDetail>header h3{margin:5px 0 3px;font-size:18px}.Wtbe8a_documentDetail>header p{color:var(--mn-muted);margin:0;font-size:11px}.Wtbe8a_documentDetail>dl{border-top:1px solid var(--mn-line);border-left:1px solid var(--mn-line);grid-template-columns:2fr .45fr .8fr .55fr;margin:13px 0;display:grid}.Wtbe8a_documentDetail>dl>div{border-right:1px solid var(--mn-line);border-bottom:1px solid var(--mn-line);min-width:0;padding:8px 9px}.Wtbe8a_documentDetail dt{color:var(--mn-faint);margin-bottom:3px;font-size:8px}.Wtbe8a_documentDetail dd{text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:9px;overflow:hidden}.Wtbe8a_documentSources{flex-wrap:wrap;align-items:center;gap:5px;margin:11px 0;display:flex}.Wtbe8a_documentSources>span{color:var(--mn-faint);margin-right:4px;font-size:9px}.Wtbe8a_documentSources code,.Wtbe8a_documentArchiveReceipt code{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:5px;padding:3px 6px;font-size:8px}.Wtbe8a_markdownBody{overflow-wrap:anywhere;border:1px solid var(--mn-line);min-height:310px;color:var(--mn-text);background:color-mix(in srgb, var(--mn-layer-2) 30%, var(--mn-layer-1));border-radius:10px;margin:16px 0 0;padding:clamp(18px,2.5vw,28px);font-size:13px;line-height:1.78}.Wtbe8a_markdownBody>:first-child{margin-top:0}.Wtbe8a_markdownBody>:last-child{margin-bottom:0}.Wtbe8a_markdownBody h1,.Wtbe8a_markdownBody h2,.Wtbe8a_markdownBody h3,.Wtbe8a_markdownBody h4{color:var(--mn-text);letter-spacing:-.015em;margin:1.55em 0 .65em;line-height:1.3}.Wtbe8a_markdownBody h1{border-bottom:1px solid var(--mn-line);padding-bottom:.35em;font-size:1.75em}.Wtbe8a_markdownBody h2{border-bottom:1px solid var(--mn-line);padding-bottom:.3em;font-size:1.42em}.Wtbe8a_markdownBody h3{font-size:1.18em}.Wtbe8a_markdownBody p,.Wtbe8a_markdownBody ul,.Wtbe8a_markdownBody ol,.Wtbe8a_markdownBody blockquote,.Wtbe8a_markdownBody table,.Wtbe8a_markdownBody pre{margin:.85em 0}.Wtbe8a_markdownBody ul,.Wtbe8a_markdownBody ol{padding-left:1.6em}.Wtbe8a_markdownBody li+li{margin-top:.3em}.Wtbe8a_markdownBody blockquote{border-left:3px solid var(--mn-accent);color:var(--mn-muted);background:color-mix(in srgb, var(--mn-accent) 4%, transparent);margin-inline:0;padding:.15em 1em}.Wtbe8a_markdownBody code{color:var(--mn-text);background:var(--mn-layer-2);font:.88em/1.55 var(--mn-code);border-radius:5px;padding:.15em .38em}.Wtbe8a_markdownBody pre{border:1px solid var(--mn-line);background:var(--mn-layer-2);border-radius:9px;max-width:100%;padding:14px 16px;overflow:auto}.Wtbe8a_markdownBody pre code{background:0 0;padding:0;font-size:11px}.Wtbe8a_markdownBody a{color:var(--mn-accent);text-underline-offset:3px;text-decoration-thickness:1px}.Wtbe8a_markdownBody hr{border:0;border-top:1px solid var(--mn-line);margin:1.8em 0}.Wtbe8a_markdownBody table{border-collapse:collapse;max-width:100%;display:block;overflow-x:auto}.Wtbe8a_markdownBody th,.Wtbe8a_markdownBody td{border:1px solid var(--mn-line);text-align:left;vertical-align:top;padding:8px 10px}.Wtbe8a_markdownBody th{background:var(--mn-layer-2);font-weight:600}.Wtbe8a_markdownBody img{border-radius:8px;max-width:100%;height:auto}.Wtbe8a_documentArchiveReceipt{border:1px solid color-mix(in srgb, var(--mn-success) 28%, var(--mn-line));background:color-mix(in srgb, var(--mn-success) 5%, transparent);border-radius:9px;margin:12px 0;padding:11px 12px}.Wtbe8a_documentArchiveReceipt p{color:var(--mn-muted);margin:4px 0 8px;font-size:10px}.Wtbe8a_documentArchiveReceipt div{flex-wrap:wrap;gap:5px;display:flex}.Wtbe8a_documentDanger{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:7px;min-height:57px;margin-top:13px;padding-top:12px;display:flex}.Wtbe8a_documentDanger>div{margin-right:auto}.Wtbe8a_documentDanger strong{font-size:11px;display:block}.Wtbe8a_documentDanger p{color:var(--mn-faint);margin:2px 0 0;font-size:9px}.Wtbe8a_documentDanger>span{color:var(--mn-danger);margin-right:auto;font-size:10px}.Wtbe8a_documentEditor{border:1px solid var(--mn-line);background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 5%, var(--mn-layer-1)), var(--mn-layer-1) 55%);border-radius:11px;margin-bottom:12px;padding:15px}.Wtbe8a_documentReader>.Wtbe8a_documentEditor{background:0 0;border:0;margin:0;padding:0}.Wtbe8a_documentEditor>header{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:12px;display:flex}.Wtbe8a_documentEditor h3{margin:0;font-size:14px}.Wtbe8a_documentEditor header p{color:var(--mn-muted);margin:2px 0 0;font-size:10px}.Wtbe8a_documentEditor header>span,.Wtbe8a_documentEditor header>code{color:var(--mn-accent);font:650 9px var(--mn-code)}.Wtbe8a_documentEditor label{color:var(--mn-faint);gap:4px;margin-top:9px;font-size:9px;display:grid}.Wtbe8a_documentEditor textarea{resize:vertical;line-height:1.65}.Wtbe8a_documentEditorMeta{grid-template-columns:.8fr 1.2fr;gap:9px;display:grid}.Wtbe8a_documentEditorMeta label{margin:0}.Wtbe8a_documentEditor footer{justify-content:flex-end;gap:7px;margin-top:11px;display:flex}.Wtbe8a_writebackLayout{grid-template-columns:minmax(220px,280px) minmax(0,1fr);align-items:start;gap:15px;display:grid}.Wtbe8a_writeGuide,.Wtbe8a_supervisedComposer{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px}.Wtbe8a_writeGuide{padding:17px}.Wtbe8a_writeGuide h3{margin:5px 0 15px;font-size:15px}.Wtbe8a_writeGuide ol{counter-reset:gate;gap:13px;margin:0;padding:0;list-style:none;display:grid}.Wtbe8a_writeGuide li{counter-increment:gate;grid-template-columns:22px minmax(0,1fr);column-gap:7px;display:grid}.Wtbe8a_writeGuide li:before{content:\"0\" counter(gate);color:var(--mn-accent);font:10px var(--mn-code);grid-row:span 2}.Wtbe8a_writeGuide li strong{font-size:12px}.Wtbe8a_writeGuide li span,.Wtbe8a_writeGuide p{color:var(--mn-faint);font-size:10px}.Wtbe8a_writeGuide p{border-top:1px solid var(--mn-line);margin:17px 0 0;padding-top:13px}.Wtbe8a_supervisedComposer{overflow:hidden}.Wtbe8a_supervisedForm{padding:18px}.Wtbe8a_supervisedHeading{justify-content:space-between;align-items:flex-start;gap:16px;margin-bottom:16px;display:flex}.Wtbe8a_supervisedHeading h3{margin:4px 0 0;font-size:17px}.Wtbe8a_sessionReady,.Wtbe8a_sessionMissing{font:650 9px var(--mn-code);border-radius:999px;padding:4px 8px}.Wtbe8a_sessionReady{color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 10%, transparent)}.Wtbe8a_sessionMissing{color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 10%, transparent)}.Wtbe8a_supervisedForm textarea{resize:vertical;border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:9px;outline:0;padding:12px;line-height:1.65}.Wtbe8a_sessionHint{color:var(--mn-danger);margin:9px 0 0;font-size:11px}.Wtbe8a_formGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-top:13px;display:grid}.Wtbe8a_fieldWide{grid-column:1/-1}.Wtbe8a_formGrid select,.Wtbe8a_formGrid input{width:100%;min-width:0}.Wtbe8a_formActions{align-items:center;gap:12px;margin-top:15px;display:flex}.Wtbe8a_formActions span{color:var(--mn-muted);font-size:11px}.Wtbe8a_advancedWrite{border-top:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 45%, var(--mn-layer-1))}.Wtbe8a_advancedWrite summary{cursor:pointer;justify-content:space-between;align-items:center;gap:16px;min-height:58px;padding:10px 18px;list-style:none;display:flex}.Wtbe8a_advancedWrite summary::-webkit-details-marker{display:none}.Wtbe8a_advancedWrite summary>span:first-child{gap:2px;display:grid}.Wtbe8a_advancedWrite summary strong{font-size:12px}.Wtbe8a_advancedWrite summary small{color:var(--mn-faint);font-size:10px}.Wtbe8a_advancedWrite summary>span:last-child{color:var(--mn-accent);font:10px var(--mn-code)}.Wtbe8a_advancedWrite[open] summary{border-bottom:1px solid var(--mn-line)}.Wtbe8a_advancedWrite[open] summary>span:last-child{font-size:0}.Wtbe8a_advancedWrite[open] summary>span:last-child:after{content:\"−\";font-size:13px}.Wtbe8a_manualForm{padding:3px 18px 18px}.Wtbe8a_manualActions{justify-content:space-between;align-items:center;gap:14px;margin-top:15px;display:flex}.Wtbe8a_manualActions p{max-width:520px;color:var(--mn-faint);margin:0;font-size:10px}.Wtbe8a_listToolbar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;grid-template-columns:minmax(0,1fr) 170px auto;gap:9px;padding:12px;display:grid}.Wtbe8a_listToolbar input,.Wtbe8a_listToolbar select{width:100%;min-width:0}.Wtbe8a_listNotice{color:var(--mn-faint);margin:10px 0 16px;font-size:10px}.Wtbe8a_listNotice span{color:var(--mn-success);font:650 9px var(--mn-code);letter-spacing:.08em;margin-right:7px}.Wtbe8a_memoryList{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:9px;display:grid}.Wtbe8a_memoryList .Wtbe8a_insightCard{height:100%;margin:0}.Wtbe8a_listProgress{border-top:1px solid var(--mn-line);min-height:58px;color:var(--mn-faint);justify-content:center;align-items:center;gap:13px;margin-top:12px;padding:10px;font-size:10px;display:flex}.Wtbe8a_compactListProgress{border-top:1px solid var(--mn-line);color:var(--mn-faint);text-align:center;justify-items:stretch;gap:7px;margin-top:8px;padding:10px 2px 2px;font-size:10px;display:grid}.Wtbe8a_compactListProgress button{width:100%}.Wtbe8a_modalBackdrop{z-index:1300;background:#0206178a;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.Wtbe8a_modal{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:14px;flex-direction:column;width:min(680px,100vw - 48px);max-height:calc(100vh - 96px);display:flex;overflow:hidden;box-shadow:0 22px 60px #02061738}.Wtbe8a_modal>header{border-bottom:1px solid var(--mn-line);flex:none;justify-content:space-between;align-items:flex-start;gap:18px;padding:15px 18px;display:flex}.Wtbe8a_modal>header h2{margin:0;font-size:15px;line-height:22px}.Wtbe8a_modal>header p{max-width:64ch;color:var(--mn-muted);margin:3px 0 0;font-size:12px;line-height:1.5}.Wtbe8a_modal>div:last-child{min-height:0;padding:18px;overflow-y:auto}.Wtbe8a_healthStrip{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;grid-template-columns:repeat(4,minmax(0,1fr));margin-bottom:13px;display:grid;overflow:hidden}.Wtbe8a_healthStrip article{box-sizing:border-box;border-right:1px solid var(--mn-line);align-items:flex-start;gap:10px;min-width:0;min-height:78px;padding:14px 15px;display:flex}.Wtbe8a_healthStrip article>div{min-width:0}.Wtbe8a_healthStrip article:last-child{border-right:0}.Wtbe8a_healthStrip small{color:var(--mn-faint);font:650 10px var(--mn-code);letter-spacing:.06em;margin-bottom:4px;display:block}.Wtbe8a_healthStrip strong{text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;display:block;overflow:hidden}.Wtbe8a_healthStrip p{color:var(--mn-muted);text-overflow:ellipsis;white-space:nowrap;margin:3px 0 0;font-size:10.5px;overflow:hidden}.Wtbe8a_healthIndicator{width:7px;height:7px;box-shadow:0 0 0 4px color-mix(in srgb, currentColor 9%, transparent);border-radius:50%;flex:none;margin-top:3px}.Wtbe8a_healthGood{color:var(--mn-success);background:currentColor}.Wtbe8a_healthBad{color:var(--mn-danger);background:currentColor}.Wtbe8a_healthMuted{color:var(--mn-faint);background:currentColor}.Wtbe8a_storageDomains{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;margin-bottom:13px;padding:16px}.Wtbe8a_storageRoot{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 45%, transparent);border-radius:9px;justify-content:space-between;align-items:center;gap:18px;min-width:0;margin-top:12px;padding:11px 12px;display:flex}.Wtbe8a_storageRoot>div:first-child{gap:4px;min-width:0;display:grid}.Wtbe8a_storageRoot span,.Wtbe8a_storageRoot small{color:var(--mn-faint);font-size:9px}.Wtbe8a_storageRoot code{color:var(--mn-muted);text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}.Wtbe8a_storageRoot>div:last-child{flex:none;justify-items:end;gap:3px;display:grid}.Wtbe8a_storageRoot strong{font:650 11px var(--mn-code)}.Wtbe8a_storageAreaGrid{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:8px;display:grid}.Wtbe8a_storageAreaGrid article{box-sizing:border-box;border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 30%, var(--mn-layer-1));border-radius:9px;flex-direction:column;min-width:0;min-height:150px;padding:12px;display:flex}.Wtbe8a_storageAreaGrid article>header{justify-content:space-between;align-items:center;gap:8px;display:flex}.Wtbe8a_storageAreaGrid article>header>div{align-items:center;gap:7px;min-width:0;display:flex}.Wtbe8a_storageAreaGrid article>header span{background:var(--mn-faint);border-radius:50%;flex:none;width:6px;height:6px}.Wtbe8a_storageAreaGrid article[data-status=ready]>header span{background:var(--mn-success);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 9%, transparent)}.Wtbe8a_storageAreaGrid article[data-status=invalid]>header span{background:var(--mn-danger);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-danger) 9%, transparent)}.Wtbe8a_storageAreaGrid article>header strong{text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}.Wtbe8a_storageAreaGrid article>header em{color:var(--mn-faint);font:normal 8px var(--mn-code);white-space:nowrap}.Wtbe8a_storageAreaMetric{align-items:baseline;gap:5px;margin-top:14px;display:flex}.Wtbe8a_storageAreaMetric strong{font:650 20px var(--mn-code)}.Wtbe8a_storageAreaMetric span{color:var(--mn-faint);font-size:9px}.Wtbe8a_storageAreaMetric code{color:var(--mn-muted);margin-left:auto;font-size:9px}.Wtbe8a_storageAreaGrid article>p{min-height:28px;color:var(--mn-muted);margin:8px 0;font-size:9px;line-height:1.5}.Wtbe8a_storagePath{border-top:1px solid var(--mn-line);color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;margin-top:auto;padding-top:8px;font-size:8px;display:block;overflow:hidden}.Wtbe8a_storageAreaGrid article>small{color:var(--mn-danger);margin-top:6px;font-size:8px;line-height:1.4;display:block}.Wtbe8a_storageUnavailable{border:1px dashed var(--mn-line);min-height:126px;color:var(--mn-muted);text-align:center;border-radius:9px;place-content:center;gap:5px;margin-top:12px;display:grid}.Wtbe8a_storageUnavailable strong{font-size:12px}.Wtbe8a_storageUnavailable p{max-width:520px;color:var(--mn-faint);margin:0;font-size:10px}.Wtbe8a_storageFootnote{color:var(--mn-faint);margin:11px 0 0;font-size:9px;line-height:1.5}.Wtbe8a_statusSectionHeader{justify-content:space-between;align-items:flex-start;gap:12px;display:flex}.Wtbe8a_statusSectionHeader h3{margin:4px 0 0;font-size:15px}.Wtbe8a_statusSectionHeader p{max-width:590px;color:var(--mn-muted);margin:5px 0 0;font-size:10px}.Wtbe8a_phaseBadge{border:1px solid color-mix(in srgb, var(--mn-accent) 25%, var(--mn-line));color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 7%, transparent);font:650 9px var(--mn-code);border-radius:999px;padding:4px 8px}.Wtbe8a_statusHeaderActions{align-items:center;gap:8px;display:flex}.Wtbe8a_versionDialogBody{gap:12px;display:grid}.Wtbe8a_versionChecking{min-height:112px;color:var(--mn-muted);justify-content:center;align-items:center;gap:10px;font-size:12px;display:flex}.Wtbe8a_versionChecking span{border:2px solid var(--mn-line);border-top-color:var(--mn-accent);border-radius:50%;width:14px;height:14px;animation:.8s linear infinite Wtbe8a_mnemon-spin}@keyframes Wtbe8a_mnemon-spin{to{transform:rotate(360deg)}}.Wtbe8a_versionError,.Wtbe8a_versionResult{border:1px solid color-mix(in srgb, var(--mn-danger) 28%, var(--mn-line));color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 6%, transparent);border-radius:9px;padding:11px 12px}.Wtbe8a_versionResult{border-color:color-mix(in srgb, var(--mn-success) 28%, var(--mn-line));color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 6%, transparent)}.Wtbe8a_versionError strong,.Wtbe8a_versionResult strong{font-size:12px}.Wtbe8a_versionError p,.Wtbe8a_versionResult p{color:var(--mn-muted);margin:3px 0 0;font-size:11px;line-height:1.5}.Wtbe8a_versionList{gap:9px;display:grid}.Wtbe8a_versionList article{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 34%, var(--mn-layer-1));border-radius:10px;padding:13px}.Wtbe8a_versionList article[data-outdated]{border-color:color-mix(in srgb, var(--mn-accent) 30%, var(--mn-line))}.Wtbe8a_versionList article>header{justify-content:space-between;align-items:center;gap:12px;display:flex}.Wtbe8a_versionList article>header>div{align-items:center;gap:8px;min-width:0;display:flex}.Wtbe8a_versionList article>header strong{font-size:13px}.Wtbe8a_versionList article>header span{border:1px solid var(--mn-line);color:var(--mn-muted);font:500 9px var(--mn-code);border-radius:999px;padding:3px 7px}.Wtbe8a_versionList article>header em{color:var(--mn-success);font:normal 10px var(--mn-code);white-space:nowrap}.Wtbe8a_versionList article[data-outdated]>header em{color:var(--mn-accent)}.Wtbe8a_versionNumbers{grid-template-columns:1fr auto 1fr;align-items:end;gap:10px;margin-top:13px;display:grid}.Wtbe8a_versionNumbers>div{gap:3px;display:grid}.Wtbe8a_versionNumbers small{color:var(--mn-faint);font-size:9px}.Wtbe8a_versionNumbers code{font-size:12px}.Wtbe8a_versionNumbers>span{color:var(--mn-faint);padding-bottom:1px}.Wtbe8a_versionList article>footer{border-top:1px solid var(--mn-line);justify-content:space-between;align-items:flex-end;gap:16px;margin-top:10px;padding-top:10px;display:flex}.Wtbe8a_versionList article>footer p{max-width:470px;color:var(--mn-muted);margin:0;font-size:10.5px;line-height:1.5}.Wtbe8a_versionList article>footer button{flex:none}.Wtbe8a_versionDialogActions{justify-content:space-between;align-items:center;gap:12px;padding-top:2px;display:flex}.Wtbe8a_versionDialogActions>span{color:var(--mn-faint);font-size:9px}.Wtbe8a_versionDialogActions>div{gap:8px;display:flex}@media (width<=1000px){.Wtbe8a_graphLayout{display:block;position:relative}.Wtbe8a_graphInspector{width:auto;min-height:0;box-shadow:none;margin-top:10px;position:static;overflow:visible}.Wtbe8a_graphInspector[data-empty]{display:none}.Wtbe8a_resultLayout{grid-template-columns:1fr}.Wtbe8a_relatedPane{grid-row:1;max-height:none;position:static}.Wtbe8a_memoryList{grid-template-columns:1fr}.Wtbe8a_storageAreaGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.Wtbe8a_runtimeGrid,.Wtbe8a_runtimeSummaryGrid{grid-template-columns:1fr}.Wtbe8a_documentWorkspace{grid-template-columns:minmax(220px,270px) minmax(0,1fr)}.Wtbe8a_documentDetail>dl{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (width<=760px){.Wtbe8a_shell{min-height:0;overflow:hidden}.Wtbe8a_masthead{grid-template-columns:minmax(0,1fr) auto;gap:8px 12px;min-height:76px;padding:10px 14px}.Wtbe8a_brandLogo{width:36px;height:36px}.Wtbe8a_headerActions{max-width:52vw}.Wtbe8a_workspacePicker>span{display:none}.Wtbe8a_workspacePicker select{width:min(170px,32vw)}.Wtbe8a_statusCluster>span:not(.Wtbe8a_statusDot){display:none}.Wtbe8a_modalBackdrop{padding:12px}.Wtbe8a_modal{width:calc(100vw - 24px);max-height:calc(100vh - 24px)}.Wtbe8a_versionList article>footer,.Wtbe8a_versionDialogActions{flex-direction:column;align-items:stretch}.Wtbe8a_versionDialogActions>div{justify-content:flex-end}.Wtbe8a_telemetry{border-top:1px solid var(--mn-line);grid-column:1/-1;justify-content:space-between;padding-top:8px}.Wtbe8a_telemetryMetric{text-align:center;flex:1;justify-items:center;gap:3px;min-width:0;padding:0 5px}.Wtbe8a_telemetryMetric:first-child{border-left:0}.Wtbe8a_topNavigation{padding:0 10px;position:relative}.Wtbe8a_topNavigation:after{z-index:2;pointer-events:none;content:\"›\";width:34px;color:var(--mn-faint);background:linear-gradient(90deg, transparent, var(--mn-layer-1) 72%);font:16px var(--mn-code);place-items:center end;padding-right:5px;display:grid;position:absolute;top:0;bottom:0;right:0}.Wtbe8a_nav{flex:1;padding-right:26px;scroll-padding-inline:10px 34px}.Wtbe8a_navGroup{gap:3px}.Wtbe8a_navGroupDivider{height:18px}.Wtbe8a_nav button{text-align:center;flex-direction:column;justify-content:center;gap:3px;min-width:60px;padding:4px 3px}.Wtbe8a_spaceSummary{display:none}.Wtbe8a_navGlyph{line-height:1}.Wtbe8a_page{padding:18px 13px calc(170px + env(safe-area-inset-bottom,0px))}.Wtbe8a_pageHeader{gap:10px;display:grid}.Wtbe8a_pageHeaderMeta{justify-content:space-between}.Wtbe8a_entityLayout,.Wtbe8a_writebackLayout{grid-template-columns:1fr}.Wtbe8a_runtimeComposerHeading,.Wtbe8a_runtimeComposerActions{flex-direction:column;align-items:stretch}.Wtbe8a_runtimeComposerActions select,.Wtbe8a_runtimeComposerActions button{width:100%}.Wtbe8a_runtimeBrowserToolbar{flex-direction:column;align-items:stretch}.Wtbe8a_runtimeFilterQuery{width:100%;min-width:0}.Wtbe8a_documentSummary{grid-template-columns:repeat(2,minmax(0,1fr))}.Wtbe8a_documentCapacity{grid-column:1/-1}.Wtbe8a_documentToolbar{flex-direction:column;align-items:stretch}.Wtbe8a_documentToolbar form{min-width:0}.Wtbe8a_documentToolbar>div,.Wtbe8a_documentToolbar>button{width:100%}.Wtbe8a_documentToolbar>div button{flex:1}.Wtbe8a_documentWorkspace{grid-template-columns:1fr;min-height:0}.Wtbe8a_documentList{-webkit-overflow-scrolling:touch;max-height:330px;overflow:auto}.Wtbe8a_documentReader{min-height:430px}.Wtbe8a_documentEditorMeta{grid-template-columns:1fr}.Wtbe8a_manualActions{flex-direction:column;align-items:stretch}.Wtbe8a_entityRail{position:static}.Wtbe8a_searchControls{grid-template-columns:repeat(2,minmax(0,1fr));display:grid}.Wtbe8a_searchActions{grid-column:1/-1}.Wtbe8a_searchActions>button{flex:1}.Wtbe8a_searchControls select{width:100%;min-width:0}.Wtbe8a_listToolbar{grid-template-columns:1fr}.Wtbe8a_bodyDirectoryHeader{display:grid}.Wtbe8a_bodyCreate form{grid-template-columns:1fr}.Wtbe8a_graphViewport{min-height:360px}.Wtbe8a_graphSvg{height:390px}.Wtbe8a_graphCanvasControls{top:7px;right:7px}.Wtbe8a_graphCanvasControls span{display:none}.Wtbe8a_previewOverlay{padding:10px;padding-bottom:calc(10px + env(safe-area-inset-bottom,0px))}.Wtbe8a_previewDialog{max-height:min(84dvh,640px)}.Wtbe8a_healthStrip{grid-template-columns:1fr}.Wtbe8a_storageRoot{flex-direction:column;align-items:flex-start}.Wtbe8a_storageRoot>div:last-child{justify-items:start}.Wtbe8a_storageAreaGrid{grid-template-columns:1fr}.Wtbe8a_flowLegend span:last-child{width:100%;margin-left:0}.Wtbe8a_healthStrip article{border-right:0;border-bottom:1px solid var(--mn-line)}.Wtbe8a_healthStrip article:last-child{border-bottom:0}.Wtbe8a_workspaceMismatch{flex-direction:column;align-items:stretch;margin-inline:13px}.Wtbe8a_workspaceMismatch>button{align-self:flex-start}}@media (width<=520px){.Wtbe8a_masthead{min-height:68px}.Wtbe8a_brand h1{font-size:16px}.Wtbe8a_headerActions{max-width:58vw}.Wtbe8a_workspacePicker select{width:min(150px,39vw)}.Wtbe8a_telemetryMetric span{font-size:10px}.Wtbe8a_nav{scroll-snap-type:x proximity}.Wtbe8a_nav button{scroll-snap-align:start;min-width:68px}.Wtbe8a_pageHeader h2{font-size:19px}.Wtbe8a_pageHeaderMeta{flex-wrap:wrap;align-items:stretch}.Wtbe8a_pageHeaderMeta>code{align-items:center;min-height:34px;display:flex}.Wtbe8a_pageHeaderMeta>button{flex:1}.Wtbe8a_emptyState{text-align:center;flex-direction:column;gap:14px;min-height:190px;padding:24px 18px}.Wtbe8a_emptyGlyph{width:62px;height:62px}.Wtbe8a_documentDetail>header,.Wtbe8a_documentDanger,.Wtbe8a_supervisedHeading,.Wtbe8a_cardTop{flex-direction:column;align-items:flex-start}.Wtbe8a_documentDetail>header>div:last-child,.Wtbe8a_documentDetail>header button{width:100%}.Wtbe8a_documentDanger>div,.Wtbe8a_documentDanger>span{margin-right:0}.Wtbe8a_documentDanger>button{width:100%}.Wtbe8a_documentDetail>dl{grid-template-columns:1fr}.Wtbe8a_markdownBody{padding:16px;font-size:12.5px}.Wtbe8a_cardActions,.Wtbe8a_confirmBar{flex-wrap:wrap;align-items:stretch}.Wtbe8a_cardActions button{flex:1}.Wtbe8a_confirmBar>span{width:100%;margin:0 0 4px}.Wtbe8a_formActions{flex-direction:column;align-items:stretch}.Wtbe8a_formActions button{width:100%}.Wtbe8a_formGrid,.Wtbe8a_searchControls{grid-template-columns:1fr}}@media (width<=1000px) and (height<=760px){.Wtbe8a_shell{min-height:0}.Wtbe8a_masthead{min-height:58px}.Wtbe8a_telemetryMetric{min-width:0;padding:1px 9px}.Wtbe8a_topNavigation{min-height:44px}.Wtbe8a_nav button{min-height:42px}.Wtbe8a_graphViewport{min-height:300px}.Wtbe8a_graphSvg{height:300px}}@media (width<=760px) and (pointer:coarse){.Wtbe8a_shell input,.Wtbe8a_shell select,.Wtbe8a_shell textarea{font-size:16px!important}}@media (prefers-reduced-motion:reduce){.Wtbe8a_shell *,.Wtbe8a_shell :before,.Wtbe8a_shell :after{scroll-behavior:auto!important;transition-duration:.01ms!important;animation-duration:.01ms!important;animation-iteration-count:1!important}.Wtbe8a_insightCard:hover{transform:none}.Wtbe8a_flowConnector[data-active] i:before{display:none}}";
		...
		var MnemonView_module_css_default = {
			"nodeCore": "Wtbe8a_nodeCore",
			"runtimeNotice": "Wtbe8a_runtimeNotice",
			"capacityLine": "Wtbe8a_capacityLine",
			"nodeBodyLabel": "Wtbe8a_nodeBodyLabel",
			"secondaryButton": "Wtbe8a_secondaryButton",
			"advancedWrite": "Wtbe8a_advancedWrite",
			"healthStrip": "Wtbe8a_healthStrip",
			"canvas": "Wtbe8a_canvas",
			"bodyEdit": "Wtbe8a_bodyEdit",
			"listToolbar": "Wtbe8a_listToolbar",
			"masthead": "Wtbe8a_masthead",
			"workspace": "Wtbe8a_workspace",
			"modal": "Wtbe8a_modal",
			"statusHeaderActions": "Wtbe8a_statusHeaderActions",
			"bodySwitch": "Wtbe8a_bodySwitch",
			"documentEditor": "Wtbe8a_documentEditor",
			"cardActions": "Wtbe8a_cardActions",
			"compactListProgress": "Wtbe8a_compactListProgress",
			"bodyDirectoryPath": "Wtbe8a_bodyDirectoryPath",
			"versionNumbers": "Wtbe8a_versionNumbers",
			"graphLegend": "Wtbe8a_graphLegend",
			"agentCitations": "Wtbe8a_agentCitations",
			"documentToolbar": "Wtbe8a_documentToolbar",
			"previewDialog": "Wtbe8a_previewDialog",
			"entityRail": "Wtbe8a_entityRail",
			"bodyHealth": "Wtbe8a_bodyHealth",
			"bodyCreate": "Wtbe8a_bodyCreate",
			"documentSources": "Wtbe8a_documentSources",
			"listNotice": "Wtbe8a_listNotice",
			"inspectorTitle": "Wtbe8a_inspectorTitle",
			"memoryList": "Wtbe8a_memoryList",
			"listProgress": "Wtbe8a_listProgress",
			"runtimeComposer": "Wtbe8a_runtimeComposer",
			"storageDomains": "Wtbe8a_storageDomains",
			"headerActions": "Wtbe8a_headerActions",
			"graphViewport": "Wtbe8a_graphViewport",
			"manualActions": "Wtbe8a_manualActions",
			"searchControls": "Wtbe8a_searchControls",
			"nav": "Wtbe8a_nav",
			"writeGuide": "Wtbe8a_writeGuide",
			"versionDialogBody": "Wtbe8a_versionDialogBody",
			"iconButton": "Wtbe8a_iconButton",
			"cardKicker": "Wtbe8a_cardKicker",
			"badges": "Wtbe8a_badges",
			"relatedPane": "Wtbe8a_relatedPane",
			"navGroup": "Wtbe8a_navGroup",
			"documentArchiveReceipt": "Wtbe8a_documentArchiveReceipt",
			"healthIndicator": "Wtbe8a_healthIndicator",
			"storagePath": "Wtbe8a_storagePath",
			"statusSectionHeader": "Wtbe8a_statusSectionHeader",
			"documentList": "Wtbe8a_documentList",
			"markdownBody": "Wtbe8a_markdownBody",
			"cardTop": "Wtbe8a_cardTop",
			"bodyGrid": "Wtbe8a_bodyGrid",
			"bodyDirectoryHeader": "Wtbe8a_bodyDirectoryHeader",
			"inspectorEye": "Wtbe8a_inspectorEye",
			"page": "Wtbe8a_page",
			"telemetryMetric": "Wtbe8a_telemetryMetric",
			"emptyGlyph": "Wtbe8a_emptyGlyph",
			"graphInspector": "Wtbe8a_graphInspector",
			"insightCard": "Wtbe8a_insightCard",
			"healthBad": "Wtbe8a_healthBad",
			"alert": "Wtbe8a_alert",
			"inspectorMeta": "Wtbe8a_inspectorMeta",
			"tags": "Wtbe8a_tags",
			"confirmBar": "Wtbe8a_confirmBar",
			"statusDot": "Wtbe8a_statusDot",
			"inspectorActions": "Wtbe8a_inspectorActions",
			"runtimeComposerActions": "Wtbe8a_runtimeComposerActions",
			"relatedSource": "Wtbe8a_relatedSource",
			"bodyDeleteConfirm": "Wtbe8a_bodyDeleteConfirm",
			"runtimeTargetHeader": "Wtbe8a_runtimeTargetHeader",
			"graphPanel": "Wtbe8a_graphPanel",
			"writebackLayout": "Wtbe8a_writebackLayout",
			"versionList": "Wtbe8a_versionList",
			"navGroupDivider": "Wtbe8a_navGroupDivider",
			"bodyDirectoryEmpty": "Wtbe8a_bodyDirectoryEmpty",
			"documentWorkspace": "Wtbe8a_documentWorkspace",
			"inlineError": "Wtbe8a_inlineError",
			"runtimeScopeFilter": "Wtbe8a_runtimeScopeFilter",
			"runtimeEntryTarget": "Wtbe8a_runtimeEntryTarget",
			"graphNode": "Wtbe8a_graphNode",
			"documentDetail": "Wtbe8a_documentDetail",
			"runtimeFilterQuery": "Wtbe8a_runtimeFilterQuery",
			"statusCluster": "Wtbe8a_statusCluster",
			"healthMuted": "Wtbe8a_healthMuted",
			"ghostButton": "Wtbe8a_ghostButton",
			"previewMeta": "Wtbe8a_previewMeta",
			"flowConnector": "Wtbe8a_flowConnector",
			"singleColumn": "Wtbe8a_singleColumn",
			"entities": "Wtbe8a_entities",
			"id": "Wtbe8a_id",
			"formActions": "Wtbe8a_formActions",
			"runtimeSummaryCard": "Wtbe8a_runtimeSummaryCard",
			"bodyDeleteSummary": "Wtbe8a_bodyDeleteSummary",
			"runtimeEntry": "Wtbe8a_runtimeEntry",
			"workspacePicker": "Wtbe8a_workspacePicker",
			"shell": "Wtbe8a_shell",
			"versionError": "Wtbe8a_versionError",
			"bodyDeleteContent": "Wtbe8a_bodyDeleteContent",
			"healthGood": "Wtbe8a_healthGood",
			"bodyEditActions": "Wtbe8a_bodyEditActions",
			"loading": "Wtbe8a_loading",
			"nodeLabel": "Wtbe8a_nodeLabel",
			"results": "Wtbe8a_results",
			"documentListEmpty": "Wtbe8a_documentListEmpty",
			"runtimeBrowser": "Wtbe8a_runtimeBrowser",
			"entityHeading": "Wtbe8a_entityHeading",
			"previewHeading": "Wtbe8a_previewHeading",
			"runtimeFootnote": "Wtbe8a_runtimeFootnote",
			"workspaceMismatch": "Wtbe8a_workspaceMismatch",
			"graphSvg": "Wtbe8a_graphSvg",
			"content": "Wtbe8a_content",
			"flowLegend": "Wtbe8a_flowLegend",
			"runtimeEmpty": "Wtbe8a_runtimeEmpty",
			"supervisedComposer": "Wtbe8a_supervisedComposer",
			"muted": "Wtbe8a_muted",
			"resultLayout": "Wtbe8a_resultLayout",
			"entityResults": "Wtbe8a_entityResults",
			"liveDot": "Wtbe8a_liveDot",
			"primaryButton": "Wtbe8a_primaryButton",
			"supervisedForm": "Wtbe8a_supervisedForm",
			"runtimeComposerHeading": "Wtbe8a_runtimeComposerHeading",
			"dangerButton": "Wtbe8a_dangerButton",
			"runtimeTargetDescription": "Wtbe8a_runtimeTargetDescription",
			"bodySignal": "Wtbe8a_bodySignal",
			"nodeHalo": "Wtbe8a_nodeHalo",
			"categoryChip": "Wtbe8a_categoryChip",
			"graphFooter": "Wtbe8a_graphFooter",
			"badge": "Wtbe8a_badge",
			"runtimeEntryMeta": "Wtbe8a_runtimeEntryMeta",
			"runtimeEntryBadges": "Wtbe8a_runtimeEntryBadges",
			"emptyState": "Wtbe8a_emptyState",
			"manualForm": "Wtbe8a_manualForm",
			"graphBackdrop": "Wtbe8a_graphBackdrop",
			"brandLogo": "Wtbe8a_brandLogo",
			"inspectorLogo": "Wtbe8a_inspectorLogo",
			"documentCapacity": "Wtbe8a_documentCapacity",
			"telemetry": "Wtbe8a_telemetry",
			"mnemon-spin": "Wtbe8a_mnemon-spin",
			"versionDialogActions": "Wtbe8a_versionDialogActions",
			"inspectorTitleRow": "Wtbe8a_inspectorTitleRow",
			"sessionReady": "Wtbe8a_sessionReady",
			"versionResult": "Wtbe8a_versionResult",
			"runtimeGrid": "Wtbe8a_runtimeGrid",
			"storageAreaMetric": "Wtbe8a_storageAreaMetric",
			"entityList": "Wtbe8a_entityList",
			"phaseBadge": "Wtbe8a_phaseBadge",
			"supervisedHeading": "Wtbe8a_supervisedHeading",
			"queryField": "Wtbe8a_queryField",
			"graphToolbar": "Wtbe8a_graphToolbar",
			"searchActions": "Wtbe8a_searchActions",
			"sessionMissing": "Wtbe8a_sessionMissing",
			"entityLayout": "Wtbe8a_entityLayout",
			"bodyEditButton": "Wtbe8a_bodyEditButton",
			"graphCanvasControls": "Wtbe8a_graphCanvasControls",
			"runtimeEntries": "Wtbe8a_runtimeEntries",
			"storageRoot": "Wtbe8a_storageRoot",
			"sectionHeading": "Wtbe8a_sectionHeading",
			"agentAnswerHeading": "Wtbe8a_agentAnswerHeading",
			"documentReader": "Wtbe8a_documentReader",
			"offline": "Wtbe8a_offline",
			"documentDanger": "Wtbe8a_documentDanger",
			"navGlyph": "Wtbe8a_navGlyph",
			"checking": "Wtbe8a_checking",
			"runtimeSummaryGrid": "Wtbe8a_runtimeSummaryGrid",
			"inspectorHeading": "Wtbe8a_inspectorHeading",
			"storageAreaGrid": "Wtbe8a_storageAreaGrid",
			"fieldWide": "Wtbe8a_fieldWide",
			"versionChecking": "Wtbe8a_versionChecking",
			"bodySwitchTrack": "Wtbe8a_bodySwitchTrack",
			"runtimeTarget": "Wtbe8a_runtimeTarget",
			"graphGridLine": "Wtbe8a_graphGridLine",
			"agentAnswer": "Wtbe8a_agentAnswer",
			"entitySearch": "Wtbe8a_entitySearch",
			"bodyDirectory": "Wtbe8a_bodyDirectory",
			"storageMode": "Wtbe8a_storageMode",
			"graphEdge": "Wtbe8a_graphEdge",
			"previewBody": "Wtbe8a_previewBody",
			"graphLayout": "Wtbe8a_graphLayout",
			"spaceSummary": "Wtbe8a_spaceSummary",
			"runtimeReadOnly": "Wtbe8a_runtimeReadOnly",
			"searchBar": "Wtbe8a_searchBar",
			"pageHeader": "Wtbe8a_pageHeader",
			"runtimeBrowserToolbar": "Wtbe8a_runtimeBrowserToolbar",
			"online": "Wtbe8a_online",
			"modalBackdrop": "Wtbe8a_modalBackdrop",
			"storageFootnote": "Wtbe8a_storageFootnote",
			"bodyCardActions": "Wtbe8a_bodyCardActions",
			"loadingPanel": "Wtbe8a_loadingPanel",
			"bodyCard": "Wtbe8a_bodyCard",
			"documentSummary": "Wtbe8a_documentSummary",
			"storageUnavailable": "Wtbe8a_storageUnavailable",
			"topNavigation": "Wtbe8a_topNavigation",
			"pageHeaderMeta": "Wtbe8a_pageHeaderMeta",
			"brand": "Wtbe8a_brand",
			"documentEditorMeta": "Wtbe8a_documentEditorMeta",
			"previewOverlay": "Wtbe8a_previewOverlay",
			"bodyCardTop": "Wtbe8a_bodyCardTop",
			"dangerSolidButton": "Wtbe8a_dangerSolidButton",
			"sessionHint": "Wtbe8a_sessionHint",
			"formGrid": "Wtbe8a_formGrid",
			"runtimeUnifiedList": "Wtbe8a_runtimeUnifiedList",
			"inspectorEmpty": "Wtbe8a_inspectorEmpty"
		};
		//#endregion
		...
		function SidebarModal(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					ref: dialogRef,
					className: appearanceClass(MnemonView_module_css_default.modal, appearance.classes.modal),
					role: "dialog",
					"aria-modal": "true",
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PageHeader, {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
						...
						children: [
							...
							}, insightKey(insight))), appearance.surface === "sidebar" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProgressiveFooter, {
		...
		function ListPage(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					view !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ProgressiveFooter, {
					...
					children: [
						...
						snapshot !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: snapshot.components.map((component) => {
								const canUpdate = component.outdated && component.updateSupported && component.checkError === void 0;
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `${MnemonView_module_css_default.healthIndicator} ${status === null ? MnemonView_module_css_default.healthMuted : status.healthy ? MnemonView_module_css_default.healthGood : MnemonView_module_css_default.healthBad}` }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: status === null ? t("status.engineChecking") : status.healthy ? status.version === void 0 ? t("status.engineConnected") : `Mnemon ${status.version}` : t("status.engineUnavailable") }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: status?.dshMnemonVersion === void 0 ? t("status.versionWaiting") : `dsh-mnemon ${status.dshMnemonVersion}` })
							] })] }),
		...
		function MnemonWorkspace({ connection, settingsScope, sessionId, workspaceId, workspaceSelection }) {
			...
			const connectionLabel = statusLoading ? t("header.checking") : status?.healthy !== true ? t("header.unavailable") : appearance.surface === "sidebar" ? t("header.connected") : catalogKnown ? t("header.connectedWithCount", { count: activeBodies }) : t("header.directoryPending");
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-footer.cwwhwj/src/client/MnemonTurnTail.module.css.mjs
		const css$2 = ".H1txYW_root{min-width:0;margin:2px 0}.H1txYW_bar{cursor:pointer;min-width:0;max-width:100%;height:22px;color:var(--dsw-alias-label-tertiary);background:0 0;border:1px solid #0000;border-radius:6px;align-items:center;gap:6px;padding:0 8px 0 6px;font-size:11px;line-height:22px;display:flex}.H1txYW_bar:hover{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.H1txYW_bar:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.H1txYW_mark{opacity:.8;flex:none;font-size:10px}.H1txYW_label{flex:none;font-weight:600}.H1txYW_metrics{align-items:center;gap:6px;min-width:0;display:inline-flex;overflow:hidden}.H1txYW_metrics span{white-space:nowrap}.H1txYW_failureMetric{color:var(--dsw-alias-state-error-primary,#d44)}.H1txYW_chevron{opacity:.7;flex:none;width:8px;height:8px;margin-left:auto}.H1txYW_chevron:before{content:\"\";border-bottom:1.5px solid;border-right:1.5px solid;width:5px;height:5px;transition:transform .12s;display:block;transform:rotate(45deg)translate(-1px,-1px)}.H1txYW_chevronOpen:before{transform:rotate(-135deg)translate(0)}.H1txYW_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);border-radius:0 8px 8px 0;align-items:center;gap:10px;min-width:0;margin:2px 0 4px;padding:6px 8px;display:flex}.H1txYW_detailLabel{color:var(--dsw-alias-label-caption);letter-spacing:.08em;text-transform:uppercase;flex:none;font-size:10px;font-weight:650}.H1txYW_tools{flex-wrap:wrap;flex:auto;gap:4px;min-width:0;display:flex}.H1txYW_toolChip{cursor:pointer;background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,Consolas, monospace);white-space:nowrap;border:none;border-radius:4px;padding:0 6px;font-size:10px;line-height:18px}.H1txYW_toolChip:hover{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-state-business-primary)}.H1txYW_toolChip:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:1px}";
		...
		var MnemonTurnTail_module_css_default = {
			"root": "H1txYW_root",
			"toolChip": "H1txYW_toolChip",
			"failureMetric": "H1txYW_failureMetric",
			"label": "H1txYW_label",
			"detailLabel": "H1txYW_detailLabel",
			"metrics": "H1txYW_metrics",
			"mark": "H1txYW_mark",
			"chevronOpen": "H1txYW_chevronOpen",
			"chevron": "H1txYW_chevron",
			"tools": "H1txYW_tools",
			"bar": "H1txYW_bar",
			"details": "H1txYW_details"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-footer.cwwhwj/src/client/MnemonSaveAction.module.css.mjs
		const css$1 = "._4LEdkG_wrap{display:inline-flex;position:relative}._4LEdkG_button{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}._4LEdkG_button:hover,._4LEdkG_button[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}._4LEdkG_button:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._4LEdkG_icon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:16px;height:16px}._4LEdkG_panel{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);width:min(340px,100vw - 32px);color:var(--dsw-alias-label-primary);border-radius:10px;padding:10px 12px;font-size:12px;line-height:18px;position:absolute;top:calc(100% + 4px);right:0;box-shadow:0 8px 24px #0000002e}._4LEdkG_panel:popover-open{top:var(--mn-save-panel-top);right:auto;left:var(--mn-save-panel-left);width:var(--mn-save-panel-width);margin:0;position:fixed}._4LEdkG_panelHeader{justify-content:space-between;align-items:center;gap:8px;display:flex}._4LEdkG_panelHeader strong{font-size:12px;font-weight:600}._4LEdkG_close{cursor:pointer;width:20px;height:20px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:5px;font-size:14px;line-height:18px}._4LEdkG_close:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._4LEdkG_hint{color:var(--dsw-alias-label-secondary);margin:6px 0 0;font-size:11px;line-height:16px}._4LEdkG_status{color:var(--dsw-alias-label-tertiary);margin-top:8px;font-size:11px}._4LEdkG_readOnly{background:var(--dsw-alias-state-warn-bg,transparent);color:var(--dsw-alias-state-warn-primary);border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}._4LEdkG_candidate{margin-top:8px;display:block}._4LEdkG_candidate>span{color:var(--dsw-alias-label-caption);letter-spacing:.08em;text-transform:uppercase;margin-bottom:4px;font-size:10px;font-weight:650;display:block}._4LEdkG_candidate textarea{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);resize:vertical;background:var(--dsw-specific-input-major,var(--dsw-alias-bg-base));width:100%;max-height:160px;color:var(--dsw-alias-label-primary);font:12px/18px var(--ds-font-family-code,Consolas, monospace);border-radius:8px;padding:8px 10px;display:block}._4LEdkG_candidate textarea:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._4LEdkG_truncated{color:var(--dsw-alias-label-tertiary);margin-top:4px;font-size:10px;line-height:14px;display:block}._4LEdkG_outcome{background:var(--dsw-alias-state-success-bg,transparent);color:var(--dsw-alias-state-success-primary);border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}._4LEdkG_failure{background:var(--dsw-alias-state-error-bg,transparent);color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}._4LEdkG_submit{cursor:pointer;background:var(--dsw-alias-button-primary-fill,var(--dsw-alias-state-business-primary));width:100%;height:28px;color:var(--dsw-alias-button-primary-text,#fff);border:none;border-radius:7px;margin-top:10px;font-size:12px;font-weight:600;line-height:28px}._4LEdkG_submit:hover:not(:disabled){filter:brightness(1.06)}._4LEdkG_submit:disabled{cursor:default;opacity:.5}._4LEdkG_submit:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}";
		...
		var MnemonSaveAction_module_css_default = {
			"close": "_4LEdkG_close",
			"truncated": "_4LEdkG_truncated",
			"status": "_4LEdkG_status",
			"failure": "_4LEdkG_failure",
			"panelHeader": "_4LEdkG_panelHeader",
			"wrap": "_4LEdkG_wrap",
			"outcome": "_4LEdkG_outcome",
			"submit": "_4LEdkG_submit",
			"icon": "_4LEdkG_icon",
			"button": "_4LEdkG_button",
			"panel": "_4LEdkG_panel",
			"hint": "_4LEdkG_hint",
			"readOnly": "_4LEdkG_readOnly",
			"candidate": "_4LEdkG_candidate"
		};
		//#endregion
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
						...
						fill: "none",
						"aria-hidden": "true",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M3.25 3.75A1.75 1.75 0 0 1 5 2h6a1.75 1.75 0 0 1 1.75 1.75v8.5A1.75 1.75 0 0 1 11 14H5a1.75 1.75 0 0 1-1.75-1.75v-8.5Z" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M6 2v3.25h4V2M5.75 10.25h4.5M8 8v4.5" })]
					})
				}), open && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					ref: panelRef,
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-footer.cwwhwj/src/client/MnemonWorkspace.module.css.mjs
		var import_client = (/* @__PURE__ */ __commonJSMin(((exports) => {
			var m = require("react-dom");
			exports.createRoot = m.createRoot;
			exports.hydrateRoot = m.hydrateRoot;
		})))();
		const css = "[data-pane=conversation]{position:relative}[data-dsh-mnemon-view]{z-index:60;background:var(--dsw-alias-bg-base);min-width:0;min-height:0;display:none;position:absolute;inset:0;overflow:hidden}.WfukyW_panelView{isolation:isolate}html[data-dsh-mnemon-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [data-dsh-mnemon-view]{display:block}html[data-dsh-mnemon-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [data-pane=conversation]>:not([data-dsh-mnemon-view]),html[data-dsh-mnemon-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [class*=centerCol]>:not([data-dsh-mnemon-view]){display:none!important}.WfukyW_entry{width:100%;height:32px;color:var(--dsw-alias-label-secondary);white-space:nowrap;cursor:pointer;background:0 0;border:none;border-radius:8px;align-items:center;gap:8px;padding:0 12px;font-size:13px;display:flex}.WfukyW_entry:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-specific-sidebar-nav-item-hover)}.WfukyW_entry[data-active]{color:var(--dsw-alias-label-primary);background:var(--dsw-specific-sidebar-nav-item-active);font-weight:600}.WfukyW_entryIcon{flex:none;justify-content:center;align-items:center;display:inline-flex}.WfukyW_entryLabel{text-overflow:ellipsis;overflow:hidden}[data-dsh-frame][data-sidebar-collapsed] .WfukyW_entry{justify-content:center;width:100%;padding:0}[data-dsh-frame][data-sidebar-collapsed] .WfukyW_entryLabel{display:none}";
		...
		var MnemonWorkspace_module_css_default = {
			"entryLabel": "WfukyW_entryLabel",
			"panelView": "WfukyW_panelView",
			"entryIcon": "WfukyW_entryIcon",
			"entry": "WfukyW_entry"
		};
		//#endregion
