window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-staged.adwBzq/src/client/MnemonSettingsCard.module.css.mjs
		const css$5 = ".D3rWGa_page{box-sizing:border-box;width:100%;min-width:0;max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:28px;padding-bottom:28px;font-family:inherit;display:flex}.D3rWGa_page *,.D3rWGa_page :before,.D3rWGa_page :after{box-sizing:border-box}.D3rWGa_page button,.D3rWGa_page input{color:inherit;font:inherit}.D3rWGa_loading{min-height:140px;color:var(--dsw-alias-label-tertiary);text-align:center;margin:0;font-size:13px;line-height:140px}.D3rWGa_pageHeader h1{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:500;line-height:24px}.D3rWGa_pageHeader p{max-width:64ch;color:var(--dsw-alias-label-tertiary);margin:8px 0 0;font-size:14px;line-height:22px}.D3rWGa_section{flex-direction:column;gap:12px;min-width:0;display:flex}.D3rWGa_sectionHeading{justify-content:space-between;align-items:flex-start;gap:18px;min-width:0;display:flex}.D3rWGa_sectionHeading>div{flex:1;min-width:0}.D3rWGa_sectionHeading h2{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;font-weight:500;line-height:22px}.D3rWGa_sectionHeading p{max-width:66ch;color:var(--dsw-alias-label-tertiary);margin:1px 0 0;font-size:12px;line-height:18px}.D3rWGa_choiceGrid{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;display:grid}.D3rWGa_displayGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.D3rWGa_choiceCard{cursor:pointer;min-width:0;display:block}.D3rWGa_choiceCard>input,.D3rWGa_toggleRow>input,.D3rWGa_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.D3rWGa_choiceFace{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;justify-content:center;gap:1px;min-width:0;min-height:66px;padding:10px 34px 10px 13px;transition:border-color .14s,background-color .14s;display:flex;position:relative}.D3rWGa_choiceFace:hover{background:var(--dsw-alias-interactive-bg-hover)}.D3rWGa_choiceFace strong{text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:21px;overflow:hidden}.D3rWGa_choiceFace small{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:17px;overflow:hidden}.D3rWGa_check{font-size:14px;line-height:18px;display:none;position:absolute;top:11px;right:12px}.D3rWGa_choiceCard>input:checked+.D3rWGa_choiceFace{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-interactive-bg-hover)}.D3rWGa_choiceCard>input:checked+.D3rWGa_choiceFace .D3rWGa_check{display:block}.D3rWGa_choiceCard>input:disabled+.D3rWGa_choiceFace{cursor:default;opacity:.42}.D3rWGa_choiceCard:has(input:disabled){cursor:default}.D3rWGa_settingRow,.D3rWGa_toggleRow{border-top:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:18px;min-width:0;min-height:62px;padding:11px 0;display:flex}.D3rWGa_settingCopy{flex-direction:column;flex:1;min-width:0;display:flex}.D3rWGa_settingCopy strong{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:21px}.D3rWGa_settingCopy small{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.D3rWGa_settingCopy code{font-family:var(--ds-font-family-code,ui-monospace, monospace)}.D3rWGa_directoryControl{flex:0 420px;align-items:center;gap:8px;min-width:0;max-width:60%;display:flex}.D3rWGa_directoryInput{border:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:38px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3);font-family:var(--ds-font-family-code,ui-monospace, monospace);border-radius:10px;outline:none;padding:0 11px;font-size:12px;line-height:20px}.D3rWGa_directoryInput::placeholder{color:var(--dsw-alias-label-caption)}.D3rWGa_directoryInput:disabled{cursor:default;opacity:.46}.D3rWGa_rowGroup{border-bottom:1px solid var(--dsw-alias-border-l2)}.D3rWGa_toggleRow{cursor:pointer}.D3rWGa_toggleRow:first-child{border-top:1px solid var(--dsw-alias-border-l2)}.D3rWGa_toggleRow:has(input:disabled){cursor:default;opacity:.46}.D3rWGa_switch{background:var(--dsw-alias-bg-layer-2);width:40px;height:24px;box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2);border-radius:999px;flex:none;transition:background-color .14s;display:block;position:relative}.D3rWGa_switch i{background:var(--dsw-alias-bg-layer-3);width:18px;height:18px;box-shadow:0 1px 3px color-mix(in srgb, var(--dsw-alias-label-primary) 22%, transparent);border-radius:50%;transition:transform .14s;position:absolute;top:3px;left:3px}.D3rWGa_toggleRow>input:checked+.D3rWGa_switch{background:var(--dsw-alias-label-primary);box-shadow:none}.D3rWGa_toggleRow>input:checked+.D3rWGa_switch i{transform:translate(16px)}.D3rWGa_pillButton,.D3rWGa_primaryPill,.D3rWGa_actions button{appearance:none;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;background:0 0;border-radius:18px;justify-content:center;align-items:center;gap:4px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.D3rWGa_pillButton:hover:not(:disabled),.D3rWGa_actions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-solid)}.D3rWGa_pillButton:disabled,.D3rWGa_primaryPill:disabled,.D3rWGa_actions button:disabled,.D3rWGa_textButton:disabled{cursor:default;opacity:.4}.D3rWGa_primaryPill,.D3rWGa_save{color:var(--dsw-alias-label-primary-foreground)!important;background:var(--dsw-alias-button-primary-fill)!important;border-color:#0000!important}.D3rWGa_primaryPill:hover:not(:disabled),.D3rWGa_save:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)!important}.D3rWGa_textButton{appearance:none;box-sizing:border-box;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;background:0 0;border:0;border-radius:14px;flex:none;justify-content:center;align-items:center;padding:0 10px;font-size:12px;line-height:18px;display:inline-flex}.D3rWGa_textButton:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.D3rWGa_activePath{width:fit-content;max-width:100%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;margin-top:4px;font-size:11px;line-height:17px;overflow:hidden}.D3rWGa_scopeMeta{color:var(--dsw-alias-label-tertiary);margin-top:1px;font-size:10px;font-style:normal;line-height:15px}.D3rWGa_rowActions{flex:none;align-items:center;gap:8px;display:flex}.D3rWGa_importBar{background:var(--dsw-alias-bg-layer-2);border-radius:12px;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:10px;min-width:0;padding:10px 12px;display:grid}.D3rWGa_importBar>div{min-width:0;display:grid}.D3rWGa_importBar strong{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:500;line-height:18px;overflow:hidden}.D3rWGa_importBar small{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.D3rWGa_importBar .D3rWGa_textButton{padding:0 10px}.D3rWGa_feedback,.D3rWGa_packFeedback{gap:4px;display:grid}.D3rWGa_feedback:empty,.D3rWGa_packFeedback:empty{display:none}.D3rWGa_feedback p,.D3rWGa_packFeedback p{overflow-wrap:anywhere;margin:0;font-size:12px;line-height:18px}.D3rWGa_error{color:var(--dsw-alias-state-error-primary)}.D3rWGa_success{color:var(--dsw-alias-state-success-primary)}.D3rWGa_readOnly{color:var(--dsw-alias-label-tertiary)}.D3rWGa_packSuccess{color:var(--dsw-alias-state-success-primary)}.D3rWGa_actions{display:none}.D3rWGa_actionsVisible{border-top:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:16px;padding-top:14px;display:flex}.D3rWGa_actions>span{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.D3rWGa_actions>div{gap:8px;display:flex}.D3rWGa_discard{color:var(--dsw-alias-label-primary);background:0 0;border-color:var(--dsw-alias-border-l2)!important}.D3rWGa_settingsNote{color:var(--dsw-alias-label-tertiary);margin:-14px 0 0;font-size:10px;line-height:16px}.D3rWGa_settingsNote code{color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,ui-monospace, monospace)}.D3rWGa_choiceCard>input:focus-visible+.D3rWGa_choiceFace,.D3rWGa_toggleRow>input:focus-visible+.D3rWGa_switch,.D3rWGa_directoryInput:focus-visible,.D3rWGa_pillButton:focus-visible,.D3rWGa_primaryPill:focus-visible,.D3rWGa_textButton:focus-visible,.D3rWGa_actions button:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3);outline:none}@media (width<=620px){.D3rWGa_page{gap:24px}.D3rWGa_choiceGrid{grid-template-columns:minmax(0,1fr)}.D3rWGa_settingRow{flex-direction:column;align-items:stretch;gap:9px}.D3rWGa_directoryControl{justify-content:space-between;max-width:none}.D3rWGa_rowActions{width:100%}.D3rWGa_rowActions button{flex:1}.D3rWGa_importBar{grid-template-columns:minmax(0,1fr) auto}.D3rWGa_importBar .D3rWGa_primaryPill{grid-column:1/-1}.D3rWGa_actionsVisible{flex-direction:column;align-items:stretch}.D3rWGa_actions>div,.D3rWGa_actions button{flex:1}}@media (prefers-reduced-motion:reduce){.D3rWGa_choiceFace,.D3rWGa_switch,.D3rWGa_switch i{transition:none}}";
		...
		var MnemonSettingsCard_module_css_default = {
			"actionsVisible": "D3rWGa_actionsVisible",
			"activePath": "D3rWGa_activePath",
			"success": "D3rWGa_success",
			"visuallyHidden": "D3rWGa_visuallyHidden",
			"primaryPill": "D3rWGa_primaryPill",
			"toggleRow": "D3rWGa_toggleRow",
			"packFeedback": "D3rWGa_packFeedback",
			"discard": "D3rWGa_discard",
			"sectionHeading": "D3rWGa_sectionHeading",
			"choiceFace": "D3rWGa_choiceFace",
			"actions": "D3rWGa_actions",
			"rowGroup": "D3rWGa_rowGroup",
			"packSuccess": "D3rWGa_packSuccess",
			"feedback": "D3rWGa_feedback",
			"check": "D3rWGa_check",
			"pillButton": "D3rWGa_pillButton",
			"section": "D3rWGa_section",
			"settingCopy": "D3rWGa_settingCopy",
			"directoryInput": "D3rWGa_directoryInput",
			"switch": "D3rWGa_switch",
			"textButton": "D3rWGa_textButton",
			"scopeMeta": "D3rWGa_scopeMeta",
			"settingsNote": "D3rWGa_settingsNote",
			"displayGrid": "D3rWGa_displayGrid",
			"choiceGrid": "D3rWGa_choiceGrid",
			"choiceCard": "D3rWGa_choiceCard",
			"importBar": "D3rWGa_importBar",
			"error": "D3rWGa_error",
			"directoryControl": "D3rWGa_directoryControl",
			"loading": "D3rWGa_loading",
			"settingRow": "D3rWGa_settingRow",
			"save": "D3rWGa_save",
			"page": "D3rWGa_page",
			"readOnly": "D3rWGa_readOnly",
			"rowActions": "D3rWGa_rowActions",
			"pageHeader": "D3rWGa_pageHeader"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-staged.adwBzq/src/client/MnemonSidebarView.module.css.mjs
		const css$4 = ".rmluMa_shell.rmluMa_shell{background:var(--dsw-alias-bg-base);font-family:var(--dsw-font-family)}.rmluMa_shell .rmluMa_masthead{background:var(--dsw-alias-bg-base);border-bottom:0;align-items:center;gap:12px;min-height:50px;padding:10px 16px 6px;display:flex}.rmluMa_shell .rmluMa_brand{flex:auto;gap:8px;overflow:hidden}.rmluMa_shell .rmluMa_brand h1{letter-spacing:0;flex:none;margin:0;font-size:16px;font-weight:700;line-height:24px}.rmluMa_shell [class*=storageMode]{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);gap:5px;min-width:96px;min-height:32px;padding:0 9px}.rmluMa_shell [class*=storageMode]>span{color:var(--dsw-alias-label-tertiary);font-size:11px}.rmluMa_shell [class*=storageMode]>strong{color:var(--dsw-alias-label-primary);font-size:12px}.rmluMa_shell .rmluMa_headerActions{flex:0 auto;gap:6px}.rmluMa_shell .rmluMa_workspacePicker{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex:0 auto;gap:7px;min-height:32px;padding-left:9px}.rmluMa_shell .rmluMa_workspacePicker>span{color:var(--dsw-alias-label-tertiary);font-size:11px;display:block}.rmluMa_shell .rmluMa_workspacePicker select{border:0;border-left:1px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-input-major);border-radius:0 7px 7px 0;width:min(190px,20vw);height:30px;padding:0 28px 0 10px;font-size:13px}.rmluMa_shell .rmluMa_statusCluster{background:0 0;border:0;border-radius:8px;gap:7px;min-height:30px;padding:0 2px 0 8px;font-size:12px}.rmluMa_shell .rmluMa_statusCluster>span:not([class*=statusDot]){min-width:56px}.rmluMa_shell .rmluMa_workspaceMismatch{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 34%, var(--dsw-alias-border-l1));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-layer-1));white-space:nowrap;border-radius:8px;flex:none;justify-content:flex-start;gap:6px;min-height:32px;margin:0;padding:0 3px 0 9px}.rmluMa_shell .rmluMa_workspaceMismatch>span{color:var(--dsw-alias-label-secondary);font-size:11px}.rmluMa_shell .rmluMa_workspaceMismatch>button{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 55%, var(--dsw-alias-border-l2));min-height:26px;color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-base);cursor:pointer;border-radius:6px;padding:0 8px;font-size:11px}.rmluMa_shell .rmluMa_workspaceMismatch>button:hover{background:var(--dsw-alias-interactive-bg-hover)}.rmluMa_shell .rmluMa_topNavigation{background:var(--dsw-alias-bg-base);border-bottom:0;gap:0;min-height:0;padding:0 16px}.rmluMa_shell .rmluMa_topNavigation:after{display:none}.rmluMa_shell .rmluMa_nav{border-bottom:1px solid var(--dsw-alias-border-l1);flex:1;gap:2px;padding-right:0}.rmluMa_shell .rmluMa_nav button{border-bottom:2px solid #0000;border-radius:6px 6px 0 0;gap:0;min-height:0;padding:7px 14px;font-size:13px;font-weight:400}.rmluMa_shell .rmluMa_nav button:hover{background:var(--dsw-alias-interactive-bg-hover)}.rmluMa_shell .rmluMa_nav button[data-active]{color:var(--dsw-alias-label-primary);border-bottom-color:var(--dsw-alias-state-business-primary);font-weight:600}.rmluMa_shell .rmluMa_memoryWorkspace{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);flex:none;padding:12px 16px 0}.rmluMa_shell .rmluMa_memoryWorkspace>[class*=pageHeader]{margin-bottom:8px}.rmluMa_shell .rmluMa_memoryNavigation{flex:none;align-items:flex-end;gap:12px;min-width:0;padding:0;display:flex}.rmluMa_shell .rmluMa_memoryTabs{scrollbar-width:none;flex:1;gap:2px;min-width:0;display:flex;overflow-x:auto}.rmluMa_shell .rmluMa_memoryTabs::-webkit-scrollbar{display:none}.rmluMa_shell .rmluMa_memoryTabs button{min-width:max-content;min-height:0;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-bottom:2px solid #0000;border-radius:6px 6px 0 0;padding:6px 12px;font-size:13px}.rmluMa_shell .rmluMa_memoryTabs button:hover{background:var(--dsw-alias-interactive-bg-hover)}.rmluMa_shell .rmluMa_memoryTabs button[data-active]{border-bottom-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-label-primary);font-weight:600}.rmluMa_shell .rmluMa_memoryWriteButton{flex:none}.rmluMa_shell .rmluMa_modalBackdrop{z-index:1300;overscroll-behavior:contain;background:var(--dsw-alias-bg-mask-1);justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.rmluMa_shell .rmluMa_modal{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);width:min(680px,100vw - 48px);max-height:calc(100vh - 96px);box-shadow:var(--dsw-shadow-lv3);border-radius:14px;flex-direction:column;display:flex;overflow:hidden}.rmluMa_shell .rmluMa_modal>header{border-bottom:1px solid var(--dsw-alias-border-l1);flex:none;justify-content:space-between;align-items:flex-start;gap:18px;padding:15px 18px;display:flex}.rmluMa_shell .rmluMa_modal>header h2{margin:0;font-size:15px;line-height:22px}.rmluMa_shell .rmluMa_modal>header p{max-width:64ch;color:var(--dsw-alias-label-secondary);margin:3px 0 0;font-size:12px;line-height:1.5}.rmluMa_shell .rmluMa_modal>div:last-child{min-height:0;padding:18px;overflow-y:auto}.rmluMa_shell .rmluMa_modal form[class*=runtimeComposer],.rmluMa_shell .rmluMa_modal form[class*=documentEditor]{background:0 0;border:0;border-radius:0;margin:0;padding:0}.rmluMa_shell .rmluMa_modal form[class*=runtimeComposer]>[class*=runtimeComposerHeading],.rmluMa_shell .rmluMa_modal form[class*=documentEditor]>header{display:none}.rmluMa_shell .rmluMa_modal section[class*=supervisedComposer]{overflow:visible}.rmluMa_shell .rmluMa_modal form[class*=supervisedForm]{padding:0}.rmluMa_shell .rmluMa_modal [class*=supervisedHeading]{margin-bottom:10px}.rmluMa_shell .rmluMa_modal [class*=supervisedHeading] h3{display:none}.rmluMa_shell .rmluMa_modal [class*=formActions]{justify-content:flex-end}.rmluMa_shell .rmluMa_modal details[class*=advancedWrite]{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:10px;margin-top:14px;overflow:hidden}.rmluMa_shell [class*=primaryButton]{min-height:32px;color:var(--dsw-alias-label-primary-foreground);background:var(--dsw-alias-button-info-fill);white-space:nowrap;border:0;border-radius:8px;padding:6px 14px;font-size:13px;font-weight:600}.rmluMa_shell [class*=primaryButton]:hover:not(:disabled){filter:none;background:var(--dsw-alias-button-info-hover)}.rmluMa_shell [class*=secondaryButton],.rmluMa_shell [class*=ghostButton]{border:1px solid var(--dsw-alias-border-l2);min-height:32px;color:var(--dsw-alias-label-primary);white-space:nowrap;background:0 0;border-radius:8px;padding:5px 12px;font-size:12px;font-weight:400}.rmluMa_shell [class*=secondaryButton]:hover:not(:disabled),.rmluMa_shell [class*=ghostButton]:hover:not(:disabled){filter:none;background:var(--dsw-alias-interactive-bg-hover)}.rmluMa_shell [class*=dangerButton]{min-height:0;color:var(--dsw-alias-state-error-primary);white-space:nowrap;background:0 0;border:0;border-radius:0;padding:0;font-size:12px;font-weight:400}.rmluMa_shell [class*=dangerButton]:hover:not(:disabled){filter:none;background:0 0;text-decoration:underline}.rmluMa_shell [class*=dangerSolidButton]{color:#fff;background:var(--dsw-alias-state-error-primary);white-space:nowrap;border:0;border-radius:8px;min-height:32px;padding:6px 14px;font-size:13px;font-weight:600}.rmluMa_shell [class*=dangerSolidButton]:hover:not(:disabled){filter:brightness(1.08)}.rmluMa_shell [class*=iconButton],.rmluMa_shell [class*=bodyEditButton],.rmluMa_shell [class*=inspectorEye],.rmluMa_shell [class*=inspectorHeading] button,.rmluMa_shell [class*=sectionHeading] button,.rmluMa_shell [class*=previewHeading] button{width:26px;height:26px;min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;border:0;border-radius:6px;justify-content:center;align-items:center;padding:0;font-size:13px;display:inline-flex}.rmluMa_shell [class*=iconButton]:hover:not(:disabled),.rmluMa_shell [class*=bodyEditButton]:hover:not(:disabled),.rmluMa_shell [class*=inspectorEye]:hover:not(:disabled),.rmluMa_shell [class*=inspectorHeading] button:hover:not(:disabled),.rmluMa_shell [class*=sectionHeading] button:hover:not(:disabled),.rmluMa_shell [class*=previewHeading] button:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover);border:0}.rmluMa_shell [class*=primaryButton],.rmluMa_shell [class*=secondaryButton],.rmluMa_shell [class*=ghostButton],.rmluMa_shell [class*=dangerButton],.rmluMa_shell [class*=dangerSolidButton],.rmluMa_shell [class*=iconButton],.rmluMa_shell [class*=bodyEditButton],.rmluMa_shell [class*=inspectorEye],.rmluMa_shell [class*=inspectorHeading] button,.rmluMa_shell [class*=sectionHeading] button,.rmluMa_shell [class*=previewHeading] button{cursor:pointer;transition:background-color .12s,color .12s,border-color .12s,outline-color .12s,box-shadow .12s,transform .12s}.rmluMa_shell [class*=primaryButton]:active:not(:disabled),.rmluMa_shell [class*=secondaryButton]:active:not(:disabled),.rmluMa_shell [class*=ghostButton]:active:not(:disabled),.rmluMa_shell [class*=dangerButton]:active:not(:disabled),.rmluMa_shell [class*=dangerSolidButton]:active:not(:disabled),.rmluMa_shell [class*=iconButton]:active:not(:disabled),.rmluMa_shell [class*=bodyEditButton]:active:not(:disabled),.rmluMa_shell [class*=inspectorEye]:active:not(:disabled),.rmluMa_shell [class*=inspectorHeading] button:active:not(:disabled),.rmluMa_shell [class*=sectionHeading] button:active:not(:disabled),.rmluMa_shell [class*=previewHeading] button:active:not(:disabled){transform:translateY(1px)}.rmluMa_shell [class*=primaryButton]:disabled,.rmluMa_shell [class*=secondaryButton]:disabled,.rmluMa_shell [class*=ghostButton]:disabled,.rmluMa_shell [class*=dangerButton]:disabled,.rmluMa_shell [class*=dangerSolidButton]:disabled,.rmluMa_shell [class*=iconButton]:disabled,.rmluMa_shell [class*=bodyEditButton]:disabled,.rmluMa_shell [class*=inspectorEye]:disabled{cursor:default;opacity:.45}.rmluMa_shell .rmluMa_canvas{background:var(--dsw-alias-bg-base)}.rmluMa_shell button,.rmluMa_shell input,.rmluMa_shell select,.rmluMa_shell textarea{font-family:var(--dsw-font-family)}.rmluMa_shell button:focus-visible,.rmluMa_shell input:focus-visible,.rmluMa_shell select:focus-visible,.rmluMa_shell textarea:focus-visible,.rmluMa_shell summary:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.rmluMa_shell .rmluMa_canvas>div{width:100%;padding:14px 16px clamp(96px,14vh,150px)}.rmluMa_shell .rmluMa_pageHeader{margin-bottom:12px}.rmluMa_shell .rmluMa_pageHeader h2{letter-spacing:0;margin-top:0;font-size:16px;line-height:1.35}.rmluMa_shell .rmluMa_pageHeader p{font-size:13px;line-height:1.55}.rmluMa_shell .rmluMa_canvas[data-lock-page-header] [class*=pageHeader]{z-index:12;border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);margin:-14px -16px 12px;padding:14px 16px 10px;position:sticky;top:0}.rmluMa_shell input,.rmluMa_shell select,.rmluMa_shell textarea{font-family:var(--dsw-font-family);font-size:13px;font-weight:400}.rmluMa_shell [class*=bodyEdit] label,.rmluMa_shell [class*=runtimeComposerActions] label,.rmluMa_shell [class*=documentEditor] label,.rmluMa_shell [class*=searchControls] label,.rmluMa_shell [class*=formGrid] label,.rmluMa_shell [class*=fieldWide]{color:var(--dsw-alias-label-secondary);gap:5px;font-size:12px;font-weight:500}.rmluMa_shell [class*=bodyEdit] input,.rmluMa_shell [class*=bodyEdit] select,.rmluMa_shell [class*=bodyEdit] textarea,.rmluMa_shell [class*=runtimeComposer]>textarea,.rmluMa_shell [class*=runtimeComposerActions] select,.rmluMa_shell [class*=runtimeEntry] select,.rmluMa_shell [class*=documentEditor] input,.rmluMa_shell [class*=documentEditor] textarea,.rmluMa_shell [class*=searchControls] select,.rmluMa_shell [class*=formGrid] select,.rmluMa_shell [class*=formGrid] input,.rmluMa_shell [class*=listToolbar] input,.rmluMa_shell [class*=listToolbar] select,.rmluMa_shell [class*=entitySearch] input,.rmluMa_shell [class*=bodyCreate] input{border:1px solid var(--dsw-alias-border-l2);min-height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major);border-radius:8px;padding:7px 10px;font-size:13px;font-weight:400}.rmluMa_shell select{cursor:pointer;font-weight:400}.rmluMa_shell textarea{font-weight:400;line-height:1.55}.rmluMa_shell [class*=cardKicker],.rmluMa_shell [class*=sectionHeading]>div>span,.rmluMa_shell [class*=entityHeading]>span,.rmluMa_shell [class*=inspectorHeading]>span{letter-spacing:.06em;font-size:11px}.rmluMa_shell [class*=bodyDirectoryHeader] p,.rmluMa_shell [class*=bodyCard]>p,.rmluMa_shell [class*=graphToolbar],.rmluMa_shell [class*=graphFooter],.rmluMa_shell [class*=runtimeTargetDescription],.rmluMa_shell [class*=documentList]>button p,.rmluMa_shell [class*=documentDetail]>header p,.rmluMa_shell [class*=documentArchiveReceipt] p,.rmluMa_shell [class*=healthStrip] p,.rmluMa_shell [class*=storageAreaGrid] article>p,.rmluMa_shell [class*=statusSectionHeader] p,.rmluMa_shell [class*=writeGuide] li span,.rmluMa_shell [class*=writeGuide]>p,.rmluMa_shell [class*=manualActions] p{font-size:12px}.rmluMa_shell [class*=bodyDirectoryPath],.rmluMa_shell [class*=bodyCard] footer,.rmluMa_shell [class*=bodyHealth],.rmluMa_shell [class*=badge],.rmluMa_shell [class*=entities] span,.rmluMa_shell [class*=runtimeEntryMeta]>span,.rmluMa_shell [class*=runtimeEntryBadges]>span,.rmluMa_shell [class*=runtimeEntryMeta] time,.rmluMa_shell [class*=runtimeFootnote],.rmluMa_shell [class*=documentSummary] article>span,.rmluMa_shell [class*=documentSummary] article>small,.rmluMa_shell [class*=documentList]>header,.rmluMa_shell [class*=documentList]>button time,.rmluMa_shell [class*=documentList]>button footer,.rmluMa_shell [class*=documentDetail] dt,.rmluMa_shell [class*=documentSources]>span,.rmluMa_shell [class*=storageRoot] span,.rmluMa_shell [class*=storageRoot] small,.rmluMa_shell [class*=storageAreaMetric] span,.rmluMa_shell [class*=storageAreaMetric] code,.rmluMa_shell [class*=storagePath],.rmluMa_shell [class*=storageAreaGrid] article>small,.rmluMa_shell [class*=storageFootnote]{font-size:11px}.rmluMa_shell [class*=bodySwitch],.rmluMa_shell [class*=graphCanvasControls] button,.rmluMa_shell [class*=documentToolbar]>div button,.rmluMa_shell [class*=documentDetail] dd,.rmluMa_shell [class*=documentDanger] p,.rmluMa_shell [class*=advancedWrite] summary small{font-size:12px}.rmluMa_shell [class*=documentList]>button strong,.rmluMa_shell [class*=runtimeEntry]>p,.rmluMa_shell [class*=inspectorMeta] dd{font-size:13px}.rmluMa_shell [class*=runtimeEntryBadges]>span{border:1px solid var(--dsw-alias-border-l1);min-height:22px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);border-radius:999px;align-items:center;padding:0 8px;font-size:11px;font-weight:400;line-height:20px;display:inline-flex}.rmluMa_shell [class*=runtimeEntryBadges]>[class*=runtimeEntryTarget]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 30%, var(--dsw-alias-border-l1));color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-layer-1));font-family:var(--dsw-font-family);font-weight:500}.rmluMa_shell [class*=runtimeEntry][data-importance=critical] [class*=runtimeEntryBadges]>span:last-child{border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 24%, var(--dsw-alias-border-l1));color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 6%, var(--dsw-alias-bg-layer-1))}.rmluMa_shell [class*=listProgress],.rmluMa_shell [class*=compactListProgress]{color:var(--dsw-alias-label-tertiary);font-size:12px}.rmluMa_shell [class*=documentWorkspace]{align-items:stretch;height:clamp(520px,100dvh - 220px,760px);min-height:520px}.rmluMa_shell [class*=documentList],.rmluMa_shell [class*=documentReader]{overscroll-behavior:contain;scrollbar-gutter:stable;min-height:0;overflow-y:auto}.rmluMa_shell article[class*=bodyCard]{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);height:100%;box-shadow:none;opacity:1;flex-direction:column;padding:12px;display:flex}.rmluMa_shell article[class*=bodyCard][data-active]{border-color:var(--dsw-alias-border-l1);box-shadow:none}.rmluMa_shell .rmluMa_bodyCardHeader{justify-content:space-between;align-items:flex-start;gap:12px;min-width:0;display:flex}.rmluMa_shell .rmluMa_bodyDirectoryActions{flex:none;align-items:center;gap:8px;display:flex}.rmluMa_shell .rmluMa_bodyDirectoryActions>strong{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent);white-space:nowrap;border-radius:999px;padding:5px 8px;font-size:11px;font-weight:600}.rmluMa_shell .rmluMa_bodyCardIdentity{flex:1;align-items:flex-start;gap:8px;min-width:0;display:flex}.rmluMa_shell .rmluMa_bodyCardIdentity>[class*=bodySignal]{flex:none;width:6px;height:6px;margin-top:7px}.rmluMa_shell .rmluMa_bodyCardIdentity>div{flex:1;gap:2px;min-width:0;display:grid}.rmluMa_shell .rmluMa_bodyCardIdentity strong{text-overflow:ellipsis;white-space:nowrap;font-size:13px;line-height:20px;overflow:hidden}.rmluMa_shell .rmluMa_bodyCardMeta{align-items:center;gap:8px;min-width:0;display:flex}.rmluMa_shell .rmluMa_bodyCardMeta code{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}.rmluMa_shell .rmluMa_bodyCardMeta [class*=bodyHealth]{letter-spacing:0;flex:none;font-size:11px}.rmluMa_shell .rmluMa_bodyCardHeader>[class*=bodySwitch]{flex:none;min-height:24px}.rmluMa_shell article[class*=bodyCard]>p{-webkit-line-clamp:4;-webkit-box-orient:vertical;min-height:6.2em;max-height:6.2em;margin:12px 0;line-height:1.55;display:-webkit-box;overflow:hidden}.rmluMa_shell .rmluMa_bodyCardFooter{justify-content:space-between;align-items:center;gap:10px;min-width:0;margin-top:auto;padding-top:9px;display:flex}.rmluMa_shell .rmluMa_bodyCardStats{flex-wrap:wrap;align-items:center;gap:4px 10px;min-width:0;display:flex}.rmluMa_shell .rmluMa_bodyCardFooter [class*=bodyCardActions]{flex:none;align-items:center;gap:6px;display:flex}.rmluMa_shell .rmluMa_itemActionButton{border:1px solid;border-radius:7px;min-height:28px;padding:4px 9px;font-size:12px;line-height:18px}.rmluMa_shell [class*=runtimeEntry] footer,.rmluMa_shell [class*=cardActions]{gap:6px}.rmluMa_shell .rmluMa_itemEditAction{color:var(--dsw-alias-state-business-primary);border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 38%, var(--dsw-alias-border-l2));background:0 0}.rmluMa_shell .rmluMa_itemEditAction:hover:not(:disabled){color:var(--dsw-alias-state-business-primary);border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 58%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent)}.rmluMa_shell .rmluMa_itemDangerAction{color:var(--dsw-alias-state-error-primary);border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 34%, var(--dsw-alias-border-l2));background:0 0;padding:4px 9px}.rmluMa_shell .rmluMa_itemDangerAction:hover:not(:disabled){border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 54%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 8%, transparent);text-decoration:none}.rmluMa_shell [class*=bodyDeleteConfirm]>p{font-size:13px}.rmluMa_shell [class*=pageHeaderMeta]>code{text-align:center;font-variant-numeric:tabular-nums;min-width:72px;font-size:11px}.rmluMa_shell .rmluMa_inspectorGlyph{border:1px solid var(--dsw-alias-border-l1);width:44px;height:44px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-1);font:20px/1 var(--mn-code);opacity:1;border-radius:10px;place-items:center;margin-bottom:10px;display:grid}@media (width<=760px){.rmluMa_shell .rmluMa_masthead{min-height:48px;padding:8px 12px 4px}.rmluMa_shell .rmluMa_headerActions{max-width:none}.rmluMa_shell .rmluMa_statusCluster>span:not([class*=statusDot]){display:inline}.rmluMa_shell [class*=storageMode]{min-width:0}.rmluMa_shell [class*=storageMode]>span,.rmluMa_shell .rmluMa_workspacePicker>span,.rmluMa_shell .rmluMa_workspaceMismatch>span{display:none}.rmluMa_shell .rmluMa_workspacePicker{gap:0;padding-left:0}.rmluMa_shell .rmluMa_workspacePicker select{border-left:0;width:min(160px,31vw)}.rmluMa_shell .rmluMa_topNavigation{padding:0 12px}.rmluMa_shell .rmluMa_memoryNavigation{padding-inline:12px}.rmluMa_shell .rmluMa_memoryTabs button{padding-inline:10px}.rmluMa_shell .rmluMa_nav button{text-align:left;flex-direction:row;min-width:max-content;padding:7px 12px}.rmluMa_shell .rmluMa_canvas>div{padding:14px 12px calc(170px + env(safe-area-inset-bottom,0px))}.rmluMa_shell .rmluMa_canvas[data-lock-page-header] [class*=pageHeader]{margin-inline:-12px;padding-inline:12px}.rmluMa_shell .rmluMa_modalBackdrop{padding:12px}.rmluMa_shell .rmluMa_modal{width:calc(100vw - 24px);max-height:calc(100vh - 24px)}.rmluMa_shell .rmluMa_modal>div:last-child{padding:14px}.rmluMa_shell [class*=documentWorkspace]{height:auto;min-height:0}.rmluMa_shell [class*=documentList]{scrollbar-gutter:auto;overflow-y:auto}.rmluMa_shell [class*=documentReader]{scrollbar-gutter:auto;overflow:visible}}@media (width<=520px){.rmluMa_shell .rmluMa_masthead{min-height:46px}.rmluMa_shell .rmluMa_brand h1{font-size:16px}.rmluMa_shell .rmluMa_headerActions{max-width:62vw}.rmluMa_shell [class*=storageMode]{padding-inline:7px}.rmluMa_shell .rmluMa_workspacePicker select{width:min(118px,30vw);padding-left:8px}.rmluMa_shell .rmluMa_workspaceMismatch>button{padding-inline:6px}.rmluMa_shell .rmluMa_statusCluster [class*=iconButton]{display:none}}@media (prefers-reduced-motion:reduce){.rmluMa_shell [class*=primaryButton],.rmluMa_shell [class*=secondaryButton],.rmluMa_shell [class*=ghostButton],.rmluMa_shell [class*=dangerButton],.rmluMa_shell [class*=dangerSolidButton],.rmluMa_shell [class*=iconButton],.rmluMa_shell [class*=bodyEditButton],.rmluMa_shell [class*=inspectorEye],.rmluMa_shell [class*=inspectorHeading] button,.rmluMa_shell [class*=sectionHeading] button,.rmluMa_shell [class*=previewHeading] button{transition:none}}";
		...
		var MnemonSidebarView_module_css_default = {
			"masthead": "rmluMa_masthead",
			"statusCluster": "rmluMa_statusCluster",
			"shell": "rmluMa_shell",
			"brand": "rmluMa_brand",
			"bodyCardHeader": "rmluMa_bodyCardHeader",
			"itemActionButton": "rmluMa_itemActionButton",
			"itemDangerAction": "rmluMa_itemDangerAction",
			"bodyDirectoryActions": "rmluMa_bodyDirectoryActions",
			"modalBackdrop": "rmluMa_modalBackdrop",
			"workspacePicker": "rmluMa_workspacePicker",
			"topNavigation": "rmluMa_topNavigation",
			"headerActions": "rmluMa_headerActions",
			"modal": "rmluMa_modal",
			"memoryNavigation": "rmluMa_memoryNavigation",
			"canvas": "rmluMa_canvas",
			"bodyCardIdentity": "rmluMa_bodyCardIdentity",
			"workspaceMismatch": "rmluMa_workspaceMismatch",
			"bodyCardMeta": "rmluMa_bodyCardMeta",
			"itemEditAction": "rmluMa_itemEditAction",
			"pageHeader": "rmluMa_pageHeader",
			"inspectorGlyph": "rmluMa_inspectorGlyph",
			"bodyCardFooter": "rmluMa_bodyCardFooter",
			"bodyCardStats": "rmluMa_bodyCardStats",
			"memoryWorkspace": "rmluMa_memoryWorkspace",
			"nav": "rmluMa_nav",
			"memoryTabs": "rmluMa_memoryTabs",
			"memoryWriteButton": "rmluMa_memoryWriteButton"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-staged.adwBzq/src/client/MnemonView.module.css.mjs
		const css$3 = ".YHuQMG_shell{--mn-bg:var(--dsw-alias-bg-base);--mn-layer-1:var(--dsw-alias-bg-layer-1);--mn-layer-2:var(--dsw-alias-bg-layer-2);--mn-input:var(--dsw-specific-input-major,var(--dsw-alias-bg-layer-2));--mn-text:var(--dsw-alias-label-primary);--mn-muted:var(--dsw-alias-label-secondary);--mn-faint:var(--dsw-alias-label-tertiary);--mn-line:var(--dsw-alias-border-l1);--mn-line-strong:var(--dsw-alias-border-l2);--mn-accent:var(--dsw-alias-state-business-primary);--mn-hover:var(--dsw-alias-interactive-bg-hover);--mn-danger:var(--dsw-alias-state-error-primary);--mn-success:var(--dsw-alias-state-success-primary);--mn-code:var(--ds-font-family-code,\"SFMono-Regular\", Consolas, monospace);--mn-sans:var(--dsw-font-family,-apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif);box-sizing:border-box;min-width:0;height:100%;min-height:0;color:var(--mn-text);background:var(--mn-bg);font:13px/1.55 var(--mn-sans);-webkit-tap-highlight-color:transparent;flex-direction:column;display:flex;overflow:hidden}.YHuQMG_shell *,.YHuQMG_shell :before,.YHuQMG_shell :after{box-sizing:border-box}.YHuQMG_shell button,.YHuQMG_shell input,.YHuQMG_shell select,.YHuQMG_shell textarea{color:inherit;font:inherit}.YHuQMG_shell button,.YHuQMG_shell select{touch-action:manipulation}.YHuQMG_shell button:focus-visible,.YHuQMG_shell input:focus-visible,.YHuQMG_shell select:focus-visible,.YHuQMG_shell textarea:focus-visible,.YHuQMG_shell summary:focus-visible,.YHuQMG_shell [role=button]:focus-visible{outline:2px solid var(--mn-accent);outline-offset:2px}.YHuQMG_masthead{border-bottom:1px solid var(--mn-line);background:var(--mn-bg);flex:none;grid-template-columns:minmax(220px,1fr) auto auto;align-items:center;gap:clamp(12px,2vw,24px);min-height:56px;padding:8px 16px;display:grid}.YHuQMG_brand{align-items:center;gap:11px;min-width:0;display:flex}.YHuQMG_brandLogo{width:32px;height:32px;box-shadow:0 0 0 1px var(--mn-line);border-radius:8px;flex:none;overflow:hidden}.YHuQMG_brand h1{letter-spacing:-.02em;margin:1px 0 0;font-size:16px;line-height:1.15}.YHuQMG_storageMode{border:1px solid var(--mn-line-strong);min-height:32px;color:var(--mn-muted);background:var(--mn-layer-1);white-space:nowrap;border-radius:8px;flex:none;align-items:center;gap:6px;padding:0 9px;display:flex}.YHuQMG_storageMode>span{font-size:10px}.YHuQMG_storageMode>strong{color:var(--mn-text);font-size:11px;font-weight:600}.YHuQMG_cardKicker,.YHuQMG_sectionHeading>div>span,.YHuQMG_entityHeading>span,.YHuQMG_inspectorHeading>span{color:var(--mn-faint);font:650 9px/1.2 var(--mn-code);letter-spacing:.12em;text-transform:uppercase}.YHuQMG_statusCluster{border:1px solid var(--mn-line-strong);min-height:34px;color:var(--mn-muted);background:var(--mn-layer-1);border-radius:9px;flex:none;align-items:center;gap:8px;padding:0 4px 0 11px;font-size:11px;display:flex}.YHuQMG_statusDot{border-radius:50%;width:6px;height:6px}.YHuQMG_online{background:var(--mn-success);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 15%, transparent)}.YHuQMG_offline{background:var(--mn-danger);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-danger) 14%, transparent)}.YHuQMG_checking{background:var(--mn-faint);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-faint) 12%, transparent)}.YHuQMG_iconButton{width:32px;height:32px;color:inherit;cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;display:grid}.YHuQMG_iconButton:hover{color:var(--mn-accent);background:var(--mn-hover)}.YHuQMG_headerActions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;display:flex}.YHuQMG_workspacePicker{min-width:0;color:var(--mn-faint);align-items:center;gap:7px;font-size:10px;display:flex}.YHuQMG_workspacePicker>span{white-space:nowrap}.YHuQMG_workspacePicker select{border:1px solid var(--mn-line-strong);width:min(190px,22vw);min-width:112px;height:34px;color:var(--mn-text);background:var(--mn-input);cursor:pointer;border-radius:9px;outline:0;padding:0 28px 0 9px;font-size:11px}.YHuQMG_workspacePicker select:hover{border-color:color-mix(in srgb, var(--mn-accent) 50%, var(--mn-line-strong))}.YHuQMG_alert,.YHuQMG_inlineError{border:1px solid color-mix(in srgb, var(--mn-danger) 32%, transparent);color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 7%, var(--mn-layer-1));border-radius:9px;padding:10px 13px;font-size:12px}.YHuQMG_alert{flex-direction:column;flex:none;margin:10px clamp(18px,2.5vw,32px) 0;display:flex}.YHuQMG_workspaceMismatch{border:1px solid color-mix(in srgb, var(--mn-accent) 36%, var(--mn-line));background:color-mix(in srgb, var(--mn-accent) 7%, var(--mn-layer-1));border-radius:10px;flex:none;justify-content:space-between;align-items:center;gap:18px;min-width:0;margin:10px clamp(18px,2.5vw,32px) 0;padding:11px 12px 11px 14px;display:flex}.YHuQMG_workspaceMismatch>div{gap:2px;min-width:0;display:grid}.YHuQMG_workspaceMismatch strong{font-size:12px}.YHuQMG_workspaceMismatch span{color:var(--mn-muted);font-size:10px}.YHuQMG_workspaceMismatch>div>div{flex-wrap:wrap;gap:5px 12px;min-width:0;margin-top:4px;display:flex}.YHuQMG_workspaceMismatch code{color:var(--mn-faint);font:9px/1.4 var(--mn-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.YHuQMG_workspaceMismatch>button{white-space:nowrap;flex:none;min-height:32px}.YHuQMG_telemetry{align-items:center;min-width:0;display:flex}.YHuQMG_telemetryMetric{border-left:1px solid var(--mn-line);gap:2px;min-width:72px;padding:1px 14px;display:grid}.YHuQMG_telemetryMetric span{color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;font-size:9px;overflow:hidden}.YHuQMG_telemetryMetric strong{font:650 13px/1 var(--mn-code);font-variant-numeric:tabular-nums}.YHuQMG_workspace{flex-direction:column;flex:1;min-height:0;display:flex}.YHuQMG_topNavigation{border-bottom:1px solid var(--mn-line);background:var(--mn-layer-1);flex:none;justify-content:space-between;align-items:stretch;gap:14px;min-width:0;min-height:46px;padding:0 16px;display:flex}.YHuQMG_nav{overscroll-behavior-inline:contain;scrollbar-width:none;align-items:stretch;gap:10px;min-width:0;display:flex;overflow-x:auto}.YHuQMG_nav::-webkit-scrollbar{display:none}.YHuQMG_navGroup{align-items:stretch;gap:14px;min-width:0;display:flex}.YHuQMG_navGroupDivider{background:var(--mn-line);flex:none;align-self:center;width:1px;height:22px}.YHuQMG_nav button{min-width:max-content;min-height:44px;color:var(--mn-muted);text-align:left;cursor:pointer;background:0 0;border:0;align-items:center;gap:7px;padding:0 3px;display:flex;position:relative}.YHuQMG_nav button:hover,.YHuQMG_nav button[aria-current=page]{color:var(--mn-text)}.YHuQMG_nav button[aria-current=page]:after{content:\"\";background:var(--mn-accent);border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.YHuQMG_nav button[aria-current=page] .YHuQMG_navGlyph{color:var(--mn-accent)}.YHuQMG_nav button>span:last-child{min-width:0;display:block}.YHuQMG_nav button strong{font-size:12px;font-weight:600}.YHuQMG_nav button small{display:none}.YHuQMG_navGlyph{color:var(--mn-faint);font:600 13px/1 var(--mn-code)}@media (width>=1000px){.YHuQMG_nav button{min-height:50px}.YHuQMG_nav button small{color:var(--mn-faint);margin-top:1px;font-size:9px;line-height:1.3;display:block}}.YHuQMG_spaceSummary{border-left:1px solid var(--mn-line);flex:none;grid-template-columns:minmax(0,1fr) auto;align-content:center;gap:1px 9px;min-width:142px;padding:0 0 0 14px;display:grid}.YHuQMG_spaceSummary>span{color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;font-size:9px;overflow:hidden}.YHuQMG_spaceSummary code{color:var(--mn-accent);font:650 12px/1 var(--mn-code);grid-row:span 2;align-self:center}.YHuQMG_spaceSummary small{color:var(--mn-faint);font-size:9px}.YHuQMG_canvas{overscroll-behavior-x:contain;overscroll-behavior-y:auto;scroll-behavior:auto;-webkit-overflow-scrolling:touch;background:var(--mn-bg);flex:1;min-width:0;overflow:auto}.YHuQMG_page{width:min(1320px,100%);min-height:100%;margin:0 auto;padding:clamp(16px,2vw,24px) clamp(16px,2.4vw,28px) clamp(96px,14vh,150px)}.YHuQMG_pageHeader{justify-content:space-between;align-items:flex-start;gap:24px;margin-bottom:16px;display:flex}.YHuQMG_pageHeader h2{letter-spacing:-.025em;margin:2px 0;font-size:20px;line-height:1.2}.YHuQMG_pageHeader p{max-width:72ch;color:var(--mn-muted);margin:0;font-size:12px;line-height:1.65}.YHuQMG_pageHeaderMeta{flex:none;align-items:center;gap:9px;display:flex}.YHuQMG_pageHeaderMeta>code{border:1px solid var(--mn-line);color:var(--mn-faint);background:var(--mn-layer-1);font:600 9px/1 var(--mn-code);letter-spacing:.06em;border-radius:7px;padding:6px 8px}.YHuQMG_primaryButton,.YHuQMG_secondaryButton,.YHuQMG_ghostButton,.YHuQMG_dangerButton,.YHuQMG_dangerSolidButton{cursor:pointer;border-radius:8px;min-height:36px;padding:0 13px;font-size:12px;transition:border-color .14s,background-color .14s,color .14s,transform .14s}.YHuQMG_primaryButton{border:1px solid var(--mn-accent);color:#fff;background:var(--mn-accent)}.YHuQMG_secondaryButton{border:1px solid var(--mn-line-strong);color:var(--mn-text);background:var(--mn-layer-1)}.YHuQMG_ghostButton,.YHuQMG_dangerButton{background:0 0;border:1px solid #0000;min-height:32px;padding:0 9px}.YHuQMG_ghostButton{color:var(--mn-muted)}.YHuQMG_dangerButton{color:var(--mn-danger)}.YHuQMG_dangerSolidButton{border:1px solid var(--mn-danger);color:#fff;background:var(--mn-danger);min-height:29px}.YHuQMG_primaryButton:hover,.YHuQMG_secondaryButton:hover,.YHuQMG_ghostButton:hover,.YHuQMG_dangerButton:hover{filter:brightness(.98);background-color:var(--mn-hover)}.YHuQMG_primaryButton:hover{background-color:var(--mn-accent)}.YHuQMG_shell button:disabled{cursor:not-allowed;opacity:.48}.YHuQMG_emptyState{border:1px dashed var(--mn-line-strong);background:color-mix(in srgb, var(--mn-layer-1) 50%, transparent);border-radius:13px;justify-content:center;align-items:center;gap:22px;min-height:220px;padding:30px;display:flex}.YHuQMG_emptyGlyph{border:1px solid color-mix(in srgb, var(--mn-accent) 35%, var(--mn-line));width:76px;height:76px;color:var(--mn-accent);background:radial-gradient(circle, color-mix(in srgb, var(--mn-accent) 12%, transparent), transparent 65%);font:500 26px/1 var(--mn-code);border-radius:50%;flex:none;place-items:center;display:grid}.YHuQMG_emptyState h3{margin:0 0 5px;font-size:16px}.YHuQMG_emptyState p{max-width:500px;color:var(--mn-muted);margin:0}.YHuQMG_loadingPanel{border:1px solid var(--mn-line);min-height:220px;color:var(--mn-muted);background:var(--mn-layer-1);border-radius:13px;place-items:center;display:grid}.YHuQMG_inlineError{margin:0 0 14px}.YHuQMG_muted,.YHuQMG_loading{color:var(--mn-faint);padding:16px 0;font-size:12px}.YHuQMG_bodyDirectory{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-1) 72%, var(--mn-bg));border-radius:11px;margin-bottom:12px;padding:12px 14px}.YHuQMG_bodyDirectoryHeader{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:10px;display:flex}.YHuQMG_bodyDirectoryHeader h3{margin:1px 0;font-size:13px}.YHuQMG_bodyDirectoryHeader p{color:var(--mn-muted);margin:0;font-size:10px}.YHuQMG_bodyDirectoryPath{max-width:min(62vw,720px);color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;margin-top:4px;font-size:9px;display:block;overflow:hidden}.YHuQMG_bodyDirectoryHeader>strong{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 9px var(--mn-code);border-radius:999px;flex:none;padding:5px 8px}.YHuQMG_bodyGrid{grid-template-columns:repeat(auto-fit,minmax(245px,1fr));gap:7px;display:grid}.YHuQMG_bodyDirectoryEmpty{border:1px dashed color-mix(in srgb, var(--mn-line) 84%, transparent);min-height:92px;color:var(--mn-muted);border-radius:12px;grid-column:1/-1;justify-content:center;align-items:center;gap:14px;display:flex}.YHuQMG_bodyDirectoryEmpty>span{opacity:.6;font-size:28px}.YHuQMG_bodyDirectoryEmpty strong{color:var(--mn-text);display:block}.YHuQMG_bodyDirectoryEmpty p{margin:3px 0 0;font-size:10px}.YHuQMG_bodyCard{--mn-body-accent:var(--mn-success);border:1px solid var(--mn-line);background:var(--mn-layer-1);opacity:.7;border-radius:9px;min-width:0;padding:9px 10px;transition:opacity .18s,border-color .18s}.YHuQMG_bodyCard[data-active]{border-color:color-mix(in srgb, var(--mn-body-accent) 42%, var(--mn-line));opacity:1;box-shadow:inset 0 1px 0 color-mix(in srgb, var(--mn-body-accent) 10%, transparent)}.YHuQMG_bodyCardTop{grid-template-columns:7px minmax(0,1fr) auto;align-items:center;gap:8px;display:grid}.YHuQMG_bodySignal{background:var(--mn-faint);border-radius:50%;width:7px;height:7px}.YHuQMG_bodyCard[data-active] .YHuQMG_bodySignal{background:var(--mn-body-accent);box-shadow:0 0 0 4px color-mix(in srgb, var(--mn-body-accent) 14%, transparent)}.YHuQMG_bodyCard:not([data-healthy]) .YHuQMG_bodySignal{background:var(--mn-danger);box-shadow:0 0 0 4px color-mix(in srgb, var(--mn-danger) 12%, transparent)}.YHuQMG_bodyCardTop>div{min-width:0;display:grid}.YHuQMG_bodyCardTop strong{text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.YHuQMG_bodyCardTop code{color:var(--mn-faint);font:9px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.YHuQMG_bodyHealth{color:var(--mn-success);font:650 8px var(--mn-code);letter-spacing:.07em;text-transform:uppercase}.YHuQMG_bodyCard:not([data-healthy]) .YHuQMG_bodyHealth{color:var(--mn-danger)}.YHuQMG_bodySwitch{min-height:32px;color:var(--mn-faint);cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0 1px;font-size:9.5px;display:flex}.YHuQMG_bodySwitchTrack{border:1px solid var(--mn-line-strong);background:var(--mn-layer-2);border-radius:999px;flex:none;width:29px;height:17px;transition:border-color .18s,background-color .18s;position:relative}.YHuQMG_bodySwitchTrack i{background:var(--mn-faint);border-radius:50%;width:11px;height:11px;transition:transform .2s cubic-bezier(.2,.8,.2,1),background-color .18s;position:absolute;top:2px;left:2px}.YHuQMG_bodySwitch:hover{color:var(--mn-text)}.YHuQMG_bodySwitch:hover .YHuQMG_bodySwitchTrack{border-color:var(--mn-body-accent)}.YHuQMG_bodySwitch[aria-checked=true]{color:var(--mn-text)}.YHuQMG_bodySwitch[aria-checked=true] .YHuQMG_bodySwitchTrack{border-color:color-mix(in srgb, var(--mn-body-accent) 65%, var(--mn-line));background:color-mix(in srgb, var(--mn-body-accent) 25%, var(--mn-layer-2))}.YHuQMG_bodySwitch[aria-checked=true] .YHuQMG_bodySwitchTrack i{background:var(--mn-body-accent);transform:translate(12px)}.YHuQMG_bodyCardActions{align-items:center;gap:6px;display:flex}.YHuQMG_bodyEditButton{width:28px;height:28px;color:var(--mn-muted);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:7px;place-items:center;font-size:12px;display:grid}.YHuQMG_bodyEditButton:hover{color:var(--mn-text);border-color:var(--mn-line);background:var(--mn-hover)}.YHuQMG_bodyEdit{gap:9px;padding-top:2px;display:grid}.YHuQMG_bodyEdit label{color:var(--mn-faint);gap:4px;font-size:9px;display:grid}.YHuQMG_bodyEdit input,.YHuQMG_bodyEdit textarea{border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:8px;outline:0;padding:7px 9px;font-size:12px;line-height:1.5}.YHuQMG_bodyEdit textarea{resize:vertical}.YHuQMG_bodyEdit input:focus,.YHuQMG_bodyEdit textarea:focus{border-color:var(--mn-accent)}.YHuQMG_bodyEditActions{justify-content:flex-end;gap:7px;display:flex}.YHuQMG_bodyDeleteConfirm{gap:16px;display:grid}.YHuQMG_bodyDeleteConfirm>p{color:var(--mn-muted);margin:0;font-size:12px;line-height:1.6}.YHuQMG_bodyDeleteSummary{border:1px solid color-mix(in srgb, var(--mn-danger) 22%, var(--mn-line));background:color-mix(in srgb, var(--mn-danger) 5%, var(--mn-layer-1));border-radius:8px;gap:3px;padding:12px;display:grid}.YHuQMG_bodyDeleteSummary strong{font-size:13px}.YHuQMG_bodyDeleteContent{white-space:pre-wrap;overflow-wrap:anywhere;margin:0;font-size:13px;font-weight:400;line-height:1.55}.YHuQMG_bodyDeleteSummary span{color:var(--mn-muted);font-size:11px}.YHuQMG_bodyCard>p{min-height:15px;color:var(--mn-muted);margin:7px 0;font-size:10px;line-height:1.45}.YHuQMG_bodyCard footer{border-top:1px solid var(--mn-line);color:var(--mn-faint);flex-wrap:wrap;gap:5px 11px;padding-top:6px;font-size:9px;display:flex}.YHuQMG_bodyCreate{border-top:1px solid var(--mn-line);margin-top:10px;padding-top:8px}.YHuQMG_bodyCreate summary{cursor:pointer;width:max-content;color:var(--mn-accent);font-size:10px;list-style:none}.YHuQMG_bodyCreate summary::-webkit-details-marker{display:none}.YHuQMG_bodyCreate form{grid-template-columns:minmax(130px,.7fr) minmax(150px,.9fr) minmax(230px,1.7fr) auto;gap:7px;margin-top:9px;display:grid}.YHuQMG_bodyCreate input{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:0;height:34px;padding:0 9px}.YHuQMG_bodyCreate input:focus{border-color:var(--mn-accent)}.YHuQMG_graphLayout{grid-template-columns:minmax(0,1fr) minmax(240px,270px);gap:10px;display:grid}.YHuQMG_graphPanel,.YHuQMG_graphInspector{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px}.YHuQMG_graphPanel{min-width:0;overflow:hidden}.YHuQMG_graphToolbar,.YHuQMG_graphFooter{min-height:43px;color:var(--mn-muted);justify-content:space-between;align-items:center;gap:14px;padding:0 13px;font-size:10px;display:flex}.YHuQMG_graphToolbar{border-bottom:1px solid var(--mn-line)}.YHuQMG_graphToolbar>div:first-child{align-items:center;gap:7px;display:flex}.YHuQMG_graphToolbar small{color:var(--mn-faint)}.YHuQMG_liveDot{background:var(--mn-success);width:6px;height:6px;box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 15%, transparent);border-radius:50%}.YHuQMG_graphLegend{flex-wrap:wrap;justify-content:flex-end;gap:5px 10px;display:flex}.YHuQMG_graphLegend span{align-items:center;gap:4px;display:flex}.YHuQMG_graphLegend span:before{content:\"\";background:var(--edge-color);border-radius:2px;width:13px;height:2px}.YHuQMG_graphLegend [data-edge=temporal]{--edge-color:#87909f}.YHuQMG_graphLegend [data-edge=scope]{--edge-color:#708199}.YHuQMG_graphLegend [data-edge=scope]:before{background:repeating-linear-gradient(90deg, var(--edge-color) 0 4px, transparent 4px 7px)}.YHuQMG_graphLegend [data-edge=semantic]{--edge-color:#4d7cfe}.YHuQMG_graphLegend [data-edge=causal]{--edge-color:#ef6b5b}.YHuQMG_graphLegend [data-edge=entity]{--edge-color:#22a879}.YHuQMG_graphViewport{background:radial-gradient(circle at 50% 48%, color-mix(in srgb, var(--mn-accent) 6%, transparent), transparent 47%);min-height:clamp(390px,42vw,560px);position:relative;overflow:hidden}.YHuQMG_graphCanvasControls{z-index:2;border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-1) 88%, transparent);box-shadow:0 6px 18px color-mix(in srgb, var(--mn-text) 7%, transparent);backdrop-filter:blur(10px);border-radius:9px;align-items:center;gap:5px;padding:4px;display:flex;position:absolute;top:10px;right:10px}.YHuQMG_graphCanvasControls span{color:var(--mn-faint);font:9px var(--mn-code);align-items:center;gap:5px;padding:0 6px;display:flex}.YHuQMG_graphCanvasControls span i{background:var(--mn-accent);width:5px;height:5px;box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-accent) 12%, transparent);border-radius:50%}.YHuQMG_graphCanvasControls button{min-height:30px;color:var(--mn-muted);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;padding:0 9px;font-size:9.5px}.YHuQMG_graphCanvasControls button:hover,.YHuQMG_graphCanvasControls button[data-active]{border-color:var(--mn-line);color:var(--mn-text);background:var(--mn-hover)}.YHuQMG_graphCanvasControls button[data-active]{color:var(--mn-accent)}.YHuQMG_graphSvg{touch-action:pan-y pinch-zoom;user-select:none;width:100%;height:clamp(390px,42vw,560px);display:block}.YHuQMG_graphBackdrop{fill:var(--mn-layer-1)}.YHuQMG_graphGridLine{stroke:var(--mn-line);stroke-width:.6px;opacity:.5}.YHuQMG_graphEdge{fill:none;stroke:#87909f;stroke-width:1px;opacity:.32;vector-effect:non-scaling-stroke}.YHuQMG_graphEdge[data-edge=scope]{stroke:#708199;stroke-dasharray:4 5;opacity:.28}.YHuQMG_graphEdge[data-edge=semantic]{stroke:#4d7cfe;opacity:.48}.YHuQMG_graphEdge[data-edge=causal]{stroke:#ef6b5b;opacity:.52}.YHuQMG_graphEdge[data-edge=entity]{stroke:#22a879;stroke-width:1.45px;opacity:.78}.YHuQMG_graphNode{--node:#8290a8;cursor:grab;touch-action:none;outline:none}.YHuQMG_graphNode[data-dragging]{cursor:grabbing}.YHuQMG_graphNode[data-category=decision]{--node:#ef8354}.YHuQMG_graphNode[data-category=preference]{--node:#a879e1}.YHuQMG_graphNode[data-category=fact]{--node:#4d7cfe}.YHuQMG_graphNode[data-category=insight]{--node:#19a77d}.YHuQMG_graphNode[data-category=context]{--node:#d8a624}.YHuQMG_graphNode[data-kind=space]{--node:var(--mn-success)}.YHuQMG_graphNode[data-kind=entity]{--node:#2b9db9}.YHuQMG_nodeHalo{fill:color-mix(in srgb, var(--node) 18%, var(--mn-layer-1));stroke:color-mix(in srgb, var(--node) 60%, var(--mn-layer-1));stroke-width:1.5px;transition:r .16s}.YHuQMG_nodeCore{fill:var(--node)}.YHuQMG_nodeLabel{fill:var(--mn-muted);font:10px var(--mn-code);pointer-events:auto}.YHuQMG_nodeBodyLabel{fill:var(--mn-faint);font:650 8px var(--mn-code);letter-spacing:.04em;pointer-events:auto}.YHuQMG_graphSvg[data-density=sparse] .YHuQMG_nodeLabel{font-size:12px}.YHuQMG_graphNode:hover .YHuQMG_nodeHalo,.YHuQMG_graphNode:focus .YHuQMG_nodeHalo,.YHuQMG_graphNode[data-selected] .YHuQMG_nodeHalo{fill:color-mix(in srgb, var(--node) 28%, var(--mn-layer-1));stroke:var(--node)}.YHuQMG_graphNode[data-selected] .YHuQMG_nodeLabel{fill:var(--mn-text);font-weight:650}.YHuQMG_graphFooter{border-top:1px solid var(--mn-line);min-height:38px;color:var(--mn-faint)}.YHuQMG_graphInspector{min-width:0;min-height:calc(clamp(390px,42vw,560px) + 83px);padding:15px;overflow:hidden}.YHuQMG_inspectorEmpty{text-align:center;flex-direction:column;justify-content:center;align-items:center;height:100%;display:flex}.YHuQMG_inspectorLogo{opacity:.72;border-radius:11px;width:54px;height:54px;margin-bottom:15px}.YHuQMG_inspectorEmpty h3{margin:7px 0 3px;font-size:14px}.YHuQMG_inspectorEmpty p{color:var(--mn-faint);margin:0;font-size:11px}.YHuQMG_inspectorHeading{justify-content:space-between;align-items:center;display:flex}.YHuQMG_inspectorHeading button,.YHuQMG_sectionHeading button{width:32px;height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;display:grid}.YHuQMG_inspectorHeading button:hover,.YHuQMG_sectionHeading button:hover{background:var(--mn-hover)}.YHuQMG_categoryChip{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 10%, transparent);border-radius:999px;margin-top:24px;padding:3px 8px;font-size:10px;display:inline-flex}.YHuQMG_inspectorTitleRow{align-items:flex-start;gap:8px;min-width:0;margin:12px 0 20px;display:flex}.YHuQMG_inspectorTitle{overflow-wrap:anywhere;white-space:pre-wrap;-webkit-line-clamp:6;-webkit-box-orient:vertical;flex:1;min-width:0;margin:0;font-size:14px;line-height:1.6;display:-webkit-box;overflow:hidden}.YHuQMG_inspectorEye{border:1px solid var(--mn-line);width:27px;height:27px;color:var(--mn-muted);background:var(--mn-layer-1);cursor:pointer;border-radius:7px;flex:none;place-items:center;transition:color .15s,border-color .15s,background-color .15s;display:grid}.YHuQMG_inspectorEye:hover{color:var(--mn-accent);border-color:var(--mn-line-strong);background:var(--mn-hover)}.YHuQMG_inspectorMeta{margin:0}.YHuQMG_inspectorMeta>div{border-top:1px solid var(--mn-line);gap:3px;padding:11px 0;display:grid}.YHuQMG_inspectorMeta dt{color:var(--mn-faint);font:9px var(--mn-code);text-transform:uppercase}.YHuQMG_inspectorMeta dd{overflow-wrap:anywhere;color:var(--mn-muted);margin:0;font-size:11px}.YHuQMG_inspectorActions{gap:8px;margin-top:20px;display:grid}.YHuQMG_previewOverlay{z-index:40;background:color-mix(in srgb, var(--mn-bg) 58%, transparent);backdrop-filter:blur(4px);place-items:center;padding:clamp(16px,4vw,48px);display:grid;position:fixed;inset:0}.YHuQMG_previewDialog{border:1px solid var(--mn-line-strong);background:var(--mn-layer-1);width:min(680px,100%);max-height:min(76dvh,640px);box-shadow:0 24px 64px color-mix(in srgb, var(--mn-text) 20%, transparent);border-radius:13px;flex-direction:column;display:flex;overflow:hidden}.YHuQMG_previewHeading{border-bottom:1px solid var(--mn-line);flex:none;justify-content:space-between;align-items:center;gap:12px;min-height:46px;padding:0 14px 0 16px;display:flex}.YHuQMG_previewHeading>span{color:var(--mn-accent);font:650 9px/1.2 var(--mn-code);letter-spacing:.08em;text-transform:uppercase}.YHuQMG_previewHeading button{width:32px;height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;font-size:15px;display:grid}.YHuQMG_previewHeading button:hover{background:var(--mn-hover)}.YHuQMG_previewMeta{border-bottom:1px solid var(--mn-line);color:var(--mn-faint);font:9px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;flex:none;padding:8px 16px;overflow:hidden}.YHuQMG_previewBody{-webkit-overflow-scrolling:touch;min-height:0;padding:14px 16px 18px;overflow:auto}.YHuQMG_previewBody p{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--mn-text);margin:0;font-size:13px;line-height:1.7}.YHuQMG_searchBar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:13px;margin-bottom:18px;padding:13px}.YHuQMG_queryField{border:1px solid var(--mn-line-strong);background:var(--mn-input);border-radius:9px;grid-template-columns:24px minmax(0,1fr) 24px;align-items:center;gap:5px;padding:0 10px;display:grid}.YHuQMG_queryField>span{color:var(--mn-accent);font:18px var(--mn-code)}.YHuQMG_queryField input{background:0 0;border:0;outline:0;width:100%;height:42px}.YHuQMG_queryField kbd{color:var(--mn-faint);font:11px var(--mn-code)}.YHuQMG_searchControls{justify-content:flex-end;align-items:flex-end;gap:10px;padding-top:10px;display:flex}.YHuQMG_searchActions{align-items:center;gap:7px;display:flex}.YHuQMG_agentAnswer{border:1px solid color-mix(in srgb, var(--mn-accent) 30%, var(--mn-line));background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 7%, var(--mn-layer-1)), var(--mn-layer-1) 60%);border-radius:11px;margin-bottom:16px;padding:16px 18px}.YHuQMG_agentAnswerHeading{justify-content:space-between;align-items:flex-start;gap:16px;display:flex}.YHuQMG_agentAnswerHeading span{color:var(--mn-accent);font:650 9px/1.2 var(--mn-code);letter-spacing:.08em}.YHuQMG_agentAnswerHeading h3{margin:4px 0 0;font-size:15px}.YHuQMG_agentAnswerHeading>code{color:var(--mn-faint);font-size:9px}.YHuQMG_agentAnswer>p{white-space:pre-wrap;color:var(--mn-text);margin:12px 0;font-size:13px;line-height:1.7}.YHuQMG_agentCitations{border-top:1px solid var(--mn-line);flex-wrap:wrap;gap:5px;padding-top:10px;display:flex}.YHuQMG_agentCitations code{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:5px;padding:3px 6px;font-size:9px}.YHuQMG_searchControls label,.YHuQMG_formGrid label,.YHuQMG_fieldWide{color:var(--mn-muted);gap:5px;font-size:11px;display:grid}.YHuQMG_searchControls select,.YHuQMG_formGrid select,.YHuQMG_formGrid input,.YHuQMG_listToolbar input,.YHuQMG_listToolbar select,.YHuQMG_entitySearch input{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:140px;height:34px;padding:0 9px}.YHuQMG_searchControls select:focus,.YHuQMG_formGrid select:focus,.YHuQMG_formGrid input:focus,.YHuQMG_listToolbar input:focus,.YHuQMG_listToolbar select:focus,.YHuQMG_entitySearch input:focus,.YHuQMG_supervisedForm textarea:focus{border-color:var(--mn-accent)}.YHuQMG_singleColumn{max-width:830px}.YHuQMG_resultLayout{grid-template-columns:minmax(0,1.15fr) minmax(300px,.85fr);align-items:start;gap:14px;display:grid}.YHuQMG_results,.YHuQMG_relatedPane,.YHuQMG_entityResults{min-width:0}.YHuQMG_sectionHeading{justify-content:space-between;align-items:center;gap:16px;min-height:39px;margin-bottom:8px;display:flex}.YHuQMG_sectionHeading h3{margin:2px 0 0;font-size:15px}.YHuQMG_sectionHeading>strong{min-width:27px;height:27px;color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 11px var(--mn-code);border-radius:7px;place-items:center;display:grid}.YHuQMG_relatedPane{border:1px solid var(--mn-line);background:var(--mn-layer-1);-webkit-overflow-scrolling:touch;border-radius:12px;max-height:calc(100dvh - 230px);padding:13px;scroll-margin-top:14px;position:sticky;top:12px;overflow:auto}.YHuQMG_relatedSource{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:8px;margin:0 0 13px;padding:10px;font-size:11px}.YHuQMG_insightCard{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;margin-bottom:9px;padding:14px;transition:border-color .15s,transform .15s,box-shadow .15s}.YHuQMG_insightCard:hover{border-color:var(--mn-line-strong);transform:translateY(-1px)}.YHuQMG_cardTop{justify-content:space-between;align-items:center;gap:10px;display:flex}.YHuQMG_badges,.YHuQMG_tags,.YHuQMG_entities{flex-wrap:wrap;gap:5px;display:flex}.YHuQMG_badge{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:999px;padding:2px 6px;font-size:9px}.YHuQMG_id{color:var(--mn-faint);font:9px var(--mn-code)}.YHuQMG_content{white-space:pre-wrap;overflow-wrap:anywhere;margin:10px 0;line-height:1.65}.YHuQMG_tags{color:var(--mn-accent);font-size:10px}.YHuQMG_entities{margin-top:7px}.YHuQMG_entities span{border:1px solid var(--mn-line);color:var(--mn-muted);border-radius:5px;padding:2px 6px;font-size:9px}.YHuQMG_cardActions{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:3px;min-height:30px;margin-top:10px;padding-top:8px;display:flex}.YHuQMG_confirmBar{width:100%;color:var(--mn-danger);justify-content:flex-end;align-items:center;gap:5px;font-size:11px;display:flex}.YHuQMG_confirmBar>span{margin-right:auto}.YHuQMG_entityLayout{grid-template-columns:265px minmax(0,1fr);align-items:start;gap:16px;display:grid}.YHuQMG_entityRail{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;padding:13px;position:sticky;top:0}.YHuQMG_entitySearch{grid-template-columns:minmax(0,1fr) auto;gap:7px;display:grid}.YHuQMG_entitySearch input{min-width:0}.YHuQMG_entityHeading{justify-content:space-between;align-items:center;margin:18px 2px 7px;display:flex}.YHuQMG_entityHeading small{color:var(--mn-faint);font-size:9px}.YHuQMG_entityList{gap:3px;display:grid}.YHuQMG_entityList button{min-height:34px;color:var(--mn-muted);cursor:pointer;text-align:left;background:0 0;border:0;border-radius:7px;justify-content:space-between;align-items:center;gap:10px;padding:0 9px;display:flex}.YHuQMG_entityList button:hover,.YHuQMG_entityList button[aria-pressed=true]{color:var(--mn-text);background:var(--mn-hover)}.YHuQMG_entityList strong{color:var(--mn-faint);font:10px var(--mn-code)}.YHuQMG_entityResults>.YHuQMG_emptyState{min-height:360px}.YHuQMG_runtimeComposer,.YHuQMG_runtimeTarget{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px}.YHuQMG_runtimeComposer{background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 5%, var(--mn-layer-1)), var(--mn-layer-1) 55%);margin-bottom:13px;padding:15px}.YHuQMG_runtimeComposerHeading{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:11px;display:flex}.YHuQMG_runtimeComposerHeading h3{margin:0 0 2px;font-size:14px}.YHuQMG_runtimeComposerHeading p{color:var(--mn-muted);margin:0;font-size:10px}.YHuQMG_runtimeComposerHeading>span{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 9px var(--mn-code);border-radius:999px;flex:none;padding:4px 8px}.YHuQMG_runtimeComposer>textarea,.YHuQMG_runtimeEntry textarea{resize:vertical;border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:9px;outline:0;padding:10px 11px;line-height:1.6}.YHuQMG_runtimeComposer>textarea:focus,.YHuQMG_runtimeEntry textarea:focus{border-color:var(--mn-accent)}.YHuQMG_runtimeComposerActions{justify-content:flex-end;align-items:flex-end;gap:9px;margin-top:10px;display:flex}.YHuQMG_runtimeComposerActions label{color:var(--mn-faint);gap:4px;font-size:9px;display:grid}.YHuQMG_runtimeComposerActions select,.YHuQMG_runtimeEntry select{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:135px;height:34px;padding:0 8px}.YHuQMG_runtimeNotice,.YHuQMG_runtimeReadOnly{border:1px solid color-mix(in srgb, var(--mn-success) 28%, var(--mn-line));color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 6%, var(--mn-layer-1));border-radius:9px;margin-bottom:13px;padding:9px 12px;font-size:11px}.YHuQMG_runtimeReadOnly{color:var(--mn-muted);border-color:var(--mn-line);background:var(--mn-layer-1)}.YHuQMG_runtimeGrid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:12px;display:grid}.YHuQMG_runtimeSummaryGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-bottom:10px;display:grid}.YHuQMG_runtimeSummaryCard{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0}.YHuQMG_runtimeBrowser{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;overflow:hidden}.YHuQMG_runtimeBrowserToolbar{border-bottom:1px solid var(--mn-line);justify-content:space-between;align-items:center;gap:12px;padding:10px;display:flex}.YHuQMG_runtimeScopeFilter{flex-wrap:wrap;align-items:center;gap:3px;display:flex}.YHuQMG_runtimeScopeFilter button{min-height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:7px;padding:0 10px}.YHuQMG_runtimeScopeFilter button:hover{background:var(--mn-hover)}.YHuQMG_runtimeScopeFilter button[data-active]{border-color:var(--mn-line);color:var(--mn-text);background:var(--mn-layer-2)}.YHuQMG_runtimeScopeFilter b{color:var(--mn-faint);font:600 10px var(--mn-code);margin-left:4px}.YHuQMG_runtimeFilterQuery{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;align-items:center;gap:7px;width:min(320px,42%);min-width:210px;padding:0 9px;display:flex}.YHuQMG_runtimeFilterQuery>span{color:var(--mn-faint)}.YHuQMG_runtimeFilterQuery input{width:100%;min-width:0;height:32px;color:var(--mn-text);background:0 0;border:0;outline:0}.YHuQMG_runtimeUnifiedList{background:color-mix(in srgb, var(--mn-layer-2) 30%, var(--mn-layer-1));grid-template-columns:1fr;gap:8px;padding:10px;display:grid}.YHuQMG_runtimeEntryBadges{flex-wrap:wrap;align-items:center;gap:5px;display:flex}.YHuQMG_runtimeEntryMeta .YHuQMG_runtimeEntryTarget{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 8%, var(--mn-layer-2));font-family:var(--mn-code)}.YHuQMG_runtimeTarget{min-width:0;overflow:hidden}.YHuQMG_runtimeTargetHeader{justify-content:space-between;align-items:center;gap:14px;padding:14px 15px 9px;display:flex}.YHuQMG_runtimeTargetHeader>div{gap:1px;display:grid}.YHuQMG_runtimeTargetHeader span{color:var(--mn-faint);font:650 9px var(--mn-code);letter-spacing:.08em}.YHuQMG_runtimeTargetHeader h3{margin:0;font-size:15px}.YHuQMG_runtimeTargetHeader>strong{min-width:28px;height:28px;color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 11px var(--mn-code);border-radius:8px;place-items:center;display:grid}.YHuQMG_capacityLine{align-items:center;gap:9px;padding:0 15px;display:flex}.YHuQMG_capacityLine>div{background:var(--mn-layer-2);border-radius:999px;flex:1;height:4px;overflow:hidden}.YHuQMG_capacityLine i{border-radius:inherit;background:var(--mn-success);height:100%;transition:width .25s;display:block}.YHuQMG_capacityLine>span{min-width:88px;color:var(--mn-faint);font:9px var(--mn-code);text-align:right}.YHuQMG_runtimeTargetDescription{min-height:31px;color:var(--mn-muted);margin:8px 15px 12px;font-size:10px}.YHuQMG_runtimeEntries{border-top:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 36%, var(--mn-layer-1));gap:7px;padding:10px;display:grid}.YHuQMG_runtimeEntry{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:9px;padding:11px;position:relative}.YHuQMG_runtimeEntry:before{content:\"\";background:var(--mn-muted);border-radius:0 2px 2px 0;width:2px;position:absolute;top:12px;bottom:12px;left:-1px}.YHuQMG_runtimeEntry[data-importance=critical]:before{background:var(--mn-danger)}.YHuQMG_runtimeEntry[data-importance=low]:before{background:var(--mn-faint);opacity:.45}.YHuQMG_runtimeEntryMeta{justify-content:space-between;align-items:center;gap:12px;display:flex}.YHuQMG_runtimeEntryMeta>span{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:999px;padding:2px 6px;font-size:9px}.YHuQMG_runtimeEntry[data-importance=critical] .YHuQMG_runtimeEntryMeta>span{color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 8%, transparent)}.YHuQMG_runtimeEntryMeta time{color:var(--mn-faint);font:8px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.YHuQMG_runtimeEntry>p{white-space:pre-wrap;overflow-wrap:anywhere;min-height:42px;margin:9px 0;font-size:12px;line-height:1.6}.YHuQMG_runtimeEntry>select{margin-top:7px}.YHuQMG_runtimeEntry footer{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:4px;min-height:30px;margin-top:7px;padding-top:7px;display:flex}.YHuQMG_runtimeEntry footer>span{color:var(--mn-danger);margin-right:auto;font-size:10px}.YHuQMG_runtimeEmpty{min-height:126px;color:var(--mn-faint);text-align:center;align-content:center;place-items:center;gap:5px;display:grid}.YHuQMG_runtimeEmpty>span{font:24px var(--mn-code);opacity:.65}.YHuQMG_runtimeEmpty p{margin:0;font-size:10px}.YHuQMG_runtimeFootnote{color:var(--mn-faint);margin:10px 2px 0;font-size:9px}.YHuQMG_documentSummary{grid-template-columns:.7fr .7fr 1.6fr;gap:9px;margin-bottom:12px;display:grid}.YHuQMG_documentSummary article{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;min-height:91px;padding:13px 14px}.YHuQMG_documentSummary article>span{color:var(--mn-faint);font-size:9px;display:block}.YHuQMG_documentSummary article>strong{font:650 21px/1 var(--mn-code);margin:7px 0 4px;display:block}.YHuQMG_documentSummary article>small{color:var(--mn-muted);font-size:9px}.YHuQMG_documentCapacity>div{background:var(--mn-layer-2);border-radius:999px;height:4px;margin:7px 0 6px;overflow:hidden}.YHuQMG_documentCapacity>div i{border-radius:inherit;background:var(--mn-accent);height:100%;transition:width .3s;display:block}.YHuQMG_documentToolbar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;align-items:center;gap:9px;margin-bottom:12px;padding:9px;display:flex}.YHuQMG_documentToolbar form{flex:1;grid-template-columns:20px minmax(0,1fr) auto;align-items:center;gap:5px;min-width:260px;padding-left:8px;display:grid}.YHuQMG_documentToolbar form>span{color:var(--mn-faint);font:15px var(--mn-code)}.YHuQMG_documentToolbar input,.YHuQMG_documentEditor input,.YHuQMG_documentEditor textarea{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;width:100%;padding:8px 10px}.YHuQMG_documentToolbar input{background:0 0;border-color:#0000;height:34px}.YHuQMG_documentToolbar input:focus,.YHuQMG_documentEditor input:focus,.YHuQMG_documentEditor textarea:focus{border-color:var(--mn-accent)}.YHuQMG_documentToolbar>div{border:1px solid var(--mn-line);background:var(--mn-layer-2);border-radius:8px;align-items:center;gap:3px;padding:3px;display:flex}.YHuQMG_documentToolbar>div button{min-height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:6px;padding:0 10px;font-size:10.5px}.YHuQMG_documentToolbar>div button[data-active]{color:var(--mn-text);background:var(--mn-layer-1);box-shadow:0 1px 3px color-mix(in srgb, var(--mn-text) 8%, transparent)}.YHuQMG_documentToolbar>div b{color:var(--mn-faint);font:600 9px var(--mn-code);margin-left:4px}.YHuQMG_documentWorkspace{grid-template-columns:minmax(250px,310px) minmax(0,1fr);gap:10px;min-height:590px;display:grid}.YHuQMG_documentList,.YHuQMG_documentReader{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;overflow:hidden}.YHuQMG_documentList{align-self:stretch}.YHuQMG_documentList>header{border-bottom:1px solid var(--mn-line);min-height:42px;color:var(--mn-faint);justify-content:space-between;align-items:center;padding:0 12px;font-size:9px;display:flex}.YHuQMG_documentList>header code{color:var(--mn-accent)}.YHuQMG_documentList>button{border:0;border-bottom:1px solid var(--mn-line);width:100%;color:var(--mn-text);text-align:left;cursor:pointer;background:0 0;padding:12px;transition:background-color .15s,box-shadow .15s;display:block}.YHuQMG_documentList>button:hover{background:var(--mn-hover)}.YHuQMG_documentList>button[data-selected]{background:color-mix(in srgb, var(--mn-accent) 7%, var(--mn-layer-1));box-shadow:inset 2px 0 var(--mn-accent)}.YHuQMG_documentList>button>div{justify-content:space-between;align-items:baseline;gap:12px;display:flex}.YHuQMG_documentList>button strong{text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.YHuQMG_documentList>button time{color:var(--mn-faint);font:8px var(--mn-code);flex:none}.YHuQMG_documentList>button p{min-height:30px;color:var(--mn-muted);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:6px 0 9px;font-size:10px;line-height:1.5;display:-webkit-box;overflow:hidden}.YHuQMG_documentList>button footer{color:var(--mn-faint);align-items:center;gap:8px;font-size:9px;display:flex}.YHuQMG_documentList>button footer code{margin-left:auto}.YHuQMG_documentList>button footer em{color:var(--mn-danger);font-style:normal}.YHuQMG_documentListEmpty{min-height:230px;color:var(--mn-muted);text-align:center;align-content:center;place-items:center;gap:4px;padding:22px;display:grid}.YHuQMG_documentListEmpty>span{color:var(--mn-accent);font:28px var(--mn-code);opacity:.6;margin-bottom:6px}.YHuQMG_documentListEmpty p{color:var(--mn-faint);margin:0;font-size:10px}.YHuQMG_documentReader{padding:clamp(16px,2vw,22px)}.YHuQMG_documentReader>.YHuQMG_emptyState{background:0 0;border:0;height:100%}.YHuQMG_documentDetail>header{border-bottom:1px solid var(--mn-line);justify-content:space-between;align-items:flex-start;gap:18px;padding-bottom:15px;display:flex}.YHuQMG_documentDetail>header span{color:var(--mn-accent);font:650 9px var(--mn-code);letter-spacing:.08em;text-transform:uppercase}.YHuQMG_documentDetail>header h3{margin:5px 0 3px;font-size:18px}.YHuQMG_documentDetail>header p{color:var(--mn-muted);margin:0;font-size:11px}.YHuQMG_documentDetail>dl{border-top:1px solid var(--mn-line);border-left:1px solid var(--mn-line);grid-template-columns:2fr .45fr .8fr .55fr;margin:13px 0;display:grid}.YHuQMG_documentDetail>dl>div{border-right:1px solid var(--mn-line);border-bottom:1px solid var(--mn-line);min-width:0;padding:8px 9px}.YHuQMG_documentDetail dt{color:var(--mn-faint);margin-bottom:3px;font-size:8px}.YHuQMG_documentDetail dd{text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:9px;overflow:hidden}.YHuQMG_documentSources{flex-wrap:wrap;align-items:center;gap:5px;margin:11px 0;display:flex}.YHuQMG_documentSources>span{color:var(--mn-faint);margin-right:4px;font-size:9px}.YHuQMG_documentSources code,.YHuQMG_documentArchiveReceipt code{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:5px;padding:3px 6px;font-size:8px}.YHuQMG_markdownBody{overflow-wrap:anywhere;border:1px solid var(--mn-line);min-height:310px;color:var(--mn-text);background:color-mix(in srgb, var(--mn-layer-2) 30%, var(--mn-layer-1));border-radius:10px;margin:16px 0 0;padding:clamp(18px,2.5vw,28px);font-size:13px;line-height:1.78}.YHuQMG_markdownBody>:first-child{margin-top:0}.YHuQMG_markdownBody>:last-child{margin-bottom:0}.YHuQMG_markdownBody h1,.YHuQMG_markdownBody h2,.YHuQMG_markdownBody h3,.YHuQMG_markdownBody h4{color:var(--mn-text);letter-spacing:-.015em;margin:1.55em 0 .65em;line-height:1.3}.YHuQMG_markdownBody h1{border-bottom:1px solid var(--mn-line);padding-bottom:.35em;font-size:1.75em}.YHuQMG_markdownBody h2{border-bottom:1px solid var(--mn-line);padding-bottom:.3em;font-size:1.42em}.YHuQMG_markdownBody h3{font-size:1.18em}.YHuQMG_markdownBody p,.YHuQMG_markdownBody ul,.YHuQMG_markdownBody ol,.YHuQMG_markdownBody blockquote,.YHuQMG_markdownBody table,.YHuQMG_markdownBody pre{margin:.85em 0}.YHuQMG_markdownBody ul,.YHuQMG_markdownBody ol{padding-left:1.6em}.YHuQMG_markdownBody li+li{margin-top:.3em}.YHuQMG_markdownBody blockquote{border-left:3px solid var(--mn-accent);color:var(--mn-muted);background:color-mix(in srgb, var(--mn-accent) 4%, transparent);margin-inline:0;padding:.15em 1em}.YHuQMG_markdownBody code{color:var(--mn-text);background:var(--mn-layer-2);font:.88em/1.55 var(--mn-code);border-radius:5px;padding:.15em .38em}.YHuQMG_markdownBody pre{border:1px solid var(--mn-line);background:var(--mn-layer-2);border-radius:9px;max-width:100%;padding:14px 16px;overflow:auto}.YHuQMG_markdownBody pre code{background:0 0;padding:0;font-size:11px}.YHuQMG_markdownBody a{color:var(--mn-accent);text-underline-offset:3px;text-decoration-thickness:1px}.YHuQMG_markdownBody hr{border:0;border-top:1px solid var(--mn-line);margin:1.8em 0}.YHuQMG_markdownBody table{border-collapse:collapse;max-width:100%;display:block;overflow-x:auto}.YHuQMG_markdownBody th,.YHuQMG_markdownBody td{border:1px solid var(--mn-line);text-align:left;vertical-align:top;padding:8px 10px}.YHuQMG_markdownBody th{background:var(--mn-layer-2);font-weight:600}.YHuQMG_markdownBody img{border-radius:8px;max-width:100%;height:auto}.YHuQMG_documentArchiveReceipt{border:1px solid color-mix(in srgb, var(--mn-success) 28%, var(--mn-line));background:color-mix(in srgb, var(--mn-success) 5%, transparent);border-radius:9px;margin:12px 0;padding:11px 12px}.YHuQMG_documentArchiveReceipt p{color:var(--mn-muted);margin:4px 0 8px;font-size:10px}.YHuQMG_documentArchiveReceipt div{flex-wrap:wrap;gap:5px;display:flex}.YHuQMG_documentDanger{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:7px;min-height:57px;margin-top:13px;padding-top:12px;display:flex}.YHuQMG_documentDanger>div{margin-right:auto}.YHuQMG_documentDanger strong{font-size:11px;display:block}.YHuQMG_documentDanger p{color:var(--mn-faint);margin:2px 0 0;font-size:9px}.YHuQMG_documentDanger>span{color:var(--mn-danger);margin-right:auto;font-size:10px}.YHuQMG_documentEditor{border:1px solid var(--mn-line);background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 5%, var(--mn-layer-1)), var(--mn-layer-1) 55%);border-radius:11px;margin-bottom:12px;padding:15px}.YHuQMG_documentReader>.YHuQMG_documentEditor{background:0 0;border:0;margin:0;padding:0}.YHuQMG_documentEditor>header{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:12px;display:flex}.YHuQMG_documentEditor h3{margin:0;font-size:14px}.YHuQMG_documentEditor header p{color:var(--mn-muted);margin:2px 0 0;font-size:10px}.YHuQMG_documentEditor header>span,.YHuQMG_documentEditor header>code{color:var(--mn-accent);font:650 9px var(--mn-code)}.YHuQMG_documentEditor label{color:var(--mn-faint);gap:4px;margin-top:9px;font-size:9px;display:grid}.YHuQMG_documentEditor textarea{resize:vertical;line-height:1.65}.YHuQMG_documentEditorMeta{grid-template-columns:.8fr 1.2fr;gap:9px;display:grid}.YHuQMG_documentEditorMeta label{margin:0}.YHuQMG_documentEditor footer{justify-content:flex-end;gap:7px;margin-top:11px;display:flex}.YHuQMG_writebackLayout{grid-template-columns:minmax(220px,280px) minmax(0,1fr);align-items:start;gap:15px;display:grid}.YHuQMG_writeGuide,.YHuQMG_supervisedComposer{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px}.YHuQMG_writeGuide{padding:17px}.YHuQMG_writeGuide h3{margin:5px 0 15px;font-size:15px}.YHuQMG_writeGuide ol{counter-reset:gate;gap:13px;margin:0;padding:0;list-style:none;display:grid}.YHuQMG_writeGuide li{counter-increment:gate;grid-template-columns:22px minmax(0,1fr);column-gap:7px;display:grid}.YHuQMG_writeGuide li:before{content:\"0\" counter(gate);color:var(--mn-accent);font:10px var(--mn-code);grid-row:span 2}.YHuQMG_writeGuide li strong{font-size:12px}.YHuQMG_writeGuide li span,.YHuQMG_writeGuide p{color:var(--mn-faint);font-size:10px}.YHuQMG_writeGuide p{border-top:1px solid var(--mn-line);margin:17px 0 0;padding-top:13px}.YHuQMG_supervisedComposer{overflow:hidden}.YHuQMG_supervisedForm{padding:18px}.YHuQMG_supervisedHeading{justify-content:space-between;align-items:flex-start;gap:16px;margin-bottom:16px;display:flex}.YHuQMG_supervisedHeading h3{margin:4px 0 0;font-size:17px}.YHuQMG_sessionReady,.YHuQMG_sessionMissing{font:650 9px var(--mn-code);border-radius:999px;padding:4px 8px}.YHuQMG_sessionReady{color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 10%, transparent)}.YHuQMG_sessionMissing{color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 10%, transparent)}.YHuQMG_supervisedForm textarea{resize:vertical;border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:9px;outline:0;padding:12px;line-height:1.65}.YHuQMG_sessionHint{color:var(--mn-danger);margin:9px 0 0;font-size:11px}.YHuQMG_formGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-top:13px;display:grid}.YHuQMG_fieldWide{grid-column:1/-1}.YHuQMG_formGrid select,.YHuQMG_formGrid input{width:100%;min-width:0}.YHuQMG_formActions{align-items:center;gap:12px;margin-top:15px;display:flex}.YHuQMG_formActions span{color:var(--mn-muted);font-size:11px}.YHuQMG_advancedWrite{border-top:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 45%, var(--mn-layer-1))}.YHuQMG_advancedWrite summary{cursor:pointer;justify-content:space-between;align-items:center;gap:16px;min-height:58px;padding:10px 18px;list-style:none;display:flex}.YHuQMG_advancedWrite summary::-webkit-details-marker{display:none}.YHuQMG_advancedWrite summary>span:first-child{gap:2px;display:grid}.YHuQMG_advancedWrite summary strong{font-size:12px}.YHuQMG_advancedWrite summary small{color:var(--mn-faint);font-size:10px}.YHuQMG_advancedWrite summary>span:last-child{color:var(--mn-accent);font:10px var(--mn-code)}.YHuQMG_advancedWrite[open] summary{border-bottom:1px solid var(--mn-line)}.YHuQMG_advancedWrite[open] summary>span:last-child{font-size:0}.YHuQMG_advancedWrite[open] summary>span:last-child:after{content:\"−\";font-size:13px}.YHuQMG_manualForm{padding:3px 18px 18px}.YHuQMG_manualActions{justify-content:space-between;align-items:center;gap:14px;margin-top:15px;display:flex}.YHuQMG_manualActions p{max-width:520px;color:var(--mn-faint);margin:0;font-size:10px}.YHuQMG_listToolbar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;grid-template-columns:minmax(0,1fr) 170px auto;gap:9px;padding:12px;display:grid}.YHuQMG_listToolbar input,.YHuQMG_listToolbar select{width:100%;min-width:0}.YHuQMG_listNotice{color:var(--mn-faint);margin:10px 0 16px;font-size:10px}.YHuQMG_listNotice span{color:var(--mn-success);font:650 9px var(--mn-code);letter-spacing:.08em;margin-right:7px}.YHuQMG_memoryList{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:9px;display:grid}.YHuQMG_memoryList .YHuQMG_insightCard{height:100%;margin:0}.YHuQMG_listProgress{border-top:1px solid var(--mn-line);min-height:58px;color:var(--mn-faint);justify-content:center;align-items:center;gap:13px;margin-top:12px;padding:10px;font-size:10px;display:flex}.YHuQMG_compactListProgress{border-top:1px solid var(--mn-line);color:var(--mn-faint);text-align:center;justify-items:stretch;gap:7px;margin-top:8px;padding:10px 2px 2px;font-size:10px;display:grid}.YHuQMG_compactListProgress button{width:100%}.YHuQMG_modalBackdrop{z-index:1300;background:#0206178a;justify-content:center;align-items:center;padding:24px;display:flex;position:fixed;inset:0}.YHuQMG_modal{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:14px;flex-direction:column;width:min(680px,100vw - 48px);max-height:calc(100vh - 96px);display:flex;overflow:hidden;box-shadow:0 22px 60px #02061738}.YHuQMG_modal>header{border-bottom:1px solid var(--mn-line);flex:none;justify-content:space-between;align-items:flex-start;gap:18px;padding:15px 18px;display:flex}.YHuQMG_modal>header h2{margin:0;font-size:15px;line-height:22px}.YHuQMG_modal>header p{max-width:64ch;color:var(--mn-muted);margin:3px 0 0;font-size:12px;line-height:1.5}.YHuQMG_modal>div:last-child{min-height:0;padding:18px;overflow-y:auto}.YHuQMG_healthStrip{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;grid-template-columns:repeat(4,minmax(0,1fr));margin-bottom:13px;display:grid;overflow:hidden}.YHuQMG_healthStrip article{box-sizing:border-box;border-right:1px solid var(--mn-line);align-items:flex-start;gap:10px;min-width:0;min-height:78px;padding:14px 15px;display:flex}.YHuQMG_healthStrip article>div{min-width:0}.YHuQMG_healthStrip article:last-child{border-right:0}.YHuQMG_healthStrip small{color:var(--mn-faint);font:650 10px var(--mn-code);letter-spacing:.06em;margin-bottom:4px;display:block}.YHuQMG_healthStrip strong{text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;display:block;overflow:hidden}.YHuQMG_healthStrip p{color:var(--mn-muted);text-overflow:ellipsis;white-space:nowrap;margin:3px 0 0;font-size:10.5px;overflow:hidden}.YHuQMG_healthIndicator{width:7px;height:7px;box-shadow:0 0 0 4px color-mix(in srgb, currentColor 9%, transparent);border-radius:50%;flex:none;margin-top:3px}.YHuQMG_healthGood{color:var(--mn-success);background:currentColor}.YHuQMG_healthBad{color:var(--mn-danger);background:currentColor}.YHuQMG_healthMuted{color:var(--mn-faint);background:currentColor}.YHuQMG_storageDomains{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;margin-bottom:13px;padding:16px}.YHuQMG_storageRoot{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 45%, transparent);border-radius:9px;justify-content:space-between;align-items:center;gap:18px;min-width:0;margin-top:12px;padding:11px 12px;display:flex}.YHuQMG_storageRoot>div:first-child{gap:4px;min-width:0;display:grid}.YHuQMG_storageRoot span,.YHuQMG_storageRoot small{color:var(--mn-faint);font-size:9px}.YHuQMG_storageRoot code{color:var(--mn-muted);text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}.YHuQMG_storageRoot>div:last-child{flex:none;justify-items:end;gap:3px;display:grid}.YHuQMG_storageRoot strong{font:650 11px var(--mn-code)}.YHuQMG_storageAreaGrid{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:8px;display:grid}.YHuQMG_storageAreaGrid article{box-sizing:border-box;border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 30%, var(--mn-layer-1));border-radius:9px;flex-direction:column;min-width:0;min-height:150px;padding:12px;display:flex}.YHuQMG_storageAreaGrid article>header{justify-content:space-between;align-items:center;gap:8px;display:flex}.YHuQMG_storageAreaGrid article>header>div{align-items:center;gap:7px;min-width:0;display:flex}.YHuQMG_storageAreaGrid article>header span{background:var(--mn-faint);border-radius:50%;flex:none;width:6px;height:6px}.YHuQMG_storageAreaGrid article[data-status=ready]>header span{background:var(--mn-success);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 9%, transparent)}.YHuQMG_storageAreaGrid article[data-status=invalid]>header span{background:var(--mn-danger);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-danger) 9%, transparent)}.YHuQMG_storageAreaGrid article>header strong{text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}.YHuQMG_storageAreaGrid article>header em{color:var(--mn-faint);font:normal 8px var(--mn-code);white-space:nowrap}.YHuQMG_storageAreaMetric{align-items:baseline;gap:5px;margin-top:14px;display:flex}.YHuQMG_storageAreaMetric strong{font:650 20px var(--mn-code)}.YHuQMG_storageAreaMetric span{color:var(--mn-faint);font-size:9px}.YHuQMG_storageAreaMetric code{color:var(--mn-muted);margin-left:auto;font-size:9px}.YHuQMG_storageAreaGrid article>p{min-height:28px;color:var(--mn-muted);margin:8px 0;font-size:9px;line-height:1.5}.YHuQMG_storagePath{border-top:1px solid var(--mn-line);color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;margin-top:auto;padding-top:8px;font-size:8px;display:block;overflow:hidden}.YHuQMG_storageAreaGrid article>small{color:var(--mn-danger);margin-top:6px;font-size:8px;line-height:1.4;display:block}.YHuQMG_storageUnavailable{border:1px dashed var(--mn-line);min-height:126px;color:var(--mn-muted);text-align:center;border-radius:9px;place-content:center;gap:5px;margin-top:12px;display:grid}.YHuQMG_storageUnavailable strong{font-size:12px}.YHuQMG_storageUnavailable p{max-width:520px;color:var(--mn-faint);margin:0;font-size:10px}.YHuQMG_storageFootnote{color:var(--mn-faint);margin:11px 0 0;font-size:9px;line-height:1.5}.YHuQMG_statusSectionHeader{justify-content:space-between;align-items:flex-start;gap:12px;display:flex}.YHuQMG_statusSectionHeader h3{margin:4px 0 0;font-size:15px}.YHuQMG_statusSectionHeader p{max-width:590px;color:var(--mn-muted);margin:5px 0 0;font-size:10px}.YHuQMG_phaseBadge{border:1px solid color-mix(in srgb, var(--mn-accent) 25%, var(--mn-line));color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 7%, transparent);font:650 9px var(--mn-code);border-radius:999px;padding:4px 8px}.YHuQMG_statusHeaderActions{align-items:center;gap:8px;display:flex}.YHuQMG_versionDialogBody{gap:12px;display:grid}.YHuQMG_versionChecking{min-height:112px;color:var(--mn-muted);justify-content:center;align-items:center;gap:10px;font-size:12px;display:flex}.YHuQMG_versionChecking span{border:2px solid var(--mn-line);border-top-color:var(--mn-accent);border-radius:50%;width:14px;height:14px;animation:.8s linear infinite YHuQMG_mnemon-spin}@keyframes YHuQMG_mnemon-spin{to{transform:rotate(360deg)}}.YHuQMG_versionError,.YHuQMG_versionResult{border:1px solid color-mix(in srgb, var(--mn-danger) 28%, var(--mn-line));color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 6%, transparent);border-radius:9px;padding:11px 12px}.YHuQMG_versionResult{border-color:color-mix(in srgb, var(--mn-success) 28%, var(--mn-line));color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 6%, transparent)}.YHuQMG_versionError strong,.YHuQMG_versionResult strong{font-size:12px}.YHuQMG_versionError p,.YHuQMG_versionResult p{color:var(--mn-muted);margin:3px 0 0;font-size:11px;line-height:1.5}.YHuQMG_versionList{gap:9px;display:grid}.YHuQMG_versionList article{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 34%, var(--mn-layer-1));border-radius:10px;padding:13px}.YHuQMG_versionList article[data-outdated]{border-color:color-mix(in srgb, var(--mn-accent) 30%, var(--mn-line))}.YHuQMG_versionList article>header{justify-content:space-between;align-items:center;gap:12px;display:flex}.YHuQMG_versionList article>header>div{align-items:center;gap:8px;min-width:0;display:flex}.YHuQMG_versionList article>header strong{font-size:13px}.YHuQMG_versionList article>header span{border:1px solid var(--mn-line);color:var(--mn-muted);font:500 9px var(--mn-code);border-radius:999px;padding:3px 7px}.YHuQMG_versionList article>header em{color:var(--mn-success);font:normal 10px var(--mn-code);white-space:nowrap}.YHuQMG_versionList article[data-outdated]>header em{color:var(--mn-accent)}.YHuQMG_versionNumbers{grid-template-columns:1fr auto 1fr;align-items:end;gap:10px;margin-top:13px;display:grid}.YHuQMG_versionNumbers>div{gap:3px;display:grid}.YHuQMG_versionNumbers small{color:var(--mn-faint);font-size:9px}.YHuQMG_versionNumbers code{font-size:12px}.YHuQMG_versionNumbers>span{color:var(--mn-faint);padding-bottom:1px}.YHuQMG_versionList article>footer{border-top:1px solid var(--mn-line);justify-content:space-between;align-items:flex-end;gap:16px;margin-top:10px;padding-top:10px;display:flex}.YHuQMG_versionList article>footer p{max-width:470px;color:var(--mn-muted);margin:0;font-size:10.5px;line-height:1.5}.YHuQMG_versionList article>footer button{flex:none}.YHuQMG_versionDialogActions{justify-content:space-between;align-items:center;gap:12px;padding-top:2px;display:flex}.YHuQMG_versionDialogActions>span{color:var(--mn-faint);font-size:9px}.YHuQMG_versionDialogActions>div{gap:8px;display:flex}@media (width<=1000px){.YHuQMG_graphLayout{display:block;position:relative}.YHuQMG_graphInspector{width:auto;min-height:0;box-shadow:none;margin-top:10px;position:static;overflow:visible}.YHuQMG_graphInspector[data-empty]{display:none}.YHuQMG_resultLayout{grid-template-columns:1fr}.YHuQMG_relatedPane{grid-row:1;max-height:none;position:static}.YHuQMG_memoryList{grid-template-columns:1fr}.YHuQMG_storageAreaGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.YHuQMG_runtimeGrid,.YHuQMG_runtimeSummaryGrid{grid-template-columns:1fr}.YHuQMG_documentWorkspace{grid-template-columns:minmax(220px,270px) minmax(0,1fr)}.YHuQMG_documentDetail>dl{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (width<=760px){.YHuQMG_shell{min-height:0;overflow:hidden}.YHuQMG_masthead{grid-template-columns:minmax(0,1fr) auto;gap:8px 12px;min-height:76px;padding:10px 14px}.YHuQMG_brandLogo{width:36px;height:36px}.YHuQMG_headerActions{max-width:52vw}.YHuQMG_workspacePicker>span{display:none}.YHuQMG_workspacePicker select{width:min(170px,32vw)}.YHuQMG_statusCluster>span:not(.YHuQMG_statusDot){display:none}.YHuQMG_modalBackdrop{padding:12px}.YHuQMG_modal{width:calc(100vw - 24px);max-height:calc(100vh - 24px)}.YHuQMG_versionList article>footer,.YHuQMG_versionDialogActions{flex-direction:column;align-items:stretch}.YHuQMG_versionDialogActions>div{justify-content:flex-end}.YHuQMG_telemetry{border-top:1px solid var(--mn-line);grid-column:1/-1;justify-content:space-between;padding-top:8px}.YHuQMG_telemetryMetric{text-align:center;flex:1;justify-items:center;gap:3px;min-width:0;padding:0 5px}.YHuQMG_telemetryMetric:first-child{border-left:0}.YHuQMG_topNavigation{padding:0 10px;position:relative}.YHuQMG_topNavigation:after{z-index:2;pointer-events:none;content:\"›\";width:34px;color:var(--mn-faint);background:linear-gradient(90deg, transparent, var(--mn-layer-1) 72%);font:16px var(--mn-code);place-items:center end;padding-right:5px;display:grid;position:absolute;top:0;bottom:0;right:0}.YHuQMG_nav{flex:1;padding-right:26px;scroll-padding-inline:10px 34px}.YHuQMG_navGroup{gap:3px}.YHuQMG_navGroupDivider{height:18px}.YHuQMG_nav button{text-align:center;flex-direction:column;justify-content:center;gap:3px;min-width:60px;padding:4px 3px}.YHuQMG_spaceSummary{display:none}.YHuQMG_navGlyph{line-height:1}.YHuQMG_page{padding:18px 13px calc(170px + env(safe-area-inset-bottom,0px))}.YHuQMG_pageHeader{gap:10px;display:grid}.YHuQMG_pageHeaderMeta{justify-content:space-between}.YHuQMG_entityLayout,.YHuQMG_writebackLayout{grid-template-columns:1fr}.YHuQMG_runtimeComposerHeading,.YHuQMG_runtimeComposerActions{flex-direction:column;align-items:stretch}.YHuQMG_runtimeComposerActions select,.YHuQMG_runtimeComposerActions button{width:100%}.YHuQMG_runtimeBrowserToolbar{flex-direction:column;align-items:stretch}.YHuQMG_runtimeFilterQuery{width:100%;min-width:0}.YHuQMG_documentSummary{grid-template-columns:repeat(2,minmax(0,1fr))}.YHuQMG_documentCapacity{grid-column:1/-1}.YHuQMG_documentToolbar{flex-direction:column;align-items:stretch}.YHuQMG_documentToolbar form{min-width:0}.YHuQMG_documentToolbar>div,.YHuQMG_documentToolbar>button{width:100%}.YHuQMG_documentToolbar>div button{flex:1}.YHuQMG_documentWorkspace{grid-template-columns:1fr;min-height:0}.YHuQMG_documentList{-webkit-overflow-scrolling:touch;max-height:330px;overflow:auto}.YHuQMG_documentReader{min-height:430px}.YHuQMG_documentEditorMeta{grid-template-columns:1fr}.YHuQMG_manualActions{flex-direction:column;align-items:stretch}.YHuQMG_entityRail{position:static}.YHuQMG_searchControls{grid-template-columns:repeat(2,minmax(0,1fr));display:grid}.YHuQMG_searchActions{grid-column:1/-1}.YHuQMG_searchActions>button{flex:1}.YHuQMG_searchControls select{width:100%;min-width:0}.YHuQMG_listToolbar{grid-template-columns:1fr}.YHuQMG_bodyDirectoryHeader{display:grid}.YHuQMG_bodyCreate form{grid-template-columns:1fr}.YHuQMG_graphViewport{min-height:360px}.YHuQMG_graphSvg{height:390px}.YHuQMG_graphCanvasControls{top:7px;right:7px}.YHuQMG_graphCanvasControls span{display:none}.YHuQMG_previewOverlay{padding:10px;padding-bottom:calc(10px + env(safe-area-inset-bottom,0px))}.YHuQMG_previewDialog{max-height:min(84dvh,640px)}.YHuQMG_healthStrip{grid-template-columns:1fr}.YHuQMG_storageRoot{flex-direction:column;align-items:flex-start}.YHuQMG_storageRoot>div:last-child{justify-items:start}.YHuQMG_storageAreaGrid{grid-template-columns:1fr}.YHuQMG_flowLegend span:last-child{width:100%;margin-left:0}.YHuQMG_healthStrip article{border-right:0;border-bottom:1px solid var(--mn-line)}.YHuQMG_healthStrip article:last-child{border-bottom:0}.YHuQMG_workspaceMismatch{flex-direction:column;align-items:stretch;margin-inline:13px}.YHuQMG_workspaceMismatch>button{align-self:flex-start}}@media (width<=520px){.YHuQMG_masthead{min-height:68px}.YHuQMG_brand h1{font-size:16px}.YHuQMG_headerActions{max-width:58vw}.YHuQMG_workspacePicker select{width:min(150px,39vw)}.YHuQMG_telemetryMetric span{font-size:10px}.YHuQMG_nav{scroll-snap-type:x proximity}.YHuQMG_nav button{scroll-snap-align:start;min-width:68px}.YHuQMG_pageHeader h2{font-size:19px}.YHuQMG_pageHeaderMeta{flex-wrap:wrap;align-items:stretch}.YHuQMG_pageHeaderMeta>code{align-items:center;min-height:34px;display:flex}.YHuQMG_pageHeaderMeta>button{flex:1}.YHuQMG_emptyState{text-align:center;flex-direction:column;gap:14px;min-height:190px;padding:24px 18px}.YHuQMG_emptyGlyph{width:62px;height:62px}.YHuQMG_documentDetail>header,.YHuQMG_documentDanger,.YHuQMG_supervisedHeading,.YHuQMG_cardTop{flex-direction:column;align-items:flex-start}.YHuQMG_documentDetail>header>div:last-child,.YHuQMG_documentDetail>header button{width:100%}.YHuQMG_documentDanger>div,.YHuQMG_documentDanger>span{margin-right:0}.YHuQMG_documentDanger>button{width:100%}.YHuQMG_documentDetail>dl{grid-template-columns:1fr}.YHuQMG_markdownBody{padding:16px;font-size:12.5px}.YHuQMG_cardActions,.YHuQMG_confirmBar{flex-wrap:wrap;align-items:stretch}.YHuQMG_cardActions button{flex:1}.YHuQMG_confirmBar>span{width:100%;margin:0 0 4px}.YHuQMG_formActions{flex-direction:column;align-items:stretch}.YHuQMG_formActions button{width:100%}.YHuQMG_formGrid,.YHuQMG_searchControls{grid-template-columns:1fr}}@media (width<=1000px) and (height<=760px){.YHuQMG_shell{min-height:0}.YHuQMG_masthead{min-height:58px}.YHuQMG_telemetryMetric{min-width:0;padding:1px 9px}.YHuQMG_topNavigation{min-height:44px}.YHuQMG_nav button{min-height:42px}.YHuQMG_graphViewport{min-height:300px}.YHuQMG_graphSvg{height:300px}}@media (width<=760px) and (pointer:coarse){.YHuQMG_shell input,.YHuQMG_shell select,.YHuQMG_shell textarea{font-size:16px!important}}@media (prefers-reduced-motion:reduce){.YHuQMG_shell *,.YHuQMG_shell :before,.YHuQMG_shell :after{scroll-behavior:auto!important;transition-duration:.01ms!important;animation-duration:.01ms!important;animation-iteration-count:1!important}.YHuQMG_insightCard:hover{transform:none}.YHuQMG_flowConnector[data-active] i:before{display:none}}";
		...
		var MnemonView_module_css_default = {
			"versionResult": "YHuQMG_versionResult",
			"shell": "YHuQMG_shell",
			"versionList": "YHuQMG_versionList",
			"advancedWrite": "YHuQMG_advancedWrite",
			"fieldWide": "YHuQMG_fieldWide",
			"bodyDirectoryPath": "YHuQMG_bodyDirectoryPath",
			"runtimeTargetDescription": "YHuQMG_runtimeTargetDescription",
			"statusSectionHeader": "YHuQMG_statusSectionHeader",
			"ghostButton": "YHuQMG_ghostButton",
			"nodeBodyLabel": "YHuQMG_nodeBodyLabel",
			"healthMuted": "YHuQMG_healthMuted",
			"graphViewport": "YHuQMG_graphViewport",
			"graphEdge": "YHuQMG_graphEdge",
			"runtimeEntries": "YHuQMG_runtimeEntries",
			"workspace": "YHuQMG_workspace",
			"spaceSummary": "YHuQMG_spaceSummary",
			"bodyDirectory": "YHuQMG_bodyDirectory",
			"insightCard": "YHuQMG_insightCard",
			"runtimeEntryBadges": "YHuQMG_runtimeEntryBadges",
			"healthBad": "YHuQMG_healthBad",
			"memoryList": "YHuQMG_memoryList",
			"versionDialogActions": "YHuQMG_versionDialogActions",
			"markdownBody": "YHuQMG_markdownBody",
			"graphFooter": "YHuQMG_graphFooter",
			"inlineError": "YHuQMG_inlineError",
			"runtimeEntry": "YHuQMG_runtimeEntry",
			"entityList": "YHuQMG_entityList",
			"bodyCreate": "YHuQMG_bodyCreate",
			"cardActions": "YHuQMG_cardActions",
			"statusCluster": "YHuQMG_statusCluster",
			"navGlyph": "YHuQMG_navGlyph",
			"bodyHealth": "YHuQMG_bodyHealth",
			"nodeHalo": "YHuQMG_nodeHalo",
			"bodySwitchTrack": "YHuQMG_bodySwitchTrack",
			"inspectorHeading": "YHuQMG_inspectorHeading",
			"graphSvg": "YHuQMG_graphSvg",
			"inspectorActions": "YHuQMG_inspectorActions",
			"searchControls": "YHuQMG_searchControls",
			"alert": "YHuQMG_alert",
			"formGrid": "YHuQMG_formGrid",
			"runtimeSummaryCard": "YHuQMG_runtimeSummaryCard",
			"offline": "YHuQMG_offline",
			"runtimeBrowser": "YHuQMG_runtimeBrowser",
			"supervisedComposer": "YHuQMG_supervisedComposer",
			"graphNode": "YHuQMG_graphNode",
			"previewDialog": "YHuQMG_previewDialog",
			"searchActions": "YHuQMG_searchActions",
			"documentEditor": "YHuQMG_documentEditor",
			"bodyCardTop": "YHuQMG_bodyCardTop",
			"documentSources": "YHuQMG_documentSources",
			"runtimeBrowserToolbar": "YHuQMG_runtimeBrowserToolbar",
			"sessionMissing": "YHuQMG_sessionMissing",
			"healthStrip": "YHuQMG_healthStrip",
			"storageAreaGrid": "YHuQMG_storageAreaGrid",
			"graphGridLine": "YHuQMG_graphGridLine",
			"manualActions": "YHuQMG_manualActions",
			"topNavigation": "YHuQMG_topNavigation",
			"inspectorEmpty": "YHuQMG_inspectorEmpty",
			"entities": "YHuQMG_entities",
			"storagePath": "YHuQMG_storagePath",
			"phaseBadge": "YHuQMG_phaseBadge",
			"bodyDeleteContent": "YHuQMG_bodyDeleteContent",
			"modalBackdrop": "YHuQMG_modalBackdrop",
			"bodySwitch": "YHuQMG_bodySwitch",
			"agentAnswerHeading": "YHuQMG_agentAnswerHeading",
			"telemetry": "YHuQMG_telemetry",
			"documentList": "YHuQMG_documentList",
			"writeGuide": "YHuQMG_writeGuide",
			"runtimeEmpty": "YHuQMG_runtimeEmpty",
			"emptyState": "YHuQMG_emptyState",
			"documentToolbar": "YHuQMG_documentToolbar",
			"entityResults": "YHuQMG_entityResults",
			"bodyDirectoryHeader": "YHuQMG_bodyDirectoryHeader",
			"brand": "YHuQMG_brand",
			"pageHeader": "YHuQMG_pageHeader",
			"queryField": "YHuQMG_queryField",
			"storageMode": "YHuQMG_storageMode",
			"resultLayout": "YHuQMG_resultLayout",
			"nav": "YHuQMG_nav",
			"listToolbar": "YHuQMG_listToolbar",
			"emptyGlyph": "YHuQMG_emptyGlyph",
			"singleColumn": "YHuQMG_singleColumn",
			"content": "YHuQMG_content",
			"inspectorTitle": "YHuQMG_inspectorTitle",
			"runtimeScopeFilter": "YHuQMG_runtimeScopeFilter",
			"formActions": "YHuQMG_formActions",
			"statusDot": "YHuQMG_statusDot",
			"brandLogo": "YHuQMG_brandLogo",
			"previewMeta": "YHuQMG_previewMeta",
			"tags": "YHuQMG_tags",
			"confirmBar": "YHuQMG_confirmBar",
			"graphLayout": "YHuQMG_graphLayout",
			"page": "YHuQMG_page",
			"id": "YHuQMG_id",
			"runtimeFilterQuery": "YHuQMG_runtimeFilterQuery",
			"healthIndicator": "YHuQMG_healthIndicator",
			"previewOverlay": "YHuQMG_previewOverlay",
			"inspectorMeta": "YHuQMG_inspectorMeta",
			"iconButton": "YHuQMG_iconButton",
			"inspectorLogo": "YHuQMG_inspectorLogo",
			"online": "YHuQMG_online",
			"muted": "YHuQMG_muted",
			"badges": "YHuQMG_badges",
			"storageFootnote": "YHuQMG_storageFootnote",
			"documentWorkspace": "YHuQMG_documentWorkspace",
			"runtimeEntryTarget": "YHuQMG_runtimeEntryTarget",
			"listNotice": "YHuQMG_listNotice",
			"runtimeSummaryGrid": "YHuQMG_runtimeSummaryGrid",
			"runtimeEntryMeta": "YHuQMG_runtimeEntryMeta",
			"runtimeFootnote": "YHuQMG_runtimeFootnote",
			"dangerButton": "YHuQMG_dangerButton",
			"storageRoot": "YHuQMG_storageRoot",
			"versionDialogBody": "YHuQMG_versionDialogBody",
			"flowConnector": "YHuQMG_flowConnector",
			"runtimeUnifiedList": "YHuQMG_runtimeUnifiedList",
			"documentDetail": "YHuQMG_documentDetail",
			"agentAnswer": "YHuQMG_agentAnswer",
			"workspacePicker": "YHuQMG_workspacePicker",
			"graphBackdrop": "YHuQMG_graphBackdrop",
			"relatedSource": "YHuQMG_relatedSource",
			"bodyDeleteConfirm": "YHuQMG_bodyDeleteConfirm",
			"badge": "YHuQMG_badge",
			"entityHeading": "YHuQMG_entityHeading",
			"bodyDeleteSummary": "YHuQMG_bodyDeleteSummary",
			"nodeLabel": "YHuQMG_nodeLabel",
			"sectionHeading": "YHuQMG_sectionHeading",
			"loading": "YHuQMG_loading",
			"nodeCore": "YHuQMG_nodeCore",
			"workspaceMismatch": "YHuQMG_workspaceMismatch",
			"categoryChip": "YHuQMG_categoryChip",
			"relatedPane": "YHuQMG_relatedPane",
			"runtimeNotice": "YHuQMG_runtimeNotice",
			"documentReader": "YHuQMG_documentReader",
			"documentArchiveReceipt": "YHuQMG_documentArchiveReceipt",
			"graphCanvasControls": "YHuQMG_graphCanvasControls",
			"loadingPanel": "YHuQMG_loadingPanel",
			"bodyEdit": "YHuQMG_bodyEdit",
			"runtimeReadOnly": "YHuQMG_runtimeReadOnly",
			"supervisedHeading": "YHuQMG_supervisedHeading",
			"listProgress": "YHuQMG_listProgress",
			"canvas": "YHuQMG_canvas",
			"secondaryButton": "YHuQMG_secondaryButton",
			"runtimeGrid": "YHuQMG_runtimeGrid",
			"writebackLayout": "YHuQMG_writebackLayout",
			"versionError": "YHuQMG_versionError",
			"inspectorTitleRow": "YHuQMG_inspectorTitleRow",
			"cardKicker": "YHuQMG_cardKicker",
			"storageAreaMetric": "YHuQMG_storageAreaMetric",
			"navGroupDivider": "YHuQMG_navGroupDivider",
			"results": "YHuQMG_results",
			"runtimeTarget": "YHuQMG_runtimeTarget",
			"dangerSolidButton": "YHuQMG_dangerSolidButton",
			"bodyEditActions": "YHuQMG_bodyEditActions",
			"runtimeComposer": "YHuQMG_runtimeComposer",
			"flowLegend": "YHuQMG_flowLegend",
			"telemetryMetric": "YHuQMG_telemetryMetric",
			"sessionHint": "YHuQMG_sessionHint",
			"manualForm": "YHuQMG_manualForm",
			"storageDomains": "YHuQMG_storageDomains",
			"pageHeaderMeta": "YHuQMG_pageHeaderMeta",
			"inspectorEye": "YHuQMG_inspectorEye",
			"previewBody": "YHuQMG_previewBody",
			"graphInspector": "YHuQMG_graphInspector",
			"documentDanger": "YHuQMG_documentDanger",
			"bodyEditButton": "YHuQMG_bodyEditButton",
			"compactListProgress": "YHuQMG_compactListProgress",
			"capacityLine": "YHuQMG_capacityLine",
			"searchBar": "YHuQMG_searchBar",
			"storageUnavailable": "YHuQMG_storageUnavailable",
			"graphToolbar": "YHuQMG_graphToolbar",
			"agentCitations": "YHuQMG_agentCitations",
			"cardTop": "YHuQMG_cardTop",
			"documentSummary": "YHuQMG_documentSummary",
			"masthead": "YHuQMG_masthead",
			"graphPanel": "YHuQMG_graphPanel",
			"entityLayout": "YHuQMG_entityLayout",
			"runtimeComposerActions": "YHuQMG_runtimeComposerActions",
			"checking": "YHuQMG_checking",
			"documentListEmpty": "YHuQMG_documentListEmpty",
			"statusHeaderActions": "YHuQMG_statusHeaderActions",
			"supervisedForm": "YHuQMG_supervisedForm",
			"graphLegend": "YHuQMG_graphLegend",
			"runtimeTargetHeader": "YHuQMG_runtimeTargetHeader",
			"modal": "YHuQMG_modal",
			"previewHeading": "YHuQMG_previewHeading",
			"bodyCardActions": "YHuQMG_bodyCardActions",
			"bodyGrid": "YHuQMG_bodyGrid",
			"bodyCard": "YHuQMG_bodyCard",
			"bodyDirectoryEmpty": "YHuQMG_bodyDirectoryEmpty",
			"runtimeComposerHeading": "YHuQMG_runtimeComposerHeading",
			"bodySignal": "YHuQMG_bodySignal",
			"documentCapacity": "YHuQMG_documentCapacity",
			"sessionReady": "YHuQMG_sessionReady",
			"entitySearch": "YHuQMG_entitySearch",
			"entityRail": "YHuQMG_entityRail",
			"versionChecking": "YHuQMG_versionChecking",
			"liveDot": "YHuQMG_liveDot",
			"navGroup": "YHuQMG_navGroup",
			"mnemon-spin": "YHuQMG_mnemon-spin",
			"versionNumbers": "YHuQMG_versionNumbers",
			"headerActions": "YHuQMG_headerActions",
			"healthGood": "YHuQMG_healthGood",
			"primaryButton": "YHuQMG_primaryButton",
			"documentEditorMeta": "YHuQMG_documentEditorMeta"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-staged.adwBzq/src/client/MnemonTurnTail.module.css.mjs
		const css$2 = ".mqcdma_root{min-width:0;margin:2px 0}.mqcdma_bar{cursor:pointer;min-width:0;max-width:100%;height:22px;color:var(--dsw-alias-label-tertiary);background:0 0;border:1px solid #0000;border-radius:6px;align-items:center;gap:6px;padding:0 8px 0 6px;font-size:11px;line-height:22px;display:flex}.mqcdma_bar:hover{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.mqcdma_bar:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.mqcdma_mark{opacity:.8;flex:none;font-size:10px}.mqcdma_label{flex:none;font-weight:600}.mqcdma_metrics{align-items:center;gap:6px;min-width:0;display:inline-flex;overflow:hidden}.mqcdma_metrics span{white-space:nowrap}.mqcdma_failureMetric{color:var(--dsw-alias-state-error-primary,#d44)}.mqcdma_chevron{opacity:.7;flex:none;width:8px;height:8px;margin-left:auto}.mqcdma_chevron:before{content:\"\";border-bottom:1.5px solid;border-right:1.5px solid;width:5px;height:5px;transition:transform .12s;display:block;transform:rotate(45deg)translate(-1px,-1px)}.mqcdma_chevronOpen:before{transform:rotate(-135deg)translate(0)}.mqcdma_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);border-radius:0 8px 8px 0;align-items:center;gap:10px;min-width:0;margin:2px 0 4px;padding:6px 8px;display:flex}.mqcdma_detailLabel{color:var(--dsw-alias-label-caption);letter-spacing:.08em;text-transform:uppercase;flex:none;font-size:10px;font-weight:650}.mqcdma_tools{flex-wrap:wrap;flex:auto;gap:4px;min-width:0;display:flex}.mqcdma_toolChip{cursor:pointer;background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,Consolas, monospace);white-space:nowrap;border:none;border-radius:4px;padding:0 6px;font-size:10px;line-height:18px}.mqcdma_toolChip:hover{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-state-business-primary)}.mqcdma_toolChip:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:1px}";
		...
		var MnemonTurnTail_module_css_default = {
			"chevron": "mqcdma_chevron",
			"chevronOpen": "mqcdma_chevronOpen",
			"mark": "mqcdma_mark",
			"tools": "mqcdma_tools",
			"bar": "mqcdma_bar",
			"failureMetric": "mqcdma_failureMetric",
			"detailLabel": "mqcdma_detailLabel",
			"toolChip": "mqcdma_toolChip",
			"label": "mqcdma_label",
			"metrics": "mqcdma_metrics",
			"details": "mqcdma_details",
			"root": "mqcdma_root"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-staged.adwBzq/src/client/MnemonSaveAction.module.css.mjs
		const css$1 = ".PgWE0a_wrap{display:inline-flex;position:relative}.PgWE0a_button{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.PgWE0a_button:hover,.PgWE0a_button[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.PgWE0a_button:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.PgWE0a_icon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:16px;height:16px}.PgWE0a_panel{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);width:min(340px,100vw - 32px);color:var(--dsw-alias-label-primary);border-radius:10px;padding:10px 12px;font-size:12px;line-height:18px;position:absolute;top:calc(100% + 4px);right:0;box-shadow:0 8px 24px #0000002e}.PgWE0a_panel:popover-open{top:var(--mn-save-panel-top);right:auto;left:var(--mn-save-panel-left);width:var(--mn-save-panel-width);margin:0;position:fixed}.PgWE0a_panelHeader{justify-content:space-between;align-items:center;gap:8px;display:flex}.PgWE0a_panelHeader strong{font-size:12px;font-weight:600}.PgWE0a_close{cursor:pointer;width:20px;height:20px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:5px;font-size:14px;line-height:18px}.PgWE0a_close:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.PgWE0a_hint{color:var(--dsw-alias-label-secondary);margin:6px 0 0;font-size:11px;line-height:16px}.PgWE0a_status{color:var(--dsw-alias-label-tertiary);margin-top:8px;font-size:11px}.PgWE0a_readOnly{background:var(--dsw-alias-state-warn-bg,transparent);color:var(--dsw-alias-state-warn-primary);border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}.PgWE0a_candidate{margin-top:8px;display:block}.PgWE0a_candidate>span{color:var(--dsw-alias-label-caption);letter-spacing:.08em;text-transform:uppercase;margin-bottom:4px;font-size:10px;font-weight:650;display:block}.PgWE0a_candidate textarea{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);resize:vertical;background:var(--dsw-specific-input-major,var(--dsw-alias-bg-base));width:100%;max-height:160px;color:var(--dsw-alias-label-primary);font:12px/18px var(--ds-font-family-code,Consolas, monospace);border-radius:8px;padding:8px 10px;display:block}.PgWE0a_candidate textarea:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.PgWE0a_truncated{color:var(--dsw-alias-label-tertiary);margin-top:4px;font-size:10px;line-height:14px;display:block}.PgWE0a_outcome{background:var(--dsw-alias-state-success-bg,transparent);color:var(--dsw-alias-state-success-primary);border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}.PgWE0a_failure{background:var(--dsw-alias-state-error-bg,transparent);color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}.PgWE0a_submit{cursor:pointer;background:var(--dsw-alias-button-primary-fill,var(--dsw-alias-state-business-primary));width:100%;height:28px;color:var(--dsw-alias-button-primary-text,#fff);border:none;border-radius:7px;margin-top:10px;font-size:12px;font-weight:600;line-height:28px}.PgWE0a_submit:hover:not(:disabled){filter:brightness(1.06)}.PgWE0a_submit:disabled{cursor:default;opacity:.5}.PgWE0a_submit:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}";
		...
		var MnemonSaveAction_module_css_default = {
			"truncated": "PgWE0a_truncated",
			"candidate": "PgWE0a_candidate",
			"wrap": "PgWE0a_wrap",
			"hint": "PgWE0a_hint",
			"readOnly": "PgWE0a_readOnly",
			"status": "PgWE0a_status",
			"failure": "PgWE0a_failure",
			"panelHeader": "PgWE0a_panelHeader",
			"outcome": "PgWE0a_outcome",
			"close": "PgWE0a_close",
			"icon": "PgWE0a_icon",
			"button": "PgWE0a_button",
			"panel": "PgWE0a_panel",
			"submit": "PgWE0a_submit"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-mnemon-css:/private/tmp/dsh-mnemon-staged.adwBzq/src/client/MnemonWorkspace.module.css.mjs
		var import_client = (/* @__PURE__ */ __commonJSMin(((exports) => {
			var m = require("react-dom");
			exports.createRoot = m.createRoot;
			exports.hydrateRoot = m.hydrateRoot;
		})))();
		const css = "[data-pane=conversation]{position:relative}[data-dsh-mnemon-view]{z-index:60;background:var(--dsw-alias-bg-base);min-width:0;min-height:0;display:none;position:absolute;inset:0;overflow:hidden}.zkSRWa_panelView{isolation:isolate}html[data-dsh-mnemon-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [data-dsh-mnemon-view]{display:block}html[data-dsh-mnemon-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [data-pane=conversation]>:not([data-dsh-mnemon-view]),html[data-dsh-mnemon-active]:not([data-dsh-taskboard-active]):not([data-dsh-ssh-active]) [class*=centerCol]>:not([data-dsh-mnemon-view]){display:none!important}.zkSRWa_entry{width:100%;height:32px;color:var(--dsw-alias-label-secondary);white-space:nowrap;cursor:pointer;background:0 0;border:none;border-radius:8px;align-items:center;gap:8px;padding:0 12px;font-size:13px;display:flex}.zkSRWa_entry:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-specific-sidebar-nav-item-hover)}.zkSRWa_entry[data-active]{color:var(--dsw-alias-label-primary);background:var(--dsw-specific-sidebar-nav-item-active);font-weight:600}.zkSRWa_entryIcon{flex:none;justify-content:center;align-items:center;display:inline-flex}.zkSRWa_entryLabel{text-overflow:ellipsis;overflow:hidden}[data-dsh-frame][data-sidebar-collapsed] .zkSRWa_entry{justify-content:center;width:100%;padding:0}[data-dsh-frame][data-sidebar-collapsed] .zkSRWa_entryLabel{display:none}";
		...
		var MnemonWorkspace_module_css_default = {
			"entryIcon": "zkSRWa_entryIcon",
			"entry": "zkSRWa_entry",
			"panelView": "zkSRWa_panelView",
			"entryLabel": "zkSRWa_entryLabel"
		};
		//#endregion
