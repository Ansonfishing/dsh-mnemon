window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$5 = ".P5oC1W_shell.P5oC1W_shell{background:var(--dsw-alias-bg-base)}.P5oC1W_shell .P5oC1W_masthead{background:var(--dsw-alias-bg-base);border-bottom:0;align-items:center;gap:12px;min-height:50px;padding:10px 16px 6px;display:flex}.P5oC1W_shell .P5oC1W_brand{flex:auto;gap:0}.P5oC1W_shell .P5oC1W_brand h1{letter-spacing:0;margin:0;font-size:16px;font-weight:700;line-height:24px}.P5oC1W_shell .P5oC1W_headerActions{flex:0 auto;gap:6px}.P5oC1W_shell .P5oC1W_workspacePicker>span{display:none}.P5oC1W_shell .P5oC1W_workspacePicker select{border-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:8px;width:min(210px,24vw);height:30px;padding-left:10px;font-size:12px}.P5oC1W_shell .P5oC1W_statusCluster{background:0 0;border:0;border-radius:8px;gap:7px;min-height:30px;padding:0 2px 0 8px;font-size:11px}.P5oC1W_shell .P5oC1W_workspaceMismatch{border-radius:8px;margin:8px 16px 0}.P5oC1W_shell .P5oC1W_topNavigation{border-bottom-color:var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);gap:0;min-height:40px;padding:0 16px}.P5oC1W_shell .P5oC1W_topNavigation:after{display:none}.P5oC1W_shell .P5oC1W_nav{flex:1;gap:2px;padding-right:0}.P5oC1W_shell .P5oC1W_navGroup{gap:2px}.P5oC1W_shell .P5oC1W_nav button{gap:0;min-height:40px;padding:0 12px;font-size:13px}.P5oC1W_shell .P5oC1W_nav button strong{font-size:13px;font-weight:500}.P5oC1W_shell .P5oC1W_nav button[aria-current=page] strong{font-weight:600}.P5oC1W_shell .P5oC1W_nav button[aria-current=page]:after{left:8px;right:8px}.P5oC1W_shell .P5oC1W_canvas{background:var(--dsw-alias-bg-base)}.P5oC1W_shell .P5oC1W_canvas>div{width:100%;padding:14px 16px clamp(96px,14vh,150px)}.P5oC1W_shell .P5oC1W_pageHeader{margin-bottom:12px}.P5oC1W_shell .P5oC1W_pageHeader h2{letter-spacing:0;margin-top:0;font-size:16px;line-height:1.35}.P5oC1W_shell .P5oC1W_pageHeader p{font-size:12px;line-height:1.55}.P5oC1W_shell .P5oC1W_inspectorGlyph{border:1px solid var(--dsw-alias-border-l1);width:44px;height:44px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-1);font:20px/1 var(--mn-code);opacity:1;border-radius:10px;place-items:center;margin-bottom:10px;display:grid}@media (width<=760px){.P5oC1W_shell .P5oC1W_masthead{min-height:48px;padding:8px 12px 4px}.P5oC1W_shell .P5oC1W_headerActions{max-width:68vw}.P5oC1W_shell .P5oC1W_workspacePicker select{width:min(170px,38vw)}.P5oC1W_shell .P5oC1W_topNavigation{padding:0 8px}.P5oC1W_shell .P5oC1W_navGroup{gap:0}.P5oC1W_shell .P5oC1W_nav button{text-align:left;flex-direction:row;min-width:max-content;min-height:40px;padding:0 10px}.P5oC1W_shell .P5oC1W_canvas>div{padding:14px 12px calc(170px + env(safe-area-inset-bottom,0px))}.P5oC1W_shell .P5oC1W_workspaceMismatch{margin-inline:12px}}@media (width<=520px){.P5oC1W_shell .P5oC1W_masthead{min-height:46px}.P5oC1W_shell .P5oC1W_brand h1{font-size:16px}.P5oC1W_shell .P5oC1W_headerActions{max-width:62vw}.P5oC1W_shell .P5oC1W_workspacePicker select{width:min(145px,40vw)}}";
