window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function MnemonWorkspace({ connection, sessionId, workspaceId, workspaceSelection }) {
			...
			const storageModeText = storageMode === void 0 ? "—" : storageScopeLabel(t, storageMode);
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [appearance.surface === "buildin" && workspacePicker, /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: statusLoading ? t("header.checking") : status?.healthy === true ? t("header.connected") : t("header.unavailable") }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: MnemonView_module_css_default.iconButton,
