window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-mnemon-css:/root/github.com/omdsh-dev/dsh-mnemon/src/client/MnemonSettingsCard.module.css.mjs
		const css$4 = ".SqmQ5W_card{box-sizing:border-box;width:100%;max-width:720px;color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-bg-layer-1));border-radius:12px;overflow:clip}.SqmQ5W_panelHeader{box-sizing:border-box;align-items:flex-start;gap:20px;min-height:76px;padding:16px;display:flex}.SqmQ5W_headerCopy{flex:1;min-width:0}.SqmQ5W_panelHeader h3{margin:0;font-size:15px;font-weight:600;line-height:22px}.SqmQ5W_panelHeader p{max-width:60ch;color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere;margin:2px 0 0;font-size:12px;line-height:18px}.SqmQ5W_status{background:var(--dsw-alias-bg-layer-2);min-height:22px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;border-radius:999px;flex:none;align-items:center;margin-top:1px;padding:0 8px;font-size:11px;font-weight:500;line-height:18px;display:inline-flex}.SqmQ5W_statusDirty{color:var(--dsw-alias-state-warn-label,var(--dsw-alias-label-primary));background:var(--dsw-alias-interactive-bg-hover)}.SqmQ5W_body{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:16px;padding:16px;display:flex}.SqmQ5W_notice{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;font-size:12px;line-height:18px}.SqmQ5W_notice code{font-family:var(--dsw-font-family-mono,var(--ds-font-family-code,monospace));font-size:.95em}.SqmQ5W_loading{min-height:48px;color:var(--dsw-alias-label-tertiary);text-align:center;margin:0;font-size:12px;line-height:48px}.SqmQ5W_primarySettings{gap:16px;width:100%;max-width:660px;display:grid}.SqmQ5W_interactionGroup{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:10px;gap:14px;width:100%;max-width:660px;margin-top:6px;padding:12px 14px 4px;display:grid}.SqmQ5W_interactionHeader{justify-content:space-between;align-items:center;gap:8px;display:flex}.SqmQ5W_interactionHeader strong{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600;line-height:18px}.SqmQ5W_interactionHeader span{color:var(--dsw-alias-state-success-primary);background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 12%, transparent);border-radius:999px;flex:none;padding:1px 8px;font-size:10px;font-weight:500;line-height:16px}.SqmQ5W_interactionHint{color:var(--dsw-alias-label-secondary);margin:-6px 0 0;font-size:11px;line-height:16px}.SqmQ5W_checkboxLine{cursor:pointer;width:fit-content;min-height:20px;color:var(--dsw-alias-label-secondary);user-select:none;align-items:center;gap:8px;font-size:12px;line-height:18px;display:inline-flex}.SqmQ5W_checkboxLine input{width:14px;height:14px;accent-color:var(--dsw-alias-state-business-primary);cursor:pointer;margin:0}.SqmQ5W_checkboxLine input:disabled{cursor:default}.SqmQ5W_field{gap:6px;min-width:0;display:grid}.SqmQ5W_fieldHeading{align-items:center;gap:6px;min-height:20px;display:flex}.SqmQ5W_fieldTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:500;line-height:18px}.SqmQ5W_overridden{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;flex:none;padding:1px 6px;font-size:10px;font-style:normal;font-weight:400;line-height:16px}.SqmQ5W_reset{color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;background:0 0;border:0;flex:none;margin-left:auto;padding:2px 0;font-size:11px;line-height:16px}.SqmQ5W_reset:hover{color:var(--dsw-alias-label-primary)}.SqmQ5W_reset:disabled{cursor:not-allowed;opacity:.5}.SqmQ5W_field input,.SqmQ5W_field select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:38px;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major,var(--dsw-alias-bg-layer-2));font:inherit;border-radius:8px;outline:0;padding:0 10px;font-size:12px;transition:border-color .12s,box-shadow .12s,background-color .12s}.SqmQ5W_field input{font-family:var(--dsw-font-family-mono,var(--ds-font-family-code,monospace))}.SqmQ5W_field input:focus,.SqmQ5W_field select:focus{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px var(--dsw-alias-interactive-bg-hover)}.SqmQ5W_field input[aria-invalid=true]{border-color:var(--dsw-alias-state-error-primary)}.SqmQ5W_field input:disabled,.SqmQ5W_field select:disabled{cursor:not-allowed;opacity:.55}.SqmQ5W_fieldHint{color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;margin:0;font-size:11px;line-height:16px}.SqmQ5W_feedback:empty{display:none}.SqmQ5W_error,.SqmQ5W_readOnly{background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:7px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.SqmQ5W_error{color:var(--dsw-alias-state-error-primary)}.SqmQ5W_readOnly{color:var(--dsw-alias-label-tertiary)}.SqmQ5W_feedback{gap:6px;display:grid}.SqmQ5W_actions{justify-content:flex-end;gap:8px;padding-top:2px;display:flex}.SqmQ5W_actions button{cursor:pointer;min-width:88px;min-height:34px;font:inherit;touch-action:manipulation;border-radius:999px;padding:7px 14px;font-size:12px;font-weight:500;line-height:18px;transition:background-color .12s,border-color .12s,color .12s,opacity .12s}.SqmQ5W_actions button:disabled{cursor:not-allowed;opacity:.5}.SqmQ5W_actions button:focus-visible,.SqmQ5W_reset:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.SqmQ5W_discard{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3,transparent);border:1px solid var(--dsw-alias-border-l2)}.SqmQ5W_discard:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-solid,var(--dsw-alias-interactive-bg-hover))}.SqmQ5W_save{color:var(--dsw-alias-label-primary-foreground,#fff);background:var(--dsw-alias-button-primary-fill,var(--dsw-alias-state-business-primary));border:1px solid #0000}.SqmQ5W_save:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover,var(--dsw-alias-state-business-primary))}@media (width<=560px){.SqmQ5W_body{padding:14px}.SqmQ5W_panelHeader{flex-direction:column;gap:8px;padding:14px}.SqmQ5W_status{margin-top:0}.SqmQ5W_field input,.SqmQ5W_field select{height:40px}.SqmQ5W_actions button{flex:1}}@media (width<=360px){.SqmQ5W_actions{flex-direction:column-reverse}.SqmQ5W_fieldHeading{flex-wrap:wrap}.SqmQ5W_reset{margin-left:0}}@media (prefers-reduced-motion:reduce){.SqmQ5W_field input,.SqmQ5W_field select,.SqmQ5W_actions button{transition:none}}";
		...
		var MnemonSettingsCard_module_css_default = {
			"discard": "SqmQ5W_discard",
			"field": "SqmQ5W_field",
			"fieldHeading": "SqmQ5W_fieldHeading",
			"headerCopy": "SqmQ5W_headerCopy",
			"fieldTitle": "SqmQ5W_fieldTitle",
			"body": "SqmQ5W_body",
			"overridden": "SqmQ5W_overridden",
			"panelHeader": "SqmQ5W_panelHeader",
			"card": "SqmQ5W_card",
			"primarySettings": "SqmQ5W_primarySettings",
			"loading": "SqmQ5W_loading",
			"fieldHint": "SqmQ5W_fieldHint",
			"notice": "SqmQ5W_notice",
			"status": "SqmQ5W_status",
			"statusDirty": "SqmQ5W_statusDirty",
			"interactionHeader": "SqmQ5W_interactionHeader",
			"interactionHint": "SqmQ5W_interactionHint",
			"reset": "SqmQ5W_reset",
			"feedback": "SqmQ5W_feedback",
			"error": "SqmQ5W_error",
			"readOnly": "SqmQ5W_readOnly",
			"checkboxLine": "SqmQ5W_checkboxLine",
			"interactionGroup": "SqmQ5W_interactionGroup",
			"actions": "SqmQ5W_actions",
			"save": "SqmQ5W_save"
		};
		//#endregion
		...
		const zh = {
			...
			"config.interactionHint": "这些对话内表面默认关闭；开启后保存立即生效，无需重启；关闭某项后对话恢复 DSH 官方默认呈现。",
		...
		const en = {
			...
			"config.interactionHint": "These in-conversation surfaces are off by default; enabling one applies immediately after saving, no restart needed. Disabling one restores DSH's official default presentation.",
		...
		const INTERACTION_ORDER = [
			"interactionToolviews",
			"interactionTurnBar",
			"interactionSaveAction"
		];
			...
			const save = async () => {
				...
				try {
					...
					for (const field of order) {
						...
						if (booleanPath !== void 0) {
							if (reset.has(field)) await scope.unsetPath(booleanPath);
							else await scope.setPath(booleanPath, draft[field] === true);
							continue;
						}
						const stringField = field;
						if (reset.has(stringField) || stringField === "dataDir" && draft.dataDir.trim() === "") await scope.unset(stringField);
						else await scope.set(stringField, draft[stringField].trim());
					}
					setDirty(/* @__PURE__ */ new Set());
					setReset(/* @__PURE__ */ new Set());
				} catch (reason) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: loading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: MnemonSettingsCard_module_css_default.interactionGroup,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: MnemonSettingsCard_module_css_default.interactionHeader,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("config.interactionTitle") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.interactionLive") })]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: MnemonSettingsCard_module_css_default.interactionHint,
									children: t("config.interactionHint")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingField, {
									controlId: "mnemon-interaction-toolviews",
									t,
									label: t("config.interactionToolviews"),
									hint: t("config.interactionToolviewsHint"),
									overridden: interactionMeta("interactionToolviews"),
									resetDisabled: controlsDisabled,
									onReset: () => resetField("interactionToolviews"),
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										className: MnemonSettingsCard_module_css_default.checkboxLine,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											id: "mnemon-interaction-toolviews",
											type: "checkbox",
											checked: draft.interactionToolviews,
											onChange: (event) => edit("interactionToolviews", event.target.checked),
											disabled: controlsDisabled
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.interactionOn") })]
									})
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingField, {
									controlId: "mnemon-interaction-turn-bar",
									t,
									label: t("config.interactionTurnBar"),
									hint: t("config.interactionTurnBarHint"),
									overridden: interactionMeta("interactionTurnBar"),
									resetDisabled: controlsDisabled,
									onReset: () => resetField("interactionTurnBar"),
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										className: MnemonSettingsCard_module_css_default.checkboxLine,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											id: "mnemon-interaction-turn-bar",
											type: "checkbox",
											checked: draft.interactionTurnBar,
											onChange: (event) => edit("interactionTurnBar", event.target.checked),
											disabled: controlsDisabled
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.interactionOn") })]
									})
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SettingField, {
									controlId: "mnemon-interaction-save-action",
									t,
									label: t("config.interactionSaveAction"),
									hint: t("config.interactionSaveActionHint"),
									overridden: interactionMeta("interactionSaveAction"),
									resetDisabled: controlsDisabled,
									onReset: () => resetField("interactionSaveAction"),
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										className: MnemonSettingsCard_module_css_default.checkboxLine,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											id: "mnemon-interaction-save-action",
											type: "checkbox",
											checked: draft.interactionSaveAction,
											onChange: (event) => edit("interactionSaveAction", event.target.checked),
											disabled: controlsDisabled
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("config.interactionOn") })]
									})
								})
		...
		function subscribeMnemonAnchor(sessionId, onAnchor) {
			...
			const handler = (event) => {
				...
				if (anchor !== void 0 && keyOf(anchor.sessionId) === key) onAnchor(anchor);
			};
		...
		*/
		...
		var MnemonClient = class {
			...
			turnActivity(turn) {
				return this.call(MNEMON_READ_CHANNEL, "turn-activity", {
					sessionId: this.sessionId,
					turn
				});
			}
		...
		//#endregion
		//#region \0dsh-mnemon-css:/root/github.com/omdsh-dev/dsh-mnemon/src/client/MnemonView.module.css.mjs
		const css$3 = ".JK_n9q_shell{--mn-bg:var(--dsw-alias-bg-base);--mn-layer-1:var(--dsw-alias-bg-layer-1);--mn-layer-2:var(--dsw-alias-bg-layer-2);--mn-input:var(--dsw-specific-input-major);--mn-text:var(--dsw-alias-label-primary);--mn-muted:var(--dsw-alias-label-secondary);--mn-faint:var(--dsw-alias-label-tertiary);--mn-line:var(--dsw-alias-border-l2);--mn-line-strong:var(--dsw-alias-border-l1);--mn-accent:var(--dsw-alias-state-business-primary);--mn-hover:var(--dsw-alias-interactive-bg-hover);--mn-danger:var(--dsw-alias-state-error-primary);--mn-success:var(--dsw-alias-state-success-primary);--mn-code:var(--ds-font-family-code,\"SFMono-Regular\", Consolas, monospace);--mn-sans:system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif;box-sizing:border-box;min-width:0;height:100%;min-height:600px;color:var(--mn-text);background:var(--mn-bg);font:13px/1.55 var(--mn-sans);-webkit-tap-highlight-color:transparent;flex-direction:column;display:flex;overflow:hidden}.JK_n9q_shell *,.JK_n9q_shell :before,.JK_n9q_shell :after{box-sizing:border-box}.JK_n9q_shell button,.JK_n9q_shell input,.JK_n9q_shell select,.JK_n9q_shell textarea{color:inherit;font:inherit}.JK_n9q_shell button,.JK_n9q_shell select{touch-action:manipulation}.JK_n9q_shell button:focus-visible,.JK_n9q_shell input:focus-visible,.JK_n9q_shell select:focus-visible,.JK_n9q_shell textarea:focus-visible,.JK_n9q_shell summary:focus-visible,.JK_n9q_shell [role=button]:focus-visible{outline:2px solid var(--mn-accent);outline-offset:2px}.JK_n9q_masthead{border-bottom:1px solid var(--mn-line);background:radial-gradient(circle at 70% -70%, color-mix(in srgb, var(--mn-accent) 12%, transparent), transparent 42%), var(--mn-bg);flex:none;grid-template-columns:minmax(260px,1fr) auto auto;align-items:center;gap:clamp(14px,2vw,28px);min-height:68px;padding:10px clamp(18px,2.5vw,32px);display:grid}.JK_n9q_brand{align-items:center;gap:11px;min-width:0;display:flex}.JK_n9q_brandLogo{width:38px;height:38px;box-shadow:0 0 0 1px var(--mn-line-strong);border-radius:9px;flex:none;overflow:hidden}.JK_n9q_brand h1{letter-spacing:-.02em;margin:1px 0 0;font-size:17px;line-height:1.15}.JK_n9q_cardKicker,.JK_n9q_sectionHeading>div>span,.JK_n9q_entityHeading>span,.JK_n9q_inspectorHeading>span{color:var(--mn-faint);font:650 9px/1.2 var(--mn-code);letter-spacing:.12em;text-transform:uppercase}.JK_n9q_statusCluster{border:1px solid var(--mn-line-strong);min-height:34px;color:var(--mn-muted);background:var(--mn-layer-1);border-radius:9px;flex:none;align-items:center;gap:8px;padding:0 4px 0 11px;font-size:11px;display:flex}.JK_n9q_statusDot{border-radius:50%;width:6px;height:6px}.JK_n9q_online{background:var(--mn-success);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 15%, transparent)}.JK_n9q_offline{background:var(--mn-danger);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-danger) 14%, transparent)}.JK_n9q_checking{background:var(--mn-faint);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-faint) 12%, transparent)}.JK_n9q_iconButton{width:32px;height:32px;color:inherit;cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;display:grid}.JK_n9q_iconButton:hover{color:var(--mn-accent);background:var(--mn-hover)}.JK_n9q_alert,.JK_n9q_inlineError{border:1px solid color-mix(in srgb, var(--mn-danger) 32%, transparent);color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 7%, var(--mn-layer-1));border-radius:9px;padding:10px 13px;font-size:12px}.JK_n9q_alert{flex-direction:column;flex:none;margin:10px clamp(18px,2.5vw,32px) 0;display:flex}.JK_n9q_telemetry{align-items:center;min-width:0;display:flex}.JK_n9q_telemetryMetric{border-left:1px solid var(--mn-line);gap:2px;min-width:72px;padding:1px 14px;display:grid}.JK_n9q_telemetryMetric span{color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;font-size:9px;overflow:hidden}.JK_n9q_telemetryMetric strong{font:650 13px/1 var(--mn-code);font-variant-numeric:tabular-nums}.JK_n9q_workspace{flex-direction:column;flex:1;min-height:0;display:flex}.JK_n9q_topNavigation{border-bottom:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-1) 72%, var(--mn-bg));flex:none;justify-content:space-between;align-items:stretch;gap:14px;min-width:0;min-height:48px;padding:0 clamp(18px,2.5vw,32px);display:flex}.JK_n9q_nav{overscroll-behavior-inline:contain;scrollbar-width:none;align-items:stretch;gap:10px;min-width:0;display:flex;overflow-x:auto}.JK_n9q_nav::-webkit-scrollbar{display:none}.JK_n9q_navGroup{align-items:stretch;gap:14px;min-width:0;display:flex}.JK_n9q_navGroupDivider{background:var(--mn-line);flex:none;align-self:center;width:1px;height:22px}.JK_n9q_nav button{min-width:max-content;min-height:44px;color:var(--mn-muted);text-align:left;cursor:pointer;background:0 0;border:0;align-items:center;gap:7px;padding:0 3px;display:flex;position:relative}.JK_n9q_nav button:hover,.JK_n9q_nav button[aria-current=page]{color:var(--mn-text)}.JK_n9q_nav button[aria-current=page]:after{content:\"\";background:var(--mn-accent);border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.JK_n9q_nav button[aria-current=page] .JK_n9q_navGlyph{color:var(--mn-accent)}.JK_n9q_nav button>span:last-child{min-width:0;display:block}.JK_n9q_nav button strong{font-size:12px;font-weight:600}.JK_n9q_nav button small{display:none}.JK_n9q_navGlyph{color:var(--mn-faint);font:600 13px/1 var(--mn-code)}@media (width>=1000px){.JK_n9q_nav button{min-height:50px}.JK_n9q_nav button small{color:var(--mn-faint);margin-top:1px;font-size:9px;line-height:1.3;display:block}}.JK_n9q_spaceSummary{border-left:1px solid var(--mn-line);flex:none;grid-template-columns:minmax(0,1fr) auto;align-content:center;gap:1px 9px;min-width:142px;padding:0 0 0 14px;display:grid}.JK_n9q_spaceSummary>span{color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;font-size:9px;overflow:hidden}.JK_n9q_spaceSummary code{color:var(--mn-accent);font:650 12px/1 var(--mn-code);grid-row:span 2;align-self:center}.JK_n9q_spaceSummary small{color:var(--mn-faint);font-size:9px}.JK_n9q_canvas{overscroll-behavior:contain;scroll-behavior:auto;-webkit-overflow-scrolling:touch;background:var(--mn-bg);flex:1;min-width:0;overflow:auto}.JK_n9q_page{width:min(1320px,100%);min-height:100%;margin:0 auto;padding:clamp(18px,2.2vw,28px) clamp(18px,2.8vw,34px) clamp(150px,18vh,190px)}.JK_n9q_pageHeader{justify-content:space-between;align-items:flex-start;gap:24px;margin-bottom:16px;display:flex}.JK_n9q_pageHeader h2{letter-spacing:-.025em;margin:2px 0;font-size:20px;line-height:1.2}.JK_n9q_pageHeader p{max-width:72ch;color:var(--mn-muted);margin:0;font-size:12px;line-height:1.65}.JK_n9q_pageHeaderMeta{flex:none;align-items:center;gap:9px;display:flex}.JK_n9q_pageHeaderMeta>code{border:1px solid var(--mn-line);color:var(--mn-faint);background:var(--mn-layer-1);font:600 9px/1 var(--mn-code);letter-spacing:.06em;border-radius:7px;padding:6px 8px}.JK_n9q_primaryButton,.JK_n9q_secondaryButton,.JK_n9q_ghostButton,.JK_n9q_dangerButton,.JK_n9q_dangerSolidButton{cursor:pointer;border-radius:8px;min-height:36px;padding:0 13px;font-size:12px;transition:border-color .14s,background-color .14s,color .14s,transform .14s}.JK_n9q_primaryButton{border:1px solid var(--mn-accent);color:#fff;background:var(--mn-accent)}.JK_n9q_secondaryButton{border:1px solid var(--mn-line-strong);color:var(--mn-text);background:var(--mn-layer-1)}.JK_n9q_ghostButton,.JK_n9q_dangerButton{background:0 0;border:1px solid #0000;min-height:32px;padding:0 9px}.JK_n9q_ghostButton{color:var(--mn-muted)}.JK_n9q_dangerButton{color:var(--mn-danger)}.JK_n9q_dangerSolidButton{border:1px solid var(--mn-danger);color:#fff;background:var(--mn-danger);min-height:29px}.JK_n9q_primaryButton:hover,.JK_n9q_secondaryButton:hover,.JK_n9q_ghostButton:hover,.JK_n9q_dangerButton:hover{filter:brightness(.98);background-color:var(--mn-hover)}.JK_n9q_primaryButton:hover{background-color:var(--mn-accent)}.JK_n9q_shell button:disabled{cursor:not-allowed;opacity:.48}.JK_n9q_emptyState{border:1px dashed var(--mn-line-strong);background:color-mix(in srgb, var(--mn-layer-1) 50%, transparent);border-radius:13px;justify-content:center;align-items:center;gap:22px;min-height:220px;padding:30px;display:flex}.JK_n9q_emptyGlyph{border:1px solid color-mix(in srgb, var(--mn-accent) 35%, var(--mn-line));width:76px;height:76px;color:var(--mn-accent);background:radial-gradient(circle, color-mix(in srgb, var(--mn-accent) 12%, transparent), transparent 65%);font:500 26px/1 var(--mn-code);border-radius:50%;flex:none;place-items:center;display:grid}.JK_n9q_emptyState h3{margin:0 0 5px;font-size:16px}.JK_n9q_emptyState p{max-width:500px;color:var(--mn-muted);margin:0}.JK_n9q_loadingPanel{border:1px solid var(--mn-line);min-height:220px;color:var(--mn-muted);background:var(--mn-layer-1);border-radius:13px;place-items:center;display:grid}.JK_n9q_inlineError{margin:0 0 14px}.JK_n9q_muted,.JK_n9q_loading{color:var(--mn-faint);padding:16px 0;font-size:12px}.JK_n9q_bodyDirectory{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-1) 72%, var(--mn-bg));border-radius:11px;margin-bottom:12px;padding:12px 14px}.JK_n9q_bodyDirectoryHeader{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:10px;display:flex}.JK_n9q_bodyDirectoryHeader h3{margin:1px 0;font-size:13px}.JK_n9q_bodyDirectoryHeader p{color:var(--mn-muted);margin:0;font-size:10px}.JK_n9q_bodyDirectoryPath{max-width:min(62vw,720px);color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;margin-top:4px;font-size:9px;display:block;overflow:hidden}.JK_n9q_bodyDirectoryHeader>strong{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 9px var(--mn-code);border-radius:999px;flex:none;padding:5px 8px}.JK_n9q_bodyGrid{grid-template-columns:repeat(auto-fit,minmax(245px,1fr));gap:7px;display:grid}.JK_n9q_bodyDirectoryEmpty{border:1px dashed color-mix(in srgb, var(--mn-line) 84%, transparent);min-height:92px;color:var(--mn-muted);border-radius:12px;grid-column:1/-1;justify-content:center;align-items:center;gap:14px;display:flex}.JK_n9q_bodyDirectoryEmpty>span{opacity:.6;font-size:28px}.JK_n9q_bodyDirectoryEmpty strong{color:var(--mn-text);display:block}.JK_n9q_bodyDirectoryEmpty p{margin:3px 0 0;font-size:10px}.JK_n9q_bodyCard{--mn-body-accent:var(--mn-success);border:1px solid var(--mn-line);background:var(--mn-layer-1);opacity:.7;border-radius:9px;min-width:0;padding:9px 10px;transition:opacity .18s,border-color .18s}.JK_n9q_bodyCard[data-active]{border-color:color-mix(in srgb, var(--mn-body-accent) 42%, var(--mn-line));opacity:1;box-shadow:inset 0 1px 0 color-mix(in srgb, var(--mn-body-accent) 10%, transparent)}.JK_n9q_bodyCardTop{grid-template-columns:7px minmax(0,1fr) auto;align-items:center;gap:8px;display:grid}.JK_n9q_bodySignal{background:var(--mn-faint);border-radius:50%;width:7px;height:7px}.JK_n9q_bodyCard[data-active] .JK_n9q_bodySignal{background:var(--mn-body-accent);box-shadow:0 0 0 4px color-mix(in srgb, var(--mn-body-accent) 14%, transparent)}.JK_n9q_bodyCard:not([data-healthy]) .JK_n9q_bodySignal{background:var(--mn-danger);box-shadow:0 0 0 4px color-mix(in srgb, var(--mn-danger) 12%, transparent)}.JK_n9q_bodyCardTop>div{min-width:0;display:grid}.JK_n9q_bodyCardTop strong{text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.JK_n9q_bodyCardTop code{color:var(--mn-faint);font:9px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.JK_n9q_bodyHealth{color:var(--mn-success);font:650 8px var(--mn-code);letter-spacing:.07em;text-transform:uppercase}.JK_n9q_bodyCard:not([data-healthy]) .JK_n9q_bodyHealth{color:var(--mn-danger)}.JK_n9q_bodySwitch{min-height:32px;color:var(--mn-faint);cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:0 1px;font-size:9.5px;display:flex}.JK_n9q_bodySwitchTrack{border:1px solid var(--mn-line-strong);background:var(--mn-layer-2);border-radius:999px;flex:none;width:29px;height:17px;transition:border-color .18s,background-color .18s;position:relative}.JK_n9q_bodySwitchTrack i{background:var(--mn-faint);border-radius:50%;width:11px;height:11px;transition:transform .2s cubic-bezier(.2,.8,.2,1),background-color .18s;position:absolute;top:2px;left:2px}.JK_n9q_bodySwitch:hover{color:var(--mn-text)}.JK_n9q_bodySwitch:hover .JK_n9q_bodySwitchTrack{border-color:var(--mn-body-accent)}.JK_n9q_bodySwitch[aria-checked=true]{color:var(--mn-text)}.JK_n9q_bodySwitch[aria-checked=true] .JK_n9q_bodySwitchTrack{border-color:color-mix(in srgb, var(--mn-body-accent) 65%, var(--mn-line));background:color-mix(in srgb, var(--mn-body-accent) 25%, var(--mn-layer-2))}.JK_n9q_bodySwitch[aria-checked=true] .JK_n9q_bodySwitchTrack i{background:var(--mn-body-accent);transform:translate(12px)}.JK_n9q_bodyCardActions{align-items:center;gap:6px;display:flex}.JK_n9q_bodyEditButton{width:28px;height:28px;color:var(--mn-muted);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:7px;place-items:center;font-size:12px;display:grid}.JK_n9q_bodyEditButton:hover{color:var(--mn-text);border-color:var(--mn-line);background:var(--mn-hover)}.JK_n9q_bodyEdit{gap:9px;padding-top:2px;display:grid}.JK_n9q_bodyEdit label{color:var(--mn-faint);gap:4px;font-size:9px;display:grid}.JK_n9q_bodyEdit input,.JK_n9q_bodyEdit textarea{border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:8px;outline:0;padding:7px 9px;font-size:12px;line-height:1.5}.JK_n9q_bodyEdit textarea{resize:vertical}.JK_n9q_bodyEdit input:focus,.JK_n9q_bodyEdit textarea:focus{border-color:var(--mn-accent)}.JK_n9q_bodyEditActions{justify-content:flex-end;gap:7px;display:flex}.JK_n9q_bodyCard>p{min-height:15px;color:var(--mn-muted);margin:7px 0;font-size:10px;line-height:1.45}.JK_n9q_bodyCard footer{border-top:1px solid var(--mn-line);color:var(--mn-faint);flex-wrap:wrap;gap:5px 11px;padding-top:6px;font-size:9px;display:flex}.JK_n9q_bodyCreate{border-top:1px solid var(--mn-line);margin-top:10px;padding-top:8px}.JK_n9q_bodyCreate summary{cursor:pointer;width:max-content;color:var(--mn-accent);font-size:10px;list-style:none}.JK_n9q_bodyCreate summary::-webkit-details-marker{display:none}.JK_n9q_bodyCreate form{grid-template-columns:minmax(130px,.7fr) minmax(150px,.9fr) minmax(230px,1.7fr) auto;gap:7px;margin-top:9px;display:grid}.JK_n9q_bodyCreate input{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:0;height:34px;padding:0 9px}.JK_n9q_bodyCreate input:focus{border-color:var(--mn-accent)}.JK_n9q_graphLayout{grid-template-columns:minmax(0,1fr) minmax(240px,270px);gap:10px;display:grid}.JK_n9q_graphPanel,.JK_n9q_graphInspector{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px}.JK_n9q_graphPanel{min-width:0;overflow:hidden}.JK_n9q_graphToolbar,.JK_n9q_graphFooter{min-height:43px;color:var(--mn-muted);justify-content:space-between;align-items:center;gap:14px;padding:0 13px;font-size:10px;display:flex}.JK_n9q_graphToolbar{border-bottom:1px solid var(--mn-line)}.JK_n9q_graphToolbar>div:first-child{align-items:center;gap:7px;display:flex}.JK_n9q_graphToolbar small{color:var(--mn-faint)}.JK_n9q_liveDot{background:var(--mn-success);width:6px;height:6px;box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 15%, transparent);border-radius:50%}.JK_n9q_graphLegend{flex-wrap:wrap;justify-content:flex-end;gap:5px 10px;display:flex}.JK_n9q_graphLegend span{align-items:center;gap:4px;display:flex}.JK_n9q_graphLegend span:before{content:\"\";background:var(--edge-color);border-radius:2px;width:13px;height:2px}.JK_n9q_graphLegend [data-edge=temporal]{--edge-color:#87909f}.JK_n9q_graphLegend [data-edge=scope]{--edge-color:#708199}.JK_n9q_graphLegend [data-edge=scope]:before{background:repeating-linear-gradient(90deg, var(--edge-color) 0 4px, transparent 4px 7px)}.JK_n9q_graphLegend [data-edge=semantic]{--edge-color:#4d7cfe}.JK_n9q_graphLegend [data-edge=causal]{--edge-color:#ef6b5b}.JK_n9q_graphLegend [data-edge=entity]{--edge-color:#22a879}.JK_n9q_graphViewport{background:radial-gradient(circle at 50% 48%, color-mix(in srgb, var(--mn-accent) 6%, transparent), transparent 47%);min-height:clamp(390px,42vw,560px);position:relative;overflow:hidden}.JK_n9q_graphCanvasControls{z-index:2;border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-1) 88%, transparent);box-shadow:0 6px 18px color-mix(in srgb, var(--mn-text) 7%, transparent);backdrop-filter:blur(10px);border-radius:9px;align-items:center;gap:5px;padding:4px;display:flex;position:absolute;top:10px;right:10px}.JK_n9q_graphCanvasControls span{color:var(--mn-faint);font:9px var(--mn-code);align-items:center;gap:5px;padding:0 6px;display:flex}.JK_n9q_graphCanvasControls span i{background:var(--mn-accent);width:5px;height:5px;box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-accent) 12%, transparent);border-radius:50%}.JK_n9q_graphCanvasControls button{min-height:30px;color:var(--mn-muted);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;padding:0 9px;font-size:9.5px}.JK_n9q_graphCanvasControls button:hover,.JK_n9q_graphCanvasControls button[data-active]{border-color:var(--mn-line);color:var(--mn-text);background:var(--mn-hover)}.JK_n9q_graphCanvasControls button[data-active]{color:var(--mn-accent)}.JK_n9q_graphSvg{touch-action:pan-y pinch-zoom;user-select:none;width:100%;height:clamp(390px,42vw,560px);display:block}.JK_n9q_graphBackdrop{fill:var(--mn-layer-1)}.JK_n9q_graphGridLine{stroke:var(--mn-line);stroke-width:.6px;opacity:.5}.JK_n9q_graphEdge{fill:none;stroke:#87909f;stroke-width:1px;opacity:.32;vector-effect:non-scaling-stroke}.JK_n9q_graphEdge[data-edge=scope]{stroke:#708199;stroke-dasharray:4 5;opacity:.28}.JK_n9q_graphEdge[data-edge=semantic]{stroke:#4d7cfe;opacity:.48}.JK_n9q_graphEdge[data-edge=causal]{stroke:#ef6b5b;opacity:.52}.JK_n9q_graphEdge[data-edge=entity]{stroke:#22a879;stroke-width:1.45px;opacity:.78}.JK_n9q_graphNode{--node:#8290a8;cursor:grab;touch-action:none;outline:none}.JK_n9q_graphNode[data-dragging]{cursor:grabbing}.JK_n9q_graphNode[data-category=decision]{--node:#ef8354}.JK_n9q_graphNode[data-category=preference]{--node:#a879e1}.JK_n9q_graphNode[data-category=fact]{--node:#4d7cfe}.JK_n9q_graphNode[data-category=insight]{--node:#19a77d}.JK_n9q_graphNode[data-category=context]{--node:#d8a624}.JK_n9q_graphNode[data-kind=space]{--node:var(--mn-success)}.JK_n9q_graphNode[data-kind=entity]{--node:#2b9db9}.JK_n9q_nodeHalo{fill:color-mix(in srgb, var(--node) 18%, var(--mn-layer-1));stroke:color-mix(in srgb, var(--node) 60%, var(--mn-layer-1));stroke-width:1.5px;transition:r .16s}.JK_n9q_nodeCore{fill:var(--node)}.JK_n9q_nodeLabel{fill:var(--mn-muted);font:10px var(--mn-code);pointer-events:auto}.JK_n9q_nodeBodyLabel{fill:var(--mn-faint);font:650 8px var(--mn-code);letter-spacing:.04em;pointer-events:auto}.JK_n9q_graphSvg[data-density=sparse] .JK_n9q_nodeLabel{font-size:12px}.JK_n9q_graphNode:hover .JK_n9q_nodeHalo,.JK_n9q_graphNode:focus .JK_n9q_nodeHalo,.JK_n9q_graphNode[data-selected] .JK_n9q_nodeHalo{fill:color-mix(in srgb, var(--node) 28%, var(--mn-layer-1));stroke:var(--node)}.JK_n9q_graphNode[data-selected] .JK_n9q_nodeLabel{fill:var(--mn-text);font-weight:650}.JK_n9q_graphFooter{border-top:1px solid var(--mn-line);min-height:38px;color:var(--mn-faint)}.JK_n9q_graphInspector{min-width:0;min-height:calc(clamp(390px,42vw,560px) + 83px);padding:15px;overflow:hidden}.JK_n9q_inspectorEmpty{text-align:center;flex-direction:column;justify-content:center;align-items:center;height:100%;display:flex}.JK_n9q_inspectorLogo{opacity:.72;border-radius:11px;width:54px;height:54px;margin-bottom:15px}.JK_n9q_inspectorEmpty h3{margin:7px 0 3px;font-size:14px}.JK_n9q_inspectorEmpty p{color:var(--mn-faint);margin:0;font-size:11px}.JK_n9q_inspectorHeading{justify-content:space-between;align-items:center;display:flex}.JK_n9q_inspectorHeading button,.JK_n9q_sectionHeading button{width:32px;height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;display:grid}.JK_n9q_inspectorHeading button:hover,.JK_n9q_sectionHeading button:hover{background:var(--mn-hover)}.JK_n9q_categoryChip{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 10%, transparent);border-radius:999px;margin-top:24px;padding:3px 8px;font-size:10px;display:inline-flex}.JK_n9q_inspectorTitleRow{align-items:flex-start;gap:8px;min-width:0;margin:12px 0 20px;display:flex}.JK_n9q_inspectorTitle{overflow-wrap:anywhere;white-space:pre-wrap;-webkit-line-clamp:6;-webkit-box-orient:vertical;flex:1;min-width:0;margin:0;font-size:14px;line-height:1.6;display:-webkit-box;overflow:hidden}.JK_n9q_inspectorEye{border:1px solid var(--mn-line);width:27px;height:27px;color:var(--mn-muted);background:var(--mn-layer-1);cursor:pointer;border-radius:7px;flex:none;place-items:center;transition:color .15s,border-color .15s,background-color .15s;display:grid}.JK_n9q_inspectorEye:hover{color:var(--mn-accent);border-color:var(--mn-line-strong);background:var(--mn-hover)}.JK_n9q_inspectorMeta{margin:0}.JK_n9q_inspectorMeta>div{border-top:1px solid var(--mn-line);gap:3px;padding:11px 0;display:grid}.JK_n9q_inspectorMeta dt{color:var(--mn-faint);font:9px var(--mn-code);text-transform:uppercase}.JK_n9q_inspectorMeta dd{overflow-wrap:anywhere;color:var(--mn-muted);margin:0;font-size:11px}.JK_n9q_inspectorActions{gap:8px;margin-top:20px;display:grid}.JK_n9q_previewOverlay{z-index:40;background:color-mix(in srgb, var(--mn-bg) 58%, transparent);backdrop-filter:blur(4px);place-items:center;padding:clamp(16px,4vw,48px);display:grid;position:fixed;inset:0}.JK_n9q_previewDialog{border:1px solid var(--mn-line-strong);background:var(--mn-layer-1);width:min(680px,100%);max-height:min(76dvh,640px);box-shadow:0 24px 64px color-mix(in srgb, var(--mn-text) 20%, transparent);border-radius:13px;flex-direction:column;display:flex;overflow:hidden}.JK_n9q_previewHeading{border-bottom:1px solid var(--mn-line);flex:none;justify-content:space-between;align-items:center;gap:12px;min-height:46px;padding:0 14px 0 16px;display:flex}.JK_n9q_previewHeading>span{color:var(--mn-accent);font:650 9px/1.2 var(--mn-code);letter-spacing:.08em;text-transform:uppercase}.JK_n9q_previewHeading button{width:32px;height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:7px;place-items:center;font-size:15px;display:grid}.JK_n9q_previewHeading button:hover{background:var(--mn-hover)}.JK_n9q_previewMeta{border-bottom:1px solid var(--mn-line);color:var(--mn-faint);font:9px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;flex:none;padding:8px 16px;overflow:hidden}.JK_n9q_previewBody{-webkit-overflow-scrolling:touch;min-height:0;padding:14px 16px 18px;overflow:auto}.JK_n9q_previewBody p{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--mn-text);margin:0;font-size:13px;line-height:1.7}.JK_n9q_searchBar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:13px;margin-bottom:18px;padding:13px}.JK_n9q_queryField{border:1px solid var(--mn-line-strong);background:var(--mn-input);border-radius:9px;grid-template-columns:24px minmax(0,1fr) 24px;align-items:center;gap:5px;padding:0 10px;display:grid}.JK_n9q_queryField>span{color:var(--mn-accent);font:18px var(--mn-code)}.JK_n9q_queryField input{background:0 0;border:0;outline:0;width:100%;height:42px}.JK_n9q_queryField kbd{color:var(--mn-faint);font:11px var(--mn-code)}.JK_n9q_searchControls{justify-content:flex-end;align-items:flex-end;gap:10px;padding-top:10px;display:flex}.JK_n9q_searchActions{align-items:center;gap:7px;display:flex}.JK_n9q_agentAnswer{border:1px solid color-mix(in srgb, var(--mn-accent) 30%, var(--mn-line));background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 7%, var(--mn-layer-1)), var(--mn-layer-1) 60%);border-radius:11px;margin-bottom:16px;padding:16px 18px}.JK_n9q_agentAnswerHeading{justify-content:space-between;align-items:flex-start;gap:16px;display:flex}.JK_n9q_agentAnswerHeading span{color:var(--mn-accent);font:650 9px/1.2 var(--mn-code);letter-spacing:.08em}.JK_n9q_agentAnswerHeading h3{margin:4px 0 0;font-size:15px}.JK_n9q_agentAnswerHeading>code{color:var(--mn-faint);font-size:9px}.JK_n9q_agentAnswer>p{white-space:pre-wrap;color:var(--mn-text);margin:12px 0;font-size:13px;line-height:1.7}.JK_n9q_agentCitations{border-top:1px solid var(--mn-line);flex-wrap:wrap;gap:5px;padding-top:10px;display:flex}.JK_n9q_agentCitations code{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:5px;padding:3px 6px;font-size:9px}.JK_n9q_searchControls label,.JK_n9q_formGrid label,.JK_n9q_fieldWide{color:var(--mn-muted);gap:5px;font-size:11px;display:grid}.JK_n9q_searchControls select,.JK_n9q_formGrid select,.JK_n9q_formGrid input,.JK_n9q_listToolbar input,.JK_n9q_listToolbar select,.JK_n9q_entitySearch input{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:140px;height:34px;padding:0 9px}.JK_n9q_searchControls select:focus,.JK_n9q_formGrid select:focus,.JK_n9q_formGrid input:focus,.JK_n9q_listToolbar input:focus,.JK_n9q_listToolbar select:focus,.JK_n9q_entitySearch input:focus,.JK_n9q_supervisedForm textarea:focus{border-color:var(--mn-accent)}.JK_n9q_singleColumn{max-width:830px}.JK_n9q_resultLayout{grid-template-columns:minmax(0,1.15fr) minmax(300px,.85fr);align-items:start;gap:14px;display:grid}.JK_n9q_results,.JK_n9q_relatedPane,.JK_n9q_entityResults{min-width:0}.JK_n9q_sectionHeading{justify-content:space-between;align-items:center;gap:16px;min-height:39px;margin-bottom:8px;display:flex}.JK_n9q_sectionHeading h3{margin:2px 0 0;font-size:15px}.JK_n9q_sectionHeading>strong{min-width:27px;height:27px;color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 11px var(--mn-code);border-radius:7px;place-items:center;display:grid}.JK_n9q_relatedPane{border:1px solid var(--mn-line);background:var(--mn-layer-1);-webkit-overflow-scrolling:touch;border-radius:12px;max-height:calc(100dvh - 230px);padding:13px;scroll-margin-top:14px;position:sticky;top:12px;overflow:auto}.JK_n9q_relatedSource{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:8px;margin:0 0 13px;padding:10px;font-size:11px}.JK_n9q_insightCard{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;margin-bottom:9px;padding:14px;transition:border-color .15s,transform .15s,box-shadow .15s}.JK_n9q_insightCard:hover{border-color:var(--mn-line-strong);transform:translateY(-1px)}.JK_n9q_cardTop{justify-content:space-between;align-items:center;gap:10px;display:flex}.JK_n9q_badges,.JK_n9q_tags,.JK_n9q_entities{flex-wrap:wrap;gap:5px;display:flex}.JK_n9q_badge{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:999px;padding:2px 6px;font-size:9px}.JK_n9q_id{color:var(--mn-faint);font:9px var(--mn-code)}.JK_n9q_content{white-space:pre-wrap;overflow-wrap:anywhere;margin:10px 0;line-height:1.65}.JK_n9q_tags{color:var(--mn-accent);font-size:10px}.JK_n9q_entities{margin-top:7px}.JK_n9q_entities span{border:1px solid var(--mn-line);color:var(--mn-muted);border-radius:5px;padding:2px 6px;font-size:9px}.JK_n9q_cardActions{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:3px;min-height:30px;margin-top:10px;padding-top:8px;display:flex}.JK_n9q_confirmBar{width:100%;color:var(--mn-danger);justify-content:flex-end;align-items:center;gap:5px;font-size:11px;display:flex}.JK_n9q_confirmBar>span{margin-right:auto}.JK_n9q_entityLayout{grid-template-columns:265px minmax(0,1fr);align-items:start;gap:16px;display:grid}.JK_n9q_entityRail{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;padding:13px;position:sticky;top:0}.JK_n9q_entitySearch{grid-template-columns:minmax(0,1fr) auto;gap:7px;display:grid}.JK_n9q_entitySearch input{min-width:0}.JK_n9q_entityHeading{justify-content:space-between;align-items:center;margin:18px 2px 7px;display:flex}.JK_n9q_entityHeading small{color:var(--mn-faint);font-size:9px}.JK_n9q_entityList{gap:3px;display:grid}.JK_n9q_entityList button{min-height:34px;color:var(--mn-muted);cursor:pointer;text-align:left;background:0 0;border:0;border-radius:7px;justify-content:space-between;align-items:center;gap:10px;padding:0 9px;display:flex}.JK_n9q_entityList button:hover,.JK_n9q_entityList button[aria-pressed=true]{color:var(--mn-text);background:var(--mn-hover)}.JK_n9q_entityList strong{color:var(--mn-faint);font:10px var(--mn-code)}.JK_n9q_entityResults>.JK_n9q_emptyState{min-height:360px}.JK_n9q_runtimeComposer,.JK_n9q_runtimeTarget{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px}.JK_n9q_runtimeComposer{background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 5%, var(--mn-layer-1)), var(--mn-layer-1) 55%);margin-bottom:13px;padding:15px}.JK_n9q_runtimeComposerHeading{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:11px;display:flex}.JK_n9q_runtimeComposerHeading h3{margin:0 0 2px;font-size:14px}.JK_n9q_runtimeComposerHeading p{color:var(--mn-muted);margin:0;font-size:10px}.JK_n9q_runtimeComposerHeading>span{color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 9px var(--mn-code);border-radius:999px;flex:none;padding:4px 8px}.JK_n9q_runtimeComposer>textarea,.JK_n9q_runtimeEntry textarea{resize:vertical;border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:9px;outline:0;padding:10px 11px;line-height:1.6}.JK_n9q_runtimeComposer>textarea:focus,.JK_n9q_runtimeEntry textarea:focus{border-color:var(--mn-accent)}.JK_n9q_runtimeComposerActions{justify-content:flex-end;align-items:flex-end;gap:9px;margin-top:10px;display:flex}.JK_n9q_runtimeComposerActions label{color:var(--mn-faint);gap:4px;font-size:9px;display:grid}.JK_n9q_runtimeComposerActions select,.JK_n9q_runtimeEntry select{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;min-width:135px;height:34px;padding:0 8px}.JK_n9q_runtimeNotice,.JK_n9q_runtimeReadOnly{border:1px solid color-mix(in srgb, var(--mn-success) 28%, var(--mn-line));color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 6%, var(--mn-layer-1));border-radius:9px;margin-bottom:13px;padding:9px 12px;font-size:11px}.JK_n9q_runtimeReadOnly{color:var(--mn-muted);border-color:var(--mn-line);background:var(--mn-layer-1)}.JK_n9q_runtimeGrid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:12px;display:grid}.JK_n9q_runtimeTarget{min-width:0;overflow:hidden}.JK_n9q_runtimeTargetHeader{justify-content:space-between;align-items:center;gap:14px;padding:14px 15px 9px;display:flex}.JK_n9q_runtimeTargetHeader>div{gap:1px;display:grid}.JK_n9q_runtimeTargetHeader span{color:var(--mn-faint);font:650 9px var(--mn-code);letter-spacing:.08em}.JK_n9q_runtimeTargetHeader h3{margin:0;font-size:15px}.JK_n9q_runtimeTargetHeader>strong{min-width:28px;height:28px;color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 9%, transparent);font:650 11px var(--mn-code);border-radius:8px;place-items:center;display:grid}.JK_n9q_capacityLine{align-items:center;gap:9px;padding:0 15px;display:flex}.JK_n9q_capacityLine>div{background:var(--mn-layer-2);border-radius:999px;flex:1;height:4px;overflow:hidden}.JK_n9q_capacityLine i{border-radius:inherit;background:var(--mn-success);height:100%;transition:width .25s;display:block}.JK_n9q_capacityLine>span{min-width:88px;color:var(--mn-faint);font:9px var(--mn-code);text-align:right}.JK_n9q_runtimeTargetDescription{min-height:31px;color:var(--mn-muted);margin:8px 15px 12px;font-size:10px}.JK_n9q_runtimeEntries{border-top:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 36%, var(--mn-layer-1));gap:7px;padding:10px;display:grid}.JK_n9q_runtimeEntry{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:9px;padding:11px;position:relative}.JK_n9q_runtimeEntry:before{content:\"\";background:var(--mn-muted);border-radius:0 2px 2px 0;width:2px;position:absolute;top:12px;bottom:12px;left:-1px}.JK_n9q_runtimeEntry[data-importance=critical]:before{background:var(--mn-danger)}.JK_n9q_runtimeEntry[data-importance=low]:before{background:var(--mn-faint);opacity:.45}.JK_n9q_runtimeEntryMeta{justify-content:space-between;align-items:center;gap:12px;display:flex}.JK_n9q_runtimeEntryMeta>span{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:999px;padding:2px 6px;font-size:9px}.JK_n9q_runtimeEntry[data-importance=critical] .JK_n9q_runtimeEntryMeta>span{color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 8%, transparent)}.JK_n9q_runtimeEntryMeta time{color:var(--mn-faint);font:8px var(--mn-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.JK_n9q_runtimeEntry>p{white-space:pre-wrap;overflow-wrap:anywhere;min-height:42px;margin:9px 0;font-size:12px;line-height:1.6}.JK_n9q_runtimeEntry>select{margin-top:7px}.JK_n9q_runtimeEntry footer{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:4px;min-height:30px;margin-top:7px;padding-top:7px;display:flex}.JK_n9q_runtimeEntry footer>span{color:var(--mn-danger);margin-right:auto;font-size:10px}.JK_n9q_runtimeEmpty{min-height:126px;color:var(--mn-faint);text-align:center;align-content:center;place-items:center;gap:5px;display:grid}.JK_n9q_runtimeEmpty>span{font:24px var(--mn-code);opacity:.65}.JK_n9q_runtimeEmpty p{margin:0;font-size:10px}.JK_n9q_runtimeFootnote{color:var(--mn-faint);margin:10px 2px 0;font-size:9px}.JK_n9q_documentSummary{grid-template-columns:.7fr .7fr 1.6fr;gap:9px;margin-bottom:12px;display:grid}.JK_n9q_documentSummary article{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;min-height:91px;padding:13px 14px}.JK_n9q_documentSummary article>span{color:var(--mn-faint);font-size:9px;display:block}.JK_n9q_documentSummary article>strong{font:650 21px/1 var(--mn-code);margin:7px 0 4px;display:block}.JK_n9q_documentSummary article>small{color:var(--mn-muted);font-size:9px}.JK_n9q_documentCapacity>div{background:var(--mn-layer-2);border-radius:999px;height:4px;margin:7px 0 6px;overflow:hidden}.JK_n9q_documentCapacity>div i{border-radius:inherit;background:var(--mn-accent);height:100%;transition:width .3s;display:block}.JK_n9q_documentToolbar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;align-items:center;gap:9px;margin-bottom:12px;padding:9px;display:flex}.JK_n9q_documentToolbar form{flex:1;grid-template-columns:20px minmax(0,1fr) auto;align-items:center;gap:5px;min-width:260px;padding-left:8px;display:grid}.JK_n9q_documentToolbar form>span{color:var(--mn-faint);font:15px var(--mn-code)}.JK_n9q_documentToolbar input,.JK_n9q_documentEditor input,.JK_n9q_documentEditor textarea{border:1px solid var(--mn-line);background:var(--mn-input);border-radius:8px;outline:0;width:100%;padding:8px 10px}.JK_n9q_documentToolbar input{background:0 0;border-color:#0000;height:34px}.JK_n9q_documentToolbar input:focus,.JK_n9q_documentEditor input:focus,.JK_n9q_documentEditor textarea:focus{border-color:var(--mn-accent)}.JK_n9q_documentToolbar>div{border:1px solid var(--mn-line);background:var(--mn-layer-2);border-radius:8px;align-items:center;gap:3px;padding:3px;display:flex}.JK_n9q_documentToolbar>div button{min-height:32px;color:var(--mn-muted);cursor:pointer;background:0 0;border:0;border-radius:6px;padding:0 10px;font-size:10.5px}.JK_n9q_documentToolbar>div button[data-active]{color:var(--mn-text);background:var(--mn-layer-1);box-shadow:0 1px 3px color-mix(in srgb, var(--mn-text) 8%, transparent)}.JK_n9q_documentToolbar>div b{color:var(--mn-faint);font:600 9px var(--mn-code);margin-left:4px}.JK_n9q_documentWorkspace{grid-template-columns:minmax(250px,310px) minmax(0,1fr);gap:10px;min-height:590px;display:grid}.JK_n9q_documentList,.JK_n9q_documentReader{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;min-width:0;overflow:hidden}.JK_n9q_documentList{align-self:stretch}.JK_n9q_documentList>header{border-bottom:1px solid var(--mn-line);min-height:42px;color:var(--mn-faint);justify-content:space-between;align-items:center;padding:0 12px;font-size:9px;display:flex}.JK_n9q_documentList>header code{color:var(--mn-accent)}.JK_n9q_documentList>button{border:0;border-bottom:1px solid var(--mn-line);width:100%;color:var(--mn-text);text-align:left;cursor:pointer;background:0 0;padding:12px;transition:background-color .15s,box-shadow .15s;display:block}.JK_n9q_documentList>button:hover{background:var(--mn-hover)}.JK_n9q_documentList>button[data-selected]{background:color-mix(in srgb, var(--mn-accent) 7%, var(--mn-layer-1));box-shadow:inset 2px 0 var(--mn-accent)}.JK_n9q_documentList>button>div{justify-content:space-between;align-items:baseline;gap:12px;display:flex}.JK_n9q_documentList>button strong{text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.JK_n9q_documentList>button time{color:var(--mn-faint);font:8px var(--mn-code);flex:none}.JK_n9q_documentList>button p{min-height:30px;color:var(--mn-muted);-webkit-line-clamp:2;-webkit-box-orient:vertical;margin:6px 0 9px;font-size:10px;line-height:1.5;display:-webkit-box;overflow:hidden}.JK_n9q_documentList>button footer{color:var(--mn-faint);align-items:center;gap:8px;font-size:9px;display:flex}.JK_n9q_documentList>button footer code{margin-left:auto}.JK_n9q_documentList>button footer em{color:var(--mn-danger);font-style:normal}.JK_n9q_documentListEmpty{min-height:230px;color:var(--mn-muted);text-align:center;align-content:center;place-items:center;gap:4px;padding:22px;display:grid}.JK_n9q_documentListEmpty>span{color:var(--mn-accent);font:28px var(--mn-code);opacity:.6;margin-bottom:6px}.JK_n9q_documentListEmpty p{color:var(--mn-faint);margin:0;font-size:10px}.JK_n9q_documentReader{padding:clamp(16px,2vw,22px)}.JK_n9q_documentReader>.JK_n9q_emptyState{background:0 0;border:0;height:100%}.JK_n9q_documentDetail>header{border-bottom:1px solid var(--mn-line);justify-content:space-between;align-items:flex-start;gap:18px;padding-bottom:15px;display:flex}.JK_n9q_documentDetail>header span{color:var(--mn-accent);font:650 9px var(--mn-code);letter-spacing:.08em;text-transform:uppercase}.JK_n9q_documentDetail>header h3{margin:5px 0 3px;font-size:18px}.JK_n9q_documentDetail>header p{color:var(--mn-muted);margin:0;font-size:11px}.JK_n9q_documentDetail>dl{border-top:1px solid var(--mn-line);border-left:1px solid var(--mn-line);grid-template-columns:2fr .45fr .8fr .55fr;margin:13px 0;display:grid}.JK_n9q_documentDetail>dl>div{border-right:1px solid var(--mn-line);border-bottom:1px solid var(--mn-line);min-width:0;padding:8px 9px}.JK_n9q_documentDetail dt{color:var(--mn-faint);margin-bottom:3px;font-size:8px}.JK_n9q_documentDetail dd{text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:9px;overflow:hidden}.JK_n9q_documentSources{flex-wrap:wrap;align-items:center;gap:5px;margin:11px 0;display:flex}.JK_n9q_documentSources>span{color:var(--mn-faint);margin-right:4px;font-size:9px}.JK_n9q_documentSources code,.JK_n9q_documentArchiveReceipt code{color:var(--mn-muted);background:var(--mn-layer-2);border-radius:5px;padding:3px 6px;font-size:8px}.JK_n9q_markdownBody{overflow-wrap:anywhere;border:1px solid var(--mn-line);min-height:310px;color:var(--mn-text);background:color-mix(in srgb, var(--mn-layer-2) 30%, var(--mn-layer-1));border-radius:10px;margin:16px 0 0;padding:clamp(18px,2.5vw,28px);font-size:13px;line-height:1.78}.JK_n9q_markdownBody>:first-child{margin-top:0}.JK_n9q_markdownBody>:last-child{margin-bottom:0}.JK_n9q_markdownBody h1,.JK_n9q_markdownBody h2,.JK_n9q_markdownBody h3,.JK_n9q_markdownBody h4{color:var(--mn-text);letter-spacing:-.015em;margin:1.55em 0 .65em;line-height:1.3}.JK_n9q_markdownBody h1{border-bottom:1px solid var(--mn-line);padding-bottom:.35em;font-size:1.75em}.JK_n9q_markdownBody h2{border-bottom:1px solid var(--mn-line);padding-bottom:.3em;font-size:1.42em}.JK_n9q_markdownBody h3{font-size:1.18em}.JK_n9q_markdownBody p,.JK_n9q_markdownBody ul,.JK_n9q_markdownBody ol,.JK_n9q_markdownBody blockquote,.JK_n9q_markdownBody table,.JK_n9q_markdownBody pre{margin:.85em 0}.JK_n9q_markdownBody ul,.JK_n9q_markdownBody ol{padding-left:1.6em}.JK_n9q_markdownBody li+li{margin-top:.3em}.JK_n9q_markdownBody blockquote{border-left:3px solid var(--mn-accent);color:var(--mn-muted);background:color-mix(in srgb, var(--mn-accent) 4%, transparent);margin-inline:0;padding:.15em 1em}.JK_n9q_markdownBody code{color:var(--mn-text);background:var(--mn-layer-2);font:.88em/1.55 var(--mn-code);border-radius:5px;padding:.15em .38em}.JK_n9q_markdownBody pre{border:1px solid var(--mn-line);background:var(--mn-layer-2);border-radius:9px;max-width:100%;padding:14px 16px;overflow:auto}.JK_n9q_markdownBody pre code{background:0 0;padding:0;font-size:11px}.JK_n9q_markdownBody a{color:var(--mn-accent);text-underline-offset:3px;text-decoration-thickness:1px}.JK_n9q_markdownBody hr{border:0;border-top:1px solid var(--mn-line);margin:1.8em 0}.JK_n9q_markdownBody table{border-collapse:collapse;max-width:100%;display:block;overflow-x:auto}.JK_n9q_markdownBody th,.JK_n9q_markdownBody td{border:1px solid var(--mn-line);text-align:left;vertical-align:top;padding:8px 10px}.JK_n9q_markdownBody th{background:var(--mn-layer-2);font-weight:600}.JK_n9q_markdownBody img{border-radius:8px;max-width:100%;height:auto}.JK_n9q_documentArchiveReceipt{border:1px solid color-mix(in srgb, var(--mn-success) 28%, var(--mn-line));background:color-mix(in srgb, var(--mn-success) 5%, transparent);border-radius:9px;margin:12px 0;padding:11px 12px}.JK_n9q_documentArchiveReceipt p{color:var(--mn-muted);margin:4px 0 8px;font-size:10px}.JK_n9q_documentArchiveReceipt div{flex-wrap:wrap;gap:5px;display:flex}.JK_n9q_documentDanger{border-top:1px solid var(--mn-line);justify-content:flex-end;align-items:center;gap:7px;min-height:57px;margin-top:13px;padding-top:12px;display:flex}.JK_n9q_documentDanger>div{margin-right:auto}.JK_n9q_documentDanger strong{font-size:11px;display:block}.JK_n9q_documentDanger p{color:var(--mn-faint);margin:2px 0 0;font-size:9px}.JK_n9q_documentDanger>span{color:var(--mn-danger);margin-right:auto;font-size:10px}.JK_n9q_documentEditor{border:1px solid var(--mn-line);background:linear-gradient(135deg, color-mix(in srgb, var(--mn-accent) 5%, var(--mn-layer-1)), var(--mn-layer-1) 55%);border-radius:11px;margin-bottom:12px;padding:15px}.JK_n9q_documentReader>.JK_n9q_documentEditor{background:0 0;border:0;margin:0;padding:0}.JK_n9q_documentEditor>header{justify-content:space-between;align-items:flex-start;gap:18px;margin-bottom:12px;display:flex}.JK_n9q_documentEditor h3{margin:0;font-size:14px}.JK_n9q_documentEditor header p{color:var(--mn-muted);margin:2px 0 0;font-size:10px}.JK_n9q_documentEditor header>span,.JK_n9q_documentEditor header>code{color:var(--mn-accent);font:650 9px var(--mn-code)}.JK_n9q_documentEditor label{color:var(--mn-faint);gap:4px;margin-top:9px;font-size:9px;display:grid}.JK_n9q_documentEditor textarea{resize:vertical;line-height:1.65}.JK_n9q_documentEditorMeta{grid-template-columns:.8fr 1.2fr;gap:9px;display:grid}.JK_n9q_documentEditorMeta label{margin:0}.JK_n9q_documentEditor footer{justify-content:flex-end;gap:7px;margin-top:11px;display:flex}.JK_n9q_writebackLayout{grid-template-columns:minmax(220px,280px) minmax(0,1fr);align-items:start;gap:15px;display:grid}.JK_n9q_writeGuide,.JK_n9q_supervisedComposer{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px}.JK_n9q_writeGuide{padding:17px}.JK_n9q_writeGuide h3{margin:5px 0 15px;font-size:15px}.JK_n9q_writeGuide ol{counter-reset:gate;gap:13px;margin:0;padding:0;list-style:none;display:grid}.JK_n9q_writeGuide li{counter-increment:gate;grid-template-columns:22px minmax(0,1fr);column-gap:7px;display:grid}.JK_n9q_writeGuide li:before{content:\"0\" counter(gate);color:var(--mn-accent);font:10px var(--mn-code);grid-row:span 2}.JK_n9q_writeGuide li strong{font-size:12px}.JK_n9q_writeGuide li span,.JK_n9q_writeGuide p{color:var(--mn-faint);font-size:10px}.JK_n9q_writeGuide p{border-top:1px solid var(--mn-line);margin:17px 0 0;padding-top:13px}.JK_n9q_supervisedComposer{overflow:hidden}.JK_n9q_supervisedForm{padding:18px}.JK_n9q_supervisedHeading{justify-content:space-between;align-items:flex-start;gap:16px;margin-bottom:16px;display:flex}.JK_n9q_supervisedHeading h3{margin:4px 0 0;font-size:17px}.JK_n9q_sessionReady,.JK_n9q_sessionMissing{font:650 9px var(--mn-code);border-radius:999px;padding:4px 8px}.JK_n9q_sessionReady{color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 10%, transparent)}.JK_n9q_sessionMissing{color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 10%, transparent)}.JK_n9q_supervisedForm textarea{resize:vertical;border:1px solid var(--mn-line);width:100%;color:var(--mn-text);background:var(--mn-input);border-radius:9px;outline:0;padding:12px;line-height:1.65}.JK_n9q_sessionHint{color:var(--mn-danger);margin:9px 0 0;font-size:11px}.JK_n9q_formGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-top:13px;display:grid}.JK_n9q_fieldWide{grid-column:1/-1}.JK_n9q_formGrid select,.JK_n9q_formGrid input{width:100%;min-width:0}.JK_n9q_formActions{align-items:center;gap:12px;margin-top:15px;display:flex}.JK_n9q_formActions span{color:var(--mn-muted);font-size:11px}.JK_n9q_advancedWrite{border-top:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 45%, var(--mn-layer-1))}.JK_n9q_advancedWrite summary{cursor:pointer;justify-content:space-between;align-items:center;gap:16px;min-height:58px;padding:10px 18px;list-style:none;display:flex}.JK_n9q_advancedWrite summary::-webkit-details-marker{display:none}.JK_n9q_advancedWrite summary>span:first-child{gap:2px;display:grid}.JK_n9q_advancedWrite summary strong{font-size:12px}.JK_n9q_advancedWrite summary small{color:var(--mn-faint);font-size:10px}.JK_n9q_advancedWrite summary>span:last-child{color:var(--mn-accent);font:10px var(--mn-code)}.JK_n9q_advancedWrite[open] summary{border-bottom:1px solid var(--mn-line)}.JK_n9q_advancedWrite[open] summary>span:last-child{font-size:0}.JK_n9q_advancedWrite[open] summary>span:last-child:after{content:\"−\";font-size:13px}.JK_n9q_manualForm{padding:3px 18px 18px}.JK_n9q_manualActions{justify-content:space-between;align-items:center;gap:14px;margin-top:15px;display:flex}.JK_n9q_manualActions p{max-width:520px;color:var(--mn-faint);margin:0;font-size:10px}.JK_n9q_listToolbar{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:11px;grid-template-columns:minmax(0,1fr) 170px auto;gap:9px;padding:12px;display:grid}.JK_n9q_listToolbar input,.JK_n9q_listToolbar select{width:100%;min-width:0}.JK_n9q_listNotice{color:var(--mn-faint);margin:10px 0 16px;font-size:10px}.JK_n9q_listNotice span{color:var(--mn-success);font:650 9px var(--mn-code);letter-spacing:.08em;margin-right:7px}.JK_n9q_memoryList{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:9px;display:grid}.JK_n9q_memoryList .JK_n9q_insightCard{height:100%;margin:0}.JK_n9q_listProgress{border-top:1px solid var(--mn-line);min-height:58px;color:var(--mn-faint);justify-content:center;align-items:center;gap:13px;margin-top:12px;padding:10px;font-size:10px;display:flex}.JK_n9q_healthStrip{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;grid-template-columns:repeat(5,minmax(0,1fr));margin-bottom:13px;display:grid;overflow:hidden}.JK_n9q_healthStrip article{box-sizing:border-box;border-right:1px solid var(--mn-line);align-items:flex-start;gap:10px;min-width:0;min-height:78px;padding:14px 15px;display:flex}.JK_n9q_healthStrip article>div{min-width:0}.JK_n9q_healthStrip article:last-child{border-right:0}.JK_n9q_healthStrip small{color:var(--mn-faint);font:650 10px var(--mn-code);letter-spacing:.06em;margin-bottom:4px;display:block}.JK_n9q_healthStrip strong{text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;display:block;overflow:hidden}.JK_n9q_healthStrip p{color:var(--mn-muted);text-overflow:ellipsis;white-space:nowrap;margin:3px 0 0;font-size:10.5px;overflow:hidden}.JK_n9q_healthIndicator{width:7px;height:7px;box-shadow:0 0 0 4px color-mix(in srgb, currentColor 9%, transparent);border-radius:50%;flex:none;margin-top:3px}.JK_n9q_healthGood{color:var(--mn-success);background:currentColor}.JK_n9q_healthBad{color:var(--mn-danger);background:currentColor}.JK_n9q_healthMuted{color:var(--mn-faint);background:currentColor}.JK_n9q_memoryFlow{border:1px solid var(--mn-line);background:radial-gradient(circle at 52% 10%, color-mix(in srgb, var(--mn-accent) 5%, transparent), transparent 28%), var(--mn-layer-1);border-radius:12px;margin-bottom:13px;padding:16px;overflow:hidden;container:JK_n9q_mnemon-flow/inline-size}.JK_n9q_memoryFlowCanvas{overscroll-behavior-inline:contain;border:1px solid var(--mn-line);background-image:linear-gradient(color-mix(in srgb, var(--mn-line) 36%, transparent) 1px, transparent 1px), linear-gradient(90deg, color-mix(in srgb, var(--mn-line) 36%, transparent) 1px, transparent 1px);background-size:24px 24px;background-color:color-mix(in srgb, var(--mn-layer-2) 28%, transparent);scrollbar-color:var(--mn-line-strong) transparent;border-radius:11px;margin-top:13px;overflow:auto hidden}.JK_n9q_flowArchitecture{gap:10px;min-width:840px;padding:10px;display:grid}.JK_n9q_flowLane{border:1px solid color-mix(in srgb, var(--mn-line) 82%, transparent);background:color-mix(in srgb, var(--mn-layer-1) 92%, transparent);min-width:0;box-shadow:inset 3px 0 0 color-mix(in srgb, var(--mn-accent) 34%, transparent);border-radius:10px;overflow:hidden}.JK_n9q_flowLane[data-lane=semantic]{box-shadow:inset 3px 0 #8b6ce77a}.JK_n9q_flowLane[data-lane=maintenance]{box-shadow:inset 3px 0 #d18a3c85}.JK_n9q_flowLane>header{border-bottom:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 42%, transparent);align-items:center;gap:9px;min-height:46px;padding:8px 12px;display:flex}.JK_n9q_flowLane>header>span{color:var(--mn-accent);font:650 9px var(--mn-code)}.JK_n9q_flowLane>header>div{gap:1px;min-width:0;display:grid}.JK_n9q_flowLane>header strong{font-size:12px}.JK_n9q_flowLane>header small{color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;font-size:9.5px;overflow:hidden}.JK_n9q_flowTrack{align-items:stretch;gap:0;min-width:0;padding:11px 12px;display:flex}.JK_n9q_flowTrack+.JK_n9q_flowTrack{padding-top:0}.JK_n9q_flowSecondaryTrack,.JK_n9q_flowReviewTrack,.JK_n9q_flowArchiveTrack{border-top:1px dashed color-mix(in srgb, var(--mn-line) 72%, transparent);padding-top:11px!important}.JK_n9q_flowArchitectureNode{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-1) 96%, transparent);border-radius:9px;flex:1 1 0;grid-template-columns:7px minmax(0,1fr);align-content:center;gap:9px;min-width:0;min-height:84px;padding:11px;transition:border-color .2s,background-color .2s,box-shadow .2s;display:grid;position:relative}.JK_n9q_flowArchitectureNode[data-kind=worker]{border-style:dashed;border-color:color-mix(in srgb, #8b6ce7 46%, var(--mn-line));background:color-mix(in srgb, #8b6ce7 4%, var(--mn-layer-1))}.JK_n9q_flowArchitectureNode[data-kind=store]{background:color-mix(in srgb, var(--mn-success) 3%, var(--mn-layer-1))}.JK_n9q_flowArchitectureNode[data-kind=task]{background:color-mix(in srgb, var(--mn-accent) 3%, var(--mn-layer-1))}.JK_n9q_flowArchitectureNode[data-emphasis=active]{border-color:color-mix(in srgb, var(--mn-accent) 56%, var(--mn-line));box-shadow:0 0 0 2px color-mix(in srgb, var(--mn-accent) 8%, transparent)}.JK_n9q_flowArchitectureNode[data-emphasis=recent]{border-color:color-mix(in srgb, var(--mn-success) 48%, var(--mn-line))}.JK_n9q_flowArchitectureNode[data-emphasis=pending]{border-color:color-mix(in srgb, #d18a3c 55%, var(--mn-line))}.JK_n9q_flowArchitectureSignal{background:var(--mn-faint);width:7px;height:7px;box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-faint) 8%, transparent);border-radius:50%;margin-top:4px}.JK_n9q_flowArchitectureNode[data-state=ready] .JK_n9q_flowArchitectureSignal{background:var(--mn-success);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 10%, transparent)}.JK_n9q_flowArchitectureNode[data-state=error] .JK_n9q_flowArchitectureSignal{background:var(--mn-danger);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-danger) 10%, transparent)}.JK_n9q_flowArchitectureNode>div{align-content:start;gap:5px;min-width:0;display:grid}.JK_n9q_flowArchitectureNode strong{overflow-wrap:break-word;word-break:normal;font-size:11.5px;line-height:1.35}.JK_n9q_flowArchitectureNode small{color:var(--mn-faint);overflow-wrap:anywhere;font-size:9.5px;line-height:1.45}.JK_n9q_flowConnector{width:clamp(38px,4.2vw,56px);color:var(--mn-faint);text-align:center;flex:none;place-content:center stretch;gap:5px;padding:0 4px;display:grid;position:relative}.JK_n9q_flowConnector span{overflow-wrap:anywhere;min-height:13px;font:8px/1.3 var(--mn-code)}.JK_n9q_flowConnector i{background:color-mix(in srgb, var(--mn-accent) 55%, var(--mn-line));height:1px;display:block;position:relative}.JK_n9q_flowConnector i:after{border-top:1px solid var(--mn-accent);border-right:1px solid var(--mn-accent);content:\"\";width:6px;height:6px;position:absolute;top:-3px;right:-1px;transform:rotate(45deg)}.JK_n9q_flowConnector[data-kind=worker] i{border-top:1px dashed color-mix(in srgb, #8b6ce7 72%, var(--mn-line));background:0 0;height:0}.JK_n9q_flowConnector[data-kind=worker] i:after{border-color:#8b6ce7}.JK_n9q_flowConnector[data-active]{color:var(--mn-text)}.JK_n9q_flowConnector[data-active] i{height:2px}.JK_n9q_flowConnector[data-active] i:before{z-index:1;content:\"\";background:var(--mn-accent);border-radius:50%;width:5px;height:5px;animation:1.9s cubic-bezier(.35,0,.65,1) infinite JK_n9q_flowTrace;position:absolute;top:-2px;left:0}.JK_n9q_flowConnector[data-kind=worker][data-active] i:before{background:#8b6ce7;top:-3px}@keyframes JK_n9q_flowTrace{0%{opacity:0;left:0}12%{opacity:1}88%{opacity:1}to{opacity:0;left:calc(100% - 5px)}}@keyframes JK_n9q_flowTraceVertical{0%{opacity:0;top:0}12%{opacity:1}88%{opacity:1}to{opacity:0;top:calc(100% - 5px)}}.JK_n9q_flowLegend{color:var(--mn-faint);flex-wrap:wrap;gap:9px 18px;margin-top:10px;font-size:9px;display:flex}.JK_n9q_flowLegend span{align-items:center;gap:6px;display:inline-flex}.JK_n9q_flowLegend span:last-child{margin-left:auto}.JK_n9q_flowLegend i{background:var(--mn-accent);width:18px;height:1px}.JK_n9q_flowLegend span:nth-child(2) i{background:0 0;border-top:1px dashed #8b6ce7;height:0}.JK_n9q_flowLegend b{background:var(--mn-success);width:6px;height:6px;box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 10%, transparent);border-radius:50%}@container JK_n9q_mnemon-flow (width<=700px){.JK_n9q_flowArchitecture{min-width:0;padding:8px}.JK_n9q_flowLane>header{align-items:flex-start}.JK_n9q_flowLane>header small{white-space:normal}.JK_n9q_flowTrack{flex-direction:column;padding:10px}.JK_n9q_flowArchitectureNode{flex:none;width:100%;min-height:72px}.JK_n9q_flowConnector{place-content:center;width:100%;height:42px;padding:5px 0}.JK_n9q_flowConnector span{min-height:0}.JK_n9q_flowConnector i{justify-self:center;width:1px;height:18px}.JK_n9q_flowConnector i:after{top:auto;bottom:0;right:-3px;transform:rotate(135deg)}.JK_n9q_flowConnector[data-kind=worker] i{border-top:0;border-left:1px dashed color-mix(in srgb, #8b6ce7 72%, var(--mn-line));width:0;height:18px}.JK_n9q_flowConnector[data-active] i{width:2px;height:18px}.JK_n9q_flowConnector[data-active] i:before{animation:1.9s cubic-bezier(.35,0,.65,1) infinite JK_n9q_flowTraceVertical;top:0;left:-2px}.JK_n9q_flowConnector[data-kind=worker][data-active] i:before{top:0}}.JK_n9q_storageDomains{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;margin-bottom:13px;padding:16px}.JK_n9q_storageRoot{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 45%, transparent);border-radius:9px;justify-content:space-between;align-items:center;gap:18px;min-width:0;margin-top:12px;padding:11px 12px;display:flex}.JK_n9q_storageRoot>div:first-child{gap:4px;min-width:0;display:grid}.JK_n9q_storageRoot span,.JK_n9q_storageRoot small{color:var(--mn-faint);font-size:9px}.JK_n9q_storageRoot code{color:var(--mn-muted);text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}.JK_n9q_storageRoot>div:last-child{flex:none;justify-items:end;gap:3px;display:grid}.JK_n9q_storageRoot strong{font:650 11px var(--mn-code)}.JK_n9q_storageAreaGrid{grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:8px;display:grid}.JK_n9q_storageAreaGrid article{box-sizing:border-box;border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 30%, var(--mn-layer-1));border-radius:9px;flex-direction:column;min-width:0;min-height:150px;padding:12px;display:flex}.JK_n9q_storageAreaGrid article>header{justify-content:space-between;align-items:center;gap:8px;display:flex}.JK_n9q_storageAreaGrid article>header>div{align-items:center;gap:7px;min-width:0;display:flex}.JK_n9q_storageAreaGrid article>header span{background:var(--mn-faint);border-radius:50%;flex:none;width:6px;height:6px}.JK_n9q_storageAreaGrid article[data-status=ready]>header span{background:var(--mn-success);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-success) 9%, transparent)}.JK_n9q_storageAreaGrid article[data-status=invalid]>header span{background:var(--mn-danger);box-shadow:0 0 0 3px color-mix(in srgb, var(--mn-danger) 9%, transparent)}.JK_n9q_storageAreaGrid article>header strong{text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}.JK_n9q_storageAreaGrid article>header em{color:var(--mn-faint);font:normal 8px var(--mn-code);white-space:nowrap}.JK_n9q_storageAreaMetric{align-items:baseline;gap:5px;margin-top:14px;display:flex}.JK_n9q_storageAreaMetric strong{font:650 20px var(--mn-code)}.JK_n9q_storageAreaMetric span{color:var(--mn-faint);font-size:9px}.JK_n9q_storageAreaMetric code{color:var(--mn-muted);margin-left:auto;font-size:9px}.JK_n9q_storageAreaGrid article>p{min-height:28px;color:var(--mn-muted);margin:8px 0;font-size:9px;line-height:1.5}.JK_n9q_storagePath{border-top:1px solid var(--mn-line);color:var(--mn-faint);text-overflow:ellipsis;white-space:nowrap;margin-top:auto;padding-top:8px;font-size:8px;display:block;overflow:hidden}.JK_n9q_storageAreaGrid article>small{color:var(--mn-danger);margin-top:6px;font-size:8px;line-height:1.4;display:block}.JK_n9q_storageUnavailable{border:1px dashed var(--mn-line);min-height:126px;color:var(--mn-muted);text-align:center;border-radius:9px;place-content:center;gap:5px;margin-top:12px;display:grid}.JK_n9q_storageUnavailable strong{font-size:12px}.JK_n9q_storageUnavailable p{max-width:520px;color:var(--mn-faint);margin:0;font-size:10px}.JK_n9q_storageFootnote{color:var(--mn-faint);margin:11px 0 0;font-size:9px;line-height:1.5}.JK_n9q_lifecyclePanel{border:1px solid var(--mn-line);background:var(--mn-layer-1);border-radius:12px;margin-top:0;padding:16px}.JK_n9q_statusSectionHeader{justify-content:space-between;align-items:flex-start;gap:12px;display:flex}.JK_n9q_statusSectionHeader h3{margin:4px 0 0;font-size:15px}.JK_n9q_statusSectionHeader p{max-width:590px;color:var(--mn-muted);margin:5px 0 0;font-size:10px}.JK_n9q_phaseBadge{border:1px solid color-mix(in srgb, var(--mn-accent) 25%, var(--mn-line));color:var(--mn-accent);background:color-mix(in srgb, var(--mn-accent) 7%, transparent);font:650 9px var(--mn-code);border-radius:999px;padding:4px 8px}.JK_n9q_lifecycleFlow{border:1px solid var(--mn-line);background:color-mix(in srgb, var(--mn-layer-2) 52%, transparent);border-radius:9px;grid-template-columns:repeat(3,minmax(0,1fr));margin-top:15px;display:grid;overflow:hidden}.JK_n9q_lifecycleFlow article{border-right:1px solid var(--mn-line);grid-template-columns:auto minmax(0,1fr) auto;align-items:start;gap:8px;padding:12px;display:grid}.JK_n9q_lifecycleFlow article:last-child{border-right:0}.JK_n9q_lifecycleFlow article[data-disabled]{opacity:.48}.JK_n9q_lifecycleFlow article>span{color:var(--mn-accent);font:650 9px var(--mn-code)}.JK_n9q_lifecycleFlow strong{font-size:11px;display:block}.JK_n9q_lifecycleFlow p{color:var(--mn-faint);margin:4px 0 0;font-size:9px;line-height:1.45}.JK_n9q_lifecycleFlow code{color:var(--mn-muted);font-size:10px}.JK_n9q_lifecycleFoot{border-top:1px solid var(--mn-line);color:var(--mn-faint);flex-wrap:wrap;gap:8px 18px;margin-top:13px;padding-top:12px;font-size:9px;display:flex}.JK_n9q_lifecycleFoot strong{color:var(--mn-text);margin-left:3px;font-weight:600}.JK_n9q_runtimeBadge{font:650 9px var(--mn-code);border-radius:999px;padding:3px 7px}.JK_n9q_runtimeOnline{color:var(--mn-success);background:color-mix(in srgb, var(--mn-success) 10%, transparent)}.JK_n9q_runtimeOffline{color:var(--mn-danger);background:color-mix(in srgb, var(--mn-danger) 10%, transparent)}.JK_n9q_runtimePending{color:var(--mn-muted);background:var(--mn-layer-2)}@media (width<=1000px){.JK_n9q_graphLayout{display:block;position:relative}.JK_n9q_graphInspector{width:auto;min-height:0;box-shadow:none;margin-top:10px;position:static;overflow:visible}.JK_n9q_graphInspector[data-empty]{display:none}.JK_n9q_resultLayout{grid-template-columns:1fr}.JK_n9q_relatedPane{grid-row:1;max-height:none;position:static}.JK_n9q_memoryList{grid-template-columns:1fr}.JK_n9q_storageAreaGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.JK_n9q_runtimeGrid{grid-template-columns:1fr}.JK_n9q_documentWorkspace{grid-template-columns:minmax(220px,270px) minmax(0,1fr)}.JK_n9q_documentDetail>dl{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (width<=760px){.JK_n9q_shell{min-height:500px;overflow:visible}.JK_n9q_masthead{grid-template-columns:minmax(0,1fr) auto;gap:8px 12px;min-height:76px;padding:10px 14px}.JK_n9q_brandLogo{width:36px;height:36px}.JK_n9q_statusCluster>span:not(.JK_n9q_statusDot){display:none}.JK_n9q_telemetry{border-top:1px solid var(--mn-line);grid-column:1/-1;justify-content:space-between;padding-top:8px}.JK_n9q_telemetryMetric{text-align:center;flex:1;justify-items:center;gap:3px;min-width:0;padding:0 5px}.JK_n9q_telemetryMetric:first-child{border-left:0}.JK_n9q_topNavigation{padding:0 10px;position:relative}.JK_n9q_topNavigation:after{z-index:2;pointer-events:none;content:\"›\";width:34px;color:var(--mn-faint);background:linear-gradient(90deg, transparent, var(--mn-layer-1) 72%);font:16px var(--mn-code);place-items:center end;padding-right:5px;display:grid;position:absolute;top:0;bottom:0;right:0}.JK_n9q_nav{flex:1;padding-right:26px;scroll-padding-inline:10px 34px}.JK_n9q_navGroup{gap:3px}.JK_n9q_navGroupDivider{height:18px}.JK_n9q_nav button{text-align:center;flex-direction:column;justify-content:center;gap:3px;min-width:60px;padding:4px 3px}.JK_n9q_spaceSummary{display:none}.JK_n9q_navGlyph{line-height:1}.JK_n9q_page{padding:18px 13px calc(170px + env(safe-area-inset-bottom,0px))}.JK_n9q_pageHeader{gap:10px;display:grid}.JK_n9q_pageHeaderMeta{justify-content:space-between}.JK_n9q_entityLayout,.JK_n9q_writebackLayout{grid-template-columns:1fr}.JK_n9q_runtimeComposerHeading,.JK_n9q_runtimeComposerActions{flex-direction:column;align-items:stretch}.JK_n9q_runtimeComposerActions select,.JK_n9q_runtimeComposerActions button{width:100%}.JK_n9q_documentSummary{grid-template-columns:repeat(2,minmax(0,1fr))}.JK_n9q_documentCapacity{grid-column:1/-1}.JK_n9q_documentToolbar{flex-direction:column;align-items:stretch}.JK_n9q_documentToolbar form{min-width:0}.JK_n9q_documentToolbar>div,.JK_n9q_documentToolbar>button{width:100%}.JK_n9q_documentToolbar>div button{flex:1}.JK_n9q_documentWorkspace{grid-template-columns:1fr;min-height:0}.JK_n9q_documentList{-webkit-overflow-scrolling:touch;max-height:330px;overflow:auto}.JK_n9q_documentReader{min-height:430px}.JK_n9q_documentEditorMeta{grid-template-columns:1fr}.JK_n9q_manualActions{flex-direction:column;align-items:stretch}.JK_n9q_entityRail{position:static}.JK_n9q_searchControls{grid-template-columns:repeat(2,minmax(0,1fr));display:grid}.JK_n9q_searchActions{grid-column:1/-1}.JK_n9q_searchActions>button{flex:1}.JK_n9q_searchControls select{width:100%;min-width:0}.JK_n9q_listToolbar{grid-template-columns:1fr}.JK_n9q_bodyDirectoryHeader{display:grid}.JK_n9q_bodyCreate form{grid-template-columns:1fr}.JK_n9q_graphViewport{min-height:360px}.JK_n9q_graphSvg{height:390px}.JK_n9q_graphCanvasControls{top:7px;right:7px}.JK_n9q_graphCanvasControls span{display:none}.JK_n9q_previewOverlay{padding:10px;padding-bottom:calc(10px + env(safe-area-inset-bottom,0px))}.JK_n9q_previewDialog{max-height:min(84dvh,640px)}.JK_n9q_healthStrip,.JK_n9q_lifecycleFlow{grid-template-columns:1fr}.JK_n9q_storageRoot{flex-direction:column;align-items:flex-start}.JK_n9q_storageRoot>div:last-child{justify-items:start}.JK_n9q_storageAreaGrid{grid-template-columns:1fr}.JK_n9q_flowLegend span:last-child{width:100%;margin-left:0}.JK_n9q_healthStrip article,.JK_n9q_lifecycleFlow article{border-right:0;border-bottom:1px solid var(--mn-line)}.JK_n9q_healthStrip article:last-child,.JK_n9q_lifecycleFlow article:last-child{border-bottom:0}}@media (width<=520px){.JK_n9q_masthead{min-height:68px}.JK_n9q_brand h1{font-size:16px}.JK_n9q_telemetryMetric span{font-size:10px}.JK_n9q_nav{scroll-snap-type:x proximity}.JK_n9q_nav button{scroll-snap-align:start;min-width:68px}.JK_n9q_pageHeader h2{font-size:19px}.JK_n9q_pageHeaderMeta{flex-wrap:wrap;align-items:stretch}.JK_n9q_pageHeaderMeta>code{align-items:center;min-height:34px;display:flex}.JK_n9q_pageHeaderMeta>button{flex:1}.JK_n9q_emptyState{text-align:center;flex-direction:column;gap:14px;min-height:190px;padding:24px 18px}.JK_n9q_emptyGlyph{width:62px;height:62px}.JK_n9q_documentDetail>header,.JK_n9q_documentDanger,.JK_n9q_supervisedHeading,.JK_n9q_cardTop{flex-direction:column;align-items:flex-start}.JK_n9q_documentDetail>header>div:last-child,.JK_n9q_documentDetail>header button{width:100%}.JK_n9q_documentDanger>div,.JK_n9q_documentDanger>span{margin-right:0}.JK_n9q_documentDanger>button{width:100%}.JK_n9q_documentDetail>dl{grid-template-columns:1fr}.JK_n9q_markdownBody{padding:16px;font-size:12.5px}.JK_n9q_cardActions,.JK_n9q_confirmBar{flex-wrap:wrap;align-items:stretch}.JK_n9q_cardActions button{flex:1}.JK_n9q_confirmBar>span{width:100%;margin:0 0 4px}.JK_n9q_formActions{flex-direction:column;align-items:stretch}.JK_n9q_formActions button{width:100%}.JK_n9q_formGrid,.JK_n9q_searchControls{grid-template-columns:1fr}}@media (width<=1000px) and (height<=760px){.JK_n9q_shell{min-height:0}.JK_n9q_masthead{min-height:58px}.JK_n9q_telemetryMetric{min-width:0;padding:1px 9px}.JK_n9q_topNavigation{min-height:44px}.JK_n9q_nav button{min-height:42px}.JK_n9q_graphViewport{min-height:300px}.JK_n9q_graphSvg{height:300px}}@media (width<=760px) and (pointer:coarse){.JK_n9q_shell input,.JK_n9q_shell select,.JK_n9q_shell textarea{font-size:16px!important}}@media (prefers-reduced-motion:reduce){.JK_n9q_shell *,.JK_n9q_shell :before,.JK_n9q_shell :after{scroll-behavior:auto!important;transition-duration:.01ms!important;animation-duration:.01ms!important;animation-iteration-count:1!important}.JK_n9q_insightCard:hover{transform:none}.JK_n9q_flowConnector[data-active] i:before{display:none}}";
		...
		var MnemonView_module_css_default = {
			"emptyGlyph": "JK_n9q_emptyGlyph",
			"workspace": "JK_n9q_workspace",
			"inspectorEmpty": "JK_n9q_inspectorEmpty",
			"capacityLine": "JK_n9q_capacityLine",
			"documentCapacity": "JK_n9q_documentCapacity",
			"brandLogo": "JK_n9q_brandLogo",
			"tags": "JK_n9q_tags",
			"nodeHalo": "JK_n9q_nodeHalo",
			"runtimeNotice": "JK_n9q_runtimeNotice",
			"documentSummary": "JK_n9q_documentSummary",
			"documentEditor": "JK_n9q_documentEditor",
			"documentListEmpty": "JK_n9q_documentListEmpty",
			"documentArchiveReceipt": "JK_n9q_documentArchiveReceipt",
			"iconButton": "JK_n9q_iconButton",
			"markdownBody": "JK_n9q_markdownBody",
			"cardTop": "JK_n9q_cardTop",
			"documentEditorMeta": "JK_n9q_documentEditorMeta",
			"manualForm": "JK_n9q_manualForm",
			"inspectorMeta": "JK_n9q_inspectorMeta",
			"categoryChip": "JK_n9q_categoryChip",
			"formActions": "JK_n9q_formActions",
			"listProgress": "JK_n9q_listProgress",
			"entities": "JK_n9q_entities",
			"cardKicker": "JK_n9q_cardKicker",
			"writebackLayout": "JK_n9q_writebackLayout",
			"advancedWrite": "JK_n9q_advancedWrite",
			"mnemon-flow": "JK_n9q_mnemon-flow",
			"flowArchitecture": "JK_n9q_flowArchitecture",
			"nodeCore": "JK_n9q_nodeCore",
			"graphViewport": "JK_n9q_graphViewport",
			"graphEdge": "JK_n9q_graphEdge",
			"graphCanvasControls": "JK_n9q_graphCanvasControls",
			"flowTrack": "JK_n9q_flowTrack",
			"inspectorTitle": "JK_n9q_inspectorTitle",
			"bodyGrid": "JK_n9q_bodyGrid",
			"flowArchiveTrack": "JK_n9q_flowArchiveTrack",
			"storageDomains": "JK_n9q_storageDomains",
			"topNavigation": "JK_n9q_topNavigation",
			"checking": "JK_n9q_checking",
			"page": "JK_n9q_page",
			"searchBar": "JK_n9q_searchBar",
			"content": "JK_n9q_content",
			"bodyHealth": "JK_n9q_bodyHealth",
			"confirmBar": "JK_n9q_confirmBar",
			"supervisedHeading": "JK_n9q_supervisedHeading",
			"memoryFlow": "JK_n9q_memoryFlow",
			"flowLane": "JK_n9q_flowLane",
			"flowTrace": "JK_n9q_flowTrace",
			"flowTraceVertical": "JK_n9q_flowTraceVertical",
			"flowSecondaryTrack": "JK_n9q_flowSecondaryTrack",
			"graphLegend": "JK_n9q_graphLegend",
			"graphPanel": "JK_n9q_graphPanel",
			"previewOverlay": "JK_n9q_previewOverlay",
			"flowLegend": "JK_n9q_flowLegend",
			"storageRoot": "JK_n9q_storageRoot",
			"storageFootnote": "JK_n9q_storageFootnote",
			"runtimeBadge": "JK_n9q_runtimeBadge",
			"runtimeTarget": "JK_n9q_runtimeTarget",
			"writeGuide": "JK_n9q_writeGuide",
			"supervisedComposer": "JK_n9q_supervisedComposer",
			"bodySwitch": "JK_n9q_bodySwitch",
			"runtimeComposer": "JK_n9q_runtimeComposer",
			"healthStrip": "JK_n9q_healthStrip",
			"flowArchitectureSignal": "JK_n9q_flowArchitectureSignal",
			"singleColumn": "JK_n9q_singleColumn",
			"graphToolbar": "JK_n9q_graphToolbar",
			"entityResults": "JK_n9q_entityResults",
			"nav": "JK_n9q_nav",
			"telemetryMetric": "JK_n9q_telemetryMetric",
			"graphLayout": "JK_n9q_graphLayout",
			"nodeLabel": "JK_n9q_nodeLabel",
			"searchActions": "JK_n9q_searchActions",
			"flowReviewTrack": "JK_n9q_flowReviewTrack",
			"lifecycleFlow": "JK_n9q_lifecycleFlow",
			"runtimePending": "JK_n9q_runtimePending",
			"badges": "JK_n9q_badges",
			"navGroup": "JK_n9q_navGroup",
			"supervisedForm": "JK_n9q_supervisedForm",
			"previewMeta": "JK_n9q_previewMeta",
			"graphFooter": "JK_n9q_graphFooter",
			"inspectorTitleRow": "JK_n9q_inspectorTitleRow",
			"fieldWide": "JK_n9q_fieldWide",
			"inlineError": "JK_n9q_inlineError",
			"entityLayout": "JK_n9q_entityLayout",
			"emptyState": "JK_n9q_emptyState",
			"bodyDirectory": "JK_n9q_bodyDirectory",
			"healthMuted": "JK_n9q_healthMuted",
			"runtimeEntryMeta": "JK_n9q_runtimeEntryMeta",
			"sessionHint": "JK_n9q_sessionHint",
			"ghostButton": "JK_n9q_ghostButton",
			"previewBody": "JK_n9q_previewBody",
			"spaceSummary": "JK_n9q_spaceSummary",
			"bodySignal": "JK_n9q_bodySignal",
			"resultLayout": "JK_n9q_resultLayout",
			"documentList": "JK_n9q_documentList",
			"healthBad": "JK_n9q_healthBad",
			"runtimeOnline": "JK_n9q_runtimeOnline",
			"statusDot": "JK_n9q_statusDot",
			"lifecyclePanel": "JK_n9q_lifecyclePanel",
			"results": "JK_n9q_results",
			"bodyCardActions": "JK_n9q_bodyCardActions",
			"storageUnavailable": "JK_n9q_storageUnavailable",
			"secondaryButton": "JK_n9q_secondaryButton",
			"storageAreaMetric": "JK_n9q_storageAreaMetric",
			"inspectorEye": "JK_n9q_inspectorEye",
			"agentCitations": "JK_n9q_agentCitations",
			"graphNode": "JK_n9q_graphNode",
			"sectionHeading": "JK_n9q_sectionHeading",
			"bodyCard": "JK_n9q_bodyCard",
			"graphBackdrop": "JK_n9q_graphBackdrop",
			"previewDialog": "JK_n9q_previewDialog",
			"bodyCardTop": "JK_n9q_bodyCardTop",
			"formGrid": "JK_n9q_formGrid",
			"documentDetail": "JK_n9q_documentDetail",
			"entityHeading": "JK_n9q_entityHeading",
			"brand": "JK_n9q_brand",
			"runtimeFootnote": "JK_n9q_runtimeFootnote",
			"manualActions": "JK_n9q_manualActions",
			"listToolbar": "JK_n9q_listToolbar",
			"graphInspector": "JK_n9q_graphInspector",
			"bodyDirectoryHeader": "JK_n9q_bodyDirectoryHeader",
			"lifecycleFoot": "JK_n9q_lifecycleFoot",
			"bodyEdit": "JK_n9q_bodyEdit",
			"runtimeReadOnly": "JK_n9q_runtimeReadOnly",
			"agentAnswerHeading": "JK_n9q_agentAnswerHeading",
			"inspectorHeading": "JK_n9q_inspectorHeading",
			"online": "JK_n9q_online",
			"dangerSolidButton": "JK_n9q_dangerSolidButton",
			"runtimeComposerActions": "JK_n9q_runtimeComposerActions",
			"memoryList": "JK_n9q_memoryList",
			"storagePath": "JK_n9q_storagePath",
			"relatedSource": "JK_n9q_relatedSource",
			"nodeBodyLabel": "JK_n9q_nodeBodyLabel",
			"badge": "JK_n9q_badge",
			"relatedPane": "JK_n9q_relatedPane",
			"runtimeEntry": "JK_n9q_runtimeEntry",
			"runtimeTargetDescription": "JK_n9q_runtimeTargetDescription",
			"inspectorActions": "JK_n9q_inspectorActions",
			"runtimeOffline": "JK_n9q_runtimeOffline",
			"sessionReady": "JK_n9q_sessionReady",
			"masthead": "JK_n9q_masthead",
			"healthIndicator": "JK_n9q_healthIndicator",
			"bodySwitchTrack": "JK_n9q_bodySwitchTrack",
			"bodyDirectoryEmpty": "JK_n9q_bodyDirectoryEmpty",
			"queryField": "JK_n9q_queryField",
			"telemetry": "JK_n9q_telemetry",
			"bodyCreate": "JK_n9q_bodyCreate",
			"navGlyph": "JK_n9q_navGlyph",
			"cardActions": "JK_n9q_cardActions",
			"flowArchitectureNode": "JK_n9q_flowArchitectureNode",
			"statusSectionHeader": "JK_n9q_statusSectionHeader",
			"phaseBadge": "JK_n9q_phaseBadge",
			"shell": "JK_n9q_shell",
			"graphGridLine": "JK_n9q_graphGridLine",
			"muted": "JK_n9q_muted",
			"insightCard": "JK_n9q_insightCard",
			"runtimeGrid": "JK_n9q_runtimeGrid",
			"bodyDirectoryPath": "JK_n9q_bodyDirectoryPath",
			"loadingPanel": "JK_n9q_loadingPanel",
			"documentReader": "JK_n9q_documentReader",
			"runtimeEmpty": "JK_n9q_runtimeEmpty",
			"documentDanger": "JK_n9q_documentDanger",
			"listNotice": "JK_n9q_listNotice",
			"navGroupDivider": "JK_n9q_navGroupDivider",
			"canvas": "JK_n9q_canvas",
			"dangerButton": "JK_n9q_dangerButton",
			"documentToolbar": "JK_n9q_documentToolbar",
			"documentWorkspace": "JK_n9q_documentWorkspace",
			"bodyEditButton": "JK_n9q_bodyEditButton",
			"offline": "JK_n9q_offline",
			"graphSvg": "JK_n9q_graphSvg",
			"entitySearch": "JK_n9q_entitySearch",
			"sessionMissing": "JK_n9q_sessionMissing",
			"pageHeader": "JK_n9q_pageHeader",
			"searchControls": "JK_n9q_searchControls",
			"runtimeTargetHeader": "JK_n9q_runtimeTargetHeader",
			"primaryButton": "JK_n9q_primaryButton",
			"bodyEditActions": "JK_n9q_bodyEditActions",
			"documentSources": "JK_n9q_documentSources",
			"alert": "JK_n9q_alert",
			"healthGood": "JK_n9q_healthGood",
			"statusCluster": "JK_n9q_statusCluster",
			"entityList": "JK_n9q_entityList",
			"memoryFlowCanvas": "JK_n9q_memoryFlowCanvas",
			"flowConnector": "JK_n9q_flowConnector",
			"storageAreaGrid": "JK_n9q_storageAreaGrid",
			"liveDot": "JK_n9q_liveDot",
			"runtimeEntries": "JK_n9q_runtimeEntries",
			"previewHeading": "JK_n9q_previewHeading",
			"entityRail": "JK_n9q_entityRail",
			"loading": "JK_n9q_loading",
			"agentAnswer": "JK_n9q_agentAnswer",
			"runtimeComposerHeading": "JK_n9q_runtimeComposerHeading",
			"pageHeaderMeta": "JK_n9q_pageHeaderMeta",
			"inspectorLogo": "JK_n9q_inspectorLogo",
			"id": "JK_n9q_id"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-mnemon-css:/root/github.com/omdsh-dev/dsh-mnemon/src/client/MnemonToolviews.module.css.mjs
		const css$2 = ".n_mfDW_root{cursor:pointer;min-width:0;height:24px;color:var(--dsw-alias-label-primary);border-radius:6px;flex-wrap:wrap;align-items:center;gap:6px;display:flex;position:relative}.n_mfDW_root:hover{background:var(--dsw-alias-interactive-bg-hover)}.n_mfDW_root:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.n_mfDW_dot{border-radius:50%;flex:none;width:6px;height:6px}.n_mfDW_dotRunning{background:var(--dsw-alias-state-info-primary);animation:1.4s ease-in-out infinite n_mfDW_mnemonToolPulse}.n_mfDW_dotOk{background:var(--dsw-alias-state-success-primary)}.n_mfDW_dotError{background:var(--dsw-alias-state-error-primary)}.n_mfDW_dotStopped{background:var(--dsw-alias-state-warn-primary)}@keyframes n_mfDW_mnemonToolPulse{0%,to{opacity:1}50%{opacity:.35}}@media (prefers-reduced-motion:reduce){.n_mfDW_dotRunning{animation:none}}.n_mfDW_leading{opacity:.85;border-radius:3px;flex:none;width:14px;height:14px}.n_mfDW_title{flex:none;font-size:12px;font-weight:500;line-height:16px}.n_mfDW_summary{white-space:nowrap;text-overflow:ellipsis;min-width:0;color:var(--dsw-alias-label-secondary);flex:auto;font-size:12px;line-height:16px;overflow:hidden}.n_mfDW_actions{opacity:0;flex:none;align-items:center;gap:4px;transition:opacity .12s;display:inline-flex}.n_mfDW_root:hover .n_mfDW_actions,.n_mfDW_root:focus-visible .n_mfDW_actions,.n_mfDW_root[data-open] .n_mfDW_actions{opacity:1}.n_mfDW_actionButton{cursor:pointer;height:20px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:5px;padding:0 8px;font-size:11px;line-height:20px}.n_mfDW_actionButton:hover{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-label-primary)}.n_mfDW_chevron{opacity:.7;flex:none;width:12px;height:12px;transition:transform .12s}.n_mfDW_chevron:before{content:\"\";border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;display:block;transform:translate(2px,1px)rotate(45deg)}.n_mfDW_chevronOpen:before{transform:translate(2px,4px)rotate(-135deg)}.n_mfDW_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);cursor:default;border-radius:0 8px 8px 0;flex-direction:column;flex-basis:100%;gap:6px;min-width:0;margin:2px 0 4px 26px;padding:8px 10px;display:flex}.n_mfDW_detailSection{min-width:0}.n_mfDW_detailLabel{color:var(--dsw-alias-label-caption);letter-spacing:.08em;text-transform:uppercase;margin-bottom:2px;font-size:10px;font-weight:650;display:block}.n_mfDW_detailCode{white-space:pre-wrap;word-break:break-word;max-height:220px;color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,Consolas, monospace);margin:0;font-size:11px;line-height:16px;overflow:auto}.n_mfDW_detailEmpty{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:16px}";
		...
		var MnemonToolviews_module_css_default = {
			"dot": "n_mfDW_dot",
			"chevron": "n_mfDW_chevron",
			"detailCode": "n_mfDW_detailCode",
			"actions": "n_mfDW_actions",
			"dotOk": "n_mfDW_dotOk",
			"summary": "n_mfDW_summary",
			"detailEmpty": "n_mfDW_detailEmpty",
			"mnemonToolPulse": "n_mfDW_mnemonToolPulse",
			"root": "n_mfDW_root",
			"actionButton": "n_mfDW_actionButton",
			"dotError": "n_mfDW_dotError",
			"details": "n_mfDW_details",
			"detailSection": "n_mfDW_detailSection",
			"leading": "n_mfDW_leading",
			"title": "n_mfDW_title",
			"dotStopped": "n_mfDW_dotStopped",
			"chevronOpen": "n_mfDW_chevronOpen",
			"detailLabel": "n_mfDW_detailLabel",
			"dotRunning": "n_mfDW_dotRunning"
		};
		//#endregion
		...
		function summaryFor(toolName, args, out, t) {
			switch (toolName) {
				...
				case "mnemon_related": {
					...
					const hits = out === null ? void 0 : countOf(out.results);
					return hits === void 0 ? truncate(id, 56) : t("toolview.relatedSummary", {
						id: truncate(id, 28),
						count: hits
					});
				}
				...
				case "mnemon_remember": return typeof args.content === "string" ? truncate(args.content, 56) : t("toolview.genericSummary");
				...
				case "mnemon_link": return `${typeof args.sourceId === "string" ? truncate(args.sourceId, 18) : "?"} → ${typeof args.targetId === "string" ? truncate(args.targetId, 18) : "?"}`;
				case "mnemon_forget": return typeof args.id === "string" ? truncate(args.id, 56) : t("toolview.genericSummary");
				case "mnemon_memory_body_create": return typeof args.name === "string" ? truncate(args.name, 56) : t("toolview.genericSummary");
				...
				case "mnemon_memory_body_merge": return t("toolview.bodyMergeSummary", {
					target: typeof args.targetMemoryBodyId === "string" ? truncate(args.targetMemoryBodyId, 24) : "?",
		...
		const MnemonToolView = (0, react.memo)(function MnemonToolView({ toolName, block, inspect, sessionId, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(settled || target !== void 0) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						}), settled && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: MnemonToolviews_module_css_default.actionButton,
							onClick: inspectCall,
						...
						children: [
							showArgs && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									children: truncate(JSON.stringify(args, null, 2), 2e3)
								})]
							}),
		...
		//#endregion
		//#region \0dsh-mnemon-css:/root/github.com/omdsh-dev/dsh-mnemon/src/client/MnemonTurnTail.module.css.mjs
		const css$1 = "._63S_sa_root{min-width:0;margin:2px 0}._63S_sa_bar{cursor:pointer;min-width:0;max-width:100%;height:22px;color:var(--dsw-alias-label-tertiary);background:0 0;border:1px solid #0000;border-radius:6px;align-items:center;gap:6px;padding:0 8px 0 6px;font-size:11px;line-height:22px;display:flex}._63S_sa_bar:hover{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}._63S_sa_bar:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._63S_sa_mark{opacity:.8;flex:none;font-size:10px}._63S_sa_label{flex:none;font-weight:600}._63S_sa_metrics{align-items:center;gap:6px;min-width:0;display:inline-flex;overflow:hidden}._63S_sa_metrics span{white-space:nowrap}._63S_sa_chevron{opacity:.7;flex:none;width:8px;height:8px;margin-left:auto}._63S_sa_chevron:before{content:\"\";border-bottom:1.5px solid;border-right:1.5px solid;width:5px;height:5px;transition:transform .12s;display:block;transform:rotate(45deg)translate(-1px,-1px)}._63S_sa_chevronOpen:before{transform:rotate(-135deg)translate(0)}._63S_sa_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);border-radius:0 8px 8px 0;align-items:center;gap:10px;min-width:0;margin:2px 0 4px;padding:6px 8px;display:flex}._63S_sa_detailLabel{color:var(--dsw-alias-label-caption);letter-spacing:.08em;text-transform:uppercase;flex:none;font-size:10px;font-weight:650}._63S_sa_tools{flex-wrap:wrap;flex:auto;gap:4px;min-width:0;display:flex}._63S_sa_toolChip{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);font-family:var(--ds-font-family-code,Consolas, monospace);white-space:nowrap;border-radius:4px;padding:0 6px;font-size:10px;line-height:18px}._63S_sa_viewButton{cursor:pointer;height:20px;color:var(--dsw-alias-state-business-primary);background:0 0;border:none;border-radius:5px;flex:none;padding:0 8px;font-size:11px;line-height:20px}._63S_sa_viewButton:hover{background:var(--dsw-alias-interactive-bg-active)}";
		...
		var MnemonTurnTail_module_css_default = {
			"metrics": "_63S_sa_metrics",
			"mark": "_63S_sa_mark",
			"details": "_63S_sa_details",
			"label": "_63S_sa_label",
			"root": "_63S_sa_root",
			"chevronOpen": "_63S_sa_chevronOpen",
			"chevron": "_63S_sa_chevron",
			"tools": "_63S_sa_tools",
			"bar": "_63S_sa_bar",
			"toolChip": "_63S_sa_toolChip",
			"viewButton": "_63S_sa_viewButton",
			"detailLabel": "_63S_sa_detailLabel"
		};
		//#endregion
		...
		function selectMnemonTurnTail(owner) {
			...
			return turn !== void 0 && turn.status === "closed";
		}
		/** One-line memory-activity bar under a completed turn; hides when the turn touched no memory. */
		const MnemonTurnTail = (0, react.memo)(function MnemonTurnTail({ turn, sessionId, connection, t }) {
			...
			(0, react.useEffect)(() => {
				...
				let alive = true;
				new MnemonClient(connection, sessionId).turnActivity(number).then((result) => {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: activity.names.map((name) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
		...
		//#endregion
		//#region \0dsh-mnemon-css:/root/github.com/omdsh-dev/dsh-mnemon/src/client/MnemonSaveAction.module.css.mjs
		const css = ".Lx9c-q_wrap{display:inline-flex;position:relative}.Lx9c-q_button{cursor:pointer;height:22px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:5px;align-items:center;gap:4px;padding:0 7px;font-size:11px;line-height:22px;display:inline-flex}.Lx9c-q_button:hover,.Lx9c-q_button[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.Lx9c-q_button:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Lx9c-q_glyph{opacity:.85;font-size:10px}.Lx9c-q_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);width:min(340px,100vw - 32px);color:var(--dsw-alias-label-primary);border-radius:10px;padding:10px 12px;font-size:12px;line-height:18px;position:absolute;top:calc(100% + 4px);right:0;box-shadow:0 8px 24px #0000002e}.Lx9c-q_panelHeader{justify-content:space-between;align-items:center;gap:8px;display:flex}.Lx9c-q_panelHeader strong{font-size:12px;font-weight:600}.Lx9c-q_close{cursor:pointer;width:20px;height:20px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:5px;font-size:14px;line-height:18px}.Lx9c-q_close:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.Lx9c-q_hint{color:var(--dsw-alias-label-secondary);margin:6px 0 0;font-size:11px;line-height:16px}.Lx9c-q_status{color:var(--dsw-alias-label-tertiary);margin-top:8px;font-size:11px}.Lx9c-q_readOnly{background:var(--dsw-alias-state-warn-bg,transparent);color:var(--dsw-alias-state-warn-primary);border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}.Lx9c-q_candidate{margin-top:8px;display:block}.Lx9c-q_candidate>span{color:var(--dsw-alias-label-caption);letter-spacing:.08em;text-transform:uppercase;margin-bottom:4px;font-size:10px;font-weight:650;display:block}.Lx9c-q_candidate textarea{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);resize:vertical;background:var(--dsw-specific-input-major,var(--dsw-alias-bg-base));width:100%;max-height:160px;color:var(--dsw-alias-label-primary);font:12px/18px var(--ds-font-family-code,Consolas, monospace);border-radius:8px;padding:8px 10px;display:block}.Lx9c-q_candidate textarea:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.Lx9c-q_outcome{background:var(--dsw-alias-state-success-bg,transparent);color:var(--dsw-alias-state-success-primary);border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}.Lx9c-q_failure{background:var(--dsw-alias-state-error-bg,transparent);color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}.Lx9c-q_submit{cursor:pointer;background:var(--dsw-alias-button-primary-fill,var(--dsw-alias-state-business-primary));width:100%;height:28px;color:var(--dsw-alias-button-primary-text,#fff);border:none;border-radius:7px;margin-top:10px;font-size:12px;font-weight:600;line-height:28px}.Lx9c-q_submit:hover:not(:disabled){filter:brightness(1.06)}.Lx9c-q_submit:disabled{cursor:default;opacity:.5}.Lx9c-q_submit:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}";
		...
		var MnemonSaveAction_module_css_default = {
			"panelHeader": "Lx9c-q_panelHeader",
			"close": "Lx9c-q_close",
			"candidate": "Lx9c-q_candidate",
			"submit": "Lx9c-q_submit",
			"wrap": "Lx9c-q_wrap",
			"button": "Lx9c-q_button",
			"readOnly": "Lx9c-q_readOnly",
			"failure": "Lx9c-q_failure",
			"outcome": "Lx9c-q_outcome",
			"hint": "Lx9c-q_hint",
			"panel": "Lx9c-q_panel",
			"glyph": "Lx9c-q_glyph",
			"status": "Lx9c-q_status"
		};
		//#endregion
		...
		const MnemonSaveAction = (0, react.memo)(function MnemonSaveAction({ messageId, sessionId, connection, t }) {
			...
			(0, react.useEffect)(() => {
				...
				client.status().then((status) => {
					if (alive) setWriteEnabled(status.writeEnabled);
				}).catch(() => {
					if (alive) setWriteEnabled(false);
				});
			...
			const submit = () => {
				...
				setFailure(null);
				setOutcome(null);
				new MnemonClient(connection, sessionId).supervise(content).then((result) => {
					setOutcome({
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						candidate !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("saveAction.candidate") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
								ref: textareaRef,
								rows: 5,
						...
						candidate !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							disabled: submitting || writeEnabled === false,
							onClick: submit,
		...
		function enabledOf(value, key) {
			return (value?.conversationInteraction)?.[key] === true;
		}
