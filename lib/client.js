window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"documents.emptyActiveText": "复杂对话的空闲审阅会自动整理档案，也可以在上方手动创建。",
			...
			"status.lifecycleText": "pre-step 只提供短提示；主 Agent 自主查询档案或召回记忆，持续空闲后由一个 fork 子 Agent 同时审阅热记忆与复杂项目档案。",
			"status.phaseIdle": "待命",
			...
			"status.writeText": "连续空闲 {seconds} 秒后 fork 完整 checkpoint，按需维护热记忆与项目档案",
		...
		const en = {
			...
			"documents.emptyActiveText": "The idle checkpoint reviewer can distill complex work automatically, or you can create one above.",
			...
			"status.lifecycleText": "Pre-step adds only a short cue. The main Agent searches Documents or recalls memory by need; after sustained idle, one fork child reviews hot memory and substantial project documentation together.",
			...
			"status.writeText": "Fork the full checkpoint after {seconds}s idle, then maintain hot memory and project Documents only when justified",
		...
		function enrichMultiSpaceGraph(graph, bodies) {
			...
			for (const body of activeBodies) for (const item of body.stats?.topEntities ?? []) {
			...
			for (const item of entities) {
				...
				for (const body of item.bodies) {
					...
					if (matching.length === 0) edges.push({
						sourceId: spaceGraphId(body.id),
						targetId: key,
						label: item.entity,
						color: "#708199",
					...
					else for (const memory of matching) edges.push({
						sourceId: key,
						targetId: graphNodeKey(memory),
						label: item.entity,
						color: "#22a879",
		...
		function StatusPage(props) {
			...
			current?.lastAt === void 0 ? t("status.noActivity") : new Date(current.lastAt).toLocaleString();
				...
				children: [
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `${MnemonView_module_css_default.healthIndicator} ${lifecycle?.sessionAvailable === true ? MnemonView_module_css_default.healthGood : MnemonView_module_css_default.healthBad}` }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: workers === void 0 ? t("status.orchestrationWaiting") : t("status.workerCounts", {
									...
									answers: workers.answers ?? 0,
									reviews: workers.reviews ?? 0,
									documentArchives: workers.documentArchives ?? 0,
									compactions: workers.compactions ?? 0,
									migrations: workers.migrations ?? 0,
							...
							children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
											...
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("status.writeWorker") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: lifecycle?.writebackMode === "guided" ? t("status.writeText", { seconds: Math.round((lifecycle.idleReviewMs ?? 0) / 1e3) }) : t("status.writeOff") })] }),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
											t("status.reviewState"),
											" ",
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: reviewState })
										] }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
											t("status.lastReview"),
											" ",
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
											t("status.reviewDocuments"),
											" ",
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: current?.lastReviewDocumentIds?.length ?? 0 })
										] }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("ul", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
											"data-ok": documents !== void 0 || void 0,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {}), documents === void 0 ? t("status.documentsUnavailable") : t("status.documentsHealthy", { count: documents.activeCount })]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("status.documentDirectory") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: documents?.directory ?? "—" }) })] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("status.activeDocuments") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: documents?.activeCount ?? "—" })] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("status.coldDocuments") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: documents?.archivedCount ?? "—" })] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("status.documentCapacity") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: documents === void 0 ? "—" : `${humanBytes(documents.activeBytes)} / ${humanBytes(documents.limitBytes)}` })] })
						] })]
					})
				]
			});
