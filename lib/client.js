window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = ".j5f0Ia_card{box-sizing:border-box;width:100%;max-width:720px;color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-bg-layer-1));border-radius:12px;overflow:clip}.j5f0Ia_panelHeader{box-sizing:border-box;align-items:flex-start;gap:20px;min-height:76px;padding:16px;display:flex}.j5f0Ia_headerCopy{flex:1;min-width:0}.j5f0Ia_panelHeader h3{margin:0;font-size:15px;font-weight:600;line-height:22px}.j5f0Ia_panelHeader p{max-width:60ch;color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere;margin:2px 0 0;font-size:12px;line-height:18px}.j5f0Ia_status{background:var(--dsw-alias-bg-layer-2);min-height:22px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;border-radius:999px;flex:none;align-items:center;margin-top:1px;padding:0 8px;font-size:11px;font-weight:500;line-height:18px;display:inline-flex}.j5f0Ia_statusDirty{color:var(--dsw-alias-state-warn-label,var(--dsw-alias-label-primary));background:var(--dsw-alias-interactive-bg-hover)}.j5f0Ia_body{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:16px;padding:16px;display:flex}.j5f0Ia_notice{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;font-size:12px;line-height:18px}.j5f0Ia_notice code{font-family:var(--dsw-font-family-mono,var(--ds-font-family-code,monospace));font-size:.95em}.j5f0Ia_loading{min-height:48px;color:var(--dsw-alias-label-tertiary);text-align:center;margin:0;font-size:12px;line-height:48px}.j5f0Ia_primarySettings{gap:16px;width:100%;max-width:660px;display:grid}.j5f0Ia_field{gap:6px;min-width:0;display:grid}.j5f0Ia_fieldHeading{align-items:center;gap:6px;min-height:20px;display:flex}.j5f0Ia_fieldTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:500;line-height:18px}.j5f0Ia_overridden{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;flex:none;padding:1px 6px;font-size:10px;font-style:normal;font-weight:400;line-height:16px}.j5f0Ia_reset{color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;background:0 0;border:0;flex:none;margin-left:auto;padding:2px 0;font-size:11px;line-height:16px}.j5f0Ia_reset:hover{color:var(--dsw-alias-label-primary)}.j5f0Ia_reset:disabled{cursor:not-allowed;opacity:.5}.j5f0Ia_field input,.j5f0Ia_field select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:38px;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major,var(--dsw-alias-bg-layer-2));font:inherit;border-radius:8px;outline:0;padding:0 10px;font-size:12px;transition:border-color .12s,box-shadow .12s,background-color .12s}.j5f0Ia_field input{font-family:var(--dsw-font-family-mono,var(--ds-font-family-code,monospace))}.j5f0Ia_field input:focus,.j5f0Ia_field select:focus{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px var(--dsw-alias-interactive-bg-hover)}.j5f0Ia_field input[aria-invalid=true]{border-color:var(--dsw-alias-state-error-primary)}.j5f0Ia_field input:disabled,.j5f0Ia_field select:disabled{cursor:not-allowed;opacity:.55}.j5f0Ia_fieldHint{color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;margin:0;font-size:11px;line-height:16px}.j5f0Ia_feedback:empty{display:none}.j5f0Ia_error,.j5f0Ia_readOnly{background:var(--dsw-alias-bg-layer-2);overflow-wrap:anywhere;border-radius:7px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.j5f0Ia_error{color:var(--dsw-alias-state-error-primary)}.j5f0Ia_readOnly{color:var(--dsw-alias-label-tertiary)}.j5f0Ia_feedback{gap:6px;display:grid}.j5f0Ia_actions{justify-content:flex-end;gap:8px;padding-top:2px;display:flex}.j5f0Ia_actions button{cursor:pointer;min-width:88px;min-height:34px;font:inherit;touch-action:manipulation;border-radius:999px;padding:7px 14px;font-size:12px;font-weight:500;line-height:18px;transition:background-color .12s,border-color .12s,color .12s,opacity .12s}.j5f0Ia_actions button:disabled{cursor:not-allowed;opacity:.5}.j5f0Ia_actions button:focus-visible,.j5f0Ia_reset:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.j5f0Ia_discard{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3,transparent);border:1px solid var(--dsw-alias-border-l2)}.j5f0Ia_discard:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-solid,var(--dsw-alias-interactive-bg-hover))}.j5f0Ia_save{color:var(--dsw-alias-label-primary-foreground,#fff);background:var(--dsw-alias-button-primary-fill,var(--dsw-alias-state-business-primary));border:1px solid #0000}.j5f0Ia_save:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover,var(--dsw-alias-state-business-primary))}@media (width<=560px){.j5f0Ia_body{padding:14px}.j5f0Ia_panelHeader{flex-direction:column;gap:8px;padding:14px}.j5f0Ia_status{margin-top:0}.j5f0Ia_field input,.j5f0Ia_field select{height:40px}.j5f0Ia_actions button{flex:1}}@media (width<=360px){.j5f0Ia_actions{flex-direction:column-reverse}.j5f0Ia_fieldHeading{flex-wrap:wrap}.j5f0Ia_reset{margin-left:0}}@media (prefers-reduced-motion:reduce){.j5f0Ia_field input,.j5f0Ia_field select,.j5f0Ia_actions button{transition:none}}";
		...
		var MnemonSettingsCard_module_css_default = {
			...
			"overridden": "j5f0Ia_overridden",
			"headerCopy": "j5f0Ia_headerCopy",
			"loading": "j5f0Ia_loading",
			"status": "j5f0Ia_status",
			"fieldHeading": "j5f0Ia_fieldHeading"
		};
		//#endregion
		...
		const zh = {
			...
			"status.flowDescription": "按真实执行边界展开每轮注入、确定性文件控制、语义 worker、CLI 数据面、冷归档与 fork 审查。",
			...
			"status.flowLaneMaintenance": "空闲维护与冷归档",
			...
			"status.flowColdArchive": "spawn 冷归档 worker",
		...
		const en = {
			...
			"status.flowDescription": "Maps the real execution boundaries across per-turn injection, deterministic file control, semantic workers, the CLI data plane, cold archive, and fork review.",
			...
			"status.flowLaneMaintenance": "Idle Maintenance and Cold Archive",
			...
			"status.flowColdArchive": "spawn Cold-archive Worker",
		...
		*/
		...
		var MnemonView_module_css_default = {
			...
			"flowSecondaryTrack": "lvR3Qq_flowSecondaryTrack",
			...
			"flowReviewTrack": "lvR3Qq_flowReviewTrack",
			"flowArchiveTrack": "lvR3Qq_flowArchiveTrack",
			...
			"mnemon-flow": "lvR3Qq_mnemon-flow",
			"searchControls": "lvR3Qq_searchControls",
			"flowArchitecture": "lvR3Qq_flowArchitecture",
			"secondaryButton": "lvR3Qq_secondaryButton",
			"entityLayout": "lvR3Qq_entityLayout",
			"markdownBody": "lvR3Qq_markdownBody",
			"listProgress": "lvR3Qq_listProgress",
			"navGlyph": "lvR3Qq_navGlyph",
			"flowTrack": "lvR3Qq_flowTrack",
			"tags": "lvR3Qq_tags",
			...
			"flowTraceVertical": "lvR3Qq_flowTraceVertical",
			"graphBackdrop": "lvR3Qq_graphBackdrop",
			"checking": "lvR3Qq_checking",
			"muted": "lvR3Qq_muted",
			...
			"flowArchitectureNode": "lvR3Qq_flowArchitectureNode",
			...
			"flowConnector": "lvR3Qq_flowConnector",
			"runtimePending": "lvR3Qq_runtimePending",
			...
			"flowArchitectureSignal": "lvR3Qq_flowArchitectureSignal",
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												flowNode(t("status.flowSupervisor"), t("status.flowRootMeta"), hostReady ? "ready" : "idle", "host", hostReady ? "active" : void 0),
