	...
	factory: (require) => {
		...
		*/
		...
		function apply(rawContext) {
			...
			for (const toolName of MNEMON_TOOLVIEW_NAMES) ctx.slots.inject("tool.call.toolview", () => ctx.slots.register({
