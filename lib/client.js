window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"status.workerCounts": "召回 {recalls} · 问答 {answers} · 审查 {reviews} · 本地整理 {compactions} · 归档 {migrations} · 常规写入 {writes}",
		...
		const en = {
			...
			"status.workerCounts": "{recalls} recalls · {answers} answers · {reviews} reviews · {compactions} local compactions · {migrations} archives · {writes} regular writes",
