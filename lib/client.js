		...
		function WorkspaceNavigation(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [appearance.surface === "sidebar" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: PAGE_TABS.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						role: "tab",
						"aria-selected": props.page === item.id,
						"data-active": props.page === item.id ? "" : void 0,
