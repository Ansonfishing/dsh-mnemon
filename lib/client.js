window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var MnemonView_module_css_default = {
			...
			"versionExecutable": "OkhtbG_versionExecutable",
			...
			"tags": "OkhtbG_tags",
			"runtimeBrowserToolbar": "OkhtbG_runtimeBrowserToolbar",
			...
			"statusHeaderActions": "OkhtbG_statusHeaderActions",
			"confirmBar": "OkhtbG_confirmBar",
			"bodyDeleteConfirm": "OkhtbG_bodyDeleteConfirm",
			"storageRoot": "OkhtbG_storageRoot",
			"runtimeEntryTarget": "OkhtbG_runtimeEntryTarget",
			"versionDialogActions": "OkhtbG_versionDialogActions",
			...
			"versionList": "OkhtbG_versionList",
			...
			"modalBackdrop": "OkhtbG_modalBackdrop",
			"runtimeEntryBadges": "OkhtbG_runtimeEntryBadges",
			"inspectorEye": "OkhtbG_inspectorEye",
			"muted": "OkhtbG_muted",
			"bodyDirectoryHeader": "OkhtbG_bodyDirectoryHeader",
			"mnemon-spin": "OkhtbG_mnemon-spin",
			"bodyEdit": "OkhtbG_bodyEdit",
			"healthGood": "OkhtbG_healthGood",
			"versionDialogBody": "OkhtbG_versionDialogBody",
			...
			"runtimeBrowser": "OkhtbG_runtimeBrowser",
			...
			"versionChecking": "OkhtbG_versionChecking",
			"badges": "OkhtbG_badges",
			"documentReader": "OkhtbG_documentReader",
			"runtimeScopeFilter": "OkhtbG_runtimeScopeFilter",
			...
			"runtimeSummaryCard": "OkhtbG_runtimeSummaryCard",
			...
			"versionResult": "OkhtbG_versionResult",
			...
			"versionError": "OkhtbG_versionError",
			...
			"runtimeSummaryGrid": "OkhtbG_runtimeSummaryGrid",
			...
			"runtimeFilterQuery": "OkhtbG_runtimeFilterQuery",
			"versionNumbers": "OkhtbG_versionNumbers",
			"nodeBodyLabel": "OkhtbG_nodeBodyLabel",
			"bodyDeleteContent": "OkhtbG_bodyDeleteContent",
			...
			"compactListProgress": "OkhtbG_compactListProgress",
			"telemetryMetric": "OkhtbG_telemetryMetric",
			"shell": "OkhtbG_shell",
			"topNavigation": "OkhtbG_topNavigation",
			"storageMode": "OkhtbG_storageMode",
			"searchControls": "OkhtbG_searchControls",
			"runtimeUnifiedList": "OkhtbG_runtimeUnifiedList",
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
									...
									children: [
										...
										component.id === "mnemon" && component.executablePath !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", {
											className: MnemonView_module_css_default.versionExecutable,
		...
		const css$1 = ".FDcGda_wrap{display:inline-flex;position:relative}.FDcGda_button{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.FDcGda_button:hover,.FDcGda_button[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.FDcGda_button:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.FDcGda_icon{flex:none;width:16px;height:16px}.FDcGda_modal{width:min(640px,100%);max-height:calc(100vh - 48px)}.FDcGda_modalContent{overscroll-behavior:contain;min-height:0;overflow-y:auto}.FDcGda_modalAction{min-width:96px}.FDcGda_status{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px;line-height:20px}.FDcGda_readOnly{background:var(--dsw-alias-state-warn-bg,transparent);color:var(--dsw-alias-state-warn-primary);border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}.FDcGda_candidate{display:block}.FDcGda_candidate>span{color:var(--dsw-alias-label-caption);margin-bottom:8px;font-size:12px;font-weight:650;line-height:18px;display:block}.FDcGda_candidate textarea{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);resize:vertical;background:var(--dsw-specific-input-major,var(--dsw-alias-bg-base));width:100%;min-height:260px;max-height:50vh;color:var(--dsw-alias-label-primary);font:13px/20px var(--ds-font-family-code,Consolas, monospace);border-radius:8px;padding:8px 10px;display:block}.FDcGda_candidate textarea:focus-visible{outline:1.5px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.FDcGda_truncated{color:var(--dsw-alias-label-tertiary);margin-top:4px;font-size:10px;line-height:14px;display:block}.FDcGda_outcome{background:var(--dsw-alias-state-success-bg,transparent);color:var(--dsw-alias-state-success-primary);border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}.FDcGda_failure{background:var(--dsw-alias-state-error-bg,transparent);color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;border-radius:6px;margin-top:8px;padding:6px 8px;font-size:11px}@supports (height:100dvh){.FDcGda_modal{max-height:calc(100dvh - 48px)}}";
		...
		var MnemonSaveAction_module_css_default = {
			...
			"modalAction": "FDcGda_modalAction",
			"modalContent": "FDcGda_modalContent",
