...
export function memoryPageForTool(name) {
    if (name === 'mnemon_document_search' || name === 'mnemon_document_manage')
        return 'documents';
    if (name === 'mnemon_runtime_memory')
        return 'runtime';
    if (name === 'mnemon_recall' || name === 'mnemon_related')
        return 'explore';
    if (name === 'mnemon_status')
        return 'status';
    return 'overview';
}
