...
type AppearanceSlot = 'shell' | 'masthead' | 'brand' | 'headerActions' | 'workspacePicker' | 'statusCluster' | 'workspaceMismatch' | 'topNavigation' | 'nav' | 'navGroup' | 'canvas' | 'pageHeader' | 'inspectorGlyph';
...
export {};
//# sourceMappingURL=MnemonViewAppearance.d.ts.map