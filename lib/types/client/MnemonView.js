    ...
    for (const item of entities) {
        ...
        for (const body of item.bodies) {
            ...
            if (matching.length === 0)
                edges.push({ sourceId: spaceGraphId(body.id), targetId: key, label: item.entity, color: '#22a879', type: 'entity' });
            else
...
function MemorySystemFlow(props) {
    ...
    return (_jsxs("section", { className: css.memoryFlow, "aria-label": t('status.flowTitle'), children: [_jsxs("div", { className: css.statusSectionHeader, children: [_jsxs("div", { children: [_jsx("h3", { children: t('status.flowTitle') }), _jsx("p", { children: t('status.flowDescription') })] }), _jsx("span", { className: `${css.runtimeBadge} ${flowActive ? css.runtimeOnline : css.runtimeOffline}`, children: flowActive ? t('status.flowLive') : t('status.flowDegraded') })] }), _jsx("div", { className: css.memoryFlowCanvas, children: _jsxs("svg", { viewBox: "0 0 1040 326", role: "img", "aria-labelledby": `${titleId} ${descriptionId}`, children: [_jsx("title", { id: titleId, children: t('status.flowTitle') }), _jsx("desc", { id: descriptionId, children: t('status.flowDescription') }), _jsxs("defs", { children: [_jsx("marker", { id: arrowId, markerWidth: "8", markerHeight: "8", refX: "7", refY: "4", orient: "auto", children: _jsx("path", { className: css.flowArrow, d: "M0 0L8 4L0 8Z" }) }), _jsx("marker", { id: archiveArrowId, markerWidth: "8", markerHeight: "8", refX: "7", refY: "4", orient: "auto", children: _jsx("path", { className: css.flowArchiveArrow, d: "M0 0L8 4L0 8Z" }) }), _jsxs("filter", { id: glowId, children: [_jsx("feGaussianBlur", { stdDeviation: "3", result: "blur" }), _jsxs("feMerge", { children: [_jsx("feMergeNode", { in: "blur" }), _jsx("feMergeNode", { in: "SourceGraphic" })] })] })] }), _jsxs("g", { className: css.flowPaths, children: [_jsx("path", { id: pathId('ingest'), markerEnd: markerEnd, d: "M190 163 C235 163 245 163 284 163" }), _jsx("path", { id: pathId('hot'), markerEnd: markerEnd, d: "M446 148 C486 130 500 88 548 78" }), _jsx("path", { id: pathId('docs'), markerEnd: markerEnd, d: "M446 163 C486 163 500 163 548 163" }), _jsx("path", { id: pathId('durable'), markerEnd: markerEnd, d: "M446 178 C486 198 500 241 548 248" }), _jsx("path", { id: pathId('hot-context'), markerEnd: markerEnd, d: "M712 78 C770 85 784 133 836 148" }), _jsx("path", { id: pathId('doc-context'), markerEnd: markerEnd, d: "M712 163 C762 163 788 163 836 163" }), _jsx("path", { id: pathId('recall'), markerEnd: markerEnd, d: "M712 248 C770 239 785 192 836 178" }), _jsx("path", { id: pathId('hot-archive'), markerEnd: archiveMarkerEnd, className: css.flowArchivePath, d: "M630 112 C630 145 630 199 630 218" }), _jsx("path", { id: pathId('doc-archive'), markerEnd: archiveMarkerEnd, className: css.flowArchivePath, d: "M670 195 C681 213 674 225 658 232" })] }), flowActive && _jsxs("g", { className: css.flowParticles, style: { '--flow-glow': `url(#${glowId})` }, "aria-hidden": "true", children: [['ingest', 'hot', 'docs', 'durable', 'hot-context', 'doc-context', 'recall'].map((path, index) => _jsx("circle", { r: "3", children: _jsx("animateMotion", { dur: `${2.4 + index * .16}s`, begin: `${index * -.47}s`, repeatCount: "indefinite", children: _jsx("mpath", { href: `#${pathId(path)}` }) }) }, path)), ['hot-archive', 'doc-archive'].map((path, index) => _jsx("circle", { className: css.flowArchiveParticle, r: "3", children: _jsx("animateMotion", { dur: `${3.1 + index * .35}s`, begin: `${index * -1.1}s`, repeatCount: "indefinite", children: _jsx("mpath", { href: `#${pathId(path)}` }) }) }, path))] }), _jsxs("g", { className: css.flowNode, "data-state": hostReady ? 'ready' : 'idle', transform: "translate(30 119)", children: [_jsx("rect", { width: "160", height: "88", rx: "15" }), _jsx("circle", { cx: "20", cy: "20", r: "4" }), _jsx("text", { className: css.flowNodeLabel, x: "18", y: "47", children: t('status.flowConversation') }), _jsx("text", { className: css.flowNodeMeta, x: "18", y: "67", children: t('status.flowTurns') })] }), _jsxs("g", { className: `${css.flowNode} ${css.flowSupervisor}`, "data-state": hostReady ? 'ready' : 'idle', transform: "translate(284 105)", children: [_jsx("rect", { width: "162", height: "116", rx: "17" }), _jsx("circle", { cx: "20", cy: "20", r: "4" }), _jsx("text", { className: css.flowNodeLabel, x: "18", y: "48", children: t('status.flowSupervisor') }), _jsx("text", { className: css.flowNodeMeta, x: "18", y: "69", children: props.reviewState }), _jsxs("text", { className: css.flowNodeValue, x: "18", y: "96", children: [score, " / ", threshold] })] }), _jsxs("g", { className: css.flowNode, "data-state": areaState(runtime), transform: "translate(548 35)", children: [_jsx("rect", { width: "164", height: "78", rx: "14" }), _jsx("circle", { cx: "20", cy: "19", r: "4" }), _jsx("text", { className: css.flowNodeLabel, x: "18", y: "43", children: t('status.storageRuntime') }), _jsx("text", { className: css.flowNodeMeta, x: "18", y: "62", children: t('status.flowEntries', { count: runtime?.itemCount ?? 0 }) })] }), _jsxs("g", { className: css.flowNode, "data-state": areaState(documentArea), transform: "translate(548 124)", children: [_jsx("rect", { width: "164", height: "78", rx: "14" }), _jsx("circle", { cx: "20", cy: "19", r: "4" }), _jsx("text", { className: css.flowNodeLabel, x: "18", y: "43", children: t('status.storageDocuments') }), _jsx("text", { className: css.flowNodeMeta, x: "18", y: "62", children: t('status.flowDocuments', { active: documents?.activeCount ?? 0, archived: documents?.archivedCount ?? 0 }) })] }), _jsxs("g", { className: css.flowNode, "data-state": status?.healthy === false ? 'error' : activeBodies > 0 ? 'ready' : 'idle', transform: "translate(548 213)", children: [_jsx("rect", { width: "164", height: "78", rx: "14" }), _jsx("circle", { cx: "20", cy: "19", r: "4" }), _jsx("text", { className: css.flowNodeLabel, x: "18", y: "43", children: t('term.spaces') }), _jsx("text", { className: css.flowNodeMeta, x: "18", y: "62", children: t('status.activeRatio', { active: activeBodies, total: bodies.length }) })] }), _jsxs("g", { className: css.flowNode, "data-state": hostReady ? 'ready' : 'idle', transform: "translate(836 119)", children: [_jsx("rect", { width: "174", height: "88", rx: "15" }), _jsx("circle", { cx: "20", cy: "20", r: "4" }), _jsx("text", { className: css.flowNodeLabel, x: "18", y: "47", children: t('status.flowContext') }), _jsx("text", { className: css.flowNodeMeta, x: "18", y: "67", children: t('status.flowContextDetail') })] })] }) }), _jsxs("div", { className: css.flowLegend, children: [_jsxs("span", { children: [_jsx("i", {}), t('status.flowReadWrite')] }), _jsxs("span", { children: [_jsx("i", {}), t('status.flowArchive')] }), _jsx("span", { children: t('status.flowCurrentScope', { scope: storageScopeLabel(t, status?.storage?.activeKind ?? 'global') }) })] })] }));
}
