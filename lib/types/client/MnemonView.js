...
function WorkspaceNavigation(props) {
    ...
    return (_jsxs("div", { className: appearanceClass(css.topNavigation, appearance.classes.topNavigation), children: [appearance.surface === 'sidebar'
                ? _jsx("div", { className: appearanceClass(css.nav, appearance.classes.nav), role: "tablist", "aria-label": t('nav.aria'), children: PAGE_TABS.map(item => _jsx("button", { type: "button", role: "tab", "aria-selected": props.page === item.id, "data-active": props.page === item.id ? '' : undefined, onClick: () => props.onSelect(item.id), children: t(item.label) }, item.id)) })
