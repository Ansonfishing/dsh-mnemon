...
function RememberPage(props) {
    ...
    return (_jsxs("div", { className: css.page, children: [_jsx(PageHeader, { kicker: "SUPERVISED WRITEBACK", title: "\u6C89\u6DC0\u8BB0\u5FC6", description: "\u4FDD\u5B58\u7A33\u5B9A\u3001\u53EF\u590D\u7528\uFF0C\u5E76\u4E14\u672A\u6765\u786E\u5B9E\u503C\u5F97\u518D\u6B21\u68C0\u7D22\u7684\u4FE1\u606F\u3002", meta: props.writeEnabled ? 'WRITE ENABLED' : 'READ ONLY' }), !props.writeEnabled ? _jsx(EmptyState, { glyph: "\u2298", title: "\u5F53\u524D\u4E3A\u53EA\u8BFB\u6A21\u5F0F", children: "\u8BF7\u5728\u672C Tab \u7684\u201C\u72B6\u6001\u201D\u9875\u9762\u542F\u7528\u5199\u5165\uFF0C\u4FDD\u5B58 settings.yaml \u5E76\u91CD\u542F DSH\u3002" }) : (_jsxs("div", { className: css.writebackLayout, children: [_jsxs("aside", { className: css.writeGuide, children: [_jsx("span", { className: css.cardKicker, children: "DURABILITY GATE" }), _jsx("h3", { children: "\u5199\u5165\u524D\u5FEB\u901F\u5224\u65AD" }), _jsxs("ol", { children: [_jsxs("li", { children: [_jsx("strong", { children: "\u7A33\u5B9A" }), _jsx("span", { children: "\u4E0D\u662F\u4E34\u65F6\u8FDB\u5EA6\u6216\u4E00\u6B21\u6027\u8F93\u51FA" })] }), _jsxs("li", { children: [_jsx("strong", { children: "\u53EF\u590D\u7528" }), _jsx("span", { children: "\u80FD\u5F71\u54CD\u672A\u6765\u7684\u9009\u62E9\u6216\u6267\u884C" })] }), _jsxs("li", { children: [_jsx("strong", { children: "\u81EA\u5305\u542B" }), _jsx("span", { children: "\u5305\u542B\u539F\u56E0\u3001\u8303\u56F4\u548C\u5FC5\u8981\u7EA6\u675F" })] })] }), _jsx("p", { children: "\u5F53\u524D\u6307\u4EE4\u4E0E\u4ED3\u5E93\u4E8B\u5B9E\u59CB\u7EC8\u9AD8\u4E8E\u5386\u53F2\u8BB0\u5FC6\u3002" })] }), _jsxs("form", { className: css.rememberForm, onSubmit: event => void save(event), children: [_jsxs("label", { className: css.fieldWide, children: ["\u8BB0\u5FC6\u5185\u5BB9", _jsx("textarea", { value: content, onChange: event => setContent(event.target.value), maxLength: 8000, rows: 8, placeholder: "\u793A\u4F8B\uFF1A\u9879\u76EE\u9009\u62E9 SQLite\uFF0C\u56E0\u4E3A\u9700\u8981\u5355\u6587\u4EF6\u90E8\u7F72\u548C\u672C\u5730\u4F18\u5148\uFF1B\u82E5\u5E76\u53D1\u5199\u5165\u6210\u4E3A\u74F6\u9888\u518D\u8BC4\u4F30 PostgreSQL\u3002" })] }), _jsxs("div", { className: css.formGrid, children: [_jsxs("label", { children: ["\u5206\u7C7B", _jsx("select", { value: category, onChange: event => setCategory(event.target.value), children: CATEGORIES.map(value => _jsx("option", { value: value, children: CATEGORY_LABELS[value] }, value)) })] }), _jsxs("label", { children: ["\u91CD\u8981\u6027", _jsx("select", { value: importance, onChange: event => setImportance(Number(event.target.value)), children: [1, 2, 3, 4, 5].map(value => _jsxs("option", { value: value, children: [value, " / 5"] }, value)) })] }), _jsxs("label", { className: css.fieldWide, children: ["\u5B9E\u4F53\uFF08\u9017\u53F7\u5206\u9694\uFF09", _jsx("input", { value: entities, onChange: event => setEntities(event.target.value), placeholder: "SQLite, DSH" })] }), _jsxs("label", { className: css.fieldWide, children: ["\u6807\u7B7E\uFF08\u9017\u53F7\u5206\u9694\uFF09", _jsx("input", { value: tags, onChange: event => setTags(event.target.value), placeholder: "architecture, local-first" })] })] }), _jsxs("div", { className: css.formActions, children: [_jsx("button", { type: "submit", className: css.primaryButton, disabled: saving || content.trim() === '', children: saving ? '保存中…' : '写入 Mnemon' }), result !== null && _jsx("span", { role: "status", children: result })] })] })] }))] }));
}
...
function StatusPage(props) {
    ...
    return (_jsxs("div", { className: css.page, children: [_jsx(PageHeader, { kicker: "RUNTIME & CONFIG", title: "\u72B6\u6001\u4E0E\u914D\u7F6E", description: "\u8BCA\u65AD\u5F53\u524D\u8FD0\u884C\u65F6\uFF0C\u5E76\u5728 Mnemon \u5DE5\u4F5C\u53F0\u5185\u7EF4\u62A4\u63D2\u4EF6\u914D\u7F6E\u3002", meta: status?.healthy === true ? 'SYSTEM NOMINAL' : 'CHECK REQUIRED', action: _jsx("button", { type: "button", className: css.secondaryButton, onClick: props.onRefresh, children: props.loading ? '检查中…' : '重新检查' }) }), _jsxs("div", { className: css.statusGrid, children: [_jsxs("article", { className: css.runtimeCard, children: [_jsxs("div", { className: css.cardTitleRow, children: [_jsxs("div", { children: [_jsx("span", { className: css.cardKicker, children: "CONNECTION" }), _jsx("h3", { children: "Mnemon Runtime" })] }), _jsx("span", { className: `${css.runtimeBadge} ${status?.healthy === true ? css.runtimeOnline : css.runtimeOffline}`, children: status?.healthy === true ? 'ONLINE' : 'OFFLINE' })] }), _jsxs("dl", { children: [_jsxs("div", { children: [_jsx("dt", { children: "CLI" }), _jsx("dd", { children: _jsx("code", { children: status?.cliPath ?? 'mnemon' }) })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u7248\u672C" }), _jsx("dd", { children: status?.version ?? '—' })] }), _jsxs("div", { children: [_jsx("dt", { children: "Store" }), _jsx("dd", { children: _jsx("code", { children: status?.store ?? 'default' }) })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u6570\u636E\u76EE\u5F55" }), _jsx("dd", { children: _jsx("code", { children: status?.dataDir ?? '~/.mnemon' }) })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u8D85\u65F6" }), _jsxs("dd", { children: [status?.timeoutMs ?? '—', " ms"] })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u9ED8\u8BA4\u53EC\u56DE" }), _jsxs("dd", { children: [status?.defaultRecallLimit ?? '—', " \u6761"] })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u8BBF\u95EE\u6A21\u5F0F" }), _jsx("dd", { children: status?.writeEnabled === true ? '读取与写入' : '只读' })] })] })] }), _jsxs("article", { className: css.infoCard, children: [_jsx("span", { className: css.cardKicker, children: "OPERATING PRINCIPLE" }), _jsx("h3", { children: "\u8BB0\u5FC6\u8FB9\u754C" }), _jsxs("ul", { children: [_jsx("li", { children: "\u53EA\u5728\u8BB0\u5FC6\u53EF\u80FD\u6539\u53D8\u7ED3\u679C\u65F6\u53EC\u56DE\u3002" }), _jsx("li", { children: "\u5F53\u524D\u7528\u6237\u6307\u4EE4\u548C\u4ED3\u5E93\u4E8B\u5B9E\u9AD8\u4E8E\u65E7\u8BB0\u5FC6\u3002" }), _jsx("li", { children: "\u53EA\u6C89\u6DC0\u7A33\u5B9A\u3001\u53EF\u590D\u7528\u7684\u6D1E\u5BDF\u3002" }), _jsx("li", { children: "\u4E0D\u4F1A\u628A\u6574\u4E2A\u8BB0\u5FC6\u5E93\u81EA\u52A8\u6CE8\u5165\u4E0A\u4E0B\u6587\u3002" })] })] }), _jsxs("article", { className: css.infoCard, children: [_jsx("span", { className: css.cardKicker, children: "NATIVE COMMAND" }), _jsx("h3", { children: "\u5BF9\u8BDD\u5185\u63A5\u5165" }), _jsxs("div", { className: css.commandList, children: [_jsx("code", { children: "/mnemon status" }), _jsx("code", { children: "/mnemon recall <query>" }), _jsx("code", { children: "/mnemon remember <content>" })] }), _jsx("p", { children: "\u67E5\u8BE2\u72B6\u6001\u3001\u53EC\u56DE\u3001\u5199\u5165\u3001\u5173\u8054\u548C\u8F6F\u5220\u9664\u5747\u53EF\u4F7F\u7528\u539F\u751F\u547D\u4EE4\u3002" })] }), _jsx("div", { className: css.settingsPanel, children: _jsx(MnemonSettingsCard, { scope: props.settingsScope }) })] })] }));
}
