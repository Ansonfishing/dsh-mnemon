...
function MnemonPanel({ ctx, settings, t }) {
    ...
    return _jsx(MnemonView, { connection: ctx.connection, settingsScope: settings, ...(sessions.current === undefined ? {} : { sessionId: sessions.current }), ...(resolvedSelectedId === undefined ? {} : { workspaceId: resolvedSelectedId }), workspaceSelection: selection, t: t });
}
