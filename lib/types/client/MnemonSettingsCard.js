...
function validation(draft) {
    ...
    if (!Number.isInteger(idleReview) || idleReview < 5_000 || idleReview > 600_000)
        return '审查空闲等待需为 5000–600000 ms 之间的整数。';
