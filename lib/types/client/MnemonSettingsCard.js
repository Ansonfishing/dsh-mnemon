...
function parsed(field, value) {
    if (isBooleanField(field))
        return value;
    if (field === 'timeoutMs' || field === 'defaultRecallLimit')
        return Number(value);
