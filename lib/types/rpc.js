...
export function createReadHandler(input, lifecycle, runtimeMemory, storage) {
...
export function createWriteHandler(input, lifecycle, runtimeMemory) {
    return async (endpoint, rawPayload) => {
        try {
            const payload = object(rawPayload);
...
export function registerRpc(connection, input, lifecycle, runtimeMemory, storage, packs) {
