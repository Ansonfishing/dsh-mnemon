...
export const zh = {
  ...
  'config.topologyTitle': '记忆拓扑',
  'config.topologyDescription': '由运行中的 Catalog 动态生成。可独立关闭每层，或限制模型自动参与；关闭不会删除已有数据。',
  'config.topologyLoading': '正在读取运行中的记忆拓扑…',
  'config.topologyUnavailable': '当前 Host 尚未提供记忆拓扑描述符；已有配置与兼容行为保持不变。',
  'config.topologyStrategy': '调度策略',
  'config.topologyEnabled': '已开启',
  'config.topologyDisabled': '已关闭',
  'config.topologyLayerToggle': '启用 {layer}',
  'config.topologyChannelAria': '{layer} 的{channel}参与模式',
  'config.topologyRecall': '召回',
  'config.topologyWrite': '写入',
  'config.topologyProjection': '投影',
  'config.topologyMaintenance': '维护',
  'config.topologyModeOff': '关闭',
  'config.topologyModeManual': '仅手动',
  'config.topologyModeAutomatic': '自动',
  'config.topologyRole': '角色',
  'config.topologyAdapters': '{count} 个 Adapter',
...
export const en = {
  ...
  'config.topologyTitle': 'Memory topology',
  'config.topologyDescription': 'Generated from the live Catalog. Disable layers independently or limit model automation. Disabling a layer never deletes its data.',
  'config.topologyLoading': 'Loading the live memory topology…',
  'config.topologyUnavailable': 'This Host does not expose a memory topology descriptor yet. Existing configuration and compatibility behavior are unchanged.',
  'config.topologyStrategy': 'Routing strategy',
  'config.topologyEnabled': 'Enabled',
  'config.topologyDisabled': 'Disabled',
  'config.topologyLayerToggle': 'Enable {layer}',
  'config.topologyChannelAria': '{layer} {channel} participation mode',
  'config.topologyRecall': 'Recall',
  'config.topologyWrite': 'Write',
  'config.topologyProjection': 'Projection',
  'config.topologyMaintenance': 'Maintenance',
  'config.topologyModeOff': 'Off',
  'config.topologyModeManual': 'Manual only',
  'config.topologyModeAutomatic': 'Automatic',
  'config.topologyRole': 'Role',
  'config.topologyAdapters': '{count} adapters',
