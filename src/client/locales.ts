...
export const zh = {
  ...
  'status.workerCounts': '召回 {recalls} · 问答 {answers} · 审查 {reviews} · 迁移 {migrations} · 归档写入 {writes}',
...
export const en = {
  ...
  'status.workerCounts': '{recalls} recalls · {answers} answers · {reviews} reviews · {migrations} migrations · {writes} archive writes',
