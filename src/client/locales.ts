...
export const zh = {
  ...
  'overview.title': '记忆体',
  'overview.description': '统一管理 Mnemon 记忆体与第三方 Provider 自动同步的记忆空间；激活后的记忆体共同参与读取、路由与实时快照。',
  ...
  'overview.directory.description': '每张卡片对应一个真实记忆空间。“激活”决定它是否参与 DSH 读取与路由；第三方标题、描述和范围由 Provider 同步，服务关闭后本地映射会被移除。',
...
export const en = {
  ...
  'overview.description': 'Manage Mnemon Memory Spaces and provider-synchronized third-party namespaces together. Active spaces participate in unified reads, routing, and live snapshots.',
  ...
  'overview.directory.description': 'Each card represents a real memory namespace. Activation controls DSH reads and routing; third-party titles, descriptions, and scopes are synchronized from the provider and their local mappings disappear when its service is disabled.',
