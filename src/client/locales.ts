...
export const zh = {
  ...
  'config.storageDescription': '统一决定三层记忆和 Provider 配置是跨工作区共享，还是随当前工作区隔离。第三方数据边界仍由各自配置决定。',
  'config.scope': '存储范围',
  ...
  'config.providerTargetWorkspace': '工作区配置目标：{workspace}',
...
export const en = {
  ...
  'config.storageDescription': 'Choose whether all three memory tiers and provider configurations are shared globally or isolated with the current workspace. Each external provider still owns its data boundary.',
  ...
  'config.providerTargetWorkspace': 'Workspace configuration target: {workspace}',
