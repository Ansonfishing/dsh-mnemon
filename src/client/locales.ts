...
export const zh = {
  ...
  'overview.directory.description': '这里的“激活”只控制记忆体是否参与 DSH 读取与路由，不会切换 Mnemon 默认 Store，也不影响其他 Agent；写入未激活记忆体后会自动激活。',
  ...
  'overview.createDialogHint': '先定义记忆体的用途，再选择由哪个底层引擎承载。',
  'overview.createIdentityTitle': '记忆体信息',
  'overview.createIdentityHint': '名称用于识别；描述会帮助 Agent 判断什么内容应写入和召回。',
  'overview.createPlacementTitle': '存储与路由',
  'overview.createPlacementHint': '固定使用一个引擎，或由 Agent 按规则和策略选择。',
  ...
  'overview.placementManualHint': '保持现有方式，由你直接选择一个记忆引擎',
  'overview.placementAutomatic': '智能选择',
  'overview.placementAutomaticHint': '先执行硬规则，再由隔离子 Agent 在合格候选中选择',
  ...
  'overview.candidateNativeReady': '始终作为本地候选',
  'overview.providerServiceRequired': '请先到设置中完成该 Provider 的服务配置',
  'overview.workspaceBinding.automatic': '随 DSH 工作区',
  'overview.workspaceBinding.optional-override': '默认随工作区，可覆盖',
  'overview.workspaceBinding.provider-global': '保持 Provider 全局作用域',
  'overview.candidateOpenViking': '纳入远程候选并提供连接',
  'overview.candidateLocal': '本地候选 · 需要完成配置',
  'overview.candidateRemote': '远程候选 · 凭据只由 Host 保存',
  ...
  'config.providerSecretStored': '已安全保存，留空不会更改',
  'config.providerSecretRemovalPending': '将在保存后移除',
  'config.providerSecretRemove': '移除',
  'config.providerSecretUndo': '撤销',
  'config.providerSecretRemovalPlaceholder': '保存后将移除；输入新凭证可替换',
  ...
  'status.nativeAria': 'Mnemon Native Provider 状态',
  ...
  'config.storageDescription': '决定 Runtime、Documents、Mnemon Native 及支持工作区绑定的 Provider 是否随当前工作区隔离；其余 Provider 保持自身全局作用域。',
  'config.scope': '存储范围',
  ...
  'config.providersDescription': '这里只配置 Provider 服务；具体记忆体及其数据范围仍在“记忆体 → 概览”中创建和管理。',
  'config.nativeSummary': '官方原生长期记忆与完整关系图',
  'config.officialNative': '官方原生',
  'config.nativeGlobalLocation': '全局数据位置',
  'config.nativeGlobalLocationHint': 'Mnemon Native 的全局范围可以使用默认目录或指定一个目录。',
  ...
  'config.providerServiceHint': '供该 Provider 的所有记忆体复用；不在这里创建记忆体。',
  'config.providerEnableHint': '填写服务配置并保存后，Provider 才会启用并进入记忆工作流。',
  ...
  'config.providerServiceSaved': '服务配置已保存',
  ...
  'config.providerTargetWorkspace': '当前 DSH 工作区：{workspace}；只有标记“随工作区”的 Provider 会切换数据范围。',
  ...
  'config.packWholeZipHint': '包含 Runtime、Documents 和 Mnemon Native 记忆体；不包含第三方数据或密钥。',
...
export const en = {
  ...
  'overview.directory.description': '“Active” controls only whether a space participates in DSH reads and routing. It does not switch Mnemon’s default Store or affect other agents. Writing to an inactive space activates it.',
  ...
  'overview.createDialogHint': 'Define what this space is for, then choose the engine that will store it.',
  ...
  'overview.createPlacementTitle': 'Storage and routing',
  'overview.createPlacementHint': 'Pin one engine, or let the agent choose from rules and strategy.',
  ...
  'overview.placementManualHint': 'Keep the existing flow and choose one memory engine directly',
  'overview.placementAutomatic': 'Smart selection',
  'overview.placementAutomaticHint': 'Enforce hard rules first, then let an isolated subagent choose among eligible engines',
  ...
  'overview.candidateNativeReady': 'Always available as the local candidate',
  'overview.providerServiceRequired': 'Configure this provider service in Settings first',
  'overview.workspaceBinding.automatic': 'Follows the DSH workspace',
  'overview.workspaceBinding.optional-override': 'Follows by default; can be overridden',
  'overview.workspaceBinding.provider-global': 'Keeps the provider-global scope',
  'overview.candidateOpenViking': 'Include the remote candidate and provide its connection',
  'overview.candidateLocal': 'Local candidate · configuration required',
  'overview.candidateRemote': 'Remote candidate · credentials remain in the Host',
  ...
  'config.providerSecretStored': 'Saved securely; leave blank to keep it',
  'config.providerSecretRemovalPending': 'Will be removed when saved',
  'config.providerSecretRemove': 'Remove',
  'config.providerSecretUndo': 'Undo',
  'config.providerSecretRemovalPlaceholder': 'Will be removed on save; enter a replacement to keep a credential',
  'overview.providerAccount': 'Account',
  'overview.providerUser': 'User',
  'overview.providerActorPeer': 'Actor Peer',
  ...
  'status.nativeAria': 'Mnemon Native provider status',
  'status.nativeLabel': 'Native provider',
  ...
  'config.storageDescription': 'Choose whether Runtime, Documents, Mnemon Native, and workspace-aware providers follow the current workspace. Other providers keep their own global scope.',
  ...
  'config.providersDescription': 'Configure provider services here. Create Memory Spaces and choose their data scopes in Memory Spaces → Overview.',
  ...
  'config.nativeGlobalLocationHint': 'Mnemon Native can use its default global directory or a directory you choose.',
  ...
  'config.providerServiceHint': 'Shared by this provider’s Memory Spaces; no Memory Space is created here.',
  'config.providerEnableHint': 'Complete and save the service configuration before this provider joins memory workflows.',
  ...
  'config.providerServiceSaved': 'Service configuration saved',
  ...
  'config.providerTargetWorkspace': 'Current DSH workspace: {workspace}. Only providers marked as workspace-following switch their data scope.',
  ...
  'config.packWholeZipHint': 'Includes Runtime, Documents, and Mnemon Native Memory Spaces; excludes external data and credentials.',
