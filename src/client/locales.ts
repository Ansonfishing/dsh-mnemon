...
export const zh = {
  ...
  'overview.providerRemote': '远程记忆 · 异步提炼',
  ...
  'overview.disconnectWarning': '这里只会从 DSH 记忆体目录移除连接；OpenViking 服务中的远程记忆不会被删除。',
...
export const en = {
  ...
  'overview.providerUser': 'User',
  'overview.providerActorPeer': 'Actor Peer',
  'overview.providerRemote': 'Remote memory · async extraction',
  ...
  'overview.disconnectWarning': 'This only removes the connection from the DSH Memory Space directory. Memories on the OpenViking service remain untouched.',
