...
export const zh = {
  ...
  'overview.metadataDescription': '选择一个或多个已激活记忆体。系统会分别通过各 Provider 最快的原生查询路径读取少量样本，再由独立子 Agent 生成标题与说明。',
  'overview.metadataUnavailable': '当前没有可承载生成任务的活跃 Agent',
...
export const en = {
  ...
  'overview.metadataDescription': 'Select one or more active Memory Spaces. The system reads a small sample through each Provider’s fastest native path, then gives each space to an isolated child Agent for its title and description.',
  'overview.metadataUnavailable': 'No active Agent is currently available to host this generation task',
