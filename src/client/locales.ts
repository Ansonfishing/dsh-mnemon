...
export const zh = {
  ...
  'config.providerSecretRevealReplacement': '既有凭证不会回传；输入新凭证后可显示',
...
export const en = {
  ...
  'config.providerSecretRevealReplacement': 'Saved credentials are not returned; enter a replacement to reveal it',
  'overview.providerAccount': 'Account',
  'overview.providerUser': 'User',
  'overview.providerActorPeer': 'Actor Peer',
