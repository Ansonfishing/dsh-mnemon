...
export const zh = {
  ...
  'config.providersDescription': '每份配置就是一个可直接启用的记忆体；连接、身份和数据边界归入对应 Provider。',
  ...
  'config.providerUnavailable': '当前 DSH 主机不支持记忆体配置。',
...
export const en = {
  ...
  'config.providersDescription': 'Each configuration is a ready-to-use Memory Space; connection, identity, and data boundaries stay with its provider.',
  ...
  'config.providerUnavailable': 'This DSH host does not support Memory Space configuration.',
