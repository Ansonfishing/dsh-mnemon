...
export const zh = {
  ...
  'config.providersDescription': '在这里启用并配置 Provider 服务。范围标签显示当前生效边界：支持工作区的 Provider 跟随上方选择，其他 Provider 保持全局；具体记忆体仍在“记忆体 → 概览”创建。',
...
export const en = {
  ...
  'config.providersDescription': 'Enable and configure provider services here. Scope tags show the active boundary: workspace-aware providers follow the selection above, while other providers stay global. Create Memory Spaces in Memory Spaces → Overview.',
